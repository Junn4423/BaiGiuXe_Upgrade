...
class lv_lv0007 extends lv_controler {
	...
	function LV_Insert(){
		$vsql="INSERT INTO lv_lv0007(lv001, lv003, lv004, lv005, lv006,lv009,lv900, lv901) 
		VALUES ('$this->lv001', '$this->lv003', '$this->lv004', '".md5($this->lv005)."', '$this->lv006',CURDATE(),'$this->lv900','$this->lv901')";
