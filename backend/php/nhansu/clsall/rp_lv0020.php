<?php
class rp_lv0020 extends lv_controler{
	var $vRowHeader="
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function LV_GetSalaryIncrease($vEmpID,$vShowLuong=0)
	{
		...
		$lvsql="
		SELECT MP.* FROM (
			select A.lv004 DateS,A.lv001,A.lv003,A.lv004,A.lv005,A.lv009,A.lv010,A.lv021,A.lv022,A.lv023,A.lv024,A.lv025,A.lv027,A.lv028,A.lv031,A.lv032,A.lv033,C.lv003 Converters from hr_lv0038 A left join hr_lv0018 C on A.lv024=C.lv001 where A.lv002='".$vEmpID."' $vCondition
			UNION
			select B.lv004 DateS,A.lv001,A.lv003,A.lv004,A.lv005,A.lv009,IF(B.lv003='DOICVPB' OR B.lv003='DOIPHONGBAN',B.lv006,A.lv010) lv010,A.lv021,A.lv022,A.lv023,A.lv024,A.lv025,B.lv010 lv027,B.lv011 lv028,A.lv031,A.lv032,A.lv033,C.lv003 Converters from hr_lv0038 A inner join hr_lv0098 B on B.lv099=A.lv001 left join hr_lv0018 C on A.lv024=C.lv001 where A.lv002='".$vEmpID."' $vCondition
		...
		while($vrow=db_fetch_array($vresult))
		{
			...
			for($y=$vYearS;$y<=$vYearE;$y++)
			{
				...
				for($m=$vMonthS;$m<=$vMonthE;$m++)
				{
					...
					//Cot moi
					//ngonngu
					$vArrContractBuild[$stt]['cot82']=$vrow['lv013']*$vrow['Converters'];
					//vitinh
					$vArrContractBuild[$stt]['cot83']=$vrow['lv014']*$vrow['Converters'];
					//Tham nien
					$vArrContractBuild[$stt]['cot84']=$vrow['lv026']*$vrow['Converters'];
					//Trợ cấp nhà trọ
					$vArrContractBuild[$stt]['cot85']=$vrow['lv016']*$vrow['Converters'];
					//Kỹ Thuật
					$vArrContractBuild[$stt]['cot86']=$vrow['lv018']*$vrow['Converters'];
					//Xăng xe
					$vArrContractBuild[$stt]['cot87']=$vrow['lv020']*$vrow['Converters'];
					//Phụ cấp trách nhiệm
					$vArrContractBuild[$stt]['cot88']=$vrow['lv025']*$vrow['Converters'];
					//Phụ cấp công trình
					$vArrContractBuild[$stt]['cot89']=$vrow['lv023']*$vrow['Converters'];
					//Phụ cấp khác
					$vArrContractBuild[$stt]['cot90']=$vrow['lv031']*$vrow['Converters'];
					//Lương
					$vArrContractBuild[$stt]['cot91']=$vrow['lv032']*$vrow['Converters'];
					//PC++
					$vArrContractBuild[$stt]['cot92']=$vrow['lv033']*$vrow['Converters'];
					//END cot moi
					...
					$vArrContractBuild[$stt]['cot11']=$vTongCongLuong2;
					if($isFirst==false )
					{
						$isFirst=true;
					...
					if(($vTongCongLuong2)!=$vPre && $vPre!=0)
					{
						$this->MonthStaff[$stt][$vEmpID][0]=$vEmpID;
						$this->MonthStaff[$stt][$vEmpID][1]=$vTongCongLuong2;
						$this->MonthStaff[$stt][$vEmpID][2]=$vPre;
						$this->MonthAll[$stt]=$stt;
						//$this->MonthStaff[$stt][$vEmpID][3]=$vArrContractBuild[$stt];
						$this->MonthStaff[$stt][$vEmpID][10]=$vrow['lv010'];
						$this->MonthStaff[$stt][$vEmpID][27]=$vrow['lv027'];
						$this->MonthStaff[$stt][$vEmpID][11]=$this->FormatView($vrow['DateS'],2);
					}
	...
	function Get_BuildList_Array_Monthly($vYear,$vMonth)
	{
		$vTable='
	...
	<tbody>
		...
		<tr height="33">
			<td height="33"><img alt="SOF.VN" height="105" src="http://sof.vn/SOF/logo.png" width="116" /></td>
			<td colspan="4" align="center"><strong>THAY ĐỔI LƯƠNG '.$vYear.'</strong></td>
			<td height="33" width="116">&nbsp;</td>
	...
	<tbody>
		<tr height="27">
			<td height="27"><strong><br />
				</strong></td>
			<td width="209"><strong><br />
				</strong></td>
			<td width="209"><strong><br />
				</strong></td>
			<td><strong>Ngày thay đổi</strong></td>
			<td align="center"><strong>Vị trí lương</strong></td>
			<td><strong><br />
				</strong></td>
		</tr>
		<tr height="27">
			<td height="27" width="209"><strong>Tên nhân viên</strong></td>
			<td width="209"><strong>Phòng ban</strong></td>
			<td width="209"><strong>Vị trí</strong></td>
			<td><strong><br />
				</strong></td>
			<td align="center"><strong>Mức cũ</strong></td>
			<td align="center"><strong>Mức mới</strong></td>
		</tr>
		@01
	</tbody>
</table>
';
	$vMonthTitle='<tr height="40">
			<td height="40" style="background:yellow"><font ><strong>THÁNG @01<strong></font></td>
			<td width="209">&nbsp;</td>
			<td width="209">&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
	...
	$vTr='
		...
		$strListEmp="";
		sort ($this->MonthAll);
		foreach($this->MonthAll as $vAction)
		{
			if($vAction>=$vYear.'-'.$vMonth)
			{
				if(count($this->MonthStaff[$vAction])>0)
				{
					$strListEmp=$strListEmp.str_replace("@01",$vAction,$vMonthTitle);
					foreach($this->MonthStaff[$vAction] as $vMonthStaff)
					{
						$vStaffOne=str_replace("@01",$this->getvaluelink('lv200',$vMonthStaff[0]),$vTr);
						$vStaffOne=str_replace("@02",$this->getvaluelink('lv201',$vMonthStaff[10]),$vStaffOne);
						$vStaffOne=str_replace("@03",$vMonthStaff[27],$vStaffOne);
						$vStaffOne=str_replace("@04",$vMonthStaff[11],$vStaffOne);
						$vStaffOne=str_replace("@05",$this->FormatView($vMonthStaff[2],20),$vStaffOne);
						$vStaffOne=str_replace("@06",$this->FormatView($vMonthStaff[1],20),$vStaffOne);
						$strListEmp=$strListEmp.$vStaffOne;
		...
		return str_replace("@01",$strListEmp,$vTable);
	...
	function Get_BuildList_Array($vArrayEmpFull)
	{
		...
		if($this->isType==6)
		{
			...
			return $this->Get_BuildList_Array_Monthly($cY,Fillnum($cM,2));
		}
		elseif($this->isType==5)
		{
			$cM=getmonth($this->datefrom);
			$cY=getyear($this->datefrom);
			if($cM==1) 
			...
			foreach($vArrayEmpFull as $vEmpFull)
			{
				...
				$vArrSum[$stt]['cot9']=$vArrSum[$stt]['cot9']+(float)$vEmpObj[$stt]['cot9'];
				$vArrSum[$stt]['cot82']=$vArrSum[$stt]['cot82']+(float)$vEmpObj[$stt]['cot82'];
				$vArrSum[$stt]['cot83']=$vArrSum[$stt]['cot83']+(float)$vEmpObj[$stt]['cot83'];
				$vArrSum[$stt]['cot84']=$vArrSum[$stt]['cot84']+(float)$vEmpObj[$stt]['cot84'];
				$vArrSum[$stt]['cot85']=$vArrSum[$stt]['cot85']+(float)$vEmpObj[$stt]['cot85'];
				$vArrSum[$stt]['cot86']=$vArrSum[$stt]['cot86']+(float)$vEmpObj[$stt]['cot86'];
				$vArrSum[$stt]['cot87']=$vArrSum[$stt]['cot87']+(float)$vEmpObj[$stt]['cot87'];
				$vArrSum[$stt]['cot88']=$vArrSum[$stt]['cot88']+(float)$vEmpObj[$stt]['cot88'];
				$vArrSum[$stt]['cot89']=$vArrSum[$stt]['cot89']+(float)$vEmpObj[$stt]['cot89'];
				$vArrSum[$stt]['cot90']=$vArrSum[$stt]['cot90']+(float)$vEmpObj[$stt]['cot90'];
				$vArrSum[$stt]['cot91']=$vArrSum[$stt]['cot91']+(float)$vEmpObj[$stt]['cot91'];
				$vArrSum[$stt]['cot92']=$vArrSum[$stt]['cot92']+(float)$vEmpObj[$stt]['cot92'];
				...
				$vArrSumAll[$stt]['cot9']=$vArrSumAll[$stt]['cot9']+(float)$vEmpObj[$stt]['cot9'];
				$vArrSumAll[$stt]['cot82']=$vArrSumAll[$stt]['cot82']+(float)$vEmpObj[$stt]['cot82'];
				$vArrSumAll[$stt]['cot83']=$vArrSumAll[$stt]['cot83']+(float)$vEmpObj[$stt]['cot83'];
				$vArrSumAll[$stt]['cot84']=$vArrSumAll[$stt]['cot84']+(float)$vEmpObj[$stt]['cot84'];
				$vArrSumAll[$stt]['cot85']=$vArrSumAll[$stt]['cot85']+(float)$vEmpObj[$stt]['cot85'];
				$vArrSumAll[$stt]['cot86']=$vArrSumAll[$stt]['cot86']+(float)$vEmpObj[$stt]['cot86'];
				$vArrSumAll[$stt]['cot87']=$vArrSumAll[$stt]['cot87']+(float)$vEmpObj[$stt]['cot87'];
				$vArrSumAll[$stt]['cot88']=$vArrSumAll[$stt]['cot88']+(float)$vEmpObj[$stt]['cot88'];
				$vArrSumAll[$stt]['cot89']=$vArrSumAll[$stt]['cot89']+(float)$vEmpObj[$stt]['cot89'];
				$vArrSumAll[$stt]['cot90']=$vArrSumAll[$stt]['cot90']+(float)$vEmpObj[$stt]['cot90'];
				$vArrSumAll[$stt]['cot91']=$vArrSumAll[$stt]['cot91']+(float)$vEmpObj[$stt]['cot91'];
				$vArrSumAll[$stt]['cot92']=$vArrSumAll[$stt]['cot92']+(float)$vEmpObj[$stt]['cot92'];				
				...
				foreach($this->DateFor as $vDateE)
				{
					...
					if($vDayInt>=$sttInt)
					{
						if($vCurY!=0 && $vCurY!=$y)
						{
							$lvListTrAll1=$lvListTrAll1.'
							<td align="right" style="background:#c3c3c3">'.$this->FormatView($vEmpObj[$vCurY][$vCurY],20)."</td>";	
							...
							$vDepTitle=$vDepTitle.'<td style="background:#c3c3c3"  colspan="3">&nbsp;</td>';
						}
						$lvListTrAll1=$lvListTrAll1.'
						<td align="right">'.$this->FormatView($vEmpObj[$stt]['cot9'],20).'</td>
						<td align="right">'.$this->FormatView($vEmpObj[$stt]['cot82'],20).'</td>
						<td align="right">'.$this->FormatView($vEmpObj[$stt]['cot83'],20).'</td>
						<td align="right">'.$this->FormatView($vEmpObj[$stt]['cot84'],20).'</td>
						<td align="right">'.$this->FormatView($vEmpObj[$stt]['cot85'],20).'</td>
						<td align="right">'.$this->FormatView($vEmpObj[$stt]['cot86'],20).'</td>
						<td align="right">'.$this->FormatView($vEmpObj[$stt]['cot87'],20).'</td>
						<td align="right">'.$this->FormatView($vEmpObj[$stt]['cot88'],20).'</td>
						<td align="right">'.$this->FormatView($vEmpObj[$stt]['cot89'],20).'</td>
						<td align="right">'.$this->FormatView($vEmpObj[$stt]['cot90'],20).'</td>
						<td align="right">'.$this->FormatView($vEmpObj[$stt]['cot91'],20).'</td>
						<td align="right">'.$this->FormatView($vEmpObj[$stt]['cot92'],20).'</td>
						<td align="right">'.$this->FormatView($vEmpObj[$stt]['cot11'],20).'</td>
						<td align="right">'.$this->FormatView($vEmpObj[$stt]['cot12'],20).'</td>';
						$vDepTitle=$vDepTitle.'<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>';
						$vArrSum[$stt]['cot9']=$vArrSum[$stt]['cot9']+(float)$vEmpObj[$stt]['cot9'];
						$vArrSum[$stt]['cot82']=$vArrSum[$stt]['cot82']+(float)$vEmpObj[$stt]['cot82'];
						$vArrSum[$stt]['cot83']=$vArrSum[$stt]['cot83']+(float)$vEmpObj[$stt]['cot83'];
						$vArrSum[$stt]['cot84']=$vArrSum[$stt]['cot84']+(float)$vEmpObj[$stt]['cot84'];
						...
						$vFooter=$vFooter.'
						<td align="right">'.$this->FormatView($vArrSum[$stt]['cot9'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSum[$stt]['cot82'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSum[$stt]['cot83'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSum[$stt]['cot84'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSum[$stt]['cot85'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSum[$stt]['cot86'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSum[$stt]['cot87'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSum[$stt]['cot88'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSum[$stt]['cot89'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSum[$stt]['cot90'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSum[$stt]['cot91'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSum[$stt]['cot92'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSum[$stt]['cot11'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSum[$stt]['cot12'],20).'</td>';
						$vFooterALL=$vFooterALL.'
						<td align="right">'.$this->FormatView($vArrSumAll[$stt]['cot9'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSumAll[$stt]['cot82'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSumAll[$stt]['cot83'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSumAll[$stt]['cot84'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSumAll[$stt]['cot85'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSumAll[$stt]['cot86'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSumAll[$stt]['cot87'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSumAll[$stt]['cot88'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSumAll[$stt]['cot89'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSumAll[$stt]['cot90'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSumAll[$stt]['cot91'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSumAll[$stt]['cot92'],20).'</td>						
						<td align="right">'.$this->FormatView($vArrSumAll[$stt]['cot11'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSumAll[$stt]['cot12'],20).'</td>';
					}
					else
					{
						if($vCurY!=0 && $vCurY!=$y)
						...
						$vDepTitle=$vDepTitle.'<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>';
						$vFooter=$vFooter.'
						<td align="right">'.$this->FormatView($vArrSum[$stt]['cot9'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSum[$stt]['cot82'],20).'</td>
						<td align="right">'.$this->FormatView($vArrSum[$stt]['cot83'],20).'</td>
	...
	function Get_String_DateFromTo()
	{
		...
		{
			if($this->lang=='VN')
				$vArrLang=Array('luong'=>'Lương CB','luongthuong'=>'Lương thưởng','thuongkhac'=>'Thưởng khác','tongluong'=>'Tổng lương','tangluong'=>'Tăng lương','tongluongtang'=>'Tổng lương tăng','ngonngu'=>'Hiểu quả CV (ABC)','vitinh'=>'Tiền ăn ca','thamnien'=>'Trợ cấp điện thoại','chuyenmon'=>'Trợ cấp nhà trọ','kythuat'=>'Công tác phí','chucvu'=>'Xăng xe','Phụ cấp trách nhiệm'=>'Phụ cấp trách nhiệm','Phụ cấp công trình'=>'Phụ cấp công trình','moitruong'=>'Phụ cấp khác','chuyencan'=>'Lương','tiencom'=>'PC++');
			else
				$vArrLang=Array('luong'=>'Basic Salary','luong'=>'Bonus Salary','thuongkhac'=>'Other Bonus','tongluong'=>'Total Salary','tangluong'=>'Salary Inscrease','tongluongtang'=>'Total inscrease','ngonngu'=>'Language','vitinh'=>'Computer','thamnien'=>'Serious','chuyenmon'=>'Major Salary','kythuat'=>'Technical Salary','chucvu'=>'Title Salary','Phụ cấp trách nhiệm'=>'Transport Salary','Phụ cấp công trình'=>'Home Salary','moitruong'=>'Environment Allowance','chuyencan'=>'Diligence Allowance','tiencom'=>'Eat Allowance');
		}
		else
		{
			if($this->lang=='VN')
				$vArrLang=Array('luong'=>'Lương','tangluong'=>'Tăng lương','tongluongtang'=>'Tổng lương tăng');
			else
				$vArrLang=Array('luong'=>'Salary','tangluong'=>'Salary Inscrease','tongluongtang'=>'Total inscrease');
		}
		$this->DateFor=Array();
		$this->lvHeader="";
		$this->lvFooter="";
		...
		if($vMinDate>$this->datefrom)
			...
			for($y=$vYearS;$y<=$vYearE;$y++)
			{
				...
				for($m=$vMonthS;$m<=$vMonthE;$m++)
				{
					...
					if($this->isType==5)
					{
						$this->lvHeader=$this->lvHeader.'<td colspan="14"><center><b>'.$vTitle.'</b></center></td>';
						$this->lvFooter=$this->lvFooter.'<td><center>'."<!--F-".$vTitle."-->".'</center></td>';
						$this->lvHeader1=$this->lvHeader1.'
						<td class="tdhprint" ><center><b>'.$vArrLang['luong'].'</b></center></td>
						<td class="tdhprint" ><center><b>'.$vArrLang['ngonngu'].'</b></center></td>
						<td class="tdhprint" ><center><b>'.$vArrLang['vitinh'].'</b></center></td>
						<td class="tdhprint" ><center><b>'.$vArrLang['thamnien'].'</b></center></td>
						<td class="tdhprint" ><center><b>'.$vArrLang['chuyenmon'].'</b></center></td>
						<td class="tdhprint" ><center><b>'.$vArrLang['kythuat'].'</b></center></td>
						<td class="tdhprint" ><center><b>'.$vArrLang['chucvu'].'</b></center></td>
						<td class="tdhprint" ><center><b>'.$vArrLang['Phụ cấp trách nhiệm'].'</b></center></td>
						<td class="tdhprint" ><center><b>'.$vArrLang['Phụ cấp công trình'].'</b></center></td>
						<td class="tdhprint" ><center><b>'.$vArrLang['moitruong'].'</b></center></td>
						<td class="tdhprint" ><center><b>'.$vArrLang['chuyencan'].'</b></center></td>
						<td class="tdhprint" ><center><b>'.$vArrLang['tiencom'].'</b></center></td>
						<td class="tdhprint" ><center><b>'.$vArrLang['tongluong'].'</b></center></td>
						
						<td class="tdhprint" ><center><b>'.$vArrLang['tangluong'].'</b></center></td>';
						$strTD=$strTD.'<td align="right">'."<!--".$vTitle."-->".'</td><td align="right">'."<!--t_".$vTitle."-->".'</td><td align="right">'."<!--o_".$vTitle."-->".'</td><td align="right">'."<!--a_".$vTitle."-->".'</td><td align="right">'."<!--_".$vTitle."-->".'</td>';
					}
					else
					{
						$this->lvHeader=$this->lvHeader.'<td colspan="2"><center><b>'.$vTitle.'</b></center></td>';
						$this->lvFooter=$this->lvFooter.'<td><center>'."<!--F-".$vTitle."-->".'</center></td>';
						$this->lvHeader1=$this->lvHeader1.'<td class="tdhprint" ><center><b>'.$vArrLang['luong'].'</b></center></td><td class="tdhprint" ><center><b>'.$vArrLang['tangluong'].'</b></center></td>';
						$strTD=$strTD.'<td align="right">'."<!--".$vTitle."-->".'</td><td align="right">'."<!--_".$vTitle."-->".'</td>';
					}
				}
				$this->lvHeader=$this->lvHeader.'<td rowspan="2" style="background:#c3c3c3"><center><b>'.$vArrLang['tongluongtang'].' '.$y.'</b></center></td>';
