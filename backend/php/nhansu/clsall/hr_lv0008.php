...
////////////
	...
	var $ArrView=array("lv001"=>"0","lv002"=>"0","lv003"=>"10","lv004"=>"0","lv005"=>"10");
	...
	function LV_Insert()
	{
		...
		$lvsql="insert into hr_lv0008 (lv001,lv002,lv003,lv004,lv005) values('$this->lv001','$this->lv002','$this->lv003','$this->lv004','$this->lv005')";
	...
	function LV_Update()
	{
		...
		$lvsql="Update hr_lv0008 set lv002='$this->lv002',lv003='$this->lv003',lv004='$this->lv004',lv005='$this->lv005' where  lv001='$this->lv001';";
		$vReturn= db_query($lvsql);
...
//////////////////////Buil list////////////////////
	...
	private function sqlcondition($vFile,$vSelectID)
	{
		...
		{
			case 'lv004':
				$vsql="select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from  hr_lv0120";
				break;
		}
		return $vsql;
	}
	public function getvaluelink($vFile,$vSelectID)
	{
		...
		{
			case 'lv004':
				$vsql="select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from  hr_lv0120 where lv001='$vSelectID'";
				break;
		}
		if($vsql=="")
		{
