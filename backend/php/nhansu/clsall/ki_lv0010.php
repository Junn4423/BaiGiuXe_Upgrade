<?php
class ki_lv0010 extends lv_controler{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
	public $lv004=null;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function LV_LoadArrPointKPI($vCalID)
	{
		$lvsql="select A.lv002,Sum(A.lv004*A.lv015)/Sum(A.lv015) TongDiem from  ki_lv0006 A inner join ki_lv0005 B on A.lv002=B.lv001 Where B.lv003='$vCalID' group by A.lv002";
		$vresult=db_query($lvsql);
		while($vrow=db_fetch_array($vresult))
		{
			$this->ArrPoint[$vrow['lv002']]=$vrow['TongDiem'];
		}
	}
	function LV_GetListCal($vYear)
	{
		$vListCal='';
		$vsql="select lv001,lv006 from tc_lv0013 where lv007='$vYear' order by lv006 asc";
		$bResult=db_query($vsql);
		while ($vrow = db_fetch_array ($bResult)){
			$this->ArrCal[$vrow['lv001']]=$vrow['lv006'];
			$this->ArrCalBack[$vrow['lv006']]=$vrow['lv001'];
			if($vListCal=='')
				$vListCal="'".$vrow['lv001']."'";
			else
				$vListCal=$vListCal.",'".$vrow['lv001']."'";
		}
		return $vListCal;
	}
	function LV_LoadArrPointKPIYear($vYear)
	{
		$vListCal=$this->LV_GetListCal($vYear);
		$lvsql="select B.lv003 CalID,B.lv002,Sum(A.lv004*A.lv015)/Sum(A.lv015) TongDiem from  ki_lv0006 A inner join ki_lv0005 B on A.lv002=B.lv001 Where B.lv003 in ($vListCal) group by B.lv003,A.lv002";
		$vresult=db_query($lvsql);
		while($vrow=db_fetch_array($vresult))
		{
			$this->ArrPointAll[$vrow['CalID']][$vrow['lv002']]=$vrow['TongDiem'];
			$this->ArrPointAllOK[$vrow['CalID']][$vrow['lv002']]=true;
		}
	}
	function LV_CalPointKPIAll($vCalID,$vParentID)
	{
		return round($this->ArrPointAll[$vCalID][$vParentID],0);
	}
	function LV_CalPointKPI($vParentID)
	{
		return round($this->ArrPoint[$vParentID],0);
	}
...
//////////////////////Buil list////////////////////
	...
	{		
		$lvTable='
		<table border="0" cellspacing="0" class="lvtable">
	<tbody>
		<tr class="lvhtable">
			...
			<td class="lvhtable" align="center" valign="middle"><b><font>Tiền đánh giá </font></b></td>-->
			<td class="lvhtable" align="center" valign="middle"><b><font>Điểm KPI</font></b></td>
		...
		';
		{
			$this->LV_LoadArrPointKPI($this->CalID);
			$strCondi="";
			
			if($this->CalID!="")
			{
				$strCondi=$strCondi." AND CC.lv003='$this->CalID' ";
			}
			if($this->lv221!="")
			{
			...
			{
				case 0:
					$lvsql="select CC.*,DD.lv001 CodeID,DD.lv002 Name,DD.lv010 CMND,DD.lv030 NgayVaoLam,DD.lv034 CuTru,DD.lv035 TamTru,DD.lv015 NgaySinh,DD.lv005 Title,DD.lv062 NhomCT,DD.lv030 DateWork,DD.lv029 Dep,DD.lv099 from ki_lv0005 CC inner join hr_lv0020 DD on CC.lv002=DD.lv001 left join hr_lv0002 E on DD.lv029=E.lv001  where 1=1 $strCondi  order by E.lv103,DD.lv008 asc,DD.lv029 Asc";
					break;
				case 1:
					$lvsql="select CC.*,DD.lv001 CodeID,DD.lv002 Name,DD.lv010 CMND,DD.lv030 NgayVaoLam,DD.lv034 CuTru,DD.lv035 TamTru,DD.lv015 NgaySinh,DD.lv005 Title,DD.lv062 NhomCT,DD.lv030 DateWork,DD.lv029 Dep,DD.lv099 from ki_lv0005 CC inner join hr_lv0020 DD on CC.lv002=DD.lv001 left join hr_lv0002 E on DD.lv029=E.lv001 where 1=1 $strCondi  order by E.lv103,DD.lv008 asc,DD.lv029 Asc";
					break;
			...
			//END CODE ABC//
					if($vArrEmp["$vEmployeeID"]!=NULL)
					{
						...
						*/
						$vABCPercen=$this->LV_CalPointKPI($vrow['lv001']);
	
						$vABC=$this->mohr_lv0038->lv034*($vABCPercen/$this->kpi_max);
						...
						$vLineOne=str_replace("@#04",$this->LV_GetPhongBanCap1($vrow['Dep']),$vLineOne);
						...
						$vLineOne=str_replace("@#08",$this->FormatView($this->mohr_lv0038->lv034,20),$vLineOne);
						$vLineOne=str_replace("@#09",$this->FormatView($vABCPercen,20),$vLineOne);
						$vLineOne=str_replace("@#10",$this->FormatView($vABC,20),$vLineOne);
	...
	function LV_BuilListReportOtherPrintLateSoonSum($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvopt=0,$vmau=0,$vshowgiokem=0,$isshift=0)
	{		
		$lvTable='
		<table border="0" cellspacing="0" class="lvtable">
	<tbody>
		<tr class="lvhtable">
			...
			<td class="lvhtable" align="center" valign="middle"><b><font>M&atilde; NV</font></b></td>
			<td class="lvhtable" align="center" valign="middle"><b><font>Họ v&agrave; T&ecirc;n </font></b></td>
			<td class="lvhtable" align="center" valign="middle"><b><font>Phòng ban</font></b></td>
			<td class="lvhtable" align="center" valign="middle"><b><font>Ng&agrave;y v&agrave;o l&agrave;m </font></b></td>
			<td class="lvhtable" align="center" valign="middle"><b><font>T1</font></b></td>
			<td class="lvhtable" align="center" valign="middle"><b><font>T2</font></b></td>
			<td class="lvhtable" align="center" valign="middle"><b><font>T3</font></b></td>
			<td class="lvhtable" align="center" valign="middle"><b><font>T4</font></b></td>
			<td class="lvhtable" align="center" valign="middle"><b><font>T5</font></b></td>
			<td class="lvhtable" align="center" valign="middle"><b><font>T6</font></b></td>
			<td class="lvhtable" align="center" valign="middle"><b><font>T7</font></b></td>
			<td class="lvhtable" align="center" valign="middle"><b><font>T8</font></b></td>
			<td class="lvhtable" align="center" valign="middle"><b><font>T9</font></b></td>
			<td class="lvhtable" align="center" valign="middle"><b><font>T10</font></b></td>
			<td class="lvhtable" align="center" valign="middle"><b><font>T11</font></b></td>
			<td class="lvhtable" align="center" valign="middle"><b><font>T12</font></b></td>
			<td class="lvhtable" align="center" valign="middle"><b><font>Số tháng<br/>làm việc</font></b></td>
			<td class="lvhtable" align="center" valign="middle"><b><font>Điểm TB</font></b></td>
		...
		';
		{
			...
			$this->LV_LoadArrPointKPIYear($this->ObjCal->lv007);
			...
			//END CODE ABC//
					if($vArrEmp["$vEmployeeID"]!=NULL)
					{
						...
						*/
						$vSoThang=0;
						$vCalT1=$this->ArrCalBack[1];
						$vABCPercenT1=$this->LV_CalPointKPIAll($vCalT1,$vrow['CodeID']);
						if($this->ArrPointAllOK[$vCalT1][$vrow['CodeID']])
						{
							$vSoThang++;
						}
						$vCalT2=$this->ArrCalBack[2];
						$vABCPercenT2=$this->LV_CalPointKPIAll($vCalT2,$vrow['CodeID']);
						if($this->ArrPointAllOK[$vCalT2][$vrow['CodeID']])
						{
							$vSoThang++;
						}
						$vCalT3=$this->ArrCalBack[3];
						$vABCPercenT3=$this->LV_CalPointKPIAll($vCalT3,$vrow['CodeID']);
						if($this->ArrPointAllOK[$vCalT3][$vrow['CodeID']])
						{
							$vSoThang++;
						}
						$vCalT4=$this->ArrCalBack[4];
						$vABCPercenT4=$this->LV_CalPointKPIAll($vCalT4,$vrow['CodeID']);
						if($this->ArrPointAllOK[$vCalT4][$vrow['CodeID']])
						{
							$vSoThang++;
						}
						$vCalT5=$this->ArrCalBack[5];
						$vABCPercenT5=$this->LV_CalPointKPIAll($vCalT5,$vrow['CodeID']);
						if($this->ArrPointAllOK[$vCalT5][$vrow['CodeID']])
						{
							$vSoThang++;
						}
						$vCalT6=$this->ArrCalBack[6];
						$vABCPercenT6=$this->LV_CalPointKPIAll($vCalT6,$vrow['CodeID']);
						if($this->ArrPointAllOK[$vCalT6][$vrow['CodeID']])
						{
							$vSoThang++;
						}
						$vCalT7=$this->ArrCalBack[7];
						$vABCPercenT7=$this->LV_CalPointKPIAll($vCalT7,$vrow['CodeID']);
						if($this->ArrPointAllOK[$vCalT7][$vrow['CodeID']])
						{
							$vSoThang++;
						}
						$vCalT8=$this->ArrCalBack[8];
						$vABCPercenT8=$this->LV_CalPointKPIAll($vCalT8,$vrow['CodeID']);
						if($this->ArrPointAllOK[$vCalT8][$vrow['CodeID']])
						{
							$vSoThang++;
						}
						$vCalT9=$this->ArrCalBack[9];
						$vABCPercenT9=$this->LV_CalPointKPIAll($vCalT9,$vrow['CodeID']);
						if($this->ArrPointAllOK[$vCalT9][$vrow['CodeID']])
						{
							$vSoThang++;
						}
						$vCalT10=$this->ArrCalBack[10];
						$vABCPercenT10=$this->LV_CalPointKPIAll($vCalT10,$vrow['CodeID']);
						if($this->ArrPointAllOK[$vCalT10][$vrow['CodeID']])
						{
							$vSoThang++;
						}
						$vCalT11=$this->ArrCalBack[11];
						$vABCPercenT11=$this->LV_CalPointKPIAll($vCalT11,$vrow['CodeID']);
						if($this->ArrPointAllOK[$vCalT11][$vrow['CodeID']])
						{
							$vSoThang++;
						}
						$vCalT12=$this->ArrCalBack[12];
						$vABCPercenT12=$this->LV_CalPointKPIAll($vCalT12,$vrow['CodeID']);
						if($this->ArrPointAllOK[$vCalT12][$vrow['CodeID']])
						{
							$vSoThang++;
						}
						//$vABC=$this->mohr_lv0038->lv034*($vABCPercen/$this->kpi_max);
						/*if(getyear($vrow['NgayVaoLam'])==$this->ObjCal->lv007)
							$vSoThang=12-getmonth($vrow['NgayVaoLam'])+1;
						else
							$vSoThang=12;*/
						$vABCPercen=($vABCPercenT1+$vABCPercenT2+$vABCPercenT3+$vABCPercenT4+$vABCPercenT5+$vABCPercenT6+$vABCPercenT7+$vABCPercenT8+$vABCPercenT9+$vABCPercenT10+$vABCPercenT11+$vABCPercenT12)/$vSoThang;
						$vABCPercen=round($vABCPercen,2);
						$vOrder++;
						$vlv006=$vlv006+$TongCong;
						$vlv007=$vlv007+$vTongTC;
						$vlv008=$vlv008+$this->mohr_lv0038->lv013;
						...
						$vLineOne=str_replace("@#04",$this->LV_GetPhongBanCap1($vrow['Dep']),$vLineOne);
						$vLineOne=str_replace("@#05",$this->FormatView($vrow['NgayVaoLam'],2),$vLineOne);
						$vLineOne=str_replace("@#06",$this->FormatView($vABCPercenT1,20),$vLineOne);
						$vLineOne=str_replace("@#07",$this->FormatView($vABCPercenT2,20),$vLineOne);
						$vLineOne=str_replace("@#08",$this->FormatView($vABCPercenT3,20),$vLineOne);
						$vLineOne=str_replace("@#09",$this->FormatView($vABCPercenT4,20),$vLineOne);
						$vLineOne=str_replace("@#10",$this->FormatView($vABCPercenT5,20),$vLineOne);
						$vLineOne=str_replace("@#11",$this->FormatView($vABCPercenT6,20),$vLineOne);
						$vLineOne=str_replace("@#12",$this->FormatView($vABCPercenT7,20),$vLineOne);
						$vLineOne=str_replace("@#13",$this->FormatView($vABCPercenT8,20),$vLineOne);
						$vLineOne=str_replace("@#14",$this->FormatView($vABCPercenT9,20),$vLineOne);
						$vLineOne=str_replace("@#15",$this->FormatView($vABCPercenT10,20),$vLineOne);
						$vLineOne=str_replace("@#16",$this->FormatView($vABCPercenT11,20),$vLineOne);
						$vLineOne=str_replace("@#17",$this->FormatView($vABCPercenT12,20),$vLineOne);
						$vLineOne=str_replace("@#18",$this->FormatView($vSoThang,20),$vLineOne);
						$vLineOne=str_replace("@#19",$this->FormatView($vABCPercen,20),$vLineOne);
