...
////////////
	...
	var $ArrView=array("lv001"=>"0","lv002"=>"0","lv003"=>"0","lv004"=>"10","lv005"=>"0","lv006"=>"10","lv007"=>"0","lv008"=>"10","lv009"=>"0","lv010"=>"0","lv011"=>"10");	
	...
	function LV_InsertAuto()
	{
		...
		$this->lv013 = ($this->lv013!="")?recoverdate(($this->lv013), $this->lang):$this->DateDefault;
		$this->lv014 = ($this->lv014!="")?recoverdate(($this->lv014), $this->lang):$this->DateDefault;
		$lvsql="insert into sl_lv0014 (lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016) values('$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->lv006','$this->lv007','$this->lv008','$this->lv009','$this->lv010','$this->lv011','$this->lv012','$this->lv013','$this->lv014','$this->lv015','$this->lv016')";
		$vReturn= db_query($lvsql);
		if($vReturn) $this->InsertLogOperation($this->DateCurrent,'sl_lv0014.insert',sof_escape_string($lvsql));
		return $vReturn;
	}
	...
	function LV_Delete($lvarr)
	{
		...
		$lvsql = "DELETE FROM sl_lv0014  WHERE sl_lv0014.lv001 IN ($lvarr) and (select lv011 from tc_lv0013 B where  B.lv001= sl_lv0014.lv002)<=1  ";
		$vReturn= db_query($lvsql);
...
//////////////////////Buil list////////////////////
	...
	function LV_GETNHAP_TP($cateid,$lvcontractid,$lvitemid,$Cut,$Color,$Size)
	{
		switch($this->lvgetdata)
		{
			...
			case 2:
				$LotID=$Cut;
				$sql="SELECT sum(A.lv004) sumall from ts_lv0009 A inner join ts_lv0008 B on A.lv002=B.lv001 where A.lv003='$lvitemid' and B.lv005='$cateid' and B.lv006='$lvcontractid' and A.lv014='$LotID'";
			...
			default:
				...
				$sql="SELECT sum(A.lv004) sumall from ts_lv0009 A inner join ts_lv0008 B on A.lv002=B.lv001 where A.lv003='$lvitemid' and B.lv005='$cateid' and B.lv006='$lvcontractid'";
				$bResult = db_query($sql);
				$vrow = db_fetch_array ($bResult);
				return $vrow['sumall'];
				break;
	...
	function LV_GETXUAT_TP($cateid,$lvcontractid,$lvitemid,$Cut,$Color,$Size)
	{
		switch($this->lvgetdata)
		{
			...
			case 2:
				$LotID=$Cut;
				$sql="SELECT sum(A.lv004) sumall from ts_lv0011 A inner join ts_lv0010 B on A.lv002=B.lv001 where A.lv003='$lvitemid' and B.lv005='$cateid' and B.lv006='$lvcontractid' and A.lv014='$LotID'";
				$bResult = db_query($sql);
				$vrow = db_fetch_array ($bResult);
				return $vrow['sumall'];
				break;
			...
			default:
				#$LotID=$Cut."-".$Color."-".$Size;
				$LotID=$Cut;
				$sql="SELECT sum(A.lv004) sumall from ts_lv0011 A inner join ts_lv0010 B on A.lv002=B.lv001 where A.lv003='$lvitemid' and B.lv005='$cateid' and B.lv006='$lvcontractid'";
				$bResult = db_query($sql);
				$vrow = db_fetch_array ($bResult);
				return $vrow['sumall'];
				break;
