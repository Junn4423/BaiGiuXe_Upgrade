...
///////////
	public $DefaultFieldList="lv001,lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv016,lv201,lv202,lv203,lv211,lv212,lv213";	
////////////////////GetDate
...
////////////
	...
	var $ArrPush=array();
	var $ArrFunc=array();
	var $ArrGet=array("lv001"=>"2","lv002"=>"3","lv003"=>"4","lv004"=>"5","lv005"=>"6","lv006"=>"7","lv007"=>"8","lv008"=>"9","lv009"=>"10","lv010"=>"11","lv011"=>"12","lv012"=>"13","lv013"=>"14","lv014"=>"15","lv015"=>"16","lv016"=>"17","lv201"=>"202","lv202"=>"203","lv203"=>"204","lv211"=>"212","lv212"=>"213","lv213"=>"214");
	var $ArrView=array("lv001"=>"0","lv002"=>"0","lv003"=>"0","lv004"=>"0","lv005"=>"0","lv006"=>"0","lv007"=>"0","lv008"=>"0","lv009"=>"0","lv010"=>"0","lv011"=>"0","lv012"=>"0","lv013"=>"0","lv014"=>"0","lv015"=>"0","lv016"=>"10","lv201"=>"0","lv202"=>"0","lv203"=>"0");
	...
	function LV_Load()
	{
		...
		if($vrow)
		{
			...
			$this->lv203=$vrow['lv203'];

			$this->lv211=$vrow['lv211'];
			$this->lv212=$vrow['lv212'];
			$this->lv213=$vrow['lv213'];
		}
	}
	function LV_GetActiveData()
	{
		$vsql="select lv001,lv002,lv014 from  hr_lv0001 A where A.lv016='1'";
		$vresult=db_query($vsql);
		while($vrow=db_fetch_array($vresult))
		{
			echo '<li><a href="javascript:LoadCustomer(\''.$vrow['lv001'].'\')">';
			$this->lv001=$vrow['lv001'];
			echo $this->lv002=$vrow['lv002'];
			$this->lv014=$vrow['lv014'];
			echo '</a></li>';
		}
	}
	function LV_CheckDatabase($vDatabase)
	{
		$lvsql="select count(*) num from  hr_lv0001 Where lv014='$vDatabase'";
	...
	function LV_LoadID($vlv001)
	{
		...
		{
			$lvsql="select * from  hr_lv0001 Where lv001='SOF'";
			$vresult=db_query($lvsql);
			$vrow=db_fetch_array($vresult);
			if($vrow)
			{
	...
	function LV_Insert()
	{
		...
		$lvsql="insert into hr_lv0001 (lv001,lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016,lv201,lv202,lv203,lv211,lv212,lv213) values('$this->lv001','$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->lv006','$this->lv007','$this->lv008','$this->lv009','$this->lv010','$this->lv011','$this->lv012','$this->lv013','$this->lv014','$this->lv015','$this->lv016','$this->lv201','$this->lv202','$this->lv203','$this->lv211','$this->lv212','$this->lv213')";
	...
	function LV_Update()
	{
		...
		$lvsql="Update hr_lv0001 set lv002='$this->lv002',lv003='$this->lv003',lv004='$this->lv004',lv005='$this->lv005',lv006='$this->lv006',lv007='$this->lv007',lv008='$this->lv008',lv009='$this->lv009',lv010='$this->lv010',lv011='$this->lv011',lv012='$this->lv012',lv013='$this->lv013',lv014='$this->lv014',lv015='$this->lv015',lv016='$this->lv016',lv201='".sof_escape_string($this->lv201)."',lv202='".sof_escape_string($this->lv202)."',lv203='".sof_escape_string($this->lv203)."' where  lv001='$this->lv001';";
		$vReturn= db_query($lvsql);
	...
	function LV_Aproval($lvarr)
	{
		...
		$lvsql = "Update hr_lv0001 set lv016=lv016+1  WHERE hr_lv0001.lv001 IN ($lvarr)  ";
		$vReturn= db_query($lvsql);
		if($vReturn) $this->InsertLogOperation($this->DateCurrent,'hr_lv0001.approval',sof_escape_string($lvsql));
		return $vReturn;
	}	
	function LV_UnAproval($lvarr)
	{
		...
		$lvsql = "Update hr_lv0001 set lv016=lv016-1  WHERE hr_lv0001.lv001 IN ($lvarr)  ";
		$vReturn= db_query($lvsql);
		if($vReturn) $this->InsertLogOperation($this->DateCurrent,'hr_lv0001.unapproval',sof_escape_string($lvsql));
		return $vReturn;
	}
	//////////get view///////////////
	function GetView()
	...
	function LV_BuilList($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvSortNum)
	{
		...
		while ($vrow = db_fetch_array ($bResult)){
			...
			for($i=0;$i<count($lstArr);$i++)
			{
				...
				$key = $lstArr[$i];
				if (isset($vrow[$key]) && isset($this->ArrView[$key])) {
					$vTemp = str_replace(
						"@02",
						$this->getvaluelink($key, $this->FormatView($vrow[$key], (int)$this->ArrView[$key])),
						$this->Align($lvTd, (int)$this->ArrView[$key])
					);
				}
				$strL=$strL.$vTemp;
			}
