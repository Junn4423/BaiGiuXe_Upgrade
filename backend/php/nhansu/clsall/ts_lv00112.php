...
////////////
	...
	function LV_Insert()
	{
		...
		$lvsql="insert into ts_lv0012 (lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010) values('$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->lv006','$this->lv007','$this->lv008','$this->lv009','$this->lv010')";
		$vReturn= db_query($lvsql);
		if($vReturn){
	...
	function LV_Update()
	{
		...
		if(!$this->LV_CheckLocked($this->lv002)) return false;
		  $lvsql="Update ts_lv0012 set lv002='$this->lv002',lv003='$this->lv003',lv004='$this->lv004',lv005='$this->lv005',lv006='$this->lv006',lv007='$this->lv007',lv008='$this->lv008',lv009='$this->lv009',lv010='$this->lv010' where  lv001='$this->lv001';";
		$vReturn= db_query($lvsql);
	...
	function LV_Delete($lvarr)
	{
		...
		$lvsql = "DELETE FROM ts_lv0012  WHERE ts_lv0012.lv001 IN ($lvarr) and (select lv007 from ts_lv0008 B where  B.lv001= ts_lv0012.lv002)<=0  ";
		$vReturn= db_query($lvsql);
		if($vReturn) {
