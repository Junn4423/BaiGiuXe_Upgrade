...
///////////
	public $DefaultFieldList="lv001,lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016,lv017,lv018,lv018,lv019,lv020,lv021,lv026,lv097,lv098,lv099,lv025";	
////////////////////GetDate
...
////////////
	...
	var $ArrPush=array();
	var $ArrFunc=array();
	var $ArrGet=array("lv001"=>"2","lv002"=>"3","lv003"=>"4","lv004"=>"5","lv005"=>"6","lv006"=>"7","lv007"=>"8","lv008"=>"9","lv009"=>"10","lv010"=>"11","lv011"=>"12","lv012"=>"13","lv013"=>"14","lv014"=>"15","lv015"=>"16","lv016"=>"17","lv017"=>"18","lv018"=>"19","lv019"=>"20","lv020"=>"21","lv021"=>"22","lv022"=>"23","lv025"=>"26","lv026"=>"27","lv097"=>"98","lv098"=>"99","lv099"=>"100");
	var $ArrView=array("lv001"=>"0","lv002"=>"0","lv003"=>"0","lv004"=>"0","lv005"=>"0","lv006"=>"0","lv007"=>"0","lv008"=>"0","lv009"=>"0","lv010"=>"0","lv011"=>"0","lv012"=>"0","lv013"=>"0","lv014"=>"0","lv015"=>"0","lv016"=>"0","lv017"=>"0","lv018"=>"0","lv019"=>"0","lv020"=>"0","lv021"=>"0","lv022"=>"0","lv025"=>"0","lv026"=>"10","lv097"=>"10","lv098"=>"10","lv099"=>"10");	
	...
	function LV_Insert()
	{
		...
		if($this->isAdd==0) return false;
		 $lvsql="insert into wh_lv0003 (lv001,lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016,lv017,lv018,lv019,lv020,lv021,lv022,lv025,lv026) values('$this->lv001','$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->lv006','$this->lv007','$this->lv008','$this->lv009','$this->lv010','$this->lv011','$this->lv012','$this->lv013','$this->lv014','$this->lv015','$this->lv016','$this->lv017','$this->lv018','$this->lv019','$this->lv020','$this->lv021','$this->lv022','$this->LV_UserID','$this->lv026')";
	...
	protected function GetCondition()
	{
		...
		if($this->lv001!="") 
		{
			...
			{	
				$vArrName=explode(",",$this->lv001);
				foreach($vArrName as $vName)
				{
					if($vName!="")
					{
					if($strCondi=="")	
						$strCondi= " AND ( lv001 = '$vName'";
					else
						$strCondi=$strCondi." OR lv001 = '$vName'";		
					}
				}
				$strCondi=$strCondi.")";
		...
		if($this->lv025!="")  $strCondi=$strCondi." and lv025='$this->lv025'";
		return $strCondi;
	}
	...
	{
		$vResult='';
		$lvsql = "select B.lv001 from ac_lv0004 B where B.lv003='SUP' and B.lv004='$vSupplierID' and B.lv017='0' and lv002='1'";
	...
	function LV_BuilList($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvSortNum)
	{
		...
		while ($vrow = db_fetch_array ($bResult)){
			...
			for($i=0;$i<count($lstArr);$i++)
			{
				...
				{
					$vTemp=str_replace("@02",str_replace("@02",$this->getvaluelink($lstArr[$i],$this->FormatView($vTienHD+$vrow['lv026']-$vTienPC,(int)$this->ArrView[$lstArr[$i]])),str_replace("@01",$vrow['lv001'] ,$lvHref)),$this->Align($lvTd,(int)$this->ArrView[$lstArr[$i]]));
				}
				else
		...
		$strF=str_replace("<!--lv099-->",$this->FormatView($vSumTienHD+$vSumTienDK-$vSumTienPC,10),$strF);
