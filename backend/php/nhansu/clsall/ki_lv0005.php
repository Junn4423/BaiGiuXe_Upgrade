<?php
/////////////coding ki_lv0005///////////////
class   ki_lv0005 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
////////////
	...
	function LV_AutoChildKPI($vCalID)
	{
		...
		while($vrow=db_fetch_array($vresult))
		{
			...
			$vKPIID=$vrow['lv004'];
			$lvsql="insert into ki_lv0006(lv002,lv003,lv004,lv005,lv006,lv007,lv015) select '$vParentID' ParentID,lv003 TargetKPI,lv005 MacDinh,lv005 MacDinh1,lv005 MacDinh2,lv005 MacDinh3,lv004 ParaRate from ki_lv0004 where lv002='$vKPIID' and lv003 not in (select B.lv003 from ki_lv0006 B where B.lv002='$vParentID')";
...
/////////////////////ListFieldExport//////////////////////////
	function ListFieldExport($lvFrom,$lvList,$maxRows)
	{
		...
		{
			window.open('".$this->Dir."ki_lv0005/?lang=".$this->lang."&childfunc='+value,'','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
		</script>
";
