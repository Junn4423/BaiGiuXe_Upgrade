...
class   jo_lv0012 extends lv_controler
{
	...
	public $lv023=null;
///////////
	public $DefaultFieldList="lv199,lv015,lv829,lv022,lv003,lv025,lv016,lv017,lv098,lv008,lv009,lv010,lv013,lv018,lv021";
////////////////////GetDate
...
////////////
	...
	var $ArrPush=array();
	var $ArrFunc=array();
	var $ArrGet=array("lv001"=>"2","lv002"=>"3","lv003"=>"4","lv004"=>"5","lv005"=>"6","lv006"=>"7","lv007"=>"8","lv008"=>"9","lv009"=>"10","lv010"=>"11","lv011"=>"12","lv012"=>"13","lv013"=>"14","lv014"=>"15","lv015"=>"16","lv016"=>"17","lv017"=>"18","lv018"=>"19","lv019"=>"20","lv020"=>"21","lv021"=>"22","lv022"=>"23","lv023"=>"24","lv024"=>"25","lv025"=>"26","lv098"=>"99","lv099"=>"100","lv199"=>"200","lv829"=>"830");
	var $ArrView=array("lv001"=>"0","lv002"=>"0","lv003"=>"0","lv004"=>"0","lv005"=>"4","lv006"=>"0","lv007"=>"4","lv008"=>"0","lv009"=>"0","lv010"=>"0","lv011"=>"0","lv012"=>"0","lv013"=>"0","lv014"=>"0","lv015"=>"0","lv016"=>"4","lv017"=>"4","lv018"=>"4","lv019"=>"4","lv020"=>"0","lv021"=>"0","lv022"=>"0","lv023"=>"0","lv024"=>"2","lv025"=>"22","lv098"=>"10","lv099"=>"0","lv199"=>"0");	
	...
	function LV_Aproval($lvarr)
	{
		...
		$sqlS1 = "SELECT *,DATEDIFF(lv017,lv016) NumsRequire FROM jo_lv0004 WHERE  jo_lv0004.lv001 IN ($lvarr)";
		$bResult = db_query($sqlS1);
		while ($vrow = db_fetch_array ($bResult)){
			$lvsql = "Update jo_lv0004 set lv021='1',lv014='$this->LV_UserID',lv019=now()  WHERE jo_lv0004.lv001 ='".$vrow['lv001']."' ";
			$vReturn= db_query($lvsql);
			if($vReturn){
	...
	function LV_UnAproval($lvarr)
	{
		...
		$lvsql = "Update jo_lv0004 set lv021='2',lv014='$this->LV_UserID',lv019=now()  WHERE jo_lv0004.lv001 IN ($lvarr)  ";
		$vReturn= db_query($lvsql);
	...
	protected function GetCondition()
	{
		...
		if($this->lv004!="") $strCondi=$strCondi." and (lv004 = '$this->lv004' or lv013='')";
		...
		$strCondi=$strCondi." and (lv004=1 or lv013='') and lv021 =0";
		return $strCondi;
	}
		////////////////Count///////////////////////////
	function GetCount()
	{
		$sqlC = "SELECT COUNT(*) AS nums FROM jo_lv0004 WHERE (lv004=1 or lv013='') and lv014='$this->LV_UserID'  and lv021=0 ".$this->GetCondition();
...
//////////////////////Buil list////////////////////
	function LV_BuilList($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvSortNum)
	{
		...
		$sqlS = "SELECT *,DATEDIFF(lv016,lv025) SoNgayXinPhep,lv015 lv829,(DATEDIFF(lv017,lv016)+IF(LEFT(lv003,3)='1/2',0.5,1)) lv098,TIMEDIFF(lv017,lv016) lv098_1 FROM jo_lv0004 WHERE (lv004=1 or lv013='') and lv014='$this->LV_UserID' and lv021=0  ".$this->GetCondition()." $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
...
//////////////////////Buil list////////////////////
	function LV_BuilListReport($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList)
	{
		...
		$sqlS = "SELECT * FROM jo_lv0004 WHERE lv004=1 and lv021=0  ".$this->RptCondition." $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
		$bResult = db_query($sqlS);
		$this->Count=db_num_rows($bResult);
		$strTrH="";
