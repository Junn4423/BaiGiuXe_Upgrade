<?php
class ts_lv0015 extends lv_controler{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function GetWH()
	{
		$sqlC="select count(*) nums from ts_lv0001";
	...
	function LV_GET_ITEMS_EXIST($vWHID,$strwh)
	{
		...
		$vsql="select distinct lv002 from ts_lv0012 where 1=1 $vcondtion";
	...
	public function GetBuilCheckListDept($vListID,$vID,$vTabIndex,$vTbl,$vFieldView='lv002',$vDepID="")
	{
		...
		$vsql="select lv001,lv003 lv002,IF(lv001='$vSelectlv001',1,0) lv003 from  ts_lv0001 where lv001 in ($strwh)";
		$strGetList="";
		$strGetScript="";
		$i=0;
		$vresult=db_query($vsql);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$vHeaderReportInventory="
		...
		$sqlS = "select A.*,B.lv002 Warehouselv002 from  ts_lv0008 A left join  wh_warehouse B on A.Warehouselv001=B.lv001 where 1=1 ".$vCondition." ORDER BY A.lv009 Desc,A.lv001 DESC";
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$vHeaderReportInventory="
		...
		$sqlS = "select A.*,B.lv002 Warehouselv002 from  ts_lv0010 A left join  wh_warehouse B on A.Warehouselv001=B.lv001 where 1=1 ".$vCondition." ORDER BY A.lv009 Desc,A.lv001 DESC";
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
	...
	$vHeaderReportInventory="
		...
		$sqlS = "select A.*,B.lv002 Unitlv002,(select sum(A1.lv004) from ts_lv0009 A1 where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from ts_lv0008 A11 Where A11.lv009<'$vDateStart' and A11.lv002='$vlv001')) ReReceiptQty,(select sum(A1.lv004) from ts_lv0009 A1 where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from ts_lv0008 A11 Where A11.lv009>='$vDateStart' and A11.lv009<='$vDateEnd' and A11.lv002='$vlv001')) InReceiptQty,(select sum(A2.lv004) from ts_lv0011 A2 where A2.lv003=A.lv001 and A2.lv002 IN (select A21.lv001 from ts_lv0010 A21 Where A21.lv009<'$vDateStart' and A21.lv002='$vlv001')) ReOutlv004 ,(select sum(A2.lv004) from ts_lv0011 A2 where A2.lv003=A.lv001 and A2.lv002 IN (select A21.lv001 from ts_lv0010 A21 Where A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd' and A21.lv002='$vlv001')) InOutlv004  from sl_lv0007 A left join sl_lv0005 B on A.lv004=B.lv001 where 1=1 and A.lv015=0";
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
		...
		$sqlS = "select MP.lv004,MP.Unitlv002,sum(IF(ISNULL(MP.ReReceiptQty),0,MP.ReReceiptQty)+IF(ISNULL(MP.InReceiptQty),0,MP.InReceiptQty)-IF(ISNULL(MP.ReOutlv004),0,MP.ReOutlv004)-IF(ISNULL(MP.InOutlv004),0,MP.InOutlv004) ) SumQty from (select A.lv004,B.lv002 Unitlv002,(select sum(A1.lv004) from ts_lv0009 A1 where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from ts_lv0008 A11 Where A11.lv009<'$vDateStart' and A11.lv002='$vlv001')) ReReceiptQty,(select sum(A1.lv004) from ts_lv0009 A1 where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from ts_lv0008 A11 Where A11.lv009>='$vDateStart' and A11.lv009<='$vDateEnd' and A11.lv002='$vlv001')) InReceiptQty,(select sum(A2.lv004) from ts_lv0011 A2 where A2.lv003=A.lv001 and A2.lv002 IN (select A21.lv001 from ts_lv0010 A21 Where A21.lv009<'$vDateStart' and A21.lv002='$vlv001')) ReOutlv004 ,(select sum(A2.lv004) from ts_lv0011 A2 where A2.lv003=A.lv001 and A2.lv002 IN (select A21.lv001 from ts_lv0010 A21 Where A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd' and A21.lv002='$vlv001')) InOutlv004   from sl_lv0007 A left join sl_lv0005 B on A.lv004=B.lv001 where 1=1 and A.lv015=0) MP group by MP.lv004,MP.Unitlv002 ";		
	...
	$vHeaderReportInventory="
		...
		$lvsql="select * from ts_lv0020 where lv002='$vlv003'  $vAddCond order by lv004 desc";
		$strAllTr='';
	...
	function LV_Get_slt_lot($vLotId,$vItemId,$vWhId)
	{
		if($this->sokho<=1)
		{
			$vsql="select sum(lv004) sumslnhap from ts_lv0009 A where A.lv003='$vItemId' and A.lv014='$vLotId'";
		}
		else
		{
			...
			if($sophieu=="") $sophieu="''";
			$vsql="select sum(lv004) sumslnhap from ts_lv0009 A where A.lv002 in ($sophieu) and A.lv003='$vItemId' and A.lv014='$vLotId'";
		}
		$vresult=db_query($vsql);
		...
		if($this->sokho<=1)
		{
			$vsql="select sum(lv004) sumslxuat from ts_lv0011 A where A.lv003='$vItemId' and A.lv014='$vLotId'";
		}
		else
		{
			if($this->sophieuxuat[$vWhId]==NULL) $this->sophieuxuat[$vWhId]=$this->get_sophieu($vWhId,1,'lv001');
			$sophieu=$this->sophieuxuat[$vWhId];
			$vsql="select sum(lv004) sumslxuat from ts_lv0011 A where A.lv002 in ($sophieu) and A.lv003='$vItemId' and A.lv014='$vLotId'";
		}
		$vresult=db_query($vsql);
		$vrow=db_fetch_array($vresult);
	...
	{
		if($vopt==0)
			$vsql="select $vField from ts_lv0008 where lv002='$vWhId'";
		else
			$vsql="select $vField from ts_lv0010 where lv002='$vWhId'";
		$vresult=db_query($vsql);
			$strReturn="";
			if($vresult)
			{
	...
	function PrintInOutCompareMonth($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$stropt,$strlv003,$strlv014,$strTyles,$strQuantiative,$strColor,$strNote,$strContractlv001,$strSource,$strCategory,$vVS_Color,$vExistItem,$vExistItemCur,$vshowimage)
	{
		...
		while ($vrow = db_fetch_array ($bResult)){		
			...
			//Kho hư
			//Kho thay thế
			//$vSPXuat=$this->LV_GetSophieu("select A21.lv001 from ts_lv0010 A21 Where A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd' $vAddContractO");
	...
	function LV_FillDataArrayMonth($vTD,$vItemID,&$vArrKho)
	{
		...
		foreach( $this->arrMonths as $vday)
		{
			...
			$lvsql=$lvsql.(($lvsql=="")?'':',')."(select sum(A11.lv004)   from ts_lv0009 A11 inner join ts_lv0008 A22 on A11.lv002=A22.lv001 Where  month(A22.lv009)=month('$vday') and year(A22.lv009)=year('$vday') and A11.lv003='$vItemID' and A22.lv002='KHOHUHONG') NK".$vNamCol.",(select sum(A11.lv004)   from ts_lv0011 A11 inner join ts_lv0010 A22 on A11.lv002=A22.lv001 Where month(A22.lv009)=month('$vday') and year(A22.lv009)=year('$vday') and A11.lv003='$vItemID' and A22.lv002='KHOTHAYTHE') XK".$vNamCol;
		}
	...
	function LV_FillDataArray($vTD,$vItemID,&$vArrKho)
	{
		...
		{
			$vNamCol=str_replace("-","",str_replace("/","",$vday));
			$lvsql=$lvsql.(($lvsql=="")?'':',')."(select sum(A11.lv004)   from ts_lv0009 A11 inner join ts_lv0008 A22 on A11.lv002=A22.lv001 Where A22.lv009='$vday' and A11.lv003='$vItemID' and A22.lv002='KHOHUHONG') NK".$vNamCol.",(select sum(A11.lv004)   from ts_lv0011 A11 inner join ts_lv0010 A22 on A11.lv002=A22.lv001 Where A22.lv009='$vday' and A11.lv003='$vItemID' and A22.lv002='KHOTHAYTHE') XK".$vNamCol;
		}
		$vSumSQL=$vSumSQL.$lvsql."";
		$vresult=db_query($vSumSQL);
		$vrow=db_fetch_array($vresult);
...
function PrintInOutPutStaffUsed($plang, $vArrLang,$vlv001,$vDateStart,$vDateEnd,$stropt,$strlv003,$strlv014,$strTyles,$strQuantiative,$strColor,$strNote,$strContractlv001,$strSource,$strCategory,$vVS_Color,$vExistItem,$vExistItemCur,$vshowimage)
	{
	...
	$vHeaderReportInventory="
		...
		$vRowLast="
			<tr>
				...
				<td class=\"right_style\" ><strong>@11</strong></td>
		...
		if($vVS_Color!="")
		{
			$vListVS_Color=$this->LV_GetSophieu("select A11.lv001 from hr_lv0020 A11 Where A11.lv001 like '%$vVS_Color%'");
			$vAddLot=$vAddLot." AND A1.lv007 in ($vListVS_Color)";	
		}
		if($strlv003!="") {
...
//		if($vAddCond!="") $vCondition = $vCondition." AND lv003 IN ( select B.lv003 from ts_lv0020 B where 1=1 $vAddCond) AND Lot IN ( select B.lv014 from ts_lv0020 B where 1=1 $vAddCond)";
		if($vAddCond!="") $vCondition = $vCondition." left join ts_lv0020 B1 on A1.lv003=B1.lv003 AND A1.lv014=B1.lv002  $vAddCond";
		$vConditionStock="";
		if($vExistItem==1)
		{
			$vListItem=$this->LV_GET_ITEMS_EXIST($vlv001,$strwh);
		...
		if($strlv003!="") $vConditionStock = $vConditionStock." AND A.lv001 LIKE '%$strlv003%'";		
		if($strCategory!="")  	 $vConditionStock=$vConditionStock." AND A.lv003 in ('".str_replace(",","','",$strCategory)."')";		;
		$vSPNhap1=$this->LV_GetSophieu("select A11.lv001 from ts_lv0008 A11 Where A11.lv009<'$vDateStart' $vAddContractR");
		$vSPNhap2=$this->LV_GetSophieu("select A11.lv001 from ts_lv0008 A11  Where A11.lv009>='$vDateStart' and A11.lv009<='$vDateEnd' $vAddContractR");
		$vSPXuat1=$this->LV_GetSophieu("select A21.lv001 from ts_lv0010 A21 Where A21.lv009<'$vDateStart' $vAddContractO");
		$vSPXuat2=$this->LV_GetSophieu("select A21.lv001 from ts_lv0010 A21 Where A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd' $vAddContractO");
		$sqlS = "select * from (select A.*,IF(ISNULL(ABC.lv008),0,ABC.lv008) giavon,B.lv002 Unitlv002,(select sum(A1.lv004) from ts_lv0009 A1  $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN ($vSPNhap1) ) ReReceiptQty,(select sum(A1.lv004) from ts_lv0009 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN ($vSPNhap2) ) InReceiptQty,(select sum(A1.lv004) from ts_lv0011 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN ($vSPXuat1) ) ReOutlv004 ,(select sum(A1.lv004) from ts_lv0011 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN ($vSPXuat2) ) InOutlv004  from sl_lv0007 A left join sl_lv0005 B on A.lv004=B.lv001 left join ts_lv0012 ABC on ABC.lv002=A.lv001 and ABC.lv003='BTI' where 1=1  and A.lv015=0 $vConditionStock) MP  where ((IF(ISNULL(MP.ReReceiptQty),0,MP.ReReceiptQty)-IF(ISNULL(MP.ReOutlv004),0,MP.ReOutlv004))<>0 or  IF(ISNULL(MP.InReceiptQty),0,MP.InReceiptQty)<>0 or IF(ISNULL(MP.InOutlv004),0,MP.InOutlv004)<>0 or (IF(ISNULL(MP.ReReceiptQty),0,MP.ReReceiptQty)-IF(ISNULL(MP.ReOutlv004),0,MP.ReOutlv004)+IF(ISNULL(MP.InReceiptQty),0,MP.InReceiptQty)-IF(ISNULL(MP.InOutlv004),0,MP.InOutlv004))<>0)";	
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
			...
			while($arrS=db_fetch_array($bResultS)){
				...
				switch($stropt)
				{
					case 2:
						...
						break;
					case 3:
						$vdetail=$this->GetBuildTableInputOutputDetail($plang, $vArrLang,$vDateStart,$vDateEnd,$arrS['lv001'],$strlv014,$strTyles,$strQuantiative,$strColor,$strNote,$strContractlv001,$strSource,$strwh,$vVS_Color);
					...
					/*case 4:
						...
						break;*/
					default:
						$vdetail = $this->GetBuildTableInputOutput($plang, $vArrLang,$vDateStart,$vDateEnd,$arrS['lv001'],$strlv014,$strTyles,$strQuantiative,$strColor,$strNote,$strContractlv001,$strSource,$strwh,$vVS_Color);
						if($vdetail=="")
							$vLineRun = str_replace("@20","", $vLineRun);		
						else
							$vLineRun = str_replace("@20","<tr><td colspan=\"".(($vshowimage==1)?11:10)."\">".$vdetail."</td></tr>", $vLineRun);		
		...
		if($vExistItemCur!=1)
		{
	  		$sqlS = "select MP.lv004,MP.Unitlv002,sum(IF(ISNULL(MP.ReReceiptQty),0,MP.ReReceiptQty)+IF(ISNULL(MP.InReceiptQty),0,MP.InReceiptQty)-IF(ISNULL(MP.ReOutlv004),0,MP.ReOutlv004)-IF(ISNULL(MP.InOutlv004),0,MP.InOutlv004) ) SumQty from (select A.lv004,B.lv002 Unitlv002,(select sum(A1.lv004) from ts_lv0009 A1  $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN (select A11.lv001 from ts_lv0008 A11 Where A11.lv009<'$vDateStart' $vAddContractR) ) ReReceiptQty,(select sum(A1.lv004) from ts_lv0009 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN (select A11.lv001 from ts_lv0008 A11  Where A11.lv009>='$vDateStart' and A11.lv009<='$vDateEnd' $vAddContractR) ) InReceiptQty,(select sum(A1.lv004) from ts_lv0011 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN (select A21.lv001 from ts_lv0010 A21 Where A21.lv009<'$vDateStart' $vAddContractO) ) ReOutlv004 ,(select sum(A1.lv004) from ts_lv0011 A1 $vCondition where A1.lv003=A.lv001 $vAddLot and A1.lv002 IN (select A21.lv001 from ts_lv0010 A21 Where A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd' $vAddContractO) ) InOutlv004  from sl_lv0007 A left join sl_lv0005 B on A.lv004=B.lv001  where 1=1 and A.lv015=0 $vConditionStock) MP group by MP.lv004,MP.Unitlv002 ";		
		...
		//Fist
		$vHeader = str_replace("@06", 'Tồn đầu kỳ', $vHeader);
		//Input Mlv001dle
		$vHeader = str_replace("@07", 'Nhập trong kỳ', $vHeader);
		//Output Mlv001dle
		$vHeader = str_replace("@08",'Xuất trong kỳ', $vHeader);
		//Last
		$vHeader = str_replace("@09",'Tồn cuối kỳ', $vHeader);		
		//Images
		$vHeader = str_replace("@10",'Giá bình quân', $vHeader);		
		//Images
		$vHeader = str_replace("@11",'Thành tiền', $vHeader);		
		}
		else
		{
			//Unit
...
//		if($vAddCond!="") $vCondition = $vCondition." AND lv003 IN ( select B.lv003 from ts_lv0020 B where 1=1 $vAddCond) AND Lot IN ( select B.lv014 from ts_lv0020 B where 1=1 $vAddCond)";
	...
	function GetBuildTableInputOutput($plang, $vArrLang,$vDateStart,$vDateEnd,$vlv003,$strlv014,$strTyles,$strQuantiative,$strColor,$strNote,$strContractlv001,$strSource,$strwh,$vVS_Color)
	{
	...
	$vHeaderReportInventory="
		...
		{
			$vListVS_Color=$this->LV_GetSophieu("select A11.lv001 from hr_lv0020 A11 Where A11.lv001 like '%$vVS_Color%'");
			$vAddLot=$vAddLot." AND A.lv007 in ($vListVS_Color)";	
		}	
		if($strTyles!="") 	$vAddCond=$vAddCond." AND B1.lv004 like '%$strTyles%'";
		if($strQuantiative!="") 	$vAddCond=$vAddCond." AND B1.lv005 like '%$strQuantiative%'";		
		if($strColor!="") 	$vAddCond=$vAddCond." AND B1.lv006 like '%$strColor%'";				
		...
		//if($vAddCond!="") $vCondition = $vCondition." AND lv003 IN ( select B.lv003 from ts_lv0020 B where 1=1 $vAddCond) AND Lot IN ( select B.lv014 from ts_lv0020 B where 1=1 $vAddCond)";
			if($vAddCond!="") $vCondition = $vCondition." left join ts_lv0020 B1 on A.lv003=B1.lv003 AND A.lv014=B1.lv002  $vAddCond";		
		  $sqlS = "select A.lv001, A.lv002 ,A.lv004,C.lv002 Unitlv002,B.lv010 HTXNK,B.lv005 Type,B.lv009 DateEnter,'N' CategoryPut,B.lv004 Title,B.lv099 KhoDen,A.lv007,A.lv014 Lot,A.lv015,B.lv006 Reference,B.lv002 WhID  from ts_lv0009 A inner join ts_lv0008 B on A.lv002=B.lv001 and (B.lv009>='$vDateStart' and B.lv009<='$vDateEnd') $vAddContractR  left join sl_lv0005 C on A.lv005=C.lv001 $vCondition where A.lv003='$vlv003' $vAddLot
				UNION
				select A.lv001, A.lv002,A.lv004,C.lv002 Unitlv002,B.lv010 HTXNK,B.lv005 Type,B.lv009 DateEnter,'X' CategoryPut,B.lv004 Title,B.lv099 KhoDen,A.lv007,A.lv014 Lot,A.lv015,B.lv006 Reference,B.lv002 WhID from ts_lv0011 A inner join ts_lv0010 B on A.lv002=B.lv001 and B.lv009>='$vDateStart' and B.lv009<='$vDateEnd' $vAddContractO left join sl_lv0005 C on A.lv005=C.lv001 $vCondition where A.lv003='$vlv003' $vAddLot 
		";
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		...
		if($totalRows>0){
			while($arrS=db_fetch_array($bResultS)){
				...
				$vLineRun = str_replace("@99", $arrS['KhoDen'], $vLineRun);
				$vLineRun = str_replace("@13", $arrS['WhID'], $vLineRun);
				$strExpportAll = $strExpportAll.$vLineRun;
				$vLineRun = $vRowLightText;
			}
		} else {
		...
		//Kho den
		$vHeader = str_replace("@99",'Đến Kho/Từ Kho', $vHeader);
		//Lot
...
//////////////////////////////////Purchase Order////////////////////////////
	function GetBuildTableInputOutputDetail($plang, $vArrLang,$vDateStart,$vDateEnd,$vlv003,$strlv014,$strTyles,$strQuantiative,$strColor,$strNote,$strContractlv001,$strSource,$strwh,$vVS_Color)
	{
	$vHeaderReportInventory="
		<table width=\"100%\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\" class=\"tblprint\">
			<tr height=\"5px\" class=\"tblRunChild\" >
		...
		//if($vAddCond!="") $vCondition = $vCondition." AND lv003 IN ( select B.lv003 from ts_lv0020 B where 1=1 $vAddCond) AND Lot IN ( select B.lv014 from ts_lv0020 B where 1=1 $vAddCond)";
		if($vAddCond!="") $vCondition = $vCondition." inner join ts_lv0020 B1 on A.lv003=B1.lv003 AND A.lv014=B1.lv014  $vAddCond";		
		 $sqlS = "select A.lv001,A.lv002 ,A.lv004,C.lv002 Unitlv002,B.lv005,B.lv009 DateEnter,'N' CategoryPut,B.lv004 Title,A.lv007,A.lv014 Lot,D.lv006,D.lv004,D.lv005,D.lv007 NoteLot,E.lv002VN Colorlv002  from ts_lv0009 A inner join ts_lv0008 B on A.lv002=B.lv001 and (B.lv009>='$vDateStart' and B.lv009<='$vDateEnd') $vAddContractR  left join sl_lv0005 C on A.lv005=C.lv001 left join ts_lv0020 D on D.lv014=A.lv014 Lot and D.lv003=A.lv003 left join  wh_color E on D.lv006=E.lv001 $vCondition where A.lv003='$vlv003' 
				UNION
				select A.lv001, A.lv002,A.lv004,C.lv002 Unitlv002,B.lv005,B.lv009 DateEnter,'X' CategoryPut,B.lv004 Title,A.lv007,A.lv014 Lot,D.lv006,D.lv004,D.lv005,D.lv007 NoteLot,E.lv002VN Colorlv002 from ts_lv0011 A inner join ts_lv0010 B on A.lv002=B.lv001 and B.lv009>='$vDateStart' and B.lv009<='$vDateEnd' $vAddContractO left join sl_lv0005 C on A.lv005=C.lv001  left join ts_lv0020 D on D.lv014=A.lv014 Lot and D.lv003=A.lv003 left join  wh_color E on D.lv006=E.lv001 $vCondition where A.lv003='$vlv003' 
		";
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
...
//////////////////////////////////Detail Sale Style////////////////////////////
	...
	$vHeaderReportInventory="
		...
		//if($vAddCond!="") $vCondition = $vCondition." AND lv003 IN ( select B.lv003 from ts_lv0020 B where 1=1 $vAddCond) AND Lot IN ( select B.lv014 from ts_lv0020 B where 1=1 $vAddCond)";
		if($vAddCond!="") $vCondition = $vCondition." inner join ts_lv0020 B1 on A.lv003=B1.lv003 AND A.lv014 Lot=B1.lv014  $vAddCond";		
		 $sqlS = "select  VC.lv004,VC.lv006,VC.lv006lv002,sum(VC.lv004D) lv004D,sum(VC.lv004N) lv004N,sum(VC.lv004X) lv004X from (select A.lv001,A.lv002,0 lv004D,A.lv004 lv004N,0 lv004X,'N' CategoryPut,D.lv006,D.lv004,E.lv002VN Colorlv002  from ts_lv0009 A inner join ts_lv0008 B on A.lv002=B.lv001 and (B.lv009>='$vDateStart' and B.lv009<='$vDateEnd') $vAddContractR left join sl_lv0005 C on A.lv005=C.lv001 left join ts_lv0020 D on D.lv014=A.lv014 Lot and D.lv003=A.lv003 left join  wh_color E on D.lv006=E.lv001 $vCondition where A.lv003='$vlv003' 
				UNION
				select A.lv001, A.lv002,0 lv004D,0 lv004N,A.lv004 lv004X,'X' CategoryPut,D.lv006,D.lv004,E.lv002VN Colorlv002 from ts_lv0011 A inner join ts_lv0010 B on A.lv002=B.lv001 and B.lv009>='$vDateStart' and B.lv009<='$vDateEnd' $vAddContractO left join sl_lv0005 C on A.lv005=C.lv001  left join ts_lv0020 D on D.lv014=A.lv014 Lot and D.lv003=A.lv003 left join  wh_color E on D.lv006=E.lv001 $vCondition where A.lv003='$vlv003'
				UNION
select A.lv001,A.lv002,A.lv004 lv004D ,0 lv004N,0 lv004X,'N' CategoryPut,D.lv006,D.lv004,E.lv002VN Colorlv002  from ts_lv0009 A inner join ts_lv0008 B on A.lv002=B.lv001 and B.lv009<'$vDateStart' $vAddContractR left join sl_lv0005 C on A.lv005=C.lv001 left join ts_lv0020 D on D.lv014=A.lv014 Lot and D.lv003=A.lv003 left join  wh_color E on D.lv006=E.lv001 $vCondition where A.lv003='$vlv003' 
				UNION
				select A.lv001, A.lv002,-A.lv004 lv004D,0 lv004N,0 lv004X,'X' CategoryPut,D.lv006,D.lv004,E.lv002VN Colorlv002 from ts_lv0011 A inner join ts_lv0010 B on A.lv002=B.lv001 and B.lv009<'$vDateStart' $vAddContractO  left join sl_lv0005 C on A.lv005=C.lv001  left join ts_lv0020 D on D.lv014=A.lv014 Lot and D.lv003=A.lv003 left join  wh_color E on D.lv006=E.lv001 $vCondition where A.lv003='$vlv003'		
				) VC		
...
//////////////////////////////////////////Purchase Order////////////////////////////////////////////////////////////////////
	...
	public function GetBuilCheckList($vListID,$vID,$vTabIndex)
	{
		...
		$vsql="select * from  sl_lv0006 where lv004='1'";
		$strGetList="";
		$strGetScript="";
		$i=0;
		$vresult=db_query($vsql);
	...
	private function sqlcondition($vFile,$vSelectlv001)
	{
		...
		switch($vFile)
		{
			...
			case 'lv003':
				...
				break;
			case 'lv004':
				$vsql="select lv001,lv002,IF(lv001='$vSelectlv001',1,0) lv003 from  ts_lv0013";
				break;
			/*case 'lv006':
				$vsql="select lv001,lv002,IF(lv001='$vSelectlv001',1,0) lv003 from  sl_lv0007";
				break;*/
			case 'lv008':
				$vsql="select lv001,lv002,IF(lv001='$vSelectlv001',1,0) lv003 from  sl_lv0006 where lv004='1'";
				break;
		}
		return $vsql;
	}
	public  function getvaluelink($vFile,$vSelectlv001)
	{
		...
		{
			case 'lv002':
				$vsql="select lv001,lv003 lv002,IF(lv001='$vSelectlv001',1,0) lv003 from  ts_lv0001 where lv001='$vSelectlv001'";
				break;
			case 'lv003':
				$vsql="select lv001,concat(lv004,lv003,lv002) lv002,IF(lv001='$vSelectlv001',1,0) lv003 from  hr_lv0020 where lv001='$vSelectlv001'";
				break;
			case 'lv004':
				$vsql="select lv001,lv002,IF(lv001='$vSelectlv001',1,0) lv003 from  ts_lv0013 where lv001='$vSelectlv001'";
				break;
			case 'lv006':
