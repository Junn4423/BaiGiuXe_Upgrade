...
////////////
	...
	{		
		...
		$lvsql="insert into mn_lv0005 (lv001,lv002,lv003,lv004,lv005) values('$this->lv001','$this->lv002','$this->lv003','$this->LV_UserID',now())";
		$vReturn= db_query($lvsql);
	...
	{
		if($this->isDel==0) return false;
		$lvsql = "DELETE FROM mn_lv0005  WHERE mn_lv0005.lv002 IN ($lvarr) and (select lv007 from ts_lv0004 B where  B.lv001= mn_lv0005.lv002)<=0  ";
		$vReturn= db_query($lvsql);
		if($vReturn) $this->InsertLogOperation($this->DateCurrent,'mn_lv0005.delete',sof_escape_string($lvsql));
		return $vReturn;
	}
