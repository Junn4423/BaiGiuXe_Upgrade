...
////////////
	...
	function LV_Aproval($lvarr)
	{
		...
		$lvsql = "Update jo_lv0004 set lv004='2'  WHERE jo_lv0004.lv001 IN ($lvarr)  ";
	...
	function LV_UnAproval($lvarr)
	{
		...
		$lvsql = "Update jo_lv0004 set lv004='1'  WHERE jo_lv0004.lv001 IN ($lvarr) and lv004=2 and lv021=0 ";
		$vReturn= db_query($lvsql);
	...
	protected function GetCondition()
	{
		...
		{
			$vListStaff=$this->LV_GetDepParent('KD,PTTT');
			$strCondi=$strCondi." and lv013='$this->lv013' and ((lv015 not in ($vListStaff) and lv003='CT') or lv003<>'CT' )";
		}
		else
