<?php
/////////////coding tc_lv0023///////////////
class   rp_lv0015 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
////////////
	...
	var $ArrView=array("lv001"=>"0","lv002"=>"0","lv003"=>"0","lv004"=>"0","lv005"=>"1","lv006"=>"0","lv007"=>"0","lv008"=>"0","lv009"=>"0","lv010"=>"0","lv011"=>"0");	
	...
	function LV_Insert()
	{
		...
		$lvsql="insert into tc_lv0023 (lv001,lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009) values('$this->lv001','$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->lv006','$this->lv007','$this->lv008','$this->lv009')";
	...
	function LV_Update()
	{
		...
		$lvsql="Update tc_lv0023 set lv002='$this->lv002',lv003='$this->lv003',lv004='$this->lv004',lv005='$this->lv005',lv006='$this->lv006',lv007='$this->lv007',lv009='$this->lv009' where  lv001='$this->lv001' AND lv008<=0;";
		$vReturn= db_query($lvsql);
		if($vReturn) {
	...
	protected function GetCondition()
	{
		...
		if($this->lv003!="") $strCondi=$strCondi." and A.lv003  = '$this->lv003'";
		...
		if($this->lv201!="") $strCondi=$strCondi." and (B.lv029  in ('".str_replace(",","','",$this->lv201)."'))";
		if($this->lv202!="") $strCondi=$strCondi." and (A.lv002  in ('".str_replace(",","','",$this->lv202)."'))";
		if($this->lv203!="") $strCondi=$strCondi." and (A.lv004  in ('".str_replace(",","','",$this->lv203)."'))";
		return $strCondi;
	}
...
";
	...
	public function GetBuilCheckList1($vListID,$vID,$vTabIndex)
	{
		$vListID=",".$vListID.",";
		$strTbl="<table  align=\"center\" class=\"lvtable\">
		<input type=\"hidden\" id=$vID name=$vID value=\"@#02\">
...
//////////////////////Buil list////////////////////
	...
	//////////////////////Buil list////////////////////
	function LV_BuilListReport_Option($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvSortNum)
	{
		...
		$lvTdH="<td width=\"@01\" class=\"lvhtable\">@02</td>";
		$lvTd="<td  class=\"@#04\" align=\"@#05\">@02</td>";
		$sqlS = "SELECT A.*,B.lv029 lv010,'______________________' lv011 FROM tc_lv0023 A inner join hr_lv0020 B on A.lv002=B.lv001  WHERE 1=1  ".$this->GetCondition()." $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
		$bResult = db_query($sqlS);
		$this->Count=db_num_rows($bResult);
		$strTrH="";
...
//////////////////////Buil list////////////////////
	function LV_BuilListReportDepart($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList)
	{
		...
		$lvTdH="<td width=\"@01\" class=\"lvhtable\">@02</td>";
		$lvTd="<td  class=\"@#04\" align=\"@#05\">@02</td>";
		$sqlS = "SELECT B.lv029 lv001,A.lv002,A.lv003,A.lv004,A.lv005,A.lv006,A.lv007,A.lv008,A.lv008 FROM tc_lv0023 A left join hr_lv0020 B on A.lv002=B.lv001 WHERE 1=1  ".$this->RptCondition." Order by B.lv029 ASC LIMIT $curRow, $maxRows";
		$vorder=$curRow;
		$bResult = db_query($sqlS);
		$this->Count=db_num_rows($bResult);
		$strTrH="";
