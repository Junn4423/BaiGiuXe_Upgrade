...
class   jo_lv0014 extends lv_controler
{
	...
	public $lv023=null;
///////////
	public $DefaultFieldList="lv015,lv829,lv022,lv003,lv025,lv016,lv017,lv098,lv008,lv009,lv010,lv013,lv018,lv021";
////////////////////GetDate
...
////////////
	...
	function LV_UnAproval($lvarr)
	{
		...
		$lvsql = "Update jo_lv0004 set lv021='0',lv013=''  WHERE jo_lv0004.lv001 IN ($lvarr)  ";
		$vReturn= db_query($lvsql);
