...
public $LE_CODE="NjlIUS02VFdULTZIS1QtNlFIQQ==";
	...
	function LV_RunAll($vArrDep,$vArrCong,$vArrShift,$vDate,$lineprocess,$vState,$vCheckNT,$vShiftCal=0,$vListEmp='',$vArrPro=NULL)
	{
		...
		*/
		...
		{
			if($lineprocess=="")
				$sqlS = "SELECT distinct A.lv001 CodeID,A.lv016,A.lv002,A.lv003,A.lv004,A.lv005,A.lv006,A.lv007,A.lv008,A.lv009,A.lv010,A.lv021 ProjectID,DayOfWeek(A.lv004) DOWS,A.lv015,B.lv002 NVID,C.lv029 lv001,EE.lv005 LockMonth,A.lv089 FixDay,C.lv009 TTNV FROM tc_lv0011 A left join tc_lv0010 B on A.lv002=B.lv001 left join tc_lv0009 EE on EE.lv002=B.lv002 and EE.lv003=MONTH('$vDate') and EE.lv004=YEAR('$vDate')  inner join hr_lv0020 C on C.lv001=B.lv002  WHERE A.lv100=0 and MONTH(A.lv004)=MONTH('$vDate') and YEAR(A.lv004)=YEAR('$vDate') and   B.lv002  in ($vListEmp) $vCondition1 order by A.lv099 ASC,A.lv004 ASC";
			else
				$sqlS = "SELECT distinct A.lv001 CodeID,A.lv016,A.lv002,A.lv003,A.lv004,A.lv005,A.lv006,A.lv007,A.lv008,A.lv009,A.lv010,A.lv021 ProjectID,DayOfWeek(A.lv004) DOWS,A.lv015,B.lv002 NVID,C.lv029 lv001,EE.lv005 LockMonth,A.lv089 FixDay,C.lv009 TTNV FROM tc_lv0011 A left join tc_lv0010 B on A.lv002=B.lv001 left join tc_lv0009 EE on EE.lv002=B.lv002 and EE.lv003=MONTH('$vDate') and EE.lv004=YEAR('$vDate')  inner join hr_lv0020 C on C.lv001=B.lv002  WHERE A.lv100=0 and MONTH(A.lv004)=MONTH('$vDate') and YEAR(A.lv004)=YEAR('$vDate') and   B.lv002  in ($vListEmp) $vCondition1  order by A.lv099 ASC,A.lv004 ASC";
		}
		else
		{
			if($lineprocess=="")
				$sqlS = "SELECT distinct A.lv001 CodeID,A.lv016,A.lv002,A.lv003,A.lv004,A.lv005,A.lv006,A.lv007,A.lv008,A.lv009,A.lv010,A.lv021 ProjectID,DayOfWeek(A.lv004) DOWS,A.lv015,B.lv002 NVID,C.lv029 lv001,EE.lv005 LockMonth,A.lv089 FixDay,C.lv009 TTNV FROM tc_lv0011 A left join tc_lv0010 B on A.lv002=B.lv001 left join tc_lv0009 EE on EE.lv002=B.lv002  and EE.lv003=MONTH('$vDate') and EE.lv004=YEAR('$vDate') inner join hr_lv0020 C on C.lv001=B.lv002  WHERE A.lv100=0 and A.lv004='$vDate' and   B.lv002  in ($vListEmp) $vCondition1 order by A.lv099 ASC,A.lv004 ASC";
			else
				$sqlS = "SELECT distinct A.lv001 CodeID,A.lv016,A.lv002,A.lv003,A.lv004,A.lv005,A.lv006,A.lv007,A.lv008,A.lv009,A.lv010,A.lv021 ProjectID,DayOfWeek(A.lv004) DOWS,A.lv015,B.lv002 NVID,C.lv029 lv001,EE.lv005 LockMonth,A.lv089 FixDay,C.lv009 TTNV FROM tc_lv0011 A left join tc_lv0010 B on A.lv002=B.lv001 left join tc_lv0009 EE on EE.lv002=B.lv002  and EE.lv003=MONTH('$vDate') and EE.lv004=YEAR('$vDate') inner join hr_lv0020 C on C.lv001=B.lv002  WHERE A.lv100=0 and A.lv004='$vDate' and   B.lv002  in ($vListEmp) $vCondition1 order by A.lv099 ASC,A.lv004 ASC";
		}
