<?php
/////////////coding ts_lv0030///////////////
class   ts_lv0030 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
///////////
	public $DefaultFieldList="lv003,lv088,lv004,lv005,lv006,lv007,lv011,lv014,lv015,lv008,lv009,lv017";	
////////////////////GetDate
	...
	public $paging=null;
	public $lang=null;
	protected $objhelp='ts_lv0030';
////////////
	var $ArrOther=array();
	var $ArrPush=array();
	var $ArrFunc=array();
	var $ArrGet=array("lv001"=>"2","lv002"=>"3","lv003"=>"4","lv004"=>"5","lv005"=>"6","lv006"=>"7","lv007"=>"8","lv008"=>"9","lv009"=>"10","lv010"=>"11","lv011"=>"12","lv012"=>"13","lv013"=>"14","lv014"=>"15","lv015"=>"16","lv016"=>"17","lv017"=>"18","lv017"=>"18","lv088"=>"89","lv089"=>"90");
	var $ArrView=array("lv001"=>"0","lv002"=>"0","lv003"=>"0","lv004"=>"1","lv005"=>"0","lv006"=>"2","lv007"=>"0","lv008"=>"10","lv009"=>"0","lv010"=>"10","lv011"=>"2","lv012"=>"0","lv013"=>"0","lv014"=>"0","lv015"=>"0","lv016"=>"22","lv017"=>"10","lv017"=>"10");	
	...
	function LV_Load()
	{
		$vsql="SELECT *,lv003 lv088,lv003 lv089 FROM  ts_lv0030";
	...
	{
		$lvsql="SELECT *,lv003 lv088,lv003 lv089 FROM  ts_lv0030 Where lv001='$vlv001'";
	...
	function LV_Insert()
	{
		...
		$lvsql="insert into ts_lv0030 (lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016) values('$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->lv006','$this->lv007','$this->lv008','$this->lv009','$this->lv010','$this->lv011','$this->lv012','$this->lv013','$this->lv014','$this->lv015','$this->lv016')";
		$vReturn= db_query($lvsql);
		if($vReturn){
		 	$this->InsertLogOperation($this->DateCurrent,'ts_lv0030.insert',sof_escape_string($lvsql));
		 }
		return $vReturn;
	}
	function LV_GetQuantityRecieption($vPOID,$vItemID,$vLot)
	{
		$lvsql="select sum(A.lv004) TotalQty from ts_lv0009 A inner join ts_lv0008 B on A.lv002=B.lv001 where  B.lv006='$vPOID' and B.lv005='MUAHANG' and A.lv003='$vItemID'";
		$vReturn= db_query($lvsql);
		if($vReturn)
		{
			$vrow=db_fetch_array($vReturn);
	...
	function LV_InsertPO($vlvUser,$vlv005,$vlv006,$vlWHID,$vDate,$vlv913=0)
	{
		...
		{		
			...
			if($vSLC>0)	{
			$lvsql1="insert into ts_lv0030 (lv002,lv003,lv004,
	...
	{
		$this->lv011 = ($this->lv011!="")?recoverdate(($this->lv011), $this->lang):$this->DateDefault;
		$lvsql="insert into ts_lv0030 (lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009
		...
		,A.lv008,'','',''
		,A.lv010
		,'$vlv913','$vDate',A.lv009,A.lv012,A.lv011 from sl_lv0007 B inner join sl_lv0014 A  on A.lv003=B.lv001 and B.lv016 = '$vlWHID' where A.lv002='$vlv006'";
		$vReturn= db_query($lvsql);
		if($vReturn){
		 	$this->InsertLogOperation($this->DateCurrent,'ts_lv0030.insert',sof_escape_string($lvsql));
		 }
	...
	function LV_InsertCONTRACT($vlvUser,$vlv005,$vlv006,$vlWHID,$vDate,$vlv913=0)
	{
		...
		{
			$this->lv011 = ($this->lv011!="")?recoverdate(($this->lv011), $this->lang):$this->DateDefault;
			$lvsql="insert into ts_lv0031 (lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009
													,lv010,lv011,lv012,lv013
													,lv014
													,lv015,lv016
			...
			,A.lv010,A.lv012,'',''
			,A.lv014
			,'$vlv913','$vDate',C.lv004,C.lv005 from ts_lv0009 A inner join ts_lv0008 B on A.lv002=B.lv001 left join  ts_lv0020 C on C.lv001=A.lv014 and C.lv002=A.lv003 and C.lv003='$vlWHID'  where B.lv005 in ('BANHANG','TRAHANG') and B.lv006='$vlv006' and B.lv002='$vlWHID' ";
			$vReturn= db_query($lvsql);
		...
		else 
		{
			...
			$vsqlAll="insert into ts_lv0030 (lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009
													,lv010,lv011,lv012,lv013
													,lv014
	...
	function LV_UpdateEdit($vOldlv004,$vOldlv006)
	{
		...
		$vReturn= db_query($lvsql);
		if($vReturn){
		 $this->InsertLogOperation($this->DateCurrent,'ts_lv0030.update',sof_escape_string($lvsql));
	...
	function LV_Delete($lvarr)
	{
		...
		$lvsql = "DELETE FROM ts_lv0030  WHERE ts_lv0030.lv001 IN ($lvarr)  ";
		$vReturn= db_query($lvsql);
		if($vReturn) {
			
			$this->InsertLogOperation($this->DateCurrent,'ts_lv0030.delete',sof_escape_string($lvsql));
		}
		return $vReturn;
	}	
	...
	function GetCount()
	{
		$sqlC = "SELECT COUNT(*) AS nums FROM ts_lv0030 WHERE 1=1 ".$this->GetCondition();
	...
	{
		 $lvsql="Update ts_lv0030 set lv013='$vValue' where  lv001='$vID';";
		 $vReturn= db_query($lvsql);
	}
	function LV_UpdateLot($vID,$vValue)
	{
		 $lvsql="Update ts_lv0030 set lv014='$vValue' where  lv001='$vID';";
		 $vReturn= db_query($lvsql);
	}
	function LV_UpdateQty($vID,$vValue)
	{
		...
		{
		 $lvsql="Update ts_lv0030 set lv004='$vValue' where  lv001='$vID';";
		 $vReturn= db_query($lvsql);
		}
	}
	function LV_UpdateQtyM($vID,$vValue)
	{
		...
		{
		 $lvsql="Update ts_lv0030 set lv006='$vValue' where  lv001='$vID';";
		 $vReturn= db_query($lvsql);
		}
	}
	function LV_UpdateQtyKg($vID,$vValue)
	{
		...
		{
		 $lvsql="Update ts_lv0030 set lv008='$vValue' where  lv001='$vID';";
		 $vReturn= db_query($lvsql);
		}
	}
			//////////////////////Buil list////////////////////
//////////////////////Buil list////////////////////
	function LV_BuilList($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow,$maxRows,$paging,$lvOrderList,$lvSortNum)
	{
		...
		$sqlS = "SELECT *,lv003 lv088,lv003 lv089 FROM ts_lv0030 WHERE 1=1  ".$this->GetCondition()." $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
...
/////////////////////ListFieldExport//////////////////////////
	function ListFieldExport($lvFrom,$lvList,$maxRows)
	{
		...
		{
			window.open('".$this->Dir."ts_lv0030/?lang=".$this->lang."&childdetailfunc='+value+'&ID=".base64_encode($this->lv002)."','','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
...
";
	...
	public function GetBuilCheckList($vListID,$vID,$vTabIndex)
	{
		...
		";
		$vsql="SELECT *,lv003 lv088,lv003 lv089 FROM  hr_lv0004";
		$strGetList="";
		$strGetScript="";
		$i=0;
		$vresult=db_query($vsql);
...
//////////////////////Buil list////////////////////
	function LV_BuilListReport($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList)
	{
		...
		$lvTdH="<td width=\"@01\" class=\"lvhtable\">@02</td>";
		$lvTd="<td align=@#05>@02</td>";
		$sqlS = "SELECT *,lv003 lv088,lv003 lv089 FROM ts_lv0030 WHERE 1=1  ".$this->RptCondition." $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
		$bResult = db_query($sqlS);
		$this->Count=db_num_rows($bResult);
		$strTrH="";
	...
	public function getvaluelink($vFile,$vSelectID)
	{
		...
		switch($vFile)
		{
			...
			case 'lv009':
				...
				break;
			case 'lv089':
				$vsql="select lv001,lv010 lv002,IF(lv001='$vSelectID',1,0) lv003 from  sl_lv0007 where lv001='$vSelectID'";
				$lvopt=0;
				break;
			case 'lv088':
