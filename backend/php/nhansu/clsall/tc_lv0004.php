...
////////////
	...
	function LV_GetTimeShift($vStart,$vEnd,$vState=0,$vFreeTime='00:00:00',&$vRealWork='00:00:00')
	{
		$vState=(int)$vState;
		if($vStart==$vEnd)
		{
		...
		else
		{
			...
			{
				$vRealWork=TIMEDIFF($vEnd,$vGetS);
				return $lvTime;
			}
			else
			{
				$vRealWork=TIMEDIFF($vEnd,$vGetS);
				$vRealWork=TIMEDIFF($vRealWork,$vFreeTime);
