<?php
class rp_lv0021 extends lv_controler{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
	public $lv004=null;
		...
		<table border="1" cellpadding="10" cellspacing="0" style="page-break-before: always" width="977" align="center">
			...
			<tbody>
				<tr>
					...
					<td colspan="4" style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0in" width="298">
						<p align="center" class="western" style="margin-bottom: 0in"><font face="Arial, sans-serif"><font style="font-size: 15pt">DANH SÁCH GIỜ VÀO RA NGOẠI LỆ</font></font></p>
					...
					<td colspan="2" style="border: 1px solid #000000; padding: 0in 0.08in" width="290">
						<p class="western" style="margin-bottom: 0in"><font face="Arial, sans-serif"><font style="font-size: 11pt">M&atilde;:........</font></font></p>
						<p class="western" style="margin-bottom: 0in"><font face="Arial, sans-serif"><font style="font-size: 11pt">Lần sửa đổi: 01</font></font></p>
						<p class="western"><font face="Arial, sans-serif"><font style="font-size: 11pt">Ng&agrave;y ban h&agrave;nh: .../.../.......</font></font></p>
					</td>
				</tr>
				<tr>
					...
					<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0in" width="232">
						<p align="center" class="western"><font face="Arial, sans-serif"><b>Mã nhân viên</b></font></p>
					</td>
					<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0in" width="232">
						<p align="center" class="western"><font face="Arial, sans-serif"><b>Tên nhân viên</b></font></p>
					</td>
					<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0in" width="81">
						<p align="center" class="western"><font face="Arial, sans-serif"><b>Ngày sửa</b></font></p>
					</td>
					<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0in" width="84">
						<p align="center" class="western"><font face="Arial, sans-serif"><b>giờ sửa</b></font></p>
					</td>
					<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0in" width="81">
						<p align="center" class="western"><font face="Arial, sans-serif"><b>Người sửa</b></font></p>
					</td>
					<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0in" width="84">
						<p align="center" class="western"><font face="Arial, sans-serif"><b>Trạng thái([0,1]:Giờ làm,-1: Giờ xoá</b></font></p>
					</td>
					<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: none; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0in" width="233">
						<p align="center" class="western"><font face="Arial, sans-serif"><b>Ghi chú</b></font></p>
					</td>
...
';
		...
		if($this->datefrom!="") 
		{
			 $strCondi=$strCondi." AND A.lv002>='$this->datefrom 00:00:00' ";
		}
		if($this->dateto!="")
		{
			$strCondi=$strCondi." AND A.lv002<='$this->dateto 23:59:59' ";
		}
		if($this->lv221!="")
		{
		...
		if($this->isStaffOff==1)  $strCondi=$strCondi." AND ( A.lv005<>'' or (not ISNULL(A.lv005))) ";
		switch($this->lvSort)
		{
			case 0:
				$lvsql="select A.*,DD.lv001 CodeID,DD.lv002 Name from tc_lv0012 A inner join hr_lv0020 DD on A.lv001=DD.lv001  where 1=1 $strCondi  order by A.lv002 asc";
				break;
			case 1:
				$lvsql="select A.*,DD.lv001 CodeID,DD.lv002 Name from tc_lv0012 A inner join hr_lv0020 DD on A.lv001=DD.lv001  where 1=1 $strCondi  order by A.lv001 asc,A.lv002 asc";
				break;
			case 2:
				$lvsql="select A.*,DD.lv001 CodeID,DD.lv002 Name from tc_lv0012 A inner join hr_lv0020 DD on A.lv001=DD.lv001  where 1=1 $strCondi  order by A.lv005 asc,A.lv002 asc";
				break;
			case 2:
				$lvsql="select A.*,DD.lv001 CodeID,DD.lv002 Name from tc_lv0012 A inner join hr_lv0020 DD on A.lv001=DD.lv001  where 1=1 $strCondi  order by A.lv005 asc,A.lv002 asc,A.lv002 asc";
				break;
			default:
				$lvsql="select A.*,DD.lv001 CodeID,DD.lv002 Name from tc_lv0012 A inner join hr_lv0020 DD on A.lv001=DD.lv001  where 1=1 $strCondi ";
				break;	
		}
		$vorder=$curRow;
		...
		while ($vrow = db_fetch_array ($bResult)){
			...
			$vLineOne=str_replace("@#04",$this->FormatView($vrow['lv002'],2),$vLineOne);
			$vLineOne=str_replace("@#05",$vrow['lv003'],$vLineOne);
			$vLineOne=str_replace("@#06",$vrow['lv005'],$vLineOne);
			$vLineOne=str_replace("@#07",$vrow['lv006'],$vLineOne);
...
////GetTime list
	...
	function Get_Arr_Employees($vmau)
	{
		...
		if($this->lvSort==0)
			$lvsql="select DD.lv001 CodeID,concat(DD.lv004,' ',DD.lv003,' ',DD.lv002) Name,DD.lv005 Title,DD.lv006 TenHoa,DD.lv030 DateWork,DD.lv029 Dep,DD.lv099 from hr_lv0020 DD where 1=1 $strCondi  order by DD.lv029 Asc,DD.lv008 asc";
		else 
			$lvsql="select DD.lv001 CodeID,concat(DD.lv004,' ',DD.lv003,' ',DD.lv002) Name,DD.lv005 Title,DD.lv006 TenHoa,DD.lv030 DateWork,DD.lv029 Dep,DD.lv099 from hr_lv0020 DD where 1=1 $strCondi  order by DD.lv008 asc";
		$vresult=db_query($lvsql);	
		$i=0;
		while($vrow=db_fetch_array($vresult))
		{
...
//////////Get Filter///////////////
	protected function GetCondition()
	{
		...
		if($this->lv029!="")  $strCondi=$strCondi." and C.lv029 in (".$this->LV_GetChildDep($this->lv029).")";
		return $strCondi;
	}
...
/*--End Extent------*/
	...
	public function GetBuilCheckListDept($vListID,$vID,$vTabIndex,$vTbl,$vFieldView='lv002',$vDepID="")
	{
		...
		if($vDepID=="") 
		{
			$vsql="select * from  ".$vTbl." where lv002='WANTAI'";
		}
		else
		{
			$vReturn="'".str_replace(",","','",$vDepID)."'";
