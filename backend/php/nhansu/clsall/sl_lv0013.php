...
////////////
	...
	function LV_UpdateGocQuay($vlv007,$vValue,$vOpt)
	{
		...
		$lvsql="update nhansu_sof_documents_v4_0.hr_lv0211 set $vField='$vValue' Where lv007='$vlv007' ";
		$vResult=db_query($lvsql);
		return $vResult;
	}
	function LV_LayGocQuay($vlv007)
	{
		$lvsql="select lv108,lv109,lv110,lv111,lv112,lv113,lv114,lv115 from  nhansu_sof_documents_v4_0.hr_lv0211 Where lv007='$vlv007' ";
		$vresult=db_query($lvsql);
		$vrow = db_fetch_array ($vresult);
		if($vrow)
		{
	...
	{
		$lvsql="select lv001 from sl_lv0013 BB where BB.lv028='$vlv010' and (BB.lv011=0) and BB.lv015='$vOpt'";
		$vresult=db_query($lvsql);
		$vrow=db_fetch_array($vresult);
		if($vrow)
		{
