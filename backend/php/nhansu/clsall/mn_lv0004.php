...
///////////
	public $DefaultFieldList="lv001,lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv099";	
////////////////////GetDate
...
////////////
	...
	var $ArrView=array("lv001"=>"0","lv002"=>"0","lv003"=>"0","lv004"=>"10","lv005"=>"0","lv006"=>"10","lv007"=>"0","lv008"=>"0","lv009"=>"0","lv010"=>"10","lv011"=>"0","lv012"=>"0","lv013"=>"1","lv099"=>"0");	
	...
	function LV_LoadStrucID($vlv002,$vlv003)
	{
		$lvsql="select * from  mn_lv0004 Where lv002='$vlv002' and lv003='$vlv003'";
	...
	{		
		...
		$lvsql="insert into mn_lv0004 (lv001,lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv099) values('$this->lv001','$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->lv006','$this->lv007','$this->lv008','$this->lv009','$this->lv010','$this->lv011','$this->lv099')";
	...
	{		
		if($this->isAdd==0) return false;
		$lvsql="insert into mn_lv0004 (lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv099) values('$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->lv006','$this->lv007','$this->lv008','$this->lv009','$this->lv010','$this->lv011','$this->lv099')";
		$vReturn= db_query($lvsql);
		if($vReturn) $this->InsertLogOperation($this->DateCurrent,'mn_lv0004.insert',sof_escape_string($lvsql));
		return $vReturn;
	}	
	function LV_Update()
	{
		if($this->isEdit==0) return false;
		  $lvsql="Update mn_lv0004 set lv002='$this->lv002',lv003='$this->lv003',lv004='$this->lv004',lv005='$this->lv005',lv006='$this->lv006',lv007='$this->lv007',lv008='$this->lv008',lv009='$this->lv009',lv010='$this->lv010',lv011='$this->lv011',lv099='$this->lv099'  where  lv001='$this->lv001';";
		$vReturn= db_query($lvsql);
	...
	function LV_Aproval($lvarr)
	{
		...
		$lvsql = "Update mn_lv0004 set lv010=1  WHERE mn_lv0004.lv001 IN ($lvarr)  ";
		$vReturn= db_query($lvsql);
		if($vReturn) $this->InsertLogOperation($this->DateCurrent,'mn_lv0004.approval',sof_escape_string($lvsql));
		return $vReturn;
	}	
	function LV_UnAproval($lvarr)
	{
		if($this->isApr==0) return false;
		$lvsql = "Update mn_lv0004 set lv010=0  WHERE mn_lv0004.lv001 IN ($lvarr)  ";
		$vReturn= db_query($lvsql);
		if($vReturn) $this->InsertLogOperation($this->DateCurrent,'mn_lv0004.unapproval',sof_escape_string($lvsql));
		return $vReturn;
	}
	//////////get view///////////////
	function GetView()
	...
	protected function GetCondition()
	{
		...
		if($this->lv099!="")  $strCondi=$strCondi." and lv099 = '$this->lv099'";
		return $strCondi;
	}
	////////////////Count///////////////////////////
	function GetCount()
...
/////////////////////ListFieldExport//////////////////////////
	function ListFieldExport($lvFrom,$lvList,$maxRows)
	{
		...
		{
			window.open('".$this->Dir."mn_lv0004/?lang=".$this->lang."&childfunc='+value+'&ID=".base64_encode($this->lv002)."','','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
	...
	private function sqlcondition($vFile,$vSelectID)
	{
		...
		/*	case 'lv007':
			...
			case 'lv008':
				...
				break;*/
			case 'lv011':
				$vsql="select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from  mn_lv0019";
				break;
		}
		return $vsql;
	}
	private function getvaluelink($vFile,$vSelectID)
	{
		...
		switch($vFile)
		{
			...
			case 'lv008':
				...
				break;*/
			case 'lv011':
				$vsql="select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from  mn_lv0019 where lv001='$vSelectID'";
				break;
			default:
				$vsql ="";
				break;
