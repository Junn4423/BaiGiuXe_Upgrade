<?php
/////////////coding tc_lv0008///////////////
class   tc_lv0036 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
////////////
	...
	function InsertAutoYear($vlv005)
	{
		
		if($this->isAdd==0) return false;
		$vlv005pre=$vlv005-1;
		$lvsql="insert into tc_lv0008 (lv002,lv003,lv004,lv005,lv006,lv007,lv008) select B.lv002,B.lv003,B.lv004+1,'$vlv005',B.lv006,B.lv007,B.lv008 from tc_lv0008 B where B.lv005='$vlv005pre' and B.lv002 not in(select C.lv002 from tc_lv0008 C where C.lv005='$vlv005')";
	...
	function InsertDepartmenAuto($vdeparment)
	{
		if($this->isAdd==0) return false;
		$lvsql="insert into tc_lv0008 (lv002,lv003,lv004,lv005,lv006,lv007,lv008) select B.lv001,'$this->lv003',0,'$this->lv005','$this->lv006','$this->lv007','$this->lv008' from hr_lv0020 B where B.lv029 in ('$vdeparment') and B.lv009 in (0,1)";
		$vReturn= db_query($lvsql);
		if($vReturn){
		 $this->InsertLogOperation($this->DateCurrent,'tc_lv0008.insert',sof_escape_string($lvsql));
		 }
	...
	function LV_Update()
	{
		...
		$lvsql="Update tc_lv0008 set lv002='$this->lv002',lv003='$this->lv003',lv004='$this->lv004',lv005='$this->lv005',lv006='$this->lv006',lv007='$this->lv007',lv008='$this->lv008' where  lv001='$this->lv001';";
		$vReturn= db_query($lvsql);
		if($vReturn) {
	...
	function LV_Delete($lvarr)
	{
		...
		$lvsql = "DELETE FROM tc_lv0008  WHERE tc_lv0008.lv005<=0 AND tc_lv0008.lv001 IN ($lvarr)";// and (select count(*) from ts_lv0009 B where  B.lv002= tc_lv0008.lv001)<=0  ";
		$vReturn= db_query($lvsql);
	...
	function GetCount()
	{
		$sqlC = "SELECT COUNT(*) AS nums FROM tc_lv0008 WHERE 1=1 ".$this->GetCondition();
