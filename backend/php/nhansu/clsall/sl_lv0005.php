...
///////////
	public $DefaultFieldList="lv001,lv002,lv005,lv003,lv004,lv006,lv007";	
////////////////////GetDate
...
////////////
	...
	var $ArrView=array("lv001"=>"0","lv002"=>"0","lv003"=>"0","lv004"=>"0","lv005"=>"0","lv006"=>"0","lv007"=>"22");
	var $ArrViewEnter=array("lv004"=>"33","lv006"=>"-1","lv007"=>"-1");
	...
	function LV_Insert()
	{
		...
		$lvsql="insert into sl_lv0005 (lv001,lv002,lv003,lv004,lv005,lv006,lv007) values('$this->lv001','$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->LV_UserID',now())";
	...
	function LV_Update()
	{
		if($this->isEdit==0) return false;
		 $lvsql="Update sl_lv0005 set lv002='$this->lv002',lv003='$this->lv003',lv004='$this->lv004',lv005='$this->lv005',lv006='$this->LV_UserID',lv007=now() where  lv001='$this->lv001';";
		$vReturn= db_query($lvsql);
...
$value = $this->Values[$vField] ?? '';					
						...
						$vstr = '<input autocomplete="off" class="txtenterquick" name="qxt'.$vField.'" type="text" id="qxt'.$vField.'" value="'.$value.'" tabindex="2" style="width:100%;min-width:30px;text-align:center;" onKeyPress="return CheckKey(event,7)">';
						$vTempEnter = str_replace("@02", $vstr, $this->Align($lvTd, (int)($this->ArrView[$lstArr[$i]] ?? 0)));
						break;
					default:
						$vTempEnter="<td>&nbsp;</td>";
			...
			for($i=0;$i<count($lstArr);$i++)
			{
				...
				{	
					case 'lv004':
						if($this->GetEdit()==1)
						{													
							$lvTdTextBox="<td align=center><input class='txtenterquick' type=\"checkbox\" value=\"1\" ".(($vrow['lv004']==1)?'checked="true"':'')." @03 onclick=\"UpdateTextCheck(this,'".$vrow['lv001']."',4)\" style=\"width:35px;text-align:center;\" tabindex=\"2\" maxlength=\"32\"   onKeyPress=\"return CheckKey(event,7)\"/></td>";
