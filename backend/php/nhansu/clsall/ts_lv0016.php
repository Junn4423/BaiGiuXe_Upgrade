<?php
/////////////coding ts_lv0016///////////////
class   ts_lv0016 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
////////////
	...
	{
		$lvsql="select * from  ts_lv0020 Where lv001='$vlv001'";
	...
	function LV_Update()
	{
		...
		$this->lv004 = ($this->lv004!="")?recoverdate(($this->lv004), $this->lang):$this->DateDefault;
		//$this->lv007 = ($this->lv007!="")?recoverdate(($this->lv007), $this->lang):$this->DateDefault;
		 $lvsql="Update ts_lv0020 set lv002='$this->lv002',lv003='$this->lv003',lv004='$this->lv004',lv005='$this->lv005',lv006='$this->lv006',lv008='$this->lv008' where  lv001='$this->lv001';";
		$vReturn= db_query($lvsql);
	...
	function LV_Delete($lvarr)
	{
		...
		$lvsql = "DELETE FROM ts_lv0020  WHERE ts_lv0020.lv001 IN ($lvarr)";// and (select count(*) from ts_lv0020 B where  B.lv002= ts_lv0020.lv001)<=0  ";
		$vReturn= db_query($lvsql);
...
/////////////////////ListFieldExport//////////////////////////
	function ListFieldExport($lvFrom,$lvList,$maxRows)
	{
		...
		{
			window.open('$this->Dir'+'ts_lv0016/?lang=".$this->lang."&childfunc='+value+'&ID=".base64_encode($this->lv002)."','','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
...
//////////////////////Buil list////////////////////
	function LV_BuilListReport($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvSortNum,$vopt)
	{
		...
		{
			case 1:
				$sqlS = "SELECT * FROM ts_lv0020 WHERE 1=1 and trim(lv001)!='' and  lv004=CURRENT_DATE() ".$this->GetCondition()." $strSort ";
				break;
			case 2:
				$sqlS = "SELECT * FROM ts_lv0020 WHERE 1=1 and trim(lv001)!='' and  lv004=ADDDATE(CURRENT_DATE(),1) ".$this->GetCondition()." $strSort ";
				break;
			default:
				$sqlS = "SELECT * FROM ts_lv0020 WHERE 1=1 and trim(lv001)!='' and  lv004<CURRENT_DATE() ".$this->GetCondition()." $strSort ";
				break;
...
private function sqlcondition($vFile,$vSelectID)
	{
		...
		switch($vFile)
		{
			...
			case 'lv013':
				...
				break;
			case 'lv014':
				$vsql="select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from  ts_lv0013";
				break;
			case 'lv016':
				$vsql="select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from  sl_lv0007";
				break;
