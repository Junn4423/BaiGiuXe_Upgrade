...
class   hr_lv0038 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
///////////
	public $DefaultFieldList="lv199,lv001,lv002,lv110,lv003,lv004,lv005,lv006,lv007,lv009,lv010,lv011,lv012,lv015,lv019,lv021,lv022,lv026,lv013,lv014,lv027,lv028,lv029,lv030,lv098,lv099,lv100,lv008,lv299";		
...
////////////
	...
	function LV_Insert($vdatabase='')
	{
		...
		$lvsql="insert into hr_lv0038 (lv002,lv003,lv004,
		lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,
		lv014,lv015,lv016,lv017,lv018,lv019,lv020,lv021,lv022,
		lv023,lv024,lv025,lv026,lv027,lv028,lv029,lv030,lv031,
		lv032,lv033,lv034,lv035,lv036,lv037,lv098,lv099,lv299) 
		values('$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->lv006','$this->lv007',
		'".sof_escape_string($this->lv008)."','$this->lv009','$this->lv010','$this->lv011','$this->lv012','$this->lv013','$this->lv014','$this->lv015','$this->lv016','$this->lv017','$this->lv018','$this->lv019','$this->lv020','$this->lv021','$this->lv022','$this->lv023','$this->lv024','$this->lv025','$this->lv026','$this->lv027','$this->lv028','$this->lv029','$this->lv030','$this->lv031','$this->lv032','$this->lv033','$this->lv034','$this->lv035','$this->lv036','$this->lv037','$this->lv098','$this->lv099','$this->lv299')";
		}
		else
		{
			$lvsql="insert into $vdatabase.hr_lv0038 (lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016,lv017,lv018,lv019,lv020,lv021,lv022,lv023,lv024,lv025,lv026,lv027,lv028,lv029,lv030,lv031,lv032,lv033,lv034,lv035,lv036,lv037,lv098,lv099,lv299) values('$this->lv002','$this->lv003','$this->lv004','$this->lv005','$this->lv006','$this->lv007','".sof_escape_string($this->lv008)."','$this->lv009','$this->lv010','$this->lv011','$this->lv012','$this->lv013','$this->lv014','$this->lv015','$this->lv016','$this->lv017','$this->lv018','$this->lv019','$this->lv020','$this->lv021','$this->lv022','$this->lv023','$this->lv024','$this->lv025','$this->lv026','$this->lv027','$this->lv028','$this->lv029','$this->lv030','$this->lv031','$this->lv032','$this->lv033','$this->lv034','$this->lv035','$this->lv036','$this->lv037','$this->lv098','$this->lv099','$this->lv299')";
		}
	...
	function LV_Update()
	{
		...
		$this->lv005 = ($this->lv005!="")?recoverdate(($this->lv005), $this->lang):$this->DateDefault;
		$this->lv098 = ($this->lv098!="")?recoverdate(($this->lv098), $this->lang):$this->DateDefault;
		$lvsql="Update hr_lv0038 set lv002='$this->lv002',lv003='$this->lv003',lv004='$this->lv004',lv005='$this->lv005',lv006='$this->lv006',lv007='$this->lv007',lv008='".sof_escape_string($this->lv008)."',lv009='$this->lv009',lv010='$this->lv010',lv011='$this->lv011',lv012='$this->lv012',lv013='$this->lv013',lv014='$this->lv014',lv015='$this->lv015',lv019='$this->lv019',lv021='$this->lv021',lv022='$this->lv022',lv026='$this->lv026',lv027='$this->lv027',lv028='$this->lv028',lv029='$this->lv029',lv030='$this->lv030',lv098='$this->lv098',lv099='$this->lv099',lv299='$this->lv299' where  lv001='$this->lv001' AND lv009<=0;";
		$vReturn= db_query($lvsql);
		if($vReturn) 
		{
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="DSNV MINH PHUONG">
  <Names>
   <NamedRange ss:Name="_FilterDatabase"
    ss:RefersTo="=\'DSNV MINH PHUONG\'!R1C1:R30C61" ss:Hidden="1"/>
  </Names>
  <Table ss:ExpandedColumnCount="61" ss:ExpandedRowCount="3000" x:FullColumns="1"
   ...
   <Row ss:AutoFitHeight="0" ss:Height="154.5" ss:StyleID="s71">
    ...
    <Cell ss:StyleID="s78"><Data ss:Type="String">Họ và Tên</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>
     <Cell ss:StyleID="s81"><Data ss:Type="String">Loại hợp đồng&#10;0: Thử việc&#10;1.Hợp đồng 1 năm lần 1&#10;2.Hợp đồng 1 năm lần 2&#10;3. Hợp đồng vô thời hạn&#10;4.Phụ lục hợp đồng</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>
    ...
    <Cell ss:StyleID="s83"><Data ss:Type="String">Giờ làm/ngày</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>
    <Cell ss:StyleID="s80"><Data ss:Type="String">Lương CB</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>
    <Cell ss:StyleID="s84"><Data ss:Type="String">MỨC LƯƠNG</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>
    <Cell ss:StyleID="s85"><Data ss:Type="String">THƯỞNG KHÁC+PHỤ CẤP</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>
    <Cell ss:StyleID="s79"><Data ss:Type="String">Tiền trừ thuế (Cơm,Xăng,ĐT)</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>
    <Cell ss:StyleID="s86"><Data ss:Type="String">LƯƠNG KPI</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>
    <Cell ss:StyleID="s79"><Data ss:Type="String">KHÔNG DÙNG</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>
    <Cell ss:StyleID="s79"><Data ss:Type="String">KHÔNG DÙNG</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>
    <Cell ss:StyleID="s79"><Data ss:Type="String">KHÔNG DÙNG</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>
    <Cell ss:StyleID="s85"><Data ss:Type="String">KHÔNG DÙNG</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>
    <Cell ss:StyleID="s85"><Data ss:Type="String">KHÔNG DÙNG</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>
    <Cell ss:StyleID="s85"><Data ss:Type="String">KHÔNG DÙNG</Data><NamedCell
    ...
    <Cell ss:StyleID="s88"><Data ss:Type="String">Tạo lịch</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>
	<Cell ss:StyleID="s88"><Data ss:Type="String">HỢP ĐỒNG CHA</Data><NamedCell
      ss:Name="_FilterDatabase"/></Cell>
   </Row>	  
   ';
		...
		if($this->isLastCheck==1)
			$sqlS = " SELECT A.*,B.lv002 NameStaff FROM hr_lv0038 A inner join hr_lv0020 B on A.lv002=B.lv001  WHERE  A.lv004<curdate() ".$this->RptCondition."  order by A.lv002,A.lv004,A.lv005 ";
		else
			$sqlS = " SELECT A.*,B.lv002 NameStaff FROM hr_lv0038 A inner join hr_lv0020 B on A.lv002=B.lv001  WHERE  A.lv004<curdate() ".$this->RptCondition."  $strSort ";
		$vorder=$curRow;
		...
		while ($vrow1 = db_fetch_array ($bResult)){
				$vrow1['lv027']=str_replace("&","&amp;",$vrow1['lv027']);
				$vrow1['lv028']=str_replace("&","&amp;",$vrow1['lv028']);
				$vrow1['lv029']=str_replace("&","&amp;",$vrow1['lv029']);
				$vrow1['lv030']=str_replace("&","&amp;",$vrow1['lv030']);	
				if($this->isLastCheck==1)
				{
				...
				<Row ss:AutoFitHeight="0">
					...
					<Cell ss:StyleID="s80"><Data ss:Type="String">1</Data></Cell>
					<Cell ss:StyleID="s80"><Data ss:Type="String">'.$vrow1['lv001'].'</Data></Cell>
				</Row>
				';
		}
		$lvTable=$lvTable.$lvTable1;
	...
	function LV_Aproval($lvarr)
	{
		...
		while($vrow=db_fetch_array($vresult))
		{
			...
			if($vReturn) 
			{
				...
				//$vrow['lv009']=='0'
				if( ($vrow['lv003']=='1' || $vrow['lv003']=='2' || $vrow['lv003']=='3'))
				{
					if($vrow['lv003']=='1')
					{
					...
					else
					{
						if($vrow['lv009']=='0')
						{
							$lvsql = "Update hr_lv0020 set lv009=0  WHERE hr_lv0020.lv001='".$vrow['lv002']."' and lv009<>0";
							$vReturn= db_query($lvsql);
						}
					}
				}
				...
				switch($lstArr[$i])
				{
					case 'lv199':
						...
						$vTemp = str_replace(
							"@02",
							$vChucNang,
							$this->Align($lvTd, (int)($this->ArrView[$key] ?? 0))
						);						
						break;
						break;
					case 'lv100':
	...
	private function sqlcondition($vFile,$vSelectID)
	{
		...
		switch($vFile)
		{
			...
			case 'lv024':
				...
				break;
			case 'lv099':
				$vsql="select lv001,concat(lv004,'->',lv005) lv002,IF(lv001='$vSelectID',1,0) lv003 from  hr_lv0038 where lv002='$this->lv002'";
				break;
			case 'lv299':
