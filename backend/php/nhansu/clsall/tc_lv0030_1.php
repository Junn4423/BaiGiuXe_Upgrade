...
public $LE_CODE="NjlIUS02VFdULTZIS1QtNlFIQQ==";
	...
	function LV_RunAll($vArrDep,$vArrCong,$vArrShift,$vDate,$lineprocess,$vState,$vCheckNT,$vShiftCal=0,$vListEmp='',$vArrPro=NULL)
	{
		...
		*/
		...
		{
			if($lineprocess=="")
				$sqlS = "SELECT distinct A.lv001 CodeID,A.lv016,A.lv002,A.lv003,A.lv004,A.lv005,A.lv006,A.lv007,A.lv008,A.lv009,A.lv010,A.lv021 ProjectID,DayOfWeek(A.lv004) DOWS,A.lv015,B.lv002 NVID,C.lv029 lv001,EE.lv005 LockMonth,A.lv089 FixDay,C.lv009 TTNV,C.lv010 isTC,C.lv011 TCTimeCal FROM tc_lv0011 A left join tc_lv0010 B on A.lv002=B.lv001 left join tc_lv0009 EE on EE.lv002=B.lv002 and EE.lv003=MONTH('$vDate') and EE.lv004=YEAR('$vDate')  inner join hr_lv0020 C on C.lv001=B.lv002  WHERE A.lv100=0 and MONTH(A.lv004)=MONTH('$vDate') and YEAR(A.lv004)=YEAR('$vDate') and   B.lv002  in ($vListEmp) $vCondition1 order by A.lv099 ASC,A.lv004 ASC";
			else
				$sqlS = "SELECT distinct A.lv001 CodeID,A.lv016,A.lv002,A.lv003,A.lv004,A.lv005,A.lv006,A.lv007,A.lv008,A.lv009,A.lv010,A.lv021 ProjectID,DayOfWeek(A.lv004) DOWS,A.lv015,B.lv002 NVID,C.lv029 lv001,EE.lv005 LockMonth,A.lv089 FixDay,C.lv009 TTNV,C.lv010 isTC,C.lv011 TCTimeCal FROM tc_lv0011 A left join tc_lv0010 B on A.lv002=B.lv001 left join tc_lv0009 EE on EE.lv002=B.lv002 and EE.lv003=MONTH('$vDate') and EE.lv004=YEAR('$vDate')  inner join hr_lv0020 C on C.lv001=B.lv002  WHERE A.lv100=0 and MONTH(A.lv004)=MONTH('$vDate') and YEAR(A.lv004)=YEAR('$vDate') and   B.lv002  in ($vListEmp) $vCondition1  order by A.lv099 ASC,A.lv004 ASC";
		}
		else
		{
			if($lineprocess=="")
				$sqlS = "SELECT distinct A.lv001 CodeID,A.lv016,A.lv002,A.lv003,A.lv004,A.lv005,A.lv006,A.lv007,A.lv008,A.lv009,A.lv010,A.lv021 ProjectID,DayOfWeek(A.lv004) DOWS,A.lv015,B.lv002 NVID,C.lv029 lv001,EE.lv005 LockMonth,A.lv089 FixDay,C.lv009 TTNV,C.lv010 isTC,C.lv011 TCTimeCal FROM tc_lv0011 A left join tc_lv0010 B on A.lv002=B.lv001 left join tc_lv0009 EE on EE.lv002=B.lv002  and EE.lv003=MONTH('$vDate') and EE.lv004=YEAR('$vDate') inner join hr_lv0020 C on C.lv001=B.lv002  WHERE A.lv100=0 and A.lv004='$vDate' and   B.lv002  in ($vListEmp) $vCondition1 order by A.lv099 ASC,A.lv004 ASC";
			else
				$sqlS = "SELECT distinct A.lv001 CodeID,A.lv016,A.lv002,A.lv003,A.lv004,A.lv005,A.lv006,A.lv007,A.lv008,A.lv009,A.lv010,A.lv021 ProjectID,DayOfWeek(A.lv004) DOWS,A.lv015,B.lv002 NVID,C.lv029 lv001,EE.lv005 LockMonth,A.lv089 FixDay,C.lv009 TTNV,C.lv010 isTC,C.lv011 TCTimeCal FROM tc_lv0011 A left join tc_lv0010 B on A.lv002=B.lv001 left join tc_lv0009 EE on EE.lv002=B.lv002  and EE.lv003=MONTH('$vDate') and EE.lv004=YEAR('$vDate') inner join hr_lv0020 C on C.lv001=B.lv002  WHERE A.lv100=0 and A.lv004='$vDate' and   B.lv002  in ($vListEmp) $vCondition1 order by A.lv099 ASC,A.lv004 ASC";
		}
		...
		while ($vrow = db_fetch_array ($bResult)){
			...
			if($vShiftCal==0)
			{
				...
				if($vrow['ShiftCal']==1 || $vrow['FixDay']==1)
				{
					if($vrow['ProjectID']!='' && $vCaPro!='')
					{
						...
						$vPassDay=$vArrTime[99][0][0];
						$vReturnTime=$this->ProcessTimeAuto($vrow['NVID'],$vArrTime,$vArrShift,1,$vrow['lv015'],$vCaPro,$vPassDay);
					}
					else
					{
						$vArrTime=$this->motc_lv0012->LV_GetListTimeA($vrow['NVID'],$vDateCal,$vArrShift,$vArrDep[$vrow['lv001']][0],$vrow['lv015'],1);
						$vPassDay=$vArrTime[99][0][0];
						$vReturnTime=$this->ProcessTimeAuto($vrow['NVID'],$vArrTime,$vArrShift,1,$vrow['lv015'],$vArrDep[$vrow['lv001']][0],$vPassDay);
					}
				...
				else
				{
					if($vrow['ProjectID']!='' && $vCaPro!='')
					{
						...
						$vPassDay=$vArrTime[99][0][0];
						$vReturnTime=$this->ProcessTimeAuto($vrow['NVID'],$vArrTime,$vArrShift,0,$vrow['lv015'],$vCaPro,$vPassDay);
					}
					else
					{
						...
						$vPassDay=$vArrTime[99][0][0];
						$vReturnTime=$this->ProcessTimeAuto($vrow['NVID'],$vArrTime,$vArrShift,0,$vrow['lv015'],$vArrDep[$vrow['lv001']][0],$vPassDay);
					}
				...
				if($vrow['ProjectID']!='' && $vCaPro!='')
					{
						...
						$vArrTime=$this->motc_lv0012->LV_GetListTimeA($vrow['NVID'],$vDateCal,$vArrShift,$vCaPro,$vrow['lv015'],1);
						$vPassDay=$vArrTime[99][0][0];
						$vReturnTime=$this->ProcessTimeAuto($vrow['NVID'],$vArrTime,$vArrShift,$vShiftCal,$vrow['lv015'],$vCaPro,$vPassDay);
					}
					else
					{
						$vArrTime=$this->motc_lv0012->LV_GetListTimeA($vrow['NVID'],$vDateCal,$vArrShift,$vArrDep[$vrow['lv001']][0],$vrow['lv015'],1);
						$vPassDay=$vArrTime[99][0][0];
						$vReturnTime=$this->ProcessTimeAuto($vrow['NVID'],$vArrTime,$vArrShift,$vShiftCal,$vrow['lv015'],$vArrDep[$vrow['lv001']][0],$vPassDay);
					}
			...
			$vTS=$this->DonXinPhep->lv002;
			if($vTS==3)  $vTimeCardID=$this->DonXinPhep->TimeCard;
			...
			if($this->DonXinPhep->lv002!=1) $this->DonXinPhep->LV_CheckPhepStateMulti($vrow['NVID'],$vrow['lv004'],'2');
			$vTimeAddMore='00:00:00';
			if(($this->DonXinPhep->lv002==1 || $this->DonXinPhep->lv002==2))
			{
			...
			$vAutoTC=false;
			//echo  $vReturnTime['GioLamRel'];
			echo $vrow['lv004'].":";
			echo '('.$vReturnTime['GioLamRel'].'>=TIMEADD(\'08:00:00\','.$vArrDep[$vrow['lv001']][11].') && '.$vrow['isTC'].'==1)';
			echo "<br/>";
			if($vReturnTime['GioLamRel']>=TIMEADD('08:00:00',$vrow['TCTimeCal']) && $vrow['isTC']==1)
			{
				$vTimeTC=TIMEDIFF($vReturnTime['GioLamRel'],'08:00:00');
				$vTimeTC=TIMEADD($vTimeTC,$vTimeTCTG);
				$vTimeTC=$this->LV_LamTronGioTC($vTimeTC);
				if(substr($vReturnTime['CaIn'],0,3)=='CaC')
				{
...
//Bộ xử lý phân tích giờ theo ca
	function ProcessTimeAuto($vEmpID,$vArrTime,$vArrShift,$vShiftCal,$vShift,$vListShiftReceive,$vPassDay=0)
	{
		$vStatus=$vPassDay;
	 	$vCount=count($vArrTime);
		$vArrReturn=Array();
		$vArrReturn['CaIn']=$vShift;
		$vArrReturn['CaOut']=$vShift;
		$vArrReturn['GioVao']=$vArrTime[0];
		$vArrReturn['GioRa']=$vArrTime[1];
		//Ca trong ngày
		if($vStatus==0 || $vStatus==2)
		{
			...
			if($vCount>1)
			{
				if($vFreeTime!='00:00:00')
				{
					...
					$vArrRA22h=$this->CheckInShift($vArrTime,$vStartTime,$vEndTime,$vCount,$vFreeTime);
					...
					$vArrReturn['GioLamRel']=$vArrRA22h[2];
		...
		else//Ca thuộc hai ngày
		{
			...
			if($vCount>1)
			{
					...
					$vArrRA22h=$this->CheckOutShiftAuto($vArrTime,$vStartTime,$vEndTime,$vCount,$vFreeTime);
					$vArrReturn['GioLam']=$vArrRA22h[0];
					$vArrReturn['GioLamRel']=$vArrRA22h[2];
					$vArrReturn['Time22h']=$vArrRA22h[1];
					$vArrReturn['FreeTime']=$vFreeTime;
...
//Bộ xử lý phân tích giờ theo ca
	function  CheckOutShiftAuto($vArrTime,$vStartTime,$vEndTime,$vCount,$vFreeTime)
	{
		...
		$vRegHours="00:00:00";
		$vTime22h="00:00:00";
		$vRegHoursRel="00:00:00";
		if($vCount==0 || $vCount==1) $vRegHours;		
		//Even
		$vCalTime=$motc_lv0004->LV_GetTimeShift($vArrTime[0],"24:00:00",1,$vFreeTime,$vRealTime);
		$vRegHours=TIMEADD($vCalTime,$vRegHours);
		$vRegHoursRel=TIMEADD($vRealTime,$vRegHoursRel);

		$vCalTime=$motc_lv0004->LV_GetTimeShift("00:00:00",$vArrTime[1],1,'00:00:00',$vRealTime);
		$vRegHoursRel=TIMEADD($vRealTime,$vRegHoursRel);
		$vRegHours=TIMEADD($vCalTime,$vRegHours);
	...
	function CheckInShift($vArrTime,$vStartTime,$vEndTime,$vCount,$vFreeTime)
	{
		...
		if(($vCount%2)==0)
		{
			for($i=0;$i<$vCount;$i++)
			{	
				//echo $vArrTime[$i][0].",".$vArrTime[$i+1].",0,$vFreeTime";
				$vCalTime=$motc_lv0004->LV_GetTimeShift($vArrTime[$i],$vArrTime[$i+1],0,$vFreeTime);
				$vCalTimeReal=$motc_lv0004->LV_GetTimeShift($vArrTime[$i],$vArrTime[$i+1],0,'00:00:00');
				$vRegHours=TIMEADD($vCalTime,$vRegHours);	
				$vRegHoursReal=TIMEADD($vCalTime,$vRegHoursReal);	
