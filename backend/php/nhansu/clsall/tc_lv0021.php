<?php
/////////////coding tc_lv0021///////////////
class   tc_lv0021 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
///////////
////////////////////GetDate
	public $DefaultFieldList="lv001,lv058,lv002,lv007,lv003,lv004,lv005,lv006,lv008,lv051,lv026,lv082,lv029,lv011,lv010,lv012,lv025,lv013,lv019,lv093,lv018,lv023,lv015,lv016,lv017,lv020,lv021,lv022,lv092,lv024,lv027,lv072,lv028,lv030,lv031,lv032,lv033,lv034,lv035,lv036,lv037,lv038,lv039,lv040,lv041,lv042,lv043,lv044,lv045,lv046,lv047,lv088,lv048,lv049,lv050,lv009,lv056,lv057,lv059,lv060,lv061,lv062,lv063,lv064,lv065,lv066,lv067,lv068,lv069,lv070,lv071,lv073,lv080,lv100,lv101,lv090,lv091";	
...
////////////
		...
		foreach($vArrFied as $vField)
	  	{
	  		...
	  		else
	  		{
	  			...
	  			$vValues=$vValues.",'".$row[$vField]."'";
	  		}
	  		$row[$vField]=$ArrList[$i];
	  		$i++;
	  	}
	  	 $lvsql="insert into tc_lv0021 (lv003,lv004,lv005,lv060,lv067,lv056,".$vFields.") values('$this->lv003','$this->lv004','$this->lv005','$this->lv060','$this->lv067','$this->lv056',".$vValues.")";
	...
	$motc_lv0021=new tc_lv0021($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Tc0020');
	...
	$motc_lv0021->LV_LoadID($vlv001);
	$motc_lv0013->LV_LoadID($motc_lv0021->lv060);
	$vArrCheck=$this->LV_CheckReNew($motc_lv0021->lv002,$motc_lv0013);
	$mohr_lv0020->LV_LoadID($motc_lv0021->lv002);
	$mohr_lv0038->LV_LoadID($motc_lv0021->lv033);
	$vFNUsed=$motc_lv0008->LV_CheckOne_FNCB($motc_lv0021->lv002,$motc_lv0013->lv007,0);
	$vFNMonth=$motc_lv0009->LV_FNLoadMonthID($motc_lv0021->lv002,$motc_lv0013->lv006,$motc_lv0013->lv007);
	$vstrRetrun='';
		$vstrRetrun=$vstrRetrun.'
		<div style="float:left;width:499px;border:0px #c3c3c3 solid;padding-right:10px;padding-bottom:10px">
	<div style="width:499px;border:1px #c3c3c3 solid;">
		<p align="center"><strong>PAY&nbsp; ADVICE (THÔNG BÁO LƯƠNG</strong>) / </strong><strong><em>'.GetMonthName(getmonth($motc_lv0021->lv005)).', '.getyear($motc_lv0021->lv005).' (Tháng '.getmonth($motc_lv0021->lv005).', '.getyear($motc_lv0021->lv005).')</em></strong><strong></strong></p>
<table style="width: 499px;" border="1" cellspacing="0" cellpadding="0">
<tbody>
<tr>
<td width="242">
<p>'.$mohr_lv0020->lv002.'</p>
</td>
<td width="257">
<p>Position:'.$mohr_lv0020->lv005.'</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td width="97">
<p align="center">Basic Salary</p>
<p align="center">(Lương cơ bản)</p>
</td>
<td width="66">
<p align="center">'.$motc_lv0021->FormatView($motc_lv0021->lv006,20).'</p>
</td>
<td width="90">
<p align="center">After 22 hour Allowance</p>
<p align="center">(Tiền làm thêm sau 22h)</p>
</td>
<td width="66">
<p align="center">'.$motc_lv0021->FormatView($motc_lv0021->lv029,20).'</p>
</td>
<td width="114">
<p align="center">PIT Tax</p>
<p align="center">(Thuế TNCN)</p>
</td>
<td width="66">
<p align="center">'.$motc_lv0021->FormatView($motc_lv0021->lv045,20).'</p>
</td>
</tr>
<tr>
<td width="97">
<p align="center">Gross salary</p>
<p align="center">(Lương bao gồm thưởng)</p>
</td>
<td width="66">
<p align="center">'.$motc_lv0021->FormatView($motc_lv0021->lv024,20).'</p>
</td>
<td width="90">
<p align="center">Night Shift</p>
<p align="center">(Tiền làm ca đêm)</p>
</td>
<td width="66">
<p align="center">'.$motc_lv0021->FormatView($motc_lv0021->lv028,20).'</p>
</td>
<td width="114">
<p align="center">Exemption for dependants</p>
<p align="center">(Số người phụ thuộc )</p>
</td>
<td width="66">
<p align="center">'.$motc_lv0021->FormatView($motc_lv0021->lv065,20).'</p>
</td>
</tr>
<tr>
<td width="97">
<p align="center">Paid day(số ngày</p>
<p align="center">trả lương)</p>
</td>
<td width="66">
<p align="center">'.$motc_lv0021->FormatView($motc_lv0021->lv013,20).'</p>
</td>
<td width="90">
<p align="center">Other allowance</p>
<p align="center">(Phụ cấp khác)</p>
</td>
<td width="66">
<p align="center">'.$motc_lv0021->FormatView($motc_lv0021->lv031,20).'</p>
</td>
<td width="114">
<p align="center">Overtime</p>
<p align="center">Allowance</p>
</td>
<td width="66">
<p align="center">-</p>
</td>
...
<tr>
<td width="97">
<p align="center">Salary Adjustment</p>
<p align="center">(Điều chỉnh lương)</p>
</td>
<td width="66">
<p align="center">&nbsp;</p>
</td>
<td width="90">
<p align="center">10,5%SI,HI&amp;UI <br /> BHXH,BHYT,</p>
<p align="center">BHTN(10,5%)</p>
</td>
<td width="66">
<p align="center">'.$motc_lv0021->FormatView($motc_lv0021->lv043,20).'</p>
</td>
<td width="114">
<p align="center">Total deduction</p>
<p align="center">Tổng giảm trừ</p>
</td>
<td width="66">
<p align="center">'.$motc_lv0021->FormatView($motc_lv0021->lv048,20).'</p>
</td>
</tr>
<tr>
<td width="97">
<p align="center">Service charge</p>
<p align="center">(Ph&iacute; dịch vụ)</p>
</td>
<td width="66">
<p align="center">'.$motc_lv0021->FormatView($motc_lv0021->lv032,20).'</p>
</td>
<td width="90">
<p align="center">Oher deduction</p>
<p align="center">(Trừ khác)</p>
</td>
<td width="66">
<p align="center">'.$motc_lv0021->FormatView($motc_lv0021->lv046,20).'</p>
</td>
<td width="114">
<p align="center">Hoàn trả tiền thuế TNCN đã nộp thừa   '.(getyear($motc_lv0021->lv005)-1).' hoặc số Tiền phải khấu trừ thêm</p>
</td>
<td width="66">
<p align="center">'.$motc_lv0021->FormatView($motc_lv0021->lv047,20).'</p>
</td>
</tr>
<tr>
<td width="97">
<p align="center">Split Shift</p>
<p align="center">(Trợ cấp ca gãy)</p>
</td>
<td width="66">
<p align="center">'.$motc_lv0021->FormatView($motc_lv0021->lv027,20).'</p>
</td>
<td width="90">
<p align="center">Tiền bán thẻ VIP Card và tiền thưởng   bán phòng</p>
</td>
<td width="66">
<p align="center">&nbsp;</p>
</td>
...
<p align="center">Lương thực lãnh</p>
</td>
<td width="66">
<p align="center">'.$motc_lv0021->FormatView($motc_lv0021->lv050,20).'</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td width="499">
<p align="center">Remark: Should you have any question,   please kindly contact Ms. An &ndash; HR Officer at 727</p>
<p align="center">Lưu &yacute;: Nếu bạn c&oacute; thắc mắc về lương,   vui long liên hệ bạn An-phòng nhân sự, số lẽ 727</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
  ...
  <td>'.($motc_lv0021->FormatView($motc_lv0021->lv006,10)).'</td>
...
<tr>
  ...
  <td>'.($motc_lv0013->FormatView($motc_lv0021->lv018,10)).'</td>
  <td width="20%">Phép năm/ Annual leave  </td>
  <td>'.($mohr_lv0020->FormatView($motc_lv0021->lv016,10)).'</td>
  <td width="20%">Không lương/ Ul </td>
  <td>'.($mohr_lv0020->FormatView($motc_lv0021->lv020,10)).'</td>
  </tr>
 <tr>
  <td>Ngày lễ và nghỉ bù/ compensation leave </td>
  <td>'.($motc_lv0013->FormatView($motc_lv0021->lv015,10)).'</td>
  <td>Bệnh/Medical leave   </td>
  <td>'.($mohr_lv0020->FormatView($motc_lv0021->lv016,10)).'</td>
  <td>Làm vào ngày lễ/ PH  </td>
  <td>'.($mohr_lv0020->FormatView($motc_lv0021->lv026,10)).'</td>
  </tr>
</table>
<br/>
';
	$vSumAdd=0;
	$vSumSub=0;
	$vSumAdd=$vSumAdd+$motc_lv0021->lv035;
	$vSumSub=$vSumSub+$motc_lv0021->lv062;
	$vSumSub=$vSumSub+$motc_lv0021->lv063;
	
	$vSumAdd=$vSumAdd+$motc_lv0021->lv040;
	
	$vSumAdd=$vSumAdd+$motc_lv0021->lv037;
	
	$vSumAdd=$vSumAdd+$motc_lv0021->lv038;
	$vSumSub=$vSumSub+$motc_lv0021->lv068;
	$vSumAdd=$vSumAdd+$motc_lv0021->lv039;;
	$vSumAdd=$vSumAdd+$motc_lv0021->lv047;
	$vSumAdd=$vSumAdd+$motc_lv0021->lv048;
	$vSumAdd=$vSumAdd+$motc_lv0021->lv049;
	$vSumAdd=$vSumAdd+$motc_lv0021->lv050;
	if($mohr_lv0038->lv019==1)
	{
		$vSumSub=$vSumSub+$motc_lv0021->lv064;
		$vSumSub=$vSumSub+$motc_lv0021->lv065;
		$vSumSub=$vSumSub+$motc_lv0021->lv066;
		$vSumSub=$vSumSub+$motc_lv0021->lv067;
	}
	else
	{
		$vSumSub=$vSumSub+$motc_lv0021->lv072;
		$vSumSub=$vSumSub+$motc_lv0021->lv073;
		$vSumSub=$vSumSub+$motc_lv0021->lv074;
		$vSumSub=$vSumSub+$motc_lv0021->lv088;
	}
	$vMeal=$motc_lv0021->LV_GetPriceProduct($motc_lv0021->lv060,'Meal');
	if($vMeal==0) $vMeal=1;
	$vSumAdd=$vSumAdd+$motc_lv0021->lv041;;
	$vTransport=$motc_lv0021->LV_GetPriceProduct($motc_lv0021->lv060,'Transport');
	if($vTransport==0) $vTransport=1;
	$vSumAdd=$vSumAdd+$motc_lv0021->lv042;
	$vSumAdd=$vSumAdd+$motc_lv0021->lv044;
	$vSumAdd=$vSumAdd+$motc_lv0021->lv043;
	$vSumAdd=$vSumAdd+$motc_lv0021->lv045;
	$vSumAdd=$vSumAdd+$motc_lv0021->lv056;
	$vSumAdd=$vSumAdd+$motc_lv0021->lv060;
	$vSumAdd=$vSumAdd+$motc_lv0021->lv046;
	$vSumAdd=$vSumAdd+$motc_lv0021->lv051;
	$vSumAdd=$vSumAdd+$motc_lv0021->lv057;
	$vSumAdd=$vSumAdd+$motc_lv0021->lv031;
	$vSumAdd=$vSumAdd+$motc_lv0021->lv036;
...
<table cellpadding="0" cellspacing="0" border="1" width="760">
	...
	<tbody>
		...
		<tr height="19">
			...
			<td align="center">'.($motc_lv0013->FormatView($motc_lv0021->lv018,10)).'</td>
			<td align="right">'.$motc_lv0013->FormatView($motc_lv0021->lv035,10).'</td>
			<td>Tạm ứng</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv062,10)).'</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		</tr>
		<tr height="19">
			...
			<td>&nbsp;</td>
			<td>Tạm ứng riêng</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv063,10)).'</td>
		...
		<tr height="19">
			...
			<td align="center">'.($motc_lv0013->FormatView($motc_lv0021->lv022,10)).'</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv036,10)).'</td>
			<td>BHXH</td>
			<td align="right">'.($motc_lv0013->FormatView((($mohr_lv0038->lv019==1)?$motc_lv0021->lv064:$motc_lv0021->lv072),10)).'</td>
			<td>Phép năm nghỉ trong tháng</td>
			<td>'.($motc_lv0008->FormatView($vFNMonth,10)).'</td>
		</tr>
		<tr height="19">
			<td height="19">Tăng ca Ngày nghỉ lễ 300%</td>
			<td align="center">'.($motc_lv0013->FormatView($motc_lv0021->lv026,10)).'</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv040,10)).'</td>
			<td>BHYT&nbsp;</td>
			<td align="right">'.($motc_lv0013->FormatView((($mohr_lv0038->lv019==1)?$motc_lv0021->lv065:$motc_lv0021->lv073),10)).'</td>
			<td>Phép năm còn lại&nbsp;</td>
			<td>'.($motc_lv0008->FormatView($vFNUsed,10)).'</td>
		</tr>
		<tr height="19">
			<td height="19">Tăng ca (Chủ nhật) 200%</td>
			<td align="center">'.($motc_lv0013->FormatView($motc_lv0021->lv023,10)).'</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv037,10)).'</td>
			<td>BHTN</td>
			<td align="right">'.($motc_lv0013->FormatView((($mohr_lv0038->lv019==1)?$motc_lv0021->lv066:$motc_lv0021->lv074),10)).'</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		</tr>
		<tr height="19">
			<td height="19">Tăng ca&nbsp; ca đêm (195%)</td>
			<td align="center">'.($motc_lv0013->FormatView($motc_lv0021->lv024,10)).'</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv038,10)).'</td>
			<td>Đoàn phí CĐ&nbsp;</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv068,10)).'</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		</tr>
		<tr height="19">
			<td height="19">Tăng ca CN của CN 260%</td>
			<td align="center">'.($motc_lv0013->FormatView($motc_lv0021->lv025,10)).'</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv039,10)).'</td>
			<td>Thuế TNCN</td>
			<td align="right">'.($motc_lv0013->FormatView((($mohr_lv0038->lv019==1)?$motc_lv0021->lv067:$motc_lv0021->lv088),10)).'</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		</tr>
		<tr height="19">
			...
			<td align="center"> - </td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv047,10)).'</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr height="19">
			...
			<td align="center"> - </td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv048,10)).'</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr height="19">
			...
			<td>&nbsp;</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv049,10)).'</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr height="19">
			...
			<td>&nbsp;</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv050,10)).'</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr height="19">
			...
			<td align="center">'.($motc_lv0013->FormatView($motc_lv0021->lv041/$vMeal,10)).'</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv041,10)).'</td>
			<td>Khác&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr height="19">
			...
			<td align="center">'.($motc_lv0013->FormatView($motc_lv0021->lv042/$vTransport,10)).'</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv042,10)).'</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr height="19">
			...
			<td align="center">-</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv044,10)).'</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr height="19">
			...
			<td align="center">'.($motc_lv0013->FormatView($motc_lv0021->lv019,10)).'</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv043,10)).'</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr height="19">
			...
			<td>&nbsp;</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv057,10)).'</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr height="19">
			...
			<td>&nbsp;</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv045,10)).'</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr height="19">
			...
			<td>&nbsp;</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv031,10)).'</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr height="19">
			...
			<td>&nbsp;</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv056,10)).'</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr height="19">
			...
			<td>&nbsp;</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv060,10)).'</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
	...
	';
		...
		<tr height="19">
			...
			<td>&nbsp;</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv046,10)).'</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr height="19">
			...
			<td>&nbsp;</td>
			<td align="right">'.($motc_lv0013->FormatView($motc_lv0021->lv051,10)).'</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
...
<table cellpadding="0" cellspacing="0" border="0" width="760">
	...
	<tbody>
		...
		<tr height="19">
			...
			$motc_lv0021->lang="EN"; 
		$vstrRetrun=$vstrRetrun.$motc_lv0021->FormatView($motc_lv0021->lv004,2).' till '.($motc_lv0021->FormatView($motc_lv0021->lv005,2)).' / Lương được tính từ';
		$motc_lv0021->lang="VN"; 
		$vstrRetrun=$vstrRetrun.$motc_lv0021->FormatView($motc_lv0021->lv004,2).'  đến '.($motc_lv0021->FormatView($motc_lv0021->lv005,2)).'</td>
		</tr>
	</tbody>
</table>
  ';
	...
	protected function GetCondition()
	{
		...
		if($this->lv029!="")  
		{
			$strCondi=$strCondi." and lv058 in (".$this->LV_GetDep($this->lv029).")";
		}
...
//////////////////////Buil list////////////////////
	function LV_BuilList($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvSortNum)
	{
		...
		while ($vrow = db_fetch_array ($bResult)){
			...
			if($vrow['lv101']==1)		$strTr=str_replace("@#04","lvlineapproval",$strTr);
...
/////////////////////ListFieldExport//////////////////////////
	function ListFieldExport($lvFrom,$lvList,$maxRows)
	{
		...
		{
			window.open('".$this->Dir."tc_lv0021/?lang=".$this->lang."&func='+value+'&NVID=".base64_encode($this->lv002)."&CalID=".base64_encode($this->lv020)."','','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
...
//////////////////////Buil list////////////////////
	...
	function LV_GetCodeKT($vCode,$vDeptID)
	{
		...
		if($vDeptID=='SOF' || $vDeptID=='TDL' || $vDeptID=='TECH' || $vDeptID=='')
		{
			$this->ArrayDeptCode[$vDeptID][0]=true;
			$this->ArrayDeptCode[$vDeptID][1]=$vCode;
			return $vCode;
		...
		while($vrow=db_fetch_array($vresult))
		{
			...
			if($vrow['lv002']=='SOF' || $vrow['lv002']=='TDL' || $vrow['lv002']=='TECH')
			{
				$this->ArrayDeptCode[$vDeptID][0]=true;
	...
	function LV_BuilListReportOther($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvSortNum)
	{
		...
		$sqlS = "select * from (SELECT A.*,AA.lv004 DeptID,C.lv007 lv101  FROM tc_lv0021 A inner join tc_lv0064 AA on AA.lv003=A.lv002 and AA.lv002=A.lv060 left join hr_lv0020 B on A.lv002=B.lv001 left join hr_lv0002 C on AA.lv004=C.lv001  WHERE 1=1  ".$this->GetConditionOtherCal().") MP $strSort LIMIT $curRow, $maxRows";
...
<tr height="25">
<td colspan="6" height="25">EXPAT   PAYROLL REGISTER/ BẢNG LƯƠNG NGƯỜI NƯỚC NGoàI -'.Fillnum($motc_lv0013->lv006,2).'/ '.$motc_lv0013->lv007.'</td>
<td>&nbsp;</td>
<td><span style="text-decoration: underline;">&nbsp;</span></td>
<td><span style="text-decoration: underline;">&nbsp;</span></td>
<td>&nbsp;</td>
...
return $vHeader.str_replace("@01",$vStrTr,$vTable).$vFooter;
	...
	function LV_LoadFullSalaryYear($vYear)
	{
		...
		while ($vrow = db_fetch_array ($bResult)){
			...
			$vArSalaryEmp[$vrow['lv002']][$vrow['Months']]['lv033']=$vArSalaryEmp[$vrow['lv002']][$vrow['Months']]['lv033']+$vrow['lv033'];//Tổng lương
			$vArSalaryEmp[$vrow['lv002']][$vrow['Months']]['lv071']=$vArSalaryEmp[$vrow['lv002']][$vrow['Months']]['lv071']+$vrow['lv071'];//Tổng lương
			$vArSalaryEmp[$vrow['lv002']][$vrow['Months']]['lv057']=$vArSalaryEmp[$vrow['lv002']][$vrow['Months']]['lv057']+$vrow['lv057'];//Cách tính lương làm thêm hay chinh thức
			$vArSalaryEmp[$vrow['lv002']][$vrow['Months']]['lv065']=$vArSalaryEmp[$vrow['lv002']][$vrow['Months']]['lv065']+$vrow['lv065'];//Số người giảm trừ
...
<td colspan="26" width="3011"><strong style="font-weight: bold;"> Thu nhập chịu thuế năm 2016 </strong></td>
<td colspan="78" width="6760"><strong style="font-weight: bold;"> Các khoản giảm trừ năm 2016 </strong></td>
...
<td colspan="25" width="2514"><strong style="font-weight: bold;"> Số thuế đã khấu trừ trong năm 2016 </strong></td>
...
';
		...
		while ($vrow = db_fetch_array ($bResult)){
			...
			else
			{
				...
				$vLineOne=str_replace("@28",$this->FormatView(0,20),$vLineOne);	
				$vLineOne=str_replace("@29",$this->FormatView($vArSalaryEmp[$vrow['lv001']]['09']['lv045'],20),$vLineOne);	
			}
			if($vArSalaryEmp[$vrow['lv001']]['10']['lv057']!=2)
			{
	...
	function LV_LuongVanPhongChinh($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvSortNum,$motc_lv0013,&$vDh=0,$mau=0)
	{
		...
		<p></p>
		<p></p>
		<table border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="1645">
		'.$vExtent.'
		<tr><td>
		...
		<tbody>
			<tr height="23">
				<td height="55" rowspan="2" width="58"><center><strong>Mã NV</strong></center></td>
				<td rowspan="2" width="152"><center><strong>Họ v&agrave; T&ecirc;n</strong></center></td>
				<td rowspan="2" width="136"><center><strong>Chức Danh</strong></center></td>
				<td rowspan="2" width="47"><center><strong>Công</strong></center></td>
				<td rowspan="2" width="44"><center><strong>Công Thực</strong></center></td>
				<td colspan="7" width="663"><center><strong>Các Khoản Được Hưởng</strong></center></td>
				<td colspan="7" width="448"><center><strong>Các Khoản Khấu Trừ</strong></center></td>
				<td rowspan="2" width="97"><center><strong>Thực Lãnh</strong></center></td>
				<td rowspan="2"><center><strong>Mã KT</strong></center></td>
			</tr>
			<tr height="32">
				<td height="32"><center><strong> Lương  </strong></center></td>
				<td><center><strong>Thưởng Khác</strong></center></td>
				<td><center><strong>Tiền gửi xe</strong></center></td>
				<td><center><strong>Điện Thoại</strong></center></td>
				<td><center><strong>Thu Khác</strong></center></td>
				<td><center><strong>Tăng Ca</strong></center></td>
				<td><center><strong>Tổng Cộng</strong></center></td>
				<td><center><strong>BHXH '.$this->FormatView($motc_lv0013->lv012+$motc_lv0013->lv013+$motc_lv0013->lv014,10).'%</strong></center></td>
				<td width="87"><center><strong>BHXH (Cty)+<br />
					KPCĐ '.$this->FormatView($motc_lv0013->lv017+$motc_lv0013->lv018+$motc_lv0013->lv019,10).'%</strong></center></td>
				<td><center><strong>Kinh phí CĐ 2%</strong></center></td>
				<td><center><strong>Thuế TNCN</strong></center></td>
				<td width="86"><center><strong>Khác <br />
					</strong></center></td>
				<td width="86"><center><strong>Đoàn Ph&iacute;</strong></center></td>
				<td><center><strong>Tổng Trừ</strong></center></td>
			</tr>
			@#01
			@#02
		</tbody>
	...
	$vTR='<tr height="17">
		...
		{
			case 0:
				$sqlS = "SELECT A.*,B.lv030 lv503,B.lv005 Position,C.lv007 KTCode,AA.lv004 DeptID  FROM tc_lv0021 A inner join tc_lv0064 AA on AA.lv003=A.lv002 and AA.lv002=A.lv060  left join hr_lv0020 B on A.lv002=B.lv001 left join hr_lv0002 C on A.lv058=C.lv001 WHERE 1=1  ".$this->GetConditionOtherCal()." $strSort LIMIT $curRow, $maxRows";
				break;
			case 1:
		...
		while ($vrow = db_fetch_array ($bResult)){
			if($strDepart!=$vrow['DeptID'].'' && $mau!=2)
			{
				...
				$vLineOne=str_replace("@#03",'',$vLineOne);
				$vLineOne=str_replace("@#04",$this->FormatView($vlv012_1,20),$vLineOne);
				$vLineOne=str_replace("@#05",$this->FormatView($vlv013_1,20),$vLineOne);
				$vLineOne=str_replace("@#06",$this->FormatView($vlv019_1,20),$vLineOne);
				$vLineOne=str_replace("@#07",$this->FormatView($vlv022_1,20),$vLineOne);
				$vLineOne=str_replace("@#08",$this->FormatView($vlv052_1,20),$vLineOne);
				$vLineOne=str_replace("@#09",$this->FormatView($vlv051_1,20),$vLineOne);
				$vLineOne=str_replace("@#10",$this->FormatView($vlv089_1,20),$vLineOne);
				$vLineOne=str_replace("@#11",$this->FormatView($vlv077_1,20),$vLineOne);
				$vLineOne=str_replace("@#12",$this->FormatView($vlv085_1,20),$vLineOne);
				$vLineOne=str_replace("@#13",$this->FormatView($vlv043_1,20),$vLineOne);
				$vLineOne=str_replace("@#14",$this->FormatView($vlv039_1,20),$vLineOne);
				$vLineOne=str_replace("@#15",$this->FormatView($vlv045_1,20),$vLineOne);
				$vLineOne=str_replace("@#35",$this->FormatView($vlv035_1,20),$vLineOne);
				$vLineOne=str_replace("@#80",$this->FormatView($vlv080_1,20),$vLineOne);
				$vLineOne=str_replace("@#16",$this->FormatView($vlv046_1,20),$vLineOne);
				$vLineOne=str_replace("@#17",$this->FormatView($vlv048_1,20),$vLineOne);
				$vLineOne=str_replace("@#18",$this->FormatView($vlv084_1,20),$vLineOne);
				$strTrH=$strTrH.$vLineOne;
				switch($mau)
					{
						case 1:
			...
			if($vOrder==1)
			{
				...
				$vLineOne=$vTR;
			$vLineOne=str_replace("@#01",$vrow['lv002'],$vLineOne);
			$vLineOne=str_replace("@#02",$this->getvaluelink('lv007',$this->FormatView($vrow['lv002'],(int)$this->ArrView['lv002'])),$vLineOne);
			$vLineOne=str_replace("@#03",$vrow['Position'],$vLineOne);
			$vLineOne=str_replace("@#04",$this->FormatView($vrow['lv012'],20),$vLineOne);
			$vLineOne=str_replace("@#05",$this->FormatView($vrow['lv013'],20),$vLineOne);
			$vLineOne=str_replace("@#06",$this->FormatView($vrow['lv019'],20),$vLineOne);
			$vLineOne=str_replace("@#07",$this->FormatView($vrow['lv022'],20),$vLineOne);
			$vLineOne=str_replace("@#08",$this->FormatView($vrow['lv052'],20),$vLineOne);
			$vLineOne=str_replace("@#09",$this->FormatView($vrow['lv051'],20),$vLineOne);
			$vLineOne=str_replace("@#10",$this->FormatView($vrow['lv089'],20),$vLineOne);
			$vLineOne=str_replace("@#11",$this->FormatView($vrow['lv077'],20),$vLineOne);
			$vLineOne=str_replace("@#12",$this->FormatView($vrow['lv085'],20),$vLineOne);
			$vLineOne=str_replace("@#13",$this->FormatView($vrow['lv043'],20),$vLineOne);
			$vLineOne=str_replace("@#14",$this->FormatView($vrow['lv039'],20),$vLineOne);
			$vLineOne=str_replace("@#15",$this->FormatView($vPIT,20),$vLineOne);
			$vLineOne=str_replace("@#35",$this->FormatView($vrow['lv035'],20),$vLineOne);
			$vLineOne=str_replace("@#80",$this->FormatView($vrow['lv080'],20),$vLineOne);
			$vLineOne=str_replace("@#16",$this->FormatView($vrow['lv046']-$vrow['lv088'],20),$vLineOne);
			$vLineOne=str_replace("@#19",$this->FormatView($vrow['KTCode'],20),$vLineOne);
			//0 PIT trừ Thuong,1 PIT trừ Luong CHinh, 2 PIT trừ luong cả hai
			switch($vrow['lv099'])
			{
				case 0:
					$vLineOne=str_replace("@#15",$this->FormatView($vPIT,20),$vLineOne);
					$vLineOne=str_replace("@#17",$this->FormatView($vrow['lv048']-$vrow['lv045'],20),$vLineOne);
					$vLineOne=str_replace("@#18",$this->FormatView($vrow['lv084'],20),$vLineOne);
					break;
				case 1:
					$vLineOne=str_replace("@#15",$this->FormatView($vPIT,20),$vLineOne);
					$vLineOne=str_replace("@#17",$this->FormatView($vrow['lv048'],20),$vLineOne);
					$vLineOne=str_replace("@#18",$this->FormatView($vrow['lv084'],20),$vLineOne);
					break;
				case 2:
					$vLineOne=str_replace("@#15",$this->FormatView($vPIT,20),$vLineOne);
					$vLineOne=str_replace("@#17",$this->FormatView($vrow['lv048']-($vrow['lv045']-$vrow['lv025']),20),$vLineOne);
					$vLineOne=str_replace("@#18",$this->FormatView($vrow['lv084'],20),$vLineOne);
					break;
				break;;
			}
		...
		$vLineOne=str_replace("@#03",'',$vLineOne);
		$vLineOne=str_replace("@#04",$this->FormatView($vlv012_0,20),$vLineOne);
		$vLineOne=str_replace("@#05",$this->FormatView($vlv013_0,20),$vLineOne);
		$vLineOne=str_replace("@#06",$this->FormatView($vlv019_0,20),$vLineOne);
		$vLineOne=str_replace("@#07",$this->FormatView($vlv022_0,20),$vLineOne);
		$vLineOne=str_replace("@#08",$this->FormatView($vlv052_0,20),$vLineOne);
		$vLineOne=str_replace("@#09",$this->FormatView($vlv051_0,20),$vLineOne);
		$vLineOne=str_replace("@#10",$this->FormatView($vlv089_0,20),$vLineOne);
		$vLineOne=str_replace("@#11",$this->FormatView($vlv077_0,20),$vLineOne);
		$vLineOne=str_replace("@#12",$this->FormatView($vlv085_0,20),$vLineOne);
		$vLineOne=str_replace("@#13",$this->FormatView($vlv043_0,20),$vLineOne);
		$vLineOne=str_replace("@#14",$this->FormatView($vlv039_0,20),$vLineOne);
		$vLineOne=str_replace("@#15",$this->FormatView($vlv045_0,20),$vLineOne);
		$vLineOne=str_replace("@#80",$this->FormatView($vlv080_0,20),$vLineOne);
		$vLineOne=str_replace("@#16",$this->FormatView($vlv046_0,20),$vLineOne);
		$vLineOne=str_replace("@#35",$this->FormatView($vlv035_0,20),$vLineOne);
		$vLineOne=str_replace("@#17",$this->FormatView($vlv048_0,20),$vLineOne);
		$vLineOne=str_replace("@#18",$this->FormatView($vlv084_0,20),$vLineOne);
		$strTrH=$strTrH.$vLineOne;
		$strTable=str_replace("@#02",'',$lvTable);
		$strTable=str_replace("@#03",$this->getvaluelink('lv058',$strDepart),$strTable);
		$strFullTbl=$strFullTbl.str_replace("@#01",$strTrH,$strTable);
	...
	function LV_LuongNganHang($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvSortNum,$motc_lv0013,&$vDh=0,$mau=0)
	{
		...
		<tbody>
			<tr height="23">
				<td height="55" ><center><strong>No</strong></center></td>
				<td  ><center><strong>CODE</strong></center></td>
				<td ><center><strong>ACCOUNT_CREDIT</strong></center></td>
				<td ><center><strong>NAME</strong></center></td>
				<td  ><center><strong> AMOUNT</strong></center></td>
				<td ><center><strong> ACCOUNT_DEBIT</strong></center></td>
				<td width="*%"><center><strong>DESCRIPTIONS</strong></center></td>
				<td ><center><strong>BRAND BANK</strong></center></td>
			</tr>
	...
	$vTR='<tr height="17">
		...
		<tbody>
			<tr height="23">
				<td height="55"  ><center><strong>No
</strong></center></td>
				<td  ><center><strong>CODE
</strong></center></td>
				<td ><center><strong>ACCOUNT_CREDIT
</strong></center></td>
				<td ><center><strong>NAME
</strong></center></td>
				<td  ><center><strong> AMOUNT 
</strong></center></td>
				<td ><center><strong> ACCOUNT_DEBIT
 </strong></center></td>
				<td width="*%" ><center><strong>DESCRIPTIONS
</strong></center></td>
			</tr>
	...
	$vTR='<tr height="17">
		...
		{
			case 0:
				$sqlS = "SELECT A.*,B.lv030 lv503,B.lv005 Position,A.lv061 BankAcount,AA.lv004 DeptID  FROM tc_lv0021 A inner join tc_lv0064 AA on AA.lv003=A.lv002 and AA.lv002=A.lv060  left join hr_lv0020 B on A.lv002=B.lv001 left join hr_lv0002 C on B.lv029=C.lv001 WHERE 1=1  ".$this->GetConditionOtherCal()." $strSort LIMIT $curRow, $maxRows";
				break;
			case 1:
				$sqlS = "SELECT A.*,B.lv030 lv503,B.lv005 Position,A.lv061 BankAcount,AA.lv004 DeptID  FROM tc_lv0021 A inner join tc_lv0064 AA on AA.lv003=A.lv002 and AA.lv002=A.lv060  left join hr_lv0020 B on A.lv002=B.lv001 left join hr_lv0002 C on B.lv029=C.lv001 WHERE (A.lv039<>0 or A.lv043<>0)  ".$this->GetConditionOtherCal()." $strSort LIMIT $curRow, $maxRows";
				break;
			case 2:
				$sqlS = "SELECT A.*,B.lv030 lv503,B.lv005 Position,A.lv061 BankAcount,AA.lv004 DeptID  FROM tc_lv0021 A inner join tc_lv0064 AA on AA.lv003=A.lv002 and AA.lv002=A.lv060  left join hr_lv0020 B on A.lv002=B.lv001 left join hr_lv0002 C on B.lv029=C.lv001 WHERE (A.lv039=0 and A.lv043=0)  ".$this->GetConditionOtherCal()." $strSort LIMIT $curRow, $maxRows";
				break;
		}
		$vorder=$curRow;
		$bResult = db_query($sqlS);
		...
		while ($vrow = db_fetch_array ($bResult)){
			...
			$vLineOne=str_replace("@#02",$vrow['lv002'],$vLineOne);
			$vLineOne=str_replace("@#03",$vrow['BankAcount'],$vLineOne);
			$vLineOne=str_replace("@#04",unicode_to_none(unicode_to_upper($this->getvaluelink('lv007',$vrow['lv002']))),$vLineOne);
			$vLineOne=str_replace("@#05",$this->FormatView($vrow['lv050'],20),$vLineOne);
			$vLineOne=str_replace("@#06",$vrow['BankAcount'],$vLineOne);
			$vLineOne=str_replace("@#08",$vrow['lv062'],$vLineOne);
			$vLineOne=str_replace("@#07",$this->getvaluelink('lv060',$vrow['lv060']),$vLineOne);
			$vLineOne=str_replace("@!02",$this->getvaluelink('lv058',$strDepart),$vLineOne);
			$strTrH=$strTrH.$vLineOne;
		}
		$vLineOne=$vTRBold;
...
<td ><center><strong>Start date<br/>(Ngày vào làm)
				...
				<td ><center><strong>Net Salary 
 </strong></center></td>
				<td ><center><strong>Signature
</strong></center></td>
				<td ><center><strong>Remarks
</strong></center></td>
			</tr>
	...
	$vTR='<tr height="17">
		...
		{
			case 0:
				$sqlS = "SELECT A.*,B.lv030 lv503,B.lv005 Position,B.lv030 DateWork,AA.lv004 DeptID  FROM tc_lv0021 A inner join tc_lv0064 AA on AA.lv003=A.lv002 and AA.lv002=A.lv060  left join hr_lv0020 B on A.lv002=B.lv001 left join hr_lv0002 C on B.lv029=C.lv001 WHERE 1=1  ".$this->GetConditionOtherCal()." $strSort LIMIT $curRow, $maxRows";
				break;
			case 1:
				$sqlS = "SELECT A.*,B.lv030 lv503,B.lv005 Position,B.lv030 DateWork,AA.lv004 DeptID  FROM tc_lv0021 A inner join tc_lv0064 AA on AA.lv003=A.lv002 and AA.lv002=A.lv060  left join hr_lv0020 B on A.lv002=B.lv001 left join hr_lv0002 C on B.lv029=C.lv001 WHERE (A.lv039<>0 or A.lv043<>0)  ".$this->GetConditionOtherCal()." $strSort LIMIT $curRow, $maxRows";
				break;
			case 2:
				$sqlS = "SELECT A.*,B.lv030 lv503,B.lv005 Position,B.lv030 DateWork,AA.lv004 DeptID  FROM tc_lv0021 A inner join tc_lv0064 AA on AA.lv003=A.lv002 and AA.lv002=A.lv060  left join hr_lv0020 B on A.lv002=B.lv001 left join hr_lv0002 C on B.lv029=C.lv001 WHERE (A.lv039=0 and A.lv043=0)  ".$this->GetConditionOtherCal()." $strSort LIMIT $curRow, $maxRows";
				break;
		}
		$vorder=$curRow;
		$bResult = db_query($sqlS);
		...
		while ($vrow = db_fetch_array ($bResult)){
			...
			$vLineOne=str_replace("@#04",$this->FormatView($vrow['DateWork'],2),$vLineOne);
...
<td style="text-align: center;" width="98">@03</td><td style="text-align: center;" width="98">@04</td>';
		$vsql="select * from hr_lv0002 where lv002='TDL' or lv001='TECH'";
		$bResult = db_query($vsql);
		$vTotalNums1=0;
		$vTotalNums2=0;
		$vTotalNums3=0;
		...
		$vArrDept['SOF']['lv001']=	'SOF';
		$vArrDept['SOF']['lv003']=	'TỔNG CỘNG';
		$vArrDept['SOF'][30]=str_replace("@01",'TỔNG CỘNG',$vTitlePB);
		$vArrDept['SOF'][31]=$vTitlePBChild;
...
2%<br/>(Hotel)
	...
	$vTR='<tr height="17">
		...
		elseif($this->lv201=='TECH')
			...
			$vsql="select * from hr_lv0002 where lv002='TECH' or lv002='TDL'";
	...
	$vTR='<tr height="17">
		...
		if($vListDep!="") 
			...
			{
				case 0:
					$sqlS = "SELECT A.*,IF(A.lv057=2,A.lv050,0) lv150,B.lv030 DateW,B.lv030 lv503,B.lv005 Position,B.lv014 BankAcount  FROM tc_lv0021 A inner join tc_lv0064 AA on AA.lv003=A.lv002 and AA.lv002=A.lv060  left join hr_lv0020 B on A.lv002=B.lv001 left join hr_lv0002 C on B.lv029=C.lv001 WHERE 1=1 and  AA.lv004 in ($vListDep) ".$this->GetConditionOtherlevel1()." $strSort LIMIT $curRow, $maxRows";
					break;
				case 1:
					$sqlS = "SELECT A.*,IF(A.lv057=2,A.lv050,0) lv150,B.lv030 DateW,B.lv030 lv503,B.lv005 Position,B.lv014 BankAcount  FROM tc_lv0021 A inner join tc_lv0064 AA on AA.lv003=A.lv002 and AA.lv002=A.lv060 left join hr_lv0020 B on A.lv002=B.lv001 left join hr_lv0002 C on B.lv029=C.lv001 WHERE (A.lv045<>0)  and  AA.lv004 in ($vListDep) ".$this->GetConditionOtherlevel1()." $strSort LIMIT $curRow, $maxRows";
					break;
				case 2:
					$sqlS = "SELECT A.*,IF(A.lv057=2,A.lv050,0) lv150,B.lv030 DateW,B.lv030 lv503,B.lv005 Position,B.lv014 BankAcount  FROM tc_lv0021 A inner join tc_lv0064 AA on AA.lv003=A.lv002 and AA.lv002=A.lv060 left join hr_lv0020 B on A.lv002=B.lv001 left join hr_lv0002 C on B.lv029=C.lv001 WHERE (A.lv045=0)  and  AA.lv004 in ($vListDep) ".$this->GetConditionOtherlevel1()." $strSort LIMIT $curRow, $maxRows";
					break;
...
<br/>( phí BH người lđ trả)</center></td>
	...
	$vTR='<tr height="17">
		...
		{
			case 0:
				$sqlS = "SELECT A.*,B.lv030 DateW,B.lv030 lv503,B.lv005 Position,B.lv014 BankAcount,AA.lv004 DeptID FROM tc_lv0021 A inner join tc_lv0064 AA on AA.lv003=A.lv002 and AA.lv002=A.lv060 left join hr_lv0020 B on A.lv002=B.lv001 left join hr_lv0002 C on B.lv029=C.lv001 WHERE 1=1 and A.lv006>0  ".$this->GetConditionOtherCal()." order by AA.lv004,AA.lv003 LIMIT $curRow, $maxRows";
				break;
			case 1:
				$sqlS = "SELECT A.*,B.lv030 DateW,B.lv030 lv503,B.lv005 Position,B.lv014 BankAcount,AA.lv004 DeptID FROM tc_lv0021 A inner join tc_lv0064 AA on AA.lv003=A.lv002 and AA.lv002=A.lv060 left join hr_lv0020 B on A.lv002=B.lv001 left join hr_lv0002 C on B.lv029=C.lv001 WHERE ((A.lv036<>0 and A.lv037<>0 and A.lv038<>0) or (A.lv040<>0 and A.lv041<>0 and A.lv042<>0)) and A.lv006>0 ".$this->GetConditionOtherCal()."  order by AA.lv004,AA.lv003 LIMIT $curRow, $maxRows";
				break;
			case 2:
				$sqlS = "SELECT A.*,B.lv030 DateW,B.lv030 lv503,B.lv005 Position,B.lv014 BankAcount,AA.lv004 DeptID FROM tc_lv0021 A inner join tc_lv0064 AA on AA.lv003=A.lv002 and AA.lv002=A.lv060 left join hr_lv0020 B on A.lv002=B.lv001 left join hr_lv0002 C on B.lv029=C.lv001 WHERE (A.lv039=0 and A.lv043=0) and A.lv006>0 ".$this->GetConditionOtherCal()."  order by AA.lv004,AA.lv003 LIMIT $curRow, $maxRows";
				break;
			case 2:
				$sqlS = "SELECT A.*,B.lv030 DateW,B.lv030 lv503,B.lv005 Position,B.lv014 BankAcount,AA.lv004 DeptID FROM tc_lv0021 A inner join tc_lv0064 AA on AA.lv003=A.lv002 and AA.lv002=A.lv060 left join hr_lv0020 B on A.lv002=B.lv001 left join hr_lv0002 C on B.lv029=C.lv001 WHERE  A.lv006>0 ".$this->GetConditionOtherCal()."  order by AA.lv004,AA.lv003 LIMIT $curRow, $maxRows";
				break;
		}
		$vorder=$curRow;
		$bResult = db_query($sqlS);
	...
	function LV_LuongVanPhongThuong($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvSortNum,$motc_lv0013,&$vDh=0,$mau=0)
	{
		$vExel=($_GET['childfunc']=='excel')?true:false;
		if($lvList=="") $lvList=$this->DefaultFieldList;
		if($this->isView==0) return false;
		...
		<tbody>
			<tr height="23">
				...
				<td ><center><strong>Chức Danh</strong></center></td>
				<td ><center><strong>Công</strong></center></td>
				<td  ><center><strong>Công Thực</strong></center></td>
				<td ><center><strong> Thưởng </strong></center></td>
				<td ><center><strong>Mức thưởng T'.$motc_lv0013->lv006.'.'.$motc_lv0013->lv007.'</strong></center></td>
				<td ><center><strong>Thưởng trên công</strong></center></td>
				<td ><center><strong>Trừ khác</strong></center></td>
				<td ><center><strong>Thuế TNCN</strong></center></td>
				<td><center><strong>Thực Lãnh</strong></center></td>
				<td><center><strong>Mã KT</strong></center></td>
			</tr>
	...
	$vTR='<tr height="17">
		...
		while ($vrow = db_fetch_array ($bResult)){
			if($strDepart!=$vrow['DeptID'].'' && $mau!=2)
			{
				if($strDepart!='')
				{
					...
					$vLineOne=str_replace("@#04",$this->FormatView($vlv012_1,20),$vLineOne);
					$vLineOne=str_replace("@#05",$this->FormatView($vlv013_1,20),$vLineOne);
					$vLineOne=str_replace("@#06",$this->FormatView($vlv023_1,20),$vLineOne);
					$vLineOne=str_replace("@#07",$this->FormatView($vlv034_1,20),$vLineOne);
					$vLineOne=str_replace("@#08",$this->FormatView($vlv045_1,20),$vLineOne);
					$vLineOne=str_replace("@#09",$this->FormatView($vlv083_1,20),$vLineOne);
					$vLineOne=str_replace("@#10",$this->FormatView($vlv025_1,20),$vLineOne);
					$vLineOne=str_replace("@#11",$this->FormatView($vlv088_1,20),$vLineOne);
					$strTrH=$strTrH.$vLineOne;
					switch($mau)
					{
						case 1:
			...
			$vLineOne=str_replace("@#04",$this->FormatView($vrow['lv012'],20),$vLineOne);
			$vLineOne=str_replace("@#05",$this->FormatView($vrow['lv013'],20),$vLineOne);
			$vLineOne=str_replace("@#06",$this->FormatView($vrow['lv023'],20),$vLineOne);
			$vLineOne=str_replace("@#07",$this->FormatView($vrow['lv034'],20),$vLineOne);
			$vLineOne=str_replace("@#08",$this->FormatView($vPIT,20),$vLineOne);
			$vLineOne=str_replace("@#09",$this->FormatView($vrow['lv083'],20),$vLineOne);
			$vLineOne=str_replace("@#10",$this->FormatView($vrow['lv025'],20),$vLineOne);
			$vLineOne=str_replace("@#11",$this->FormatView($vrow['lv088'],20),$vLineOne);
			$vLineOne=str_replace("@!02",$this->getvaluelink('lv058',$strDepart),$vLineOne);
		...
		$vLineOne=str_replace("@#04",$this->FormatView($vlv012_0,20),$vLineOne);
		$vLineOne=str_replace("@#05",$this->FormatView($vlv013_0,20),$vLineOne);
		$vLineOne=str_replace("@#06",$this->FormatView($vlv023_0,20),$vLineOne);
		$vLineOne=str_replace("@#07",$this->FormatView($vlv034_0,20),$vLineOne);
		$vLineOne=str_replace("@#08",$this->FormatView($vlv045_0,20),$vLineOne);
		$vLineOne=str_replace("@#09",$this->FormatView($vlv083_0,20),$vLineOne);
		$vLineOne=str_replace("@#10",$this->FormatView($vlv025_0,20),$vLineOne);
		$vLineOne=str_replace("@#11",$this->FormatView($vlv088_0,20),$vLineOne);
		$strTrH=$strTrH.$vLineOne;
		$strTable=str_replace("@#02",'',$lvTable);
		$strTable=str_replace("@#03",$this->getvaluelink('lv058',$strDepart),$strTable);
		$strFullTbl=$strFullTbl.str_replace("@#01",$strTrH,$strTable);
	...
	<tbody>
		<tr height="72">
			...
			<td rowspan="3" style="text-align: center;" width="117"><strong>&nbsp;Ph&iacute; C&ocirc;ng Đoàn <br />
				2%<br />
				(Hotel)&nbsp;</strong></td>
...
<td rowspan="3" width="134"><strong>Ph&iacute; C&ocirc;ng Đoàn <br /> 2%<br /> (Hotel)</strong></td>
...
<td rowspan="3" width="119"><strong>Hoàn trả tiền thuế TNCN đ&atilde; nộp thừa 2015 Hoặc số Tiền c&ograve;n phải khấu   trừ thuế 2015 th&ecirc;m</strong></td>
...
<td><strong>21</strong></td>
	...
	function LV_BuilListReportOtherNone($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList,$lvSortNum)
	{
		...
		if($vExel)
			...
			$lvTdString=$lvTd;
		$sqlS = "SELECT A.*,B.lv030 lv503,AA.lv004 DeptID,C.lv007 lv101  FROM tc_lv0021 A inner join tc_lv0064 AA on AA.lv003=A.lv002 and AA.lv002=A.lv060 left join hr_lv0020 B on A.lv002=B.lv001 left join hr_lv0002 C on AA.lv004=C.lv001  WHERE 1=1  ".$this->GetConditionOtherCal()." order by AA.lv004,AA.lv003 LIMIT $curRow, $maxRows";
		$vorder=$curRow;
		$bResult = db_query($sqlS);
		$this->Count=db_num_rows($bResult);
		$strTrH="";
	...
	{
		if (!empty($this->ArrGetValueLink[$vFile][$vSelectID][0])) {return $this->ArrGetValueLink[$vFile][$vSelectID][1];}
		if($vSelectID=="")
		{
			return $vSelectID;
		}
