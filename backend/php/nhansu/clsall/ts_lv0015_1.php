...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$vHeaderReportInventory="
	    ...
	    $lvsql="select * from ts_lv0020 where lv002='$vlv003' and lv003='$vlv001' $vAddCond order by lv004 desc";
		$strAllTr='';
...
//		if($vAddCond!="") $vCondition = $vCondition." AND lv003 IN ( select B.lv003 from ts_lv0020 B where 1=1 $vAddCond) AND Lot IN ( select B.lv014 from ts_lv0020 B where 1=1 $vAddCond)";
	...
	$vHeaderReportInventory="
		...
		//if($vAddCond!="") $vCondition = $vCondition." AND lv003 IN ( select B.lv003 from ts_lv0020 B where 1=1 $vAddCond) AND Lot IN ( select B.lv014 from ts_lv0020 B where 1=1 $vAddCond)";
		  ...
		  $sqlS = "select A.lv001, A.lv002 ,A.lv004,C.lv002 Unitlv002,B.lv005 Type,B.lv009 DateEnter,'N' CategoryPut,B.lv004 Title,A.lv007,A.lv014 Lot,A.lv015,B.lv006 Reference,B.lv002 WhID  from ts_lv0009 A inner join ts_lv0008 B on A.lv002=B.lv001 and (B.lv009>='$vDateStart' and B.lv009<='$vDateEnd') $vAddContractR  left join sl_lv0005 C on A.lv005=C.lv001 $vCondition where A.lv003='$vlv003' $vAddLot
				UNION
				select A.lv001, A.lv002,A.lv004,C.lv002 Unitlv002,B.lv005 Type,B.lv009 DateEnter,'X' CategoryPut,B.lv004 Title,A.lv007,A.lv014 Lot,A.lv015,B.lv006 Reference,B.lv002 WhID from ts_lv0011 A inner join ts_lv0010 B on A.lv002=B.lv001 and B.lv009>='$vDateStart' and B.lv009<='$vDateEnd' $vAddContractO left join sl_lv0005 C on A.lv005=C.lv001 $vCondition where A.lv003='$vlv003' $vAddLot 
		";
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
