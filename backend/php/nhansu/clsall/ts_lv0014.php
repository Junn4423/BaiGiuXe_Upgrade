<?php
class ts_lv0014 extends lv_controler{
	var $vRowHeader="
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$vHeaderReportInventory="
		...
		$sqlS = "select * from (select A.*,B.lv002 Unitlv002,(select sum(A1.lv004) from ts_lv0009 A1 where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from ts_lv0008 A11 Where A11.lv009<'$vDateStart' $vAddContractR)) ReReceiptQty,(select sum(A1.lv004) from ts_lv0009 A1 where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from ts_lv0008 A11 Where A11.lv009>='$vDateStart' and A11.lv009<='$vDateEnd' $vAddContractR)) InReceiptQty,(select sum(A2.lv004) from ts_lv0011 A2 where A2.lv003=A.lv001 and A2.lv002 IN (select A21.lv001 from ts_lv0010 A21 Where A21.lv009<'$vDateStart' $vAddContractO)) ReOutlv004 ,(select sum(A2.lv004) from ts_lv0011 A2 where A2.lv003=A.lv001 and A2.lv002 IN (select A21.lv001 from ts_lv0010 A21 Where A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd' $vAddContractO)) InOutlv004  from sl_lv0007 A left join sl_lv0005 B on A.lv004=B.lv001  where 1=1 and A.lv015=0 $vConditionStock) MP  where ((MP.ReReceiptQty-MP.ReOutlv004)<>0 or  MP.InReceiptQty<>0 or MP.InOutlv004<>0 )";
...
//		if($vAddCond!="") $vCondition = $vCondition." AND lv003 IN ( select B.lv003 from ts_lv0020 B where 1=1 $vAddCond) AND Lot IN ( select B.lv014 from ts_lv0020 B where 1=1 $vAddCond)";
		if($vAddCond!="") $vCondition = $vCondition." inner join ts_lv0020 B1 on A1.lv003=B1.lv003 AND A1.Lot=B1.lv014  $vAddCond";
		$vConditionStock="";
		$strwh=$this->Get_TSControler();
		if($vExistItem==1)
		{
		...
		$sqlS = "select A.*,B.lv002 Unitlv002,(select sum(A1.lv004) from ts_lv0009 A1  $vCondition where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from ts_lv0008 A11 Where A11.lv009<'$vDateStart' $vAddContractR) ) ReReceiptQty,(select sum(A1.lv004) from ts_lv0009 A1 $vCondition where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from ts_lv0008 A11  Where A11.lv009>='$vDateStart' and A11.lv009<='$vDateEnd' $vAddContractR) ) InReceiptQty,(select sum(A1.lv004) from ts_lv0011 A1 $vCondition where A1.lv003=A.lv001 and A1.lv002 IN (select A21.lv001 from ts_lv0010 A21 Where A21.lv009<'$vDateStart' $vAddContractO) ) ReOutlv004 ,(select sum(A1.lv004) from ts_lv0011 A1 $vCondition where A1.lv003=A.lv001 and A1.lv002 IN (select A21.lv001 from ts_lv0010 A21 Where A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd' $vAddContractO) ) InOutlv004  from sl_lv0007 A left join sl_lv0005 B on A.lv004=B.lv001  where 1=1 and A.lv015=0 $vConditionStock";	
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
		$strExpportAll = "";
		...
		$sqlS = "select MP.lv004,MP.Unitlv002,sum(IF(ISNULL(MP.ReReceiptQty),0,MP.ReReceiptQty)+IF(ISNULL(MP.InReceiptQty),0,MP.InReceiptQty)-IF(ISNULL(MP.ReOutlv004),0,MP.ReOutlv004)-IF(ISNULL(MP.InOutlv004),0,MP.InOutlv004) ) SumQty from (select A.lv004,B.lv002 Unitlv002,(select sum(A1.lv004) from ts_lv0009 A1  $vCondition where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from ts_lv0008 A11 Where A11.lv009<'$vDateStart' $vAddContractR) ) ReReceiptQty,(select sum(A1.lv004) from ts_lv0009 A1 $vCondition where A1.lv003=A.lv001 and A1.lv002 IN (select A11.lv001 from ts_lv0008 A11  Where A11.lv009>='$vDateStart' and A11.lv009<='$vDateEnd' $vAddContractR) ) InReceiptQty,(select sum(A1.lv004) from ts_lv0011 A1 $vCondition where A1.lv003=A.lv001 and A1.lv002 IN (select A21.lv001 from ts_lv0010 A21 Where A21.lv009<'$vDateStart' $vAddContractO) ) ReOutlv004 ,(select sum(A1.lv004) from ts_lv0011 A1 $vCondition where A1.lv003=A.lv001 and A1.lv002 IN (select A21.lv001 from ts_lv0010 A21 Where A21.lv009>='$vDateStart' and A21.lv009<='$vDateEnd' $vAddContractO) ) InOutlv004  from sl_lv0007 A left join sl_lv0005 B on A.lv004=B.lv001 where 1=1 and A.lv015=0 $vConditionStock) MP group by MP.lv004,MP.Unitlv002 ";		
		$strExpportAll=$strExpportAll.$this->SumSQLRun($sqlS,8,$vArrLang[14],$plang);	
		$strExpportAll = str_replace("@01", $vNumline, $strExpportAll);
		///////////////////////////////////////////////////////////////
		$vHeader = $vHeaderReportInventory;
	...
	$vHeaderReportInventory="
		...
		$sqlS = "select A.lv001, A.lv002 ,A.lv004,C.lv002 Unitlv002,B.lv005 Type,B.lv009 DateEnter,'N' CategoryPut,B.lv004 Title,A.lv007,A.lv014 Lot,A.lv015,B.lv006 Reference  from ts_lv0009 A inner join ts_lv0008 B on A.lv002=B.lv001 and (B.lv009>='$vDateStart' and B.lv009<='$vDateEnd') $vAddContractR  left join sl_lv0005 C on A.lv005=C.lv001 $vCondition where A.lv003='$vlv003' 
				UNION
				select A.lv001, A.lv002,A.lv004,C.lv002 Unitlv002,B.lv005 Type,B.lv009 DateEnter,'X' CategoryPut,B.lv004 Title,A.lv007,A.lv014 Lot,A.lv015,B.lv006 Reference from ts_lv0011 A inner join ts_lv0010 B on A.lv002=B.lv001 and B.lv009>='$vDateStart' and B.lv009<='$vDateEnd' $vAddContractO left join sl_lv0005 C on A.lv005=C.lv001 $vCondition where A.lv003='$vlv003' 
		";
		$bResultS = db_query($sqlS);
		$totalRows = db_num_rows($bResultS);
		$vLineRun = "";
