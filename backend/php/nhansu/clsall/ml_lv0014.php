...
////////////
	...
	function LV_Aproval($lvarr)
	{
		...
		$lvsql = "select A.lv001,A.lv002,A.lv003,A.lv004,A.lv005,A.lv006,A.lv007,A.lv008,C.lv009 lv009,A.lv010,A.lv011,A.lv012,A.lv013,A.lv014,B.lv005 StateSend from ml_lv0001 A left join  ml_lv0001_ C on A.lv001=C.lv001 left join ml_lv0008 B on A.lv003=B.lv002 and A.lv006=B.lv003 WHERE A.lv001 IN ($lvarr) and A.lv018=1  ";
		$vReturn= db_query($lvsql);
		if(!$vReturn) return;
