...
///////////
	public $DefaultFieldList="lv001,lv022,lv013,lv098,lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv014,lv015,lv016,lv017,lv018,lv099,lv094,lv096";	
////////////////////GetDate
...
////////////
	...
	var $ArrPush=array();
	var $ArrFunc=array();
	var $ArrGet=array("lv001"=>"2","lv002"=>"3","lv003"=>"4","lv004"=>"5","lv005"=>"6","lv006"=>"7","lv007"=>"8","lv008"=>"9","lv009"=>"10","lv010"=>"11","lv011"=>"12","lv012"=>"13","lv013"=>"14","lv014"=>"15","lv015"=>"16","lv016"=>"17","lv017"=>"18","lv018"=>"19","lv022"=>"23","lv094"=>"95","lv095"=>"96","lv096"=>"97","lv098"=>"99","lv099"=>"100");
	var $ArrView=array("lv001"=>"0","lv002"=>"0","lv003"=>"0","lv004"=>"0","lv005"=>"0","lv006"=>"0","lv007"=>"0","lv008"=>"0","lv009"=>"2","lv010"=>"0","lv011"=>"0","lv012"=>"0","lv013"=>"0","lv014"=>"2","lv015"=>"0","lv016"=>"0","lv017"=>"10","lv018"=>"0","lv022"=>"0","lv094"=>"0","lv095"=>"0","lv096"=>"0","lv098"=>"0","lv099"=>"0");	
	...
	function LV_Insert()
	{
		...
		if($vReturn) 
		{
			$lvsql="insert into ac_lv0005 (lv002,lv003,lv004,lv005,lv006,lv007) values('$this->lv001','$this->lv019','$this->lv019','1111','131','SL(Bán hàng)')";
			$vReturn= db_query($lvsql);
			$this->InsertLogOperation($this->DateCurrent,'ac_lv0004.insert',sof_escape_string($lvsql));
		}
		return $vReturn;
	}	
	function LV_InsertTK0()
	{
		if($this->isAdd==0) return false;
		$this->lv009 = ($this->lv009!="")?recoverdate(($this->lv009), $this->lang)." ".gettime($this->lv009):$this->DateDefault;
		$this->lv014 = ($this->lv014!="")?recoverdate(($this->lv014), $this->lang):$this->DateDefault;
		...
		if($vReturn) 
		{
			echo $lvsql="insert into ac_lv0005 (lv002,lv003,lv004,lv005,lv006,lv007) values('$this->lv001','$this->lv019','$this->lv019','000','000','Nạp từ tập tin')";
			$vReturn= db_query($lvsql);
			$this->InsertLogOperation($this->DateCurrent,'ac_lv0004.insert',sof_escape_string($lvsql));
		}
		return $vReturn;
...
//GetMoney
	...
	protected function GetCondition()
	{
		...
		if($this->lv115!="")  $strCondi=$strCondi." and lv115 = '$this->lv115'";
		return $strCondi;
	}
		////////////////Count///////////////////////////
	function GetCount()
...
/////////////////////ListFieldExport//////////////////////////
	function ListFieldExport($lvFrom,$lvList,$maxRows)
	{
		...
		{
			window.open('".$this->Dir."sl_lv0058/?lang=".$this->lang."&childdetailfunc='+value+'&ID=".$this->lv013."','','width=800,height=600,left=200,top=100,screenX=0,screenY=100,resizable=yes,status=no,scrollbars=yes,menubar=yes');
		}
...
//////////////////////Buil list////////////////////
	function LV_BuilListReport($lvList,$lvFrom,$lvChkAll,$lvChk,$curRow, $maxRows,$paging,$lvOrderList)
	{
		...
		$sqlS = "SELECT * FROM ac_lv0004 WHERE 1=1 and lv013='$this->PBHID' $strSort LIMIT $curRow, $maxRows";
		$vorder=$curRow;
		$bResult = db_query($sqlS);
		$this->Count=db_num_rows($bResult);
		$strTrH="";
	...
	private function sqlcondition($vFile,$vSelectID)
	{
		...
		switch($vFile)
		{
			...
			case 'lv088':
				$vsql="
				select distinct A.lv008 lv001,concat(B.lv004,' ',B.lv003,' ',B.lv002) lv002,IF(A.lv001='$vSelectID',1,0) lv003 from  sp_lv0009 A left join hr_lv0020 B on A.lv008=B.lv001 where A.lv002 in ( select BB.lv001 from sp_lv0008 BB where BB.lv002='$vSelectID') 
				UNION
				select distinct A.lv008 lv001,concat(B.lv004,' ',B.lv003,' ',B.lv002) lv002,IF(A.lv001='$vSelectID',1,0) lv003 from  sp_lv0110 A left join hr_lv0020 B on A.lv008=B.lv001 where A.lv002 in ( '$vSelectID')
				";
				break;
			case 'lv022':
	...
	public function getvaluelink($vFile,$vSelectID)
	{
		...
		switch($vFile)
		{
			...
			case 'lv111':
				...
				break;
			case 'lv022':
				$vsql="select lv001,lv002,IF(lv001='$vSelectID',1,0) lv003 from  cr_lv0008 where lv001='$vSelectID'";
				break;
