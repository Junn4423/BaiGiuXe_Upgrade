...
////////////
	...
	function LV_AutoInsertItem($vlv003)
	{
		$lvsql="insert into wh_lv0012(lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009) select A.lv003,B.lv002,0,A.lv005,0,A.lv007,0,A.lv009 from wh_lv0009 A inner join wh_lv0008 B on A.lv002=B.lv001 and B.lv002='$vlv003' where concat(A.lv003,'@',B.lv002) not in (select  concat(AA.lv002,'@',AA.lv003) from wh_lv0012 AA where AA.lv003='$vlv003');";
		$vReturn= db_query($lvsql);
		if($vReturn) $this->InsertLogOperation($this->DateCurrent,'wh_lv0012.insert',sof_escape_string($lvsql));
		return $vReturn;
	}
	function LV_Insert()
	{		
		...
		switch($vFile)
		{
			case 'lv002':
				$vsql="
					...
					union
					select lv001,lv003 lv002,IF(lv001='$vSelectID',1,0) lv003 from  wh_lv0001
				";
				break;
			case 'lv007':
