<?php
/////////////coding hr_lv0020///////////////
class   tc_lv0033 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
	...
	public $lv044=null;	
///////////
	public $DefaultFieldList="lv001,lv002,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016,lv017,lv018,lv019,lv020,lv021,lv043,lv022,lv023,lv024,lv025,lv026,lv027,lv028,lv029,lv030,lv044,lv031,lv032,lv033,lv034,lv035,lv036,lv037,lv038,lv039,lv040,lv041,lv042";	
////////////////////GetDate
...
////////////
	...
	{
		$strCondi=" and ( lv009=0 or lv009=1)";
		...
		if($this->lv029!="")  
		{
			$strCondi=$strCondi." and lv029 in ('".str_replace(",","','",$this->lv029)."')";
		}
