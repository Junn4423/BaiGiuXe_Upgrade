<?php
/////////////coding hr_lv0020///////////////
class   tc_lv0006 extends lv_controler
{
	public $lv001=null;
	public $lv002=null;
	public $lv003=null;
...
///////////
	public $DefaultFieldList="lv001,lv002,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv012,lv013,lv014,lv015,lv016,lv017,lv018,lv019,lv020,lv021,lv043,lv022,lv023,lv024,lv026,lv027,lv028,lv029,lv030,lv044,lv031,lv032,lv033,lv034,lv035,lv036,lv037,lv038,lv039,lv040,lv041,lv042,lv099";	
////////////////////GetDate
...
////////////
	...
	protected function GetCondition()
	{
		...
		$strCondi=$strCondi." and ( lv009 not in (3,2))";
	...
	public function LV_GetChildDepSelect($vDepID,$vSelectID)
	{
		...
		$vReturn="'".str_replace(",","','",$vDepID)."'";
		echo $vsql="select lv001,lv003 from  hr_lv0002 where (lv001 in ($vReturn) or lv002 in ($vReturn))  order by lv003";
		$bResult=db_query($vsql);
		while ($vrow = db_fetch_array ($bResult)){
