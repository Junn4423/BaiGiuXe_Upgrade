...
if($mowh_lv0021->GetView()==1)
{
    ...
    $mocr_lv0342->DefaultFieldList="lv299,lv052,lv157,lv149,lv150,lv011,lv914,lv012,lv152,lv061,lv008,lv009,lv139,lv049,lv154,lv155,lv004,lv153,lv204,lv156,lv005,lv006,lv054,lv162,lv163,lv062,lv063,lv140,lv158,lv170,lv171,lv172,lv173,lv174,lv175,lv176,lv177,lv178,lv179,lv180,lv181,lv182,lv183,lv184,lv185,lv186,lv187,lv188,lv189,lv190,lv191,lv192,lv193,lv194,lv141,lv142,lv143,lv145,lv146,lv147";//
    //////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $mocr_lv0342->ArrPush[9]=$vLangArr[26];
    $mocr_lv0342->ArrPush[10]=$vLangArr[27];
    $mocr_lv0342->ArrPush[11]=$vLangArr[28];
    $mocr_lv0342->ArrPush[12]=$vLangArr[29];
    $mocr_lv0342->ArrPush[13]=$vLangArr[30];
    ...
    $mocr_lv0342->ArrPush[51]=$vLangArr[68];
    ...
    $mocr_lv0342->ArrPush[62]=$vLangArr[79];
    ...
    $mocr_lv0342->ArrPush[141]='Warranty Time';
    $mocr_lv0342->ArrPush[142]='Fault Product Type';
    $mocr_lv0342->ArrPush[143]='Q.ty Fault Product';
    $mocr_lv0342->ArrPush[144]='Thời gian trả SP lỗi';
    ...
    $mocr_lv0342->ArrPush[146]='Charge Express Fault Product';
    $mocr_lv0342->ArrPush[147]='Name Express Fault Product';
    $mocr_lv0342->ArrPush[148]='Booking Express Bill No.';
    $mocr_lv0342->ArrPush[149]='SHIPPER';
    $mocr_lv0342->ArrPush[150]='Date (Loading)';
    $mocr_lv0342->ArrPush[151]='Date Estimated (Loading)';
    $mocr_lv0342->ArrPush[152]='AGENT SHIPPING';
    $mocr_lv0342->ArrPush[153]='Type (Our ref.)';
    $mocr_lv0342->ArrPush[154]='Sample Q\'ty ';
    $mocr_lv0342->ArrPush[155]='Model Sup';
    $mocr_lv0342->ArrPush[156]='Brand Sup';
    $mocr_lv0342->ArrPush[157]='Extra Q\'ty';
    $mocr_lv0342->ArrPush[158]='Date issue';
    $mocr_lv0342->ArrPush[159]='Catalogue';
    $mocr_lv0342->ArrPush[171]='Drawing/Construction';
    $mocr_lv0342->ArrPush[172]='TEST IP (54/65/67/68)';
    $mocr_lv0342->ArrPush[173]='IES File & Test Integrating Sphere';
    $mocr_lv0342->ArrPush[174]='Manual & maintaince';
    $mocr_lv0342->ArrPush[175]='CER. LM80 Chip';
    $mocr_lv0342->ArrPush[176]='CER.  (Pdf) IEC/EN/EMC/Driver';
    $mocr_lv0342->ArrPush[177]='Picture  Goods/ Packing ';
    $mocr_lv0342->ArrPush[178]='Picture  chip/driver/ Acessories';
    $mocr_lv0342->ArrPush[179]='Sample Date (Loading)';
    $mocr_lv0342->ArrPush[180]='Sample Express (Loading)';
    $mocr_lv0342->ArrPush[181]='Sample Delivery Date';
    $mocr_lv0342->ArrPush[182]='Sample Second Delivery Date';
    $mocr_lv0342->ArrPush[183]='Sample Loading By';
    $mocr_lv0342->ArrPush[184]='Sample Loading  Place';
    ...
    {
        //////////////////////////////////////////////////////////////////////////////////////////////////////
        $mocr_lv0342->LoadSaveOperationLocal($_SESSION['ERPSOFV2RUserID'],'cr_lv0342_1',$strCode);
        //////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    elseif($_POST["txtFlag"]==2)
    {
        ...
        $mocr_lv0342->SaveOperation($_SESSION['ERPSOFV2RUserID'],'cr_lv0342_1',$vFieldList,(int)$_POST['lvmaxrow'],(int)$_POST['curPg'],$vOrderList,(int)$_POST['lvsort']);
    }
?>
<html>
<head>
...
//////// Chi tiền đợt 3
    ...
    <tr><td colspan="20">
        <?php 
        $mocr_lv0342->LoadSaveOperation($_SESSION['ERPSOFV2RUserID'],'cr_lv0342_1');
        //////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    <tr>
        ...
        <td colspan="2" style="font-family: Arial; font-size: 12px;" align="left" valign="center"><span style="color: #000000;"><br /></span></td>
        <td colspan="4" style="font-family: Arial; font-size: 12px;" align="left" valign="center"><span style="color: #000000;"></span></td>
        <td colspan="<?php echo (4-$vTruCot+($vTypeID==0)?3:1);?>" style="font-family: Arial; font-size: 12px;" align="left" valign="center"><strong><span style="color: #000000; font-size: 14px;">Payment Percent(%): <span style="color:red"><?php echo $mocr_lv0342->FormatView($vTongPercent,20).(($vTongPercent>0)?'%':'');?></span></span></strong></td>
    <?php
        $vStrTem=$mocr_lv0342->strTD;
