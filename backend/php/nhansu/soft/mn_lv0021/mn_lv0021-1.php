...
require_once("$vDir../clsall/mn_lv0021.php");

/////////////init object//////////////
$momn_lv0021=new mn_lv0021($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Mn0021');
$momn_lv0021->Dir=$vDir;
$momn_lv0021->TypePO=$_GET['TypePO'];
$momn_lv0021->LV_OptionType();
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
if($momn_lv0021->GetView()>0)
{	
	if(isset($_GET['ajaxchitiethistory']))
	{
		require_once("$vDir../clsall/cr_lv0105.php");
		$mocr_lv0105=new cr_lv0105($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Mn0021');
		if($plang=="") $plang="VN";
...
$momn_lv0021->lang=strtoupper($plang);
//////////////////////////////////////////////////////////////////////////////////////////////////////
$momn_lv0021->ArrPush[0]=$vLangArr[17];
$momn_lv0021->ArrPush[1]=$vLangArr[18];
$momn_lv0021->ArrPush[2]=$vLangArr[19];
$momn_lv0021->ArrPush[3]=$vLangArr[20];
$momn_lv0021->ArrPush[4]=$vLangArr[21];
$momn_lv0021->ArrPush[5]=$vLangArr[22];
$momn_lv0021->ArrPush[6]=$vLangArr[23];
$momn_lv0021->ArrPush[7]=$vLangArr[24];
$momn_lv0021->ArrPush[8]=$vLangArr[25];
$momn_lv0021->ArrPush[9]=$vLangArr[26];
$momn_lv0021->ArrPush[10]=$vLangArr[27];
$momn_lv0021->ArrPush[11]=$vLangArr[28];
$momn_lv0021->ArrPush[12]=$vLangArr[29];
$momn_lv0021->ArrPush[13]=$vLangArr[40];
$momn_lv0021->ArrPush[14]=$vLangArr[31];
$momn_lv0021->ArrPush[15]=$vLangArr[32];
$momn_lv0021->ArrPush[16]='Tỷ giá tiền tệ thứ 2';
$momn_lv0021->ArrPush[28]='Trạng thái duyệt';
$momn_lv0021->ArrPush[13]='Tiền tệ thứ 2';
$momn_lv0021->ArrPush[14]='Tỷ giá VNĐ';
$momn_lv0021->ArrPush[15]='';
$momn_lv0021->ArrPush[16]='Tỷ giá tiền tệ thứ 2';
$momn_lv0021->ArrPush[17]='Tiền tệ chính';
$momn_lv0021->ArrPush[88]='Mã nhóm đơn hàng';
$momn_lv0021->ArrPush[89]='Phiếu ĐNVT';
$momn_lv0021->ArrPush[90]='PBH Số';
$momn_lv0021->ArrPush[190]='Tên dự án';
$momn_lv0021->ArrPush[91]='Phiếu đầu ra';
$momn_lv0021->ArrPush[213]='Tổng tiền';
$momn_lv0021->ArrPush[214]='Thanh toán';
$momn_lv0021->ArrPush[99]='Tiền nợ treo';
$momn_lv0021->ArrPush[100]='Tiền nợ còn lại';
$momn_lv0021->ArrPush[115]='Mã công việc';
$momn_lv0021->ArrPush[212]='Tổng tiền mua VNĐ';
$momn_lv0021->ArrPush[213]='Tổng tiền mua chính';
$momn_lv0021->ArrPush[214]='Thanh toán chính';
$momn_lv0021->ArrPush[215]='Tổng tiền mua thứ 2';
$momn_lv0021->ArrPush[216]='Thanh toán thứ 2';
$momn_lv0021->ArrPush[217]='Qui đổi thanh toán thứ 2 → chính';
$momn_lv0021->ArrPush[218]='Qui đổi thanh toán';
$momn_lv0021->ArrPush[219]='Tổng tiền nợ còn lại';
$momn_lv0021->ArrPush[221]='Thanh toán VND';
$momn_lv0021->ArrPush[222]='Qui đổi thanh toán VND → chính';
$momn_lv0021->ArrPush[283]='Tổng tiền mua chính trước VAT';
$momn_lv0021->ArrPush[293]='Tiền VAT';

$momn_lv0021->ArrPush[105]=$vLangArr[42];
$momn_lv0021->ArrPush[106]=$vLangArr[43];
$momn_lv0021->ArrPush[107]=$vLangArr[44];
$momn_lv0021->ArrPush[108]=$vLangArr[45];
$momn_lv0021->ArrPush[109]=$vLangArr[46];
$momn_lv0021->ArrPush[110]=$vLangArr[47];
$momn_lv0021->ArrPush[111]=$vLangArr[48];
$momn_lv0021->ArrPush[112]=$vLangArr[49];
$momn_lv0021->ArrPush[113]=$vLangArr[50];
$momn_lv0021->ArrPush[114]=$vLangArr[51];

$momn_lv0021->ArrPush[200]='Chức năng';

$momn_lv0021->ArrFunc[0]='//Function';
$momn_lv0021->ArrFunc[1]=$vLangArr[2];
$momn_lv0021->ArrFunc[2]=$vLangArr[4];
$momn_lv0021->ArrFunc[3]=$vLangArr[6];
$momn_lv0021->ArrFunc[4]=$vLangArr[7];
$momn_lv0021->ArrFunc[5]=GetLangExcept('Rpt',$plang);
$momn_lv0021->ArrFunc[6]=GetLangExcept('duyet',$plang);
$momn_lv0021->ArrFunc[7]=GetLangExcept('tralai',$plang);
$momn_lv0021->ArrFunc[8]=$vLangArr[10];
$momn_lv0021->ArrFunc[9]=$vLangArr[12];
$momn_lv0021->ArrFunc[10]=$vLangArr[0];
$momn_lv0021->ArrFunc[11]=$vLangArr[35];
$momn_lv0021->ArrFunc[12]=$vLangArr[36];
$momn_lv0021->ArrFunc[13]=$vLangArr[37];
$momn_lv0021->ArrFunc[14]=$vLangArr[38];
$momn_lv0021->ArrFunc[15]=$vLangArr[39];
////Other
$momn_lv0021->ArrOther[1]=$vLangArr[33];
$momn_lv0021->ArrOther[2]=$vLangArr[34];
//////Delete message///
$lvMessage=array();
...
if($flagID==1)
{
	...
	$strar="'".$strar."'";
	$vresult=$momn_lv0021->LV_Delete($strar);
	$vStrMessage=GetNoDelete($strar,"mn_lv0021",$lvMessage);
}
elseif($flagID==2)
{
$momn_lv0021->lv001=$_POST['txtlv001'];
if( $_GET['ID']=="")
$momn_lv0021->lv002=$_POST['txtlv002'];
else
$momn_lv0021->lv002= $_GET['ID'] ?? '';
$momn_lv0021->lv003=$_POST['txtlv003'];
$momn_lv0021->lv004=$_POST['txtlv004'];
$momn_lv0021->lv005=$_POST['txtlv005'];
$momn_lv0021->lv006=$_POST['txtlv006'];
$momn_lv0021->lv007=$_POST['txtlv007'];
$momn_lv0021->lv008=$_POST['txtlv008'];
$momn_lv0021->lv009=$_POST['txtlv009'];
$momn_lv0021->lv010=$_POST['txtlv010'];
$momn_lv0021->lv011=$_POST['txtlv011'];
$momn_lv0021->lv012=$_POST['txtlv012'];
$momn_lv0021->lv013=$_POST['txtlv013'];
$momn_lv0021->lv014=$_POST['txtlv014'];
}
elseif($flagID==3)
{
	$strar=substr($strchk,0,strlen($strchk)-1);
	$strar=str_replace("@","','",$strar);
	$strar="'".$strar."'";
	$vresult=$momn_lv0021->LV_Aproval($strar);
}
elseif($flagID==4)
{
	$strar=substr($strchk,0,strlen($strchk)-1);
	$strar=str_replace("@","','",$strar);
	$strar="'".$strar."'";
	$vresult=$momn_lv0021->LV_UnAproval($strar);
}
elseif($flagID==24)
{
	$momn_lv0021->Remark=$_POST['txtRemark'];
	$strar="'".$strchk."'";
	$vresult=$momn_lv0021->LV_UnAproval($strar);
}
elseif($flagID==34)
...
{
	//////////////////////////////////////////////////////////////////////////////////////////////////////
$momn_lv0021->LoadSaveOperation($_SESSION['ERPSOFV2RUserID'],'mn_lv0021');
//////////////////////////////////////////////////////////////////////////////////////////////////////
$vFieldList=$momn_lv0021->ListView;
$curPage = $momn_lv0021->CurPage;
$maxRows =$momn_lv0021->MaxRows;
$vOrderList=$momn_lv0021->ListOrder;
$vSortNum=$momn_lv0021->SortNum;
}
...
$momn_lv0021->SaveOperation($_SESSION['ERPSOFV2RUserID'],'mn_lv0021',$vFieldList,(int)$_POST['lvmaxrow'],(int)$_POST['curPg'],$vOrderList,(int)$_POST['lvsort']);
...
$momn_lv0021->trangthai=$_GET['trangthai'];
$totalRowsC=$momn_lv0021->GetCount();
$maxPages = 10;
if($curPage=="") 
$curPage = 1;
...
function Delete(vValue)
{
	...
	o.txtFlag.value=1;
	 o.action="?func=<?php echo $_GET['func'];?>"+"&ID=<?php echo  $_GET['ID']?>&trangthai=<?php echo $_GET['trangthai']?>"+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,2,0);?>"
	 o.submit();

}
function RunFunction(vID,func)
{
	var str="<br><iframe id='lvframefrm' height=1200 marginheight=0 marginwidth=0 frameborder=0 src=<?php echo $vDir;?>mn_lv0021?func=<?php echo $_GET['func'];?>&childfunc="+func+"&ID=<?php echo  $_GET['ID'] ?? '';?>&trangthai=<?php echo $_GET['trangthai']?>&TypePO=<?php echo $_GET['TypePO']?>&ChildID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?> class=lvframe></iframe>";
...
var o=document.frmchoose;
 	o.txtStringID.value=vValue;
	o.txtFlag.value=3;
	 o.action="?func=<?php echo $_GET['func'];?>"+"&ID=<?php echo  $_GET['ID']?>&trangthai=<?php echo $_GET['trangthai']?>"+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,1,0);?>"
	 o.submit();
}
function UnApr()
{
...
function Report(vValue)
{
	...
	o.action="<?php echo $vDir;?>mn_lv0021?func=<?php echo $_GET['func'];?>&childfunc=rpt1&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
...
function Report2(vValue)
{
	var o=document.frmprocess;
	o.target="_blank";
	o.action="<?php echo $vDir;?>mn_lv0021?func=<?php echo $_GET['func'];?>&childfunc=rpt1&ID="+vValue+"&lang=<?php echo $plang;?>";
	o.submit();
}
...
function Report3(vValue)
{
	var o=document.frmprocess;
	o.target="_blank";
	o.action="<?php echo $vDir;?>mn_lv0021?func=<?php echo $_GET['func'];?>&childfunc=rpt3&ID="+vValue+"&lang=<?php echo $plang;?>";
	o.submit();
...
function Report9(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0021?func=<?php echo $_GET['func'];?>&childfunc=rpt9&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
...
function Report19(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0021?func=<?php echo $_GET['func'];?>&childfunc=rpt19&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report19KTT(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0021?func=<?php echo $_GET['func'];?>&childfunc=rpt19ktt&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report19KTVT(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0021?func=<?php echo $_GET['func'];?>&childfunc=rpt19ktvt&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report19KTCT(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0021?func=<?php echo $_GET['func'];?>&childfunc=rpt19ktct&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report69(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0021?func=<?php echo $_GET['func'];?>&childfunc=rpt69&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report10(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0021?func=<?php echo $_GET['func'];?>&childfunc=rpt10&TypeID=4&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
...
function Report20(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0021?func=<?php echo $_GET['func'];?>&childfunc=rpt20&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report20KTT(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0021?func=<?php echo $_GET['func'];?>&childfunc=rpt20ktt&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report20KTVT(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0021?func=<?php echo $_GET['func'];?>&childfunc=rpt20ktvt&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report20KTCT(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0021?func=<?php echo $_GET['func'];?>&childfunc=rpt20ktct&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report5(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0021?func=<?php echo $_GET['func'];?>&childfunc=rpt5&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
	//var fun2="Report5('"+vValue+"')";
	setTimeout(fun2,100);
}
...
<?php
if($momn_lv0021->GetView()==1)
{
?>
<body  onkeyup="KeyPublicRun(event)">

				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<div><div id="lvleft"><form onSubmit="return false;" action="?func=<?php echo $_GET['func'];?>&ID=<?php echo  $_GET['ID']?>&trangthai=<?php echo $_GET['trangthai']?>&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,1,0);?>" method="post" name="frmchoose" id="frmchoose">
						...
						<table style="background:#f2f2f2;font:10px arial" >	
								...
								<tr>
									<td><select class="norequired" name="LANGIAOHANG"  id="LANGIAOHANG"  style="min-width:90px;width:100%;">
											...
											<?php echo $momn_lv0021->LV_LinkField('lv000',$mosl_lv0013->LANGIAOHANG);?>
										</select>
									</td>
								<td  height="20px"><input  autocomplete="off" style="width:120px;text-align:center;" name="txtlv001" type="text" id="txtlv001" value="<?php echo $momn_lv0021->lv001;?>" tabindex="9" maxlength="50" style="width:100%" onKeyPress="return CheckKey(event,7)"></td>
								<td>
									<table width="95%">
											<tr>
											<td>
								...
								<td  height="20px"><input  autocomplete="off" style="width:120px;text-align:center;" name="txtTenDuAn" type="text" id="txtTenDuAn" value="<?php echo $momn_lv0021->TenDuAn;?>" tabindex="9" maxlength="50" style="width:100%" onKeyPress="return CheckKey(event,7)"></td> 
								<td>
									<table width="95%">
											<tr>
											<td>
								...
								<td  height="20px"><input  autocomplete="off" style="width:120px;text-align:center;" name="txtlv004" type="text" id="txtlv004" value="<?php echo $momn_lv0021->lv004;?>" tabindex="9" maxlength="50" style="width:100%" onKeyPress="return CheckKey(event,7)" onClick="if(self.gfPop)gfPop.fPopCalendar(this);return false;" autocomplete="off" ></td> 
								<td><table width="100%"><tr><td>
									<select name="txtlv010" id="txtlv010"   tabindex="14"  style="width:100px" onKeyPress="return CheckKeys(event,7,this)">
										<option value=''>...</option>
										<?php echo $momn_lv0021->LV_LinkField('lv010',$momn_lv0021->lv010);?>
									</select>
								</td>
								<td>
					  ...
					  <input type="hidden" name="curPg" value="<?php echo  $curPage;?>"/>
						...
						<input type="hidden" name="txtlv002" id="txtlv002" value="<?php echo $momn_lv0021->lv002;?>"/>
						<input type="hidden" name="txtlv003" id="txtlv003" value="<?php echo $momn_lv0021->lv003;?>"/>
						<input type="hidden" name="txtlv004" id="txtlv004" value="<?php echo $momn_lv0021->lv004;?>"/>
						<input type="hidden" name="txtlv005" id="txtlv005" value="<?php echo $momn_lv0021->lv005;?>"/>
						<input type="hidden" name="txtlv006" id="txtlv006" value="<?php echo $momn_lv0021->lv006;?>"/>
						<input type="hidden" name="txtlv007" id="txtlv007" value="<?php echo $momn_lv0021->lv007;?>"/>
						<input type="hidden" name="txtlv008" id="txtlv008" value="<?php echo $momn_lv0021->lv008;?>"/>
						<input type="hidden" name="txtlv009" id="txtlv009" value="<?php echo $momn_lv0021->lv009;?>"/>
						<input type="hidden" name="txtlv011" id="txtlv011" value="<?php echo $momn_lv0021->lv011;?>"/>
						<?php echo $momn_lv0021->LV_BuilList($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
				  </form>
...
div.innerHTML='<?php echo $momn_lv0021->ArrPush[0];?>';	
</script>
</html>