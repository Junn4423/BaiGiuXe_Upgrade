...
require_once("../../clsall/ts_lv0024.php");
//////////////init object////////////////
$lvts_lv0024=new ts_lv0024($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ts0024');
/////////Get ID///////////////
$lvts_lv0024->lv001=$_GET['ChildID'];
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","TS0036.txt",$plang);
...
if($vFlag==1)
{
		$lvts_lv0024->lv002=$_POST['txtlv002'];
		$lvts_lv0024->lv003=$_POST['txtlv003'];
		$lvts_lv0024->lv004=$_POST['txtlv004'];
		$lvts_lv0024->lv005=$_POST['txtlv005'];
		if($_FILES['userfile']['name']!="" && $_FILES['userfile']['name']!=NULL)
		{
		$lvts_lv0024->lv006=$_FILES['userfile']['name'];
		}
		else
			{
			$lvts_lv0024->lv006=$_POST['txtlv006'];	
			}		
		$vresult=$lvts_lv0024->LV_Update();
		if($vresult==true) {
			if($_FILES['userfile']['name']!="" && $_FILES['userfile']['name']!=NULL)
			{
			UploadImg($lvts_lv0024->lv002."_".$lvts_lv0024->lv001, $lvts_lv0024->lv006);
			}
...
function isnumber(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvts_lv0024->lv002;?>";
		o.txtlv003.value="<?php echo $lvts_lv0024->lv003;?>";
		o.txtlv004.value="<?php echo $lvts_lv0024->lv004;?>";
		o.txtlv005.value="<?php echo $lvts_lv0024->lv005;?>";
		o.txtlv006.value="<?php echo $lvts_lv0024->lv006;?>";			
		o.txtlv002.focus();
	}
	function Cancel()
	{
					...
					<?php		
						...
						?>
							...
							<tr>
								...
								<td  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvts_lv0024->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvts_lv0024->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/><br>
							  <table><tr><td>
							  <ul id="pop-nav" lang="pop-nav1" onMouseOver="ChangeName(this,1)" onkeyup="ChangeName(this,1)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch1" id="txtlvsearch1" style="width:200px" onKeyUp="LoadPopup(this,'txtlv002','ts_lv0003','lv002')" onFocus="LoadPopup(this,'txtlv002','ts_lv0003','lv002')" tabindex="200" >
...
<tr>
				  ...
				  <td  height="20px"><select  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
							  ...
							  <?php echo $lvts_lv0024->LV_LinkField('lv003',$lvts_lv0024->lv003);?>
							  </select>	</td>
						  </tr>								
							<tr>
							  <td  height="20px"><?php echo $vLangArr[18];?></td>
							  <td  height="20px"><input  name="txtlv004" type="text" id="txtlv004" value="<?php echo $lvts_lv0024->lv004;?>" tabindex="8" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
						  
							<tr>
							  <td  height="20px"><?php echo $vLangArr[19];?></td>
							  <td  height="20px"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo $lvts_lv0024->FormatView($lvts_lv0024->lv005,2);?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
							  ...
							  <input name="txtlv006" type="hidden" id="txtlv006" value="<?php echo $lvts_lv0024->lv006;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>				 
							<tr>
