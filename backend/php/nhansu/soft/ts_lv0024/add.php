...
$lvts_lv0024->lv001=InsertWithCheckExt('ts_lv0024', 'lv001', '',0);
if( $_GET['ID']=="")
$lvts_lv0024->lv002=$_POST['txtlv002'];
else
$lvts_lv0024->lv002= $_GET['ID'] ?? '';
$lvts_lv0024->lv003=$_POST['txtlv003'];
$lvts_lv0024->lv004=$_POST['txtlv004'];
$lvts_lv0024->lv005=GetServerDate()." ".GetServerTime();
$lvts_lv0024->lv006=$_FILES['userfile']['name'];
if($vFlag==1)
{
		
		$vresult=$lvts_lv0024->LV_Insert();
		if($vresult==true) {
