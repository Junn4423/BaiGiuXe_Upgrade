...
$motc_lv0071->lv004=$year."-".$month;
$motc_lv0071->datefrom=$year."-".$month."-01";
$motc_lv0071->dateto=$year."-".$month."-".Fillnum(GetDayInMonth($year,$month),2);
$motc_lv0071->lv028="";
...
<body  onkeyup="KeyPublicRun(event)">
			...
			<div>
					...
					<div id="lvleft">
						...
						echo $motc_lv0071->LV_BuilListReportOtherPrintLateSoon($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,0,$_POST['chkviewinfo']);?>
					</div>
					<div>
					<?php 
					if($plang=="") $plang="VN";
					...
					echo $motc_lv0002->LV_BuilListReportTC('lv001,lv002,lv003','document.frmchoose','chkAll','lvChk',$curRow, 1000,$paging,'',$motc_lv0071->ArrTC);?>
					</div>
		</div>
</body>
