					...
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<tr>
							...
							<tr>
							  ...
							  <td  height="20">
							  <table style="width:80%"><tr><td width="50%"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/><option value=""></option><?php echo $lvts_lv0054->LV_LinkField('lv003',$vlv003);?>
							  </select>
							  </td>
							  <td>
...
<tr>
							...
							<tr>
							  ...
							  <td  height="20"><table style="width:80%"><tr><td width="50%"><select name="txtlv005" id="txtlv005"   tabindex="9"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/>
							  	<option value=""></option>
								<?php echo $lvts_lv0054->LV_LinkField('lv005',$vlv005);?>
							  </select>
							  </td>
							  <td>
...
<tr>
								...
								<option value=""></option>
							  <?php echo $lvts_lv0054->LV_LinkField('lv007',$vlv007);?>
							  </select>
							  </td>
							  <td>
							...
							<tr>
							  ...
							  <td  height="20"><table style="width:80%"><tr>
							  	<td width="50%"><select name="txtlv009" id="txtlv009"   tabindex="13"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/>
							 		<option value=""></option>
							  		<?php echo $lvts_lv0054->LV_LinkField('lv009',$vlv009);?>
							  </select>
							  </td><td>
				  ...
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo (float)$vlv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
							  ...
							  <td  height="20">
							  	<table style="width:80%"><tr><td width="50%"><select name="txtlv011" id="txtlv011"   tabindex="15"  style="width:100%" onkeypress="return CheckKey(event,7)"/>
							  		<option value=""></option>
							  		<?php echo $lvts_lv0054->LV_LinkField('lv011',$vlv011);?>
							  		</select>
							  </td><td>
							  <ul id="pop-nav4" lang="pop-nav4" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
							...
							<!--<tr>
							  ...
							  <?php echo $lvts_lv0054->LV_LinkField('lv012',$vlv012);?>
							...
							<tr>
							  ...
							  <?php echo $lvts_lv0054->LV_LinkField('lv013',$vlv013);?>
							  </select><br><table style="width:80%"><tr><td>
