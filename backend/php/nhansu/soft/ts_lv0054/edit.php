...
$lvts_lv0054->lv001=$_GET['ChildDetailID'];
...
if($vFlag==1)
{
$lvts_lv0054->lv002=$_POST['txtlv002'];
...
$lvts_lv0054->lv016=GetServerDate()." ".GetServerTime();
		...
		$vresult=$lvts_lv0054->LV_UpdateEdit($_POST['txtlv004old'],$_POST['txtlv006old']);
		if($vresult==true) {
...
$lvts_lv0054->LV_LoadID($lvts_lv0054->lv001);
					...
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvts_lv0054->lv001=="")?InsertWithCheckExt('ts_lv0054', 'lv001', '',10):$lvts_lv0054->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
...
<tr>
				  ...
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo (float)$lvts_lv0054->lv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
							  ...
							  <td  height="20"><input name="txtlv011" id="txtlv011"   tabindex="15"  style="width:100%" onkeypress="return CheckKey(event,7)" value="<?php echo $lvts_lv0054->FormatView($lvts_lv0054->lv011,2);?>"/></td></tr>
							<tr>
