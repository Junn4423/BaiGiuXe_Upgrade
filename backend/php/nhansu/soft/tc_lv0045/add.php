...
$lvtc_lv0045->lv001=$_POST['txtlv001'];
					...
					<form action="#" method="post" enctype="multipart/form-data" name="frmadd">
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
								...
								<td width="*%"  height="20px"><input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvtc_lv0045->lv001=="")?InsertWithCheckExt('tc_lv0045', 'lv001', 'CEXP',3):$lvtc_lv0045->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
							<tr>
