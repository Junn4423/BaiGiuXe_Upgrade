...
/////////Get ID///////////////
$lvtc_lv0038->lv001=$_GET['ChildID'];
...
$lvtc_lv0038->LV_LoadID($lvtc_lv0038->lv001);
...
function isnumber(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvtc_lv0038->lv002;?>";	
		o.txtlv002.focus();
	}
	function Cancel()
	{
						...
						?>
							...
							<tr>
								...
								<td width="*%"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvtc_lv0038->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
							</tr>
							<tr>
