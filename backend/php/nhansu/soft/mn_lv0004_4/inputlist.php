...
$momn_lv0004_4->ArrPush[12]=$vLangArr[29];
$momn_lv0004_4->ArrPush[13]=$vLangArr[30];
$momn_lv0004_4->ArrPush[14]=$vLangArr[31];
$momn_lv0004_4->ArrPush[15]=$vLangArr[32];
...
$momn_lv0004_4->ArrFunc[6]='';
$momn_lv0004_4->ArrFunc[7]='';
$momn_lv0004_4->ArrFunc[8]=$vLangArr[10];
$momn_lv0004_4->ArrFunc[9]=$vLangArr[12];
$momn_lv0004_4->ArrFunc[10]=$vLangArr[0];
$momn_lv0004_4->ArrFunc[11]=$vLangArr[33];
$momn_lv0004_4->ArrFunc[12]=$vLangArr[34];
$momn_lv0004_4->ArrFunc[13]=$vLangArr[35];
$momn_lv0004_4->ArrFunc[14]=$vLangArr[36];
$momn_lv0004_4->ArrFunc[15]=$vLangArr[37];

////Other
$momn_lv0004_4->ArrOther[1]=$vLangArr[31];
$momn_lv0004_4->ArrOther[2]=$vLangArr[32];
//////Delete message///
$lvMessage=array();
...
$vSortNum=$momn_lv0004_4->SortNum;
}
...
$momn_lv0004_4->lv002=$_GET['ChildID'];
...
//	$tsql="select count(*) from department where CompanyID ";
	...
	{
		$momn_lv0004_4->lv001=$_POST['txtlv001'.$i];
		$momn_lv0004_4->lv002=$_POST['txtlv002'.$i];
		$momn_lv0004_4->lv008=$_POST['txtlv008'.$i];
		$momn_lv0004_4->lv009=$_POST['txtlv009'.$i];
		$momn_lv0004_4->lv010=$_POST['txtlv010'.$i];
		$momn_lv0004_4->lv011=$_POST['txtlv011'.$i];
		$momn_lv0004_4->lv012=$_POST['txtlv012'.$i];
		$vresult=$momn_lv0004_4->LV_UpdateOther();
...
{
	var str="<br><iframe id='lvframefrm' height=600 marginheight=0 marginwidth=0 frameborder=0 src=<?php echo $vDir;?>mn_lv0004_4?func=<?php echo $_GET['func'];?>&childfunc=<?php echo $_GET['childfunc'];?>&childdetailfunc="+func+"&ID=<?php echo  $_GET['ID'] ?? '';?>&ChildID=<?php echo $_GET['ChildID'];?>&ChildDetailID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?>'\" class=lvframe></iframe>";
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<div><div id="lvleft"><form onSubmit="return false;" action="?func=<?php echo $_GET['func'];?>&childfunc=<?php echo $_GET['childfunc'];?>&ID=<?php echo  $_GET['ID']?>&ChildID=<?php echo $_GET['ChildID'];?>&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,2,0);?>" method="post" name="frmchoose" id="frmchoose">
					  <input type="hidden" name="curPg" value="<?php echo  $curPage;?>"/>
						<?php echo $momn_lv0004_4->LV_BuilListInput($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
