...
if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","TC0005.txt",$plang);
...
$motc_lv0003->lv002=base64_decode( $_GET['ID']);
...
?>
				...
				<?php echo $motc_lv0003->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
