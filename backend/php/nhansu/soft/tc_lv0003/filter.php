					...
					<form action="#" name="frmfilter" method="post">
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
							  ...
							  <td  height="20px"><input name="txtlv002" type="text" id="txtlv002" value="<?php echo $lvtc_lv0003->FormatView($vlv002,2);?>" tabindex="6" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
							...
							<tr>
							  ...
							  <td  height="20px"><select name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onkeypress="return CheckKey(event,7)"><option value=""></option>
