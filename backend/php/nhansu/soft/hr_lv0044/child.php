...
require_once("../paras.php");
require_once("../../clsall/lv_menusl0044.php");

$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","HR0165.txt",$plang);
//init object
$lv_menusl0044=new lv_menusl0044();
//Set variant
$lv_menusl0044->itemlst=$pitemlst;
$lv_menusl0044->childlst=$pchildlst;
$lv_menusl0044->level3lst=$plevel3lst;
$lv_menusl0044->child3lst=$pchild3lst;
...
<div id="content_child">
					...
					<TBODY>
						<TR vAlign="center" align="middle">				
							<td><form name="frmhr_employee" action="#" method="post">
								...
								<option value="1" <?php echo ($lv_menusl0044->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
								<option value="2" <?php echo ((int)$lv_menusl0044->level3lst==2)?'selected="selected"':'';?>>2.<?php echo $vLangArr[9];?></option>
								<option value="3" <?php echo ((int)$lv_menusl0044->level3lst==3)?'selected="selected"':'';?>>3.<?php echo $vLangArr[10];?></option>
								<option value="4" <?php echo ((int)$lv_menusl0044->level3lst==4)?'selected="selected"':'';?>>4.<?php echo $vLangArr[11];?></option>
								<option value="5" <?php echo ((int)$lv_menusl0044->level3lst==5)?'selected="selected"':'';?>>5.<?php echo $vLangArr[12];?></option>
	...
	<?php
	$lv_menusl0044->Dir="../";
include($lv_menusl0044->GetLinkEmp());
?>
	</div></div></td></tr></table>
			<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
...
document.frmhr_employee.cbxoption.value="<?php echo $lv_menusl0044->level3lst;?>";
