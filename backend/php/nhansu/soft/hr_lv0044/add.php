...
$lvhr_lv0044->lv001=$_POST['txtlv001'];
if( $_GET['ID']=="")
...
if($lvhr_lv0044->lv004==NULL || $lvhr_lv0044->lv004=="") $lvhr_lv0044->lv004=getInfor($_SESSION['ERPSOFV2RUserID'],2);
$lvhr_lv0044->lv005=$_POST['txtlv005'];
if($lvhr_lv0044->lv005==""|| $lvhr_lv0044->lv005==NULL) $lvhr_lv0044->lv005=GetServerDate();
    ...
    <h2 id="pageName"><?php echo $vLangArr[0];?></h2>
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<form action="#"  name="frmadd" id="frmadd"  method="post" enctype="multipart/form-data">
						...
						<table width="900" border="0" align="left" class="table1">
							<tr>
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvhr_lv0044->lv001=="")?InsertWithCheckExt('hr_lv0044', 'lv001', 'IS',4):$lvhr_lv0044->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
						    </tr>
							<tr>
				  ...
				  <table width="80%"><tr><td width="50%">
					<input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:100%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvhr_lv0044->lv004;?>"/></td>
					<td>
												  <ul id="pop-nav3" lang="pop-nav3" onMouseOver="ChangeName(this,3)" onkeyup="ChangeName(this,3)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlv004_search" id="txtlv004_search" style="width:100%" onKeyUp="LoadPopup(this,'txtlv004','hr_lv0020','concat(lv004,@! @!,lv003,@! @!,lv002)')" onFocus="LoadPopup(this,'txtlv004','hr_lv0020','concat(lv004,@! @!,lv003,@! @!,lv002)')" tabindex="200" >
				  ...
				  <td  height="20px"><select  name="txtlv020"  id="txtlv020"  tabindex="13" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" onChange="LoadText(this,'txtlv007','hr_lv0043','lv003',document.frmadd.txtlv002.value,-1,'<?php echo $plang;?>')"/><option value=""></option><?php echo $lvhr_lv0044->LV_LinkField('lv008',$lvhr_lv0044->lv008);?>
				  </select>							 </td>
							  </tr>	
							  	<tr>
							  <td  height="20" valign="top">&nbsp;</td>
							  <td  height="20"><textarea name="txtlv007" rows="15" id="txtlv007" style="width:80%" tabindex="13"><?php echo $lvhr_lv0044->lv007;?></textarea></td>
							</tr>				  																			
							<tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[22];?></td>
				  <td  height="20px"><select  name="txtlv021"  id="txtlv021"  tabindex="13" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" onChange="LoadText(this,'txtlv008','hr_lv0043','lv003',document.frmadd.txtlv002.value,-1,'<?php echo $plang;?>')"/><option value=""></option><?php echo $lvhr_lv0044->LV_LinkField('lv008',$lvhr_lv0044->lv008);?>
				  </select>							 </td>
							  </tr>	
							  	<tr>
							  <td  height="20" valign="top">&nbsp;</td>
				  ...
				  <td  height="20px"><select  name="txtlv022"  id="txtlv0222"  tabindex="13" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" onChange="LoadText(this,'txtlv009','hr_lv0043','lv003',document.frmadd.txtlv002.value,-1,'<?php echo $plang;?>')"/><option value=""></option><?php echo $lvhr_lv0044->LV_LinkField('lv008',$lvhr_lv0044->lv008);?>
				  </select>							 </td>
							  </tr>	
							  	<tr>
							  <td  height="20" valign="top">&nbsp;</td>
				  ...
				  <td  height="20px"><select  name="txtlv023"  id="txtlv023"  tabindex="13" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" onChange="LoadText(this,'txtlv010','hr_lv0043','lv003',document.frmadd.txtlv002.value,-1,'<?php echo $plang;?>')"/><option value=""></option><?php echo $lvhr_lv0044->LV_LinkField('lv008',$lvhr_lv0044->lv008);?>
				  </select>							 </td>
							  </tr>	
							  	<tr>
							  <td  height="20" valign="top">&nbsp;</td>
				  ...
				  <td  height="20"><input name="txtlv012" id="txtlv012"   tabindex="12"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo ($lvhr_lv0044->lv012=="")?"26":$lvhr_lv0044->lv012;?>"/></td>
						  </tr>		
                            <tr>
							  <td  height="20"><?php echo $vLangArr[30];?></td>
				  <td  height="20"><input name="txtlv013" id="txtlv013"   tabindex="13"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo ($lvhr_lv0044->lv013=="")?"4.5":$lvhr_lv0044->lv013;?>"/></td>
						  </tr>	
                          <tr>
							  <td  height="20"><?php echo $vLangArr[31];?></td>
				  <td  height="20"><input name="txtlv014" id="txtlv014"   tabindex="13"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo ($lvhr_lv0044->lv014=="")?"2":$lvhr_lv0044->lv014;?>"/></td>
						  </tr>		
							<tr>
