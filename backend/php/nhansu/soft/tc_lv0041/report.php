...
$motc_lv0041->lv029=$_GET['txtlv029'];
...
$motc_lv0041->lv001=$_GET['txtlv001'];
?>
...
<body  onkeyup="KeyPublicRun(event)">
			...
			<div>
					...
					<div id="lvleft">
						...
						echo $motc_lv0041->LV_BuilListReportOtherPrintLateSoon($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,0,$_GET['chkviewinfo']);?>
					</div>
