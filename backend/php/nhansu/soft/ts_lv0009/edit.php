...
//////////////init object////////////////
$lvts_lv0009=new ts_lv0009($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ts0009');
//$mowb_lv0006=new wb_lv0006($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Wb0006');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvts_lv0009->lv001=$_GET['ChildDetailID'];
//$lvts_lv0009->obj_wb_lv0006=$mowb_lv0006;
if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","TS0013.txt",$plang);
$lvts_lv0009->lang=strtoupper($plang);
$curPage = (int)($_POST['curPg'] ?? 1);	
$vFlag   = (int)($_POST['txtFlag'] ?? 0);
if($vFlag==1)
{
$lvts_lv0009->lv002=$_POST['txtlv002'];
$lvts_lv0009->lv003=$_POST['txtlv003'];
$lvts_lv0009->lv004=$_POST['txtlv004'];
$lvts_lv0009->lv005=$_POST['txtlv005'];
$lvts_lv0009->lv006=$_POST['txtlv006'];
$lvts_lv0009->lv007=$_POST['txtlv007'];
$lvts_lv0009->lv008=$_POST['txtlv008'];
$lvts_lv0009->lv009=$_POST['txtlv009'];
$lvts_lv0009->lv010=$_POST['txtlv010'];
$lvts_lv0009->lv011=$_POST['txtlv011'];
$lvts_lv0009->lv012=$_POST['txtlv012'];
$lvts_lv0009->lv013=$_POST['txtlv013'];
$lvts_lv0009->lv014=$_POST['txtlv014'];
$lvts_lv0009->lv015=$_POST['txtlv015'];
$lvts_lv0009->lv016=GetServerDate()." ".GetServerTime();
		
		$vresult=$lvts_lv0009->LV_UpdateEdit($_POST['txtlv004old'],$_POST['txtlv006old']);
		if($vresult==true) {
...
$lvts_lv0009->LV_LoadID($lvts_lv0009->lv001);
					...
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvts_lv0009->lv001=="")?InsertWithCheckExt('ts_lv0009', 'lv001', '',10):$lvts_lv0009->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[16];?></td>
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvts_lv0009->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
						<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[17];?></td>
							  <td  height="20">
							  <table style="width:80%"><tr><td width="50%">
							  	<input name="txtlv003" type="text" id="txtlv003"  value="<?php echo $lvts_lv0009->lv003;?>" tabindex="6" maxlength="225" style="width:100%" onKeyPress="return CheckKey(event,7)"/>
							  </td>
							  <td>
...
<tr>
				              ...
				              <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvts_lv0009->lv004;?>"/></td>
</tr>							  
							<tr>
							  ...
							  <?php echo $lvts_lv0009->LV_LinkField('lv005',$lvts_lv0009->lv005);?>
							  </select>
							  </td>
							  <td>
							...
							<tr>
							  ...
							  <td  height="20">
							  <input name="txtlv006" type="text" id="txtlv006"  value="<?php echo $lvts_lv0009->FormatView($lvts_lv0009->lv006,2);?>" tabindex="10" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
						  <span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
															onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmadd.txtlv006);return false;" /></span></td></tr>
<tr>
							  ...
							  <?php echo $lvts_lv0009->LV_LinkField('lv007',$lvts_lv0009->lv007);?>
							  </select>
							  </td>
							  <td>
							...
							<tr>
							  ...
							  <td  height="20">	<input type="text" name="txtlv008" id="txtlv008"  style="width:80%"  tabindex="12"  value="<?php echo (float)$lvts_lv0009->lv008;?>" onKeyPress="return CheckKey(event,7)">					  </td>
						    </tr>
							<tr>
							  ...
							  <?php echo $lvts_lv0009->LV_LinkField('lv009',$lvts_lv0009->lv009);?>
							  </select>
							  </td><td>
				  ...
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo (float)$lvts_lv0009->lv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>							 			  							 <tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[25];?></td>
							  <td  height="20"><input name="txtlv011" id="txtlv011"   tabindex="15"  style="width:100%" onkeypress="return CheckKey(event,7)" value="<?php echo $lvts_lv0009->FormatView($lvts_lv0009->lv011,2);?>"/></td></tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[26];?></td>
							  <td  height="20"><input type="text" name="txtlv012" id="txtlv012"   tabindex="16"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvts_lv0009->lv012;?>" /> </td>
						    </tr>
							<!--<tr>
							  ...
							  <?php echo $lvts_lv0009->LV_LinkField('lv013',$lvts_lv0009->lv013);?>
				  ...
				  <td  height="20"><input  name="txtlv014" type="text" id="txtlv014" value="<?php echo $lvts_lv0009->lv014;?>" tabindex="18" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>		
						   <tr>
							  <td  height="20"><?php echo $vLangArr[29];?></td>
				  <td  height="20"><input  name="txtlv015" type="text" id="txtlv015" value="<?php echo $lvts_lv0009->lv015;?>" tabindex="19" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>		
						<tr>
