...
$lvts_lv0009->lv001=$_POST['txtlv001'];
$lvts_lv0009->lv002=$_GET['ChildID'];
...
<tr>
				  ...
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo (float)$lvts_lv0009->lv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  ...
						  <tr>
							  ...
							  <td  height="20">
							  	<input name="txtlv011" id="txtlv011"   tabindex="15"  style="width:100%" onkeypress="return CheckKey(event,7)" value="<?php echo $lvts_lv0009->FormatView($lvts_lv0009->lv011,2);?>"/>
							  </td></tr>
							<tr>
