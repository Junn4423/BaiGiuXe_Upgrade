...
/////////////init object//////////////
$moki_lv0013=new ki_lv0013($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ki0013');
...
////Other
$moki_lv0013->ArrOther[1]=$vLangArr[28];
$moki_lv0013->ArrOther[2]=$vLangArr[29];
//////Delete message///
$lvMessage=array();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$moki_lv0013->lv002=base64_decode( $_GET['ID']);
...
?>
						...
						<?php echo $moki_lv0013->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
