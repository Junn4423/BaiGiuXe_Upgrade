...
/////////////init object//////////////
$mohr_lv0020=new hr_lv0020($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Rp0017');
...
$vStrMessage="";
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////
$mohr_lv0020->LoadSaveOperation($_SESSION['ERPSOFV2RUserID'],'rp_lv0017');
//////////////////////////////////////////////////////////////////////////////////////////////////////
...
$mohr_lv0020->typecontract=$_POST['txttypecontract'];
...
?>
						...
						<?php echo $mohr_lv0020->LV_BuilListReportAdvanceContract($vFieldList,'document.frmchoose','chkAll','lvChk',0,100000,$paging,$vOrderList,$vSortNum);?>
