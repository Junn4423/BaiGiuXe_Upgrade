...
/////////////init object//////////////
$morp_lv0016=new  rp_lv0016($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Rp0017');
/////////////init object//////////////
...
{
	//////////////////////////////////////////////////////////////////////////////////////////////////////
$morp_lv0016->LoadSaveOperation($_SESSION['ERPSOFV2RUserID'],'rp_lv0017');
//////////////////////////////////////////////////////////////////////////////////////////////////////
...
$morp_lv0016->SaveOperation($_SESSION['ERPSOFV2RUserID'],'rp_lv0017',$vFieldList,(int)$_POST['lvmaxrow'],(int)$_POST['curPg'],$vOrderList,(int)$_POST['lvsort']);
}
$vStrMessage="";
if($flagID==1)
{
...
function RptWH(vValue)
{
	...
	o.txttypecontract.value=getChecked(o.chklvtypecontract.value,'chklvtypecontract');	
	o.target="_blank";
	o.action="rp_lv0017/?func="+o.childfunc.value+"&lang=<?php echo $plang;?>";
	o.submit();
	o.target="_self";
	o.action="";
}
...
//-->
					...
					<input name="txtStringID" type="hidden" id="txtStringID" />
					 ...
					 <table width="100%" border="0" align="center" class="table1">
							<tr>
                             ...
                             <tr>
							  ...
							  <td width="178"  height="20">
								...
								<?php echo $morp_lv0016->GetBuilCheckListDep($morp_lv0016->lv002,'chklv029',10,'hr_lv0002','lv003');?></td>
								</div>
							</tr>	
							  <tr>
					    ...
					    <tr>
							  ...
							  <td  height="20"><div style="width:100%;height:150px;position:relative;overflow: auto;top:0px;"> <?php echo $morp_lv0016->GetBuilCheckList($morp_lv0016->TypeContract,'chklvtypecontract',10,'hr_lv0039');?></div></td>
					   </tr>
                      <tr>
				      <td  height="20"><?php echo "Ngày hợp đồng từ";?></td>
			          ...
			          <span class="td"><img src="../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
						  ...
						  <tr>
				      <td  height="20"><?php echo "Ngày hợp đồng đến";?></td>
			          ...
			          <span class="td"><img src="../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
						   ...
						   <tr>
				      <td  height="20"><?php echo $vLangArr[79];?></td>
        ...
        <TR vAlign=center align=middle>
            ...
            name=remove> <?php echo $vLangArr[10];?></a></TD>
					...
					<input name="txtlv028" type="hidden" id="txtlv028" value="<?php echo $morp_lv0016->lv028;?>" >
					<input name="txttypecontract" type="hidden" id="txttypecontract" value="<?php echo $morp_lv0016->typecontract;?>" >
