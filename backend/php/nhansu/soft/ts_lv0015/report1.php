...
////Init object//////////////
		...
		$mots_lv0015->path_server="";
$mots_lv0015->path_web="";
/////////Varian////////////////		
...
if($vlv001!="")
{
	...
	{
		$mots_lv0001->LV_LoadID($vWH);
		if($mots_lv0001->lv001!=NULL && $mots_lv0001->lv001!='')
		{
			if($vDSKho=="") $vDSKho= $mots_lv0001->lv003;
			else
			$vDSKho=$vDSKho.", ".$mots_lv0001->lv003;
		}
	}
}
////////////////////////////////////////////Get Data////////////////////////////////////////////////
...
<script language="javascript" src="<?php echo $vDir;?>../javascripts/printscript.js"></script>
...
function ViewInfos(vValue,vType){
	...
	//o.txtFlag.value = "5";
	o.action="<?php echo $vDir;?>ts_lv0010/?func=&childfunc=rpt&ID="+vValue+"&lang=<?php echo $plang;?>";
	}
	else
	{
	...
	//o.txtFlag.value = "5";
	o.action="<?php echo $vDir;?>ts_lv0008/?func=&childfunc=rpt&ID="+vValue+"&lang=<?php echo $plang;?>";
...
window.open('<?php echo $vDir;?>ts_lv0020/?func=rpt&lang=<?php echo $plang;?>&StockID='+vStockID+'&LotID='+vValue,'Requirement','width=600,height=200,left=200,top=350,resizable=yes,screenX=0,screenY=100,scrollbars=yes');
}
		...
		<tr>
			<td align="center" colspan="6">
				<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							<td align="center">
							<font style="font-size:14px;font-weight:bold"><?php echo $mots_lv0015->GetCompany();?></font>
							<br/>
							<div>
							Địa chỉ:<?php echo $mots_lv0015->GetAddress();?>
			...
			<td height="20px" colspan="6" align="center" class="normaltext">
				<?php 
						switch($vOptRun)
							{
								case 2:
									$strDataShow = $mots_lv0015->PrintInOutPutInStockDetail($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv006,$vlv007,$strTyles,$strQuantitative,$strColor,$strNote,$vlv005,$vlv004,$vlv008,$vlv009,$vexist,$vexistcur,$vshowimage);
									break;
								case 3:
									$strDataShow = $mots_lv0015->PrintInOutPutInStockDetail($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),1,$vlv006,$vlv007,$strTyles,$strQuantitative,$strColor,$strNote,$vlv005,$vlv004,$vlv008,$vlv009,$vexist,$vexistcur,$vshowimage);									
									break;
								case 4:
									$strDataShow = $mots_lv0015->PrintInOutPutInStockDetail($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),4,$vlv006,$vlv007,$strTyles,$strQuantitative,$strColor,$strNote,$vlv005,$vlv004,$vlv008,$vlv009,$vexist,$vexistcur,$vshowimage);									
									break;
							}
		...
		<tr>
			<td height="20px" colspan="6" align="center" class="normaltext">
				<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
					...
					<tr>
						<td>&nbsp;</td>
						<td class="center_style"><b><?php echo 'HCNS';?></b>&nbsp;</td>
						<td class="center_style">&nbsp;</td>
						<td class="center_style"><b><?php echo 'QUẢN LÝ';?></b>&nbsp;</td>
						<td class="center_style">&nbsp;</td>
						<td class="center_style"><b><?php echo 'BGĐ';?></b>&nbsp;</td>
						<td>&nbsp;</td>
					</tr>
