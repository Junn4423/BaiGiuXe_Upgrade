...
require_once("../../clsall/jo_lv0015.php");
//////////////init object////////////////
$lvjo_lv0015=new jo_lv0015($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Jo0015');
/////////Get ID///////////////
$lvjo_lv0015->lv001= $_GET['ID'] ?? '';
...
if($vFlag==1)
{
		$lvjo_lv0015->lv002=$_POST['txtlv002'];		
		$vresult=$lvjo_lv0015->LV_Update();
		if($vresult==true) {
...
$lvjo_lv0015->LV_LoadID($lvjo_lv0015->lv001);
...
function isphone(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvjo_lv0015->lv002;?>";
		o.txtlv003.value="<?php echo $lvjo_lv0015->lv003;?>";
		o.txtlv004.value="<?php echo $lvjo_lv0015->lv004;?>";
		o.txtlv005.value="<?php echo $lvjo_lv0015->lv005;?>";	
		o.txtlv002.focus();
	}
	function Cancel()
	{
					...
					<?php		
						...
						?>
							...
							<tr>
							  ...
							  <td width="335"  height="20px"><input  name="txtlv001" type="text" id="txtlv001" readonly="true" value="<?php echo $lvjo_lv0015->lv001;?>" /></td>
							</tr>
						<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input  name="txtlv002" type="text" id="txtlv002" value="<?php echo $lvjo_lv0015->lv002;?>" tabindex="6" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
