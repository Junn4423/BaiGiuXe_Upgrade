...
$mots_lv0003->ArrPush[18]=$vLangArr[35];
$mots_lv0003->ArrPush[19]=$vLangArr[36];
$mots_lv0003->ArrPush[20]=$vLangArr[37];
$mots_lv0003->ArrPush[21]=$vLangArr[38];
$mots_lv0003->ArrPush[22]=$vLangArr[39];
$mots_lv0003->ArrPush[23]=$vLangArr[40];
$mots_lv0003->ArrPush[24]=$vLangArr[41];
$mots_lv0003->ArrPush[25]=$vLangArr[42];
$mots_lv0003->ArrPush[26]=$vLangArr[43];
...
$mots_lv0003->ArrFunc[11]=$vLangArr[63];
$mots_lv0003->ArrFunc[12]=$vLangArr[64];
$mots_lv0003->ArrFunc[13]=$vLangArr[65];
$mots_lv0003->ArrFunc[14]=$vLangArr[66];

////Other
$mots_lv0003->ArrOther[1]=$vLangArr[61];
$mots_lv0003->ArrOther[2]=$vLangArr[62];
//////Delete message///
$lvMessage=array();
...
?>
						...
						<?php echo $mots_lv0003->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
