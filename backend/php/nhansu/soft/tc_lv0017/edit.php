...
/////////Get ID///////////////
$lvtc_lv0017->lv001=$_GET['ChildID'];
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","TC0032.txt",$plang);
$lvtc_lv0017->lang= strtolower($plang);
...
if($vFlag==1)
{
		$lvtc_lv0017->lv002=$_POST['txtlv002'];
		$lvtc_lv0017->lv003=$_POST['txtlv003'];
		$lvtc_lv0017->lv004=$_POST['txtlv004'];
		$lvtc_lv0017->lv005=$_POST['txtlv005'];
		$lvtc_lv0017->lv006=$_POST['txtlv006'];
		$lvtc_lv0017->lv007=$_POST['txtlv007'];
		$lvtc_lv0017->lv009=getInfor($_SESSION['ERPSOFV2RUserID'],2);
		$vresult=$lvtc_lv0017->LV_Update();
		if($vresult==true) {
...
$lvtc_lv0017->LV_LoadID($lvtc_lv0017->lv001);
...
function isnumber(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvtc_lv0017->lv002;?>";
		o.txtlv003.value="<?php echo $lvtc_lv0017->lv003;?>";
		o.txtlv004.value="<?php echo $lvtc_lv0017->lv004;?>";
		o.txtlv005.value="<?php echo $lvtc_lv0017->lv005;?>";
		o.txtlv006.value="<?php echo $lvtc_lv0017->lv006;?>";	
		o.txtlv007.value="<?php echo $lvtc_lv0017->lv007;?>";				
		o.txtlv002.focus();
	}
	function Cancel()
	{
					...
					<?php		
						...
						?>
								...
								<td width="*%"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvtc_lv0017->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvtc_lv0017->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[17];?></td>
				  <td  height="20px">
							  <table width="80%"><tr><td width="50%"><select name="txtlv003" id="txtlv003"  tabindex="7" maxlength="50" style="width:100%" onKeyPress="return CheckKeys(event,7,this)">
							   <?php echo $lvtc_lv0017->LV_LinkField('lv003',$lvtc_lv0017->lv003);?>
                              </select></td><td>
							  ...
							  <table width="80%"><tr><td width="50%"><select name="txtlv004" id="txtlv004"  tabindex="8" maxlength="50" style="width:100%" onKeyPress="return CheckKeys(event,7,this)">
							   <?php echo $lvtc_lv0017->LV_LinkField('lv004',$lvtc_lv0017->lv004);?>
                              </select></td><td>
							  ...
							  <td  height="20px"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo (int)$lvtc_lv0017->lv005;?>" tabindex="10" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
							  ...
							  <td  height="20px">
							  <table width="80%"><tr><td width="50%"><select name="txtlv006" id="txtlv006"  tabindex="11" maxlength="50" style="width:100%" onKeyPress="return CheckKeys(event,7,this)">
							   <?php echo $lvtc_lv0017->LV_LinkField('lv006',$lvtc_lv0017->lv006);?>
                              </select></td><td>
							  ...
							  <td  height="20px"><input name="txtlv007" type="text" id="txtlv007" value="<?php echo $lvtc_lv0017->lv007;?>" tabindex="12" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>			 
							<tr>
