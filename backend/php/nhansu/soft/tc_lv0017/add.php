					...
					<form action="#" name="frmadd" method="post">
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
							  ...
							  <td  height="20px">  <table width="80%"><tr><td width="50%"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvtc_lv0017->lv002;?>" tabindex="6" maxlength="225" style="width:100%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td><td>
