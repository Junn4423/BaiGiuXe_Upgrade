...
function isphone(s){
	...
	function Save()
	{
		...
		o.txtlv012.value=document.frmfilter.txtlv013.value;	
					...
					<form action="#" name="frmfilter" method="post">
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
							  ...
							  <td  height="20px">
				  				<table width="80%"><tr><td width="50%"><select  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/>
				  				<option value=""></option>
								<?php echo $lvhr_lv0045->LV_LinkField('lv003',$vlv003);?>
				  				</select></td><td>
							...
							<tr>
							  ...
							  <td  height="20px"><table width="80%"><tr><td width="50%"><select  name="txtlv005"  id="txtlv005"  tabindex="10" maxlength="255" style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/>
							  	<option value=""></option>
								<?php echo $lvhr_lv0045->LV_LinkField('lv005',$vlv005);?>
				  </select></td><td>
							  ...
							  <td  height="20px"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo $vlv006;?>" tabindex="11" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>																			
							<tr>
							<tr>
							...
							<tr>
							  ...
							  <td  height="20px"><input name="txtlv010" type="text" id="txtlv010" value="<?php echo $vlv010;?>" tabindex="12" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							</tr>	
							<tr>
							  <td  height="20px"><?php echo $vLangArr[25];?></td>
							  <td  height="20px"><input name="txtlv011" type="text" id="txtlv011" value="<?php echo $vlv011;?>" tabindex="12" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							</tr>	
							<tr>
							  <td  height="20px"><?php echo $vLangArr[26];?></td>
							  <td  height="20px"><input name="txtlv012" type="text" id="txtlv012" value="<?php echo $vlv012;?>" tabindex="12" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							</tr>	
							<tr>
							  <td  height="20px"><?php echo $vLangArr[27];?></td>
							  <td  height="20px"><input name="txtlv013" type="text" id="txtlv013" value="<?php echo $vlv013;?>" tabindex="12" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							</tr>	
                            <tr>
							  <td  height="20px"><?php echo $vLangArr[31];?></td>
							  <td  height="20px"><input name="txtlv015" type="text" id="txtlv015" value="<?php echo $vlv015;?>" tabindex="14" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							</tr>	
                            <tr>
							  <td  height="20px"><?php echo $vLangArr[32];?></td>
							  <td  height="20px"><input name="txtlv016" type="text" id="txtlv016" value="<?php echo $vlv016;?>" tabindex="15" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							</tr>	
                            <tr>
							  <td  height="20px"><?php echo $vLangArr[33];?></td>
							  <td  height="20px"><input name="txtlv017" type="text" id="txtlv017" value="<?php echo $vlv017;?>" tabindex="16" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							</tr>	
                            <tr>
							  <td  height="20px"><?php echo $vLangArr[34];?></td>
							  <td  height="20px"><input name="txtlv018" type="text" id="txtlv018" value="<?php echo $vlv018;?>" tabindex="17" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"> <span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
							  ...
							  <td  height="20"><input type="text" name="txtlv019" id="txtlv019" tabindex="18" style="width:80%"  value="<?php echo $vlv019;?>" onKeyPress="return CheckKey(event,7)">							  </td>
							</tr>		
							<tr>
							  ...
							  <td  height="20"><select name="txtlv014" id="txtlv014" tabindex="12" style="width:80%" onKeyPress="return CheckKey(event,7)">
							  	<option value=""></option>
							  	<?php echo $lvhr_lv0045->LV_LinkField('lv014',$vlv014);?>
								
							    </select>							  </td>
							</tr>	
							  <tr>
							  <td  height="20px"><?php echo $vLangArr[22];?></td>
				  <td  height="20px"><select  name="txtlv008"  id="txtlv008"  tabindex="13" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" ><option value=""></option><option value="0"  <?php echo ($vlv008=='0')?'selected="selected"':"";?>>0</option><option value="1" <?php echo ($vlv008=='1')?'selected="selected"':"";?>>1</option></select>					 </td>
							  </tr>	
							  <tr>
