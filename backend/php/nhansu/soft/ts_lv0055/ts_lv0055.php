...
$vNow=GetServerDate();
$mots_lv0055->lv002=getyear($vNow)."-".getmonth($vNow)."-"."01";
$mots_lv0055->lv003=$vNow;
//$ma=$_GET['ma'];
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
                    ...
                    <input type="hidden" name="lang" value="<?php echo $plang;?>" />
					 <table width="100%" border="0" align="center" id="table1">
							...
							<tr>
							  ...
							  <td  height="20"><select name="txtlv001" id="txtlv001"   tabindex="6"  style="width:80%" onkeypress="return CheckKey(event,7)">
							   				<?php
												...
												?>
							  <?php echo $mots_lv0055->LV_LinkField('lv002',$mots_lv0055->lv002);?>
							 
                              </select>							    </td>
							</tr><tr>
				      <td  height="20"><?php echo $vLangArr[2];?></td>
				      <td  height="20"><input name="txtlv002" type="text" id="txtlv002" value="<?php echo formatdate($mots_lv0055->lv002,$plang);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
				      ...
				      <td  height="20"><input name="txtlv003" type="text" id="txtlv003" value="<?php echo formatdate($mots_lv0055->lv003,$plang);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
				        <span class="td"><img src="../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
						 ...
						 <tr>
							  ...
							  <option value=""></option>
							  <?php echo $mots_lv0055->LV_LinkField('lv004',$mots_lv0055->lv004);?>
							  </select>	</td></tr>
						  <tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[27];?></td>
							  <td  height="20">
							   <table width="80%"><tr><td width="50%">
							    <input name="txtlv005" type="text" id="txtlv005"  value="<?php echo $mots_lv0055->lv005;?>" tabindex="10" maxlength="225" style="width:100%" onKeyPress="return CheckKeys(event,7)"/>
							    </td>
							    <td>
						 ...
						 <tr>
							  ...
							  <option value=""></option>
							  <?php echo $mots_lv0055->LV_LinkField('lv006',$mots_lv0055->lv006);?>
							  </select>
							  </td>
							  <td>
                             ...
                             <tr>
							  ...
							  <td  height="20"><input name="txtlv008" type="hidden" id="txtlv008" value="<?php echo $mots_lv0055->lv008;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"> <?php echo $mots_lv0055->GetBuilCheckList($mots_lv0055->lv008,'chklv008',10);?></td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[24];?></td>
				  <td  height="20">
							  <table width="80%"><tr><td width="50%">
							  <input  name="txtlv007" type="text" id="txtlv007" value="<?php echo $mots_lv0055->lv007;?>" tabindex="9" maxlength="255" style="width:100%" onKeyPress="return CheckKeys(event,7,this)" />
							  </td>
							  <td>
