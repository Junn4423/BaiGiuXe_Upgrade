...
require_once("../../clsall/tc_lv0032.php");
//////////////init object////////////////
$lvtc_lv0032=new tc_lv0032($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Tc0032');
...
$lvtc_lv0032->lv001=$_POST['txtlv001'];
$lvtc_lv0032->lv002=$_POST['txtlv002'];
$lvtc_lv0032->lv003=$_POST['txtlv003'];

if($vFlag==1)
{
		
		$vresult=$lvtc_lv0032->LV_Insert();
		if($vresult==true) {
					...
					<form action="#" method="post" enctype="multipart/form-data" name="frmadd">
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
								...
								<td width="*%"  height="20px"><input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvtc_lv0032->lv001=="")?InsertWithCheckExt('tc_lv0032', 'lv001', '',1):$lvtc_lv0032->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvtc_lv0032->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>								
							<tr>
							  <td  height="20px"><?php echo $vLangArr[17];?></td>
							  <td  height="20px"><textarea  name="txtlv003" rows="4"  id="txtlv003" style="width:80%"  tabindex="7" ><?php echo $lvtc_lv0032->lv003;?></textarea></td>
							</tr>																	
							<tr>
