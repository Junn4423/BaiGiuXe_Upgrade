						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvml_lv0013->lv001=="")?InsertWithCheckExt('huyvanv2_0.ml_lv0013', 'lv001', 'TEM',3):$lvml_lv0013->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
							</tr>
							<tr>
