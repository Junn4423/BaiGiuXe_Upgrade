					...
					<form action="#" name="frmfilter" method="post">
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
							  ...
							  <td  height="20px">
							  <table width="80%"><tr><td width="50%"><select name="txtlv003" id="txtlv003"   tabindex="7" maxlength="225" style="width:100%" onKeyPress="return CheckKeys(event,7,this)" readonly="true"/><option value=""></option><?php echo $lvhr_lv0030->LV_LinkField('lv003',$lvhr_lv0030->lv003);?></select></td><td>
