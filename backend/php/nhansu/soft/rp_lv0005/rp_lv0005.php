				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
                    ...
                    <input type="hidden" name="lang" value="<?php echo $_GET['lang'];?>" />
					 <table width="100%" border="0" align="center" class="table1">
                             ...
                             <tr>
							  ...
							  <td width="178"  height="20">
								  <div style="max-height:400px;overflow:auto">
									<input name="txtlv002" type="hidden" id="txtlv002" value="<?php echo $morp_lv0005->lv002;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"> <?php echo $morp_lv0005->GetBuilCheckListDept($morp_lv0005->lv002,'chklv002',10,'hr_lv0002','lv003',$morp_lv0005->lv029);?>
								  </div>
							  </td>
						    </tr>	
						  <tr>
							  ...
							  <td  height="20">
							   <div style="max-height:200px;overflow:auto">
									<input name="txtlv003" type="hidden" id="txtlv003" value="<?php echo $morp_lv0005->lv003;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"> <?php echo $morp_lv0005->GetBuilCheckList('0,1,4,5,6','chklv003',10,'hr_lv0022');?>
								</div>
							</td>
					   </tr>	
							  ...
							  <td  height="20"><table><tr><td><input name="txtlv004" type="text" id="txtlv004" value="<?php echo $morp_lv0005->lv004;?>" tabindex="9" maxlength="50" style="width:100%" onKeyPress="return CheckKeys(event,7,this)" /></td><td>
				      ...
				      <td  height="20"><input name="txtdatefrom" type="text" id="txtdatefrom" value="<?php echo $morp_lv0005->FormatView($lvDateFrom,2);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
				      ...
				      <td  height="20"><input name="txtdateto" type="text" id="txtdateto" value="<?php echo $morp_lv0005->FormatView($lvDateTo,2);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
			          <span class="td"><img src="../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
					    ...
					    <tr>
					   		<td><?php echo $vLangArr[28];?></td><td><select name="txtlv221">
					   			<option value="0"><?php echo $vLangArr[30];?></option>
								<option value="2" ><?php echo $vLangArr[38];?></option>
								<option value="4"  selected="selected"><?php echo 'Xuất mẫu chỉ đi trễ về sớm và cả hai';?></option>
								<option value="5"  ><?php echo 'Xuất mẫu chỉ thiếu giờ và không quét';?></option>
					   			<option value="1" ><?php echo $vLangArr[31];?></option>
					   		</select></td>
					   </tr>	
					   <tr>
