...
function isphone(s){
	...
	function Save()
	{
		...
		o.txtlv013.value=document.frmfilter.txtlv012.value;		
...
<tr>
				  ...
				  <option value=""></option>
							...
							<tr>
							  ...
							  <td  height="20px"><input name="txtlv008" type="text" id="txtlv008" value="<?php echo $vlv008;?>" tabindex="11" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"><select  name="txtlv010"  id="txtlv010" tabindex="11" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/><?php echo $lvhr_lv0026->LV_LinkField('lv010',$vlv010);?></select></td>
							  </tr>	
							  <tr>
							  <td  height="20px"><?php echo $vLangArr[23];?></td>
							  <td  height="20px"><input name="txtlv009" type="text" id="txtlv009" value="<?php echo $vlv009;?>" tabindex="12" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>
							  <tr>
							  <td  height="20px"><?php echo $vLangArr[29];?></td>
							  <td  height="20px"><input name="txtlv012" type="text" id="txtlv012" value="<?php echo $vlv012;?>" tabindex="13" maxlength="1" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>							  
							  <tr>
							  <td  height="20px"><?php echo $vLangArr[30];?></td>
							  <td  height="20px"><input name="txtlv013" type="text" id="txtlv013" value="<?php echo $vlv013;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
						      </td>
							  </tr>	
							<tr>
