...
if ($sExport == "excel") {
   ...
   header('Content-Disposition: attachment; filename=salaryhotel.xls');
}
if ($sExport == "word") {
    header('Content-Type: application/vnd.ms-word; charset=utf-8');
    header('Content-Disposition: attachment; filename=salaryhotel.doc');
}
if($sExport=="pdf"){
...
<?php
$vstrReturn= $motc_lv0020->LV_LuongHotel($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,$motc_lv0013,$motc_lv0020->optbh,$motc_lv0020->ismau);
echo $vstrReturn;
?>
