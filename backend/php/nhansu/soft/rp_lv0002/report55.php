...
$motc_lv0020->CalMonth=Fillnum($motc_lv0013->lv006,2);
	...
	function Show_CC_Title(Stt)
{
	if(document.getElementById('CC_Title_'+Stt).innerHTML=='')
	{
		...
		document.getElementById('CCCC_Title_'+Stt).innerHTML=document.getElementById('CCCC_Title').innerHTML;
		document.getElementById('CCCCC_Title_'+Stt).innerHTML=document.getElementById('CCCCC_Title').innerHTML;
	}
	else
	{
		document.getElementById('CC_Title_'+Stt).innerHTML='';
		document.getElementById('CCC_Title_'+Stt).innerHTML='';
		document.getElementById('CCCC_Title_'+Stt).innerHTML='';
		document.getElementById('CCCCC_Title_'+Stt).innerHTML='';
	}
...
<td colspan="5" rowspan="2" align="left" valign="middle" width="500"><strong><span style="font: 26px Arial,Tahoma;text-align:center"><div ondblclick="this.innerHTML='CHI NHÁNH CÔNG TY CỔ PHẦN SỢI THẾ KỶ'">CÔNG TY CỔ PHẦN SỢI THẾ KỶ</div></span></strong></td>
...
<tr>
<td colspan="5" align="center" valign="middle" style="padding:5px;"><strong><span style="font:bold 26px Arial,Tahoma;">BẢNG TỔNG HỢP THANH TOÁN LƯƠNG ĐỢT THÁNG <?php echo getmonth($motc_lv0013->lv004);?>/<?php echo getyear($motc_lv0013->lv004);?></span></strong></td>
</tr>
<tr>
<td colspan="5" align="center" valign="middle"><span style="font-size: small;"><?php echo $vLangArr[22];?>:<?php echo $motc_lv0013->FormatView($motc_lv0013->lv004,2);?> <?php echo 'đền ngày';?> <?php echo $motc_lv0013->FormatView($motc_lv0013->lv005,2);?></td>
</tr>
<?php	
	}
	else
...
<tr>
<td colspan="5" align="center" valign="middle" style="padding:5px;"><strong><span style="font:bold 26px Arial,Tahoma;"><input type="text" value="BẢNG TỔNG HỢP THANH TOÁN LƯƠNG ĐỢT THÁNG <?php echo getmonth($motc_lv0013->lv004);?>/<?php echo getyear($motc_lv0013->lv004);?>" style="border:0px #fff solid;width:100%;height:40px;text-align:center;font:22px arial,tahoma;"/></span></strong></td>
</tr>
<tr>
<td colspan="5" align="center" valign="middle"><span style="font-size: small;"><input type="text" value="<?php echo $vLangArr[22];?>:<?php echo $motc_lv0013->FormatView($motc_lv0013->lv004,2);?> <?php echo 'đền ngày';?> <?php echo $motc_lv0013->FormatView($motc_lv0013->lv005,2);?>" style="font: 12px Arial,Tahoma;border:0px #fff solid;width:100%;text-align:center;"/></td>
</tr>
<?php
}
?>
...
<br/>
<?php
$vstrReturn= $motc_lv0020->LV_LuongNganHangThuong($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,$motc_lv0013,$motc_lv0020->optbh,$motc_lv0020->ismau);
echo $vstrReturn;
?>
...
<td>&nbsp;</td>
<td  height="27" align="center" style="font: 12px Arial,Tahoma;"><strong>GIÁM ĐỐC TQL</strong></td>
<td>&nbsp;</td>
<td  height="27" align="center" style="font: 12px Arial,Tahoma;"><strong>GIÁM ĐỐC TÀI CHÍNH</strong></td>
<td>&nbsp;</td>
