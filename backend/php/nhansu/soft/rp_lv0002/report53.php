...
<tr>
<td colspan="5" align="center" valign="middle"><strong><span style="font-size: large;font-size:24px"><input type="text" value="CÁC KHOẢN GIẢM TRỪ LƯƠNG THÁNG <?php echo getmonth($motc_lv0013->lv004);?>/<?php echo getyear($motc_lv0013->lv004);?>" style="border:0px #fff solid;width:100%;text-align:center;font:16px arial,tahoma;"/></span></strong></td>
</tr>
<tr>
<td colspan="5" align="center" valign="middle"><span style="font-size: small;"><input type="text" value="<?php echo $vLangArr[22];?>:<?php echo $motc_lv0013->FormatView($motc_lv0013->lv004,2);?> <?php echo 'đến ngày';?> <?php echo $motc_lv0013->FormatView($motc_lv0013->lv005,2);?>" style="border:0px #fff solid;width:100%;text-align:center;"/></td>
</tr>
</tbody>
</table>

<?php
$vstrReturn= $motc_lv0020->LV_LuongVanPhong1DongPhi_KHAC($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,$motc_lv0013,$motc_lv0020->optbh,$motc_lv0020->ismau);
echo $vstrReturn;
?>
<table style="width: 880px;" border="0" cellspacing="0" cellpadding="0">
<tbody>
<tr><td colspan="9" align="right"><span style="font-size: small;"><input type="text" value="TP.HCM ngày <?php echo getday($motc_lv0013->DateCurrent);?> tháng <?php echo getmonth($motc_lv0013->DateCurrent);?> năm <?php echo getyear($motc_lv0013->DateCurrent);?>" style="border:0px #fff solid;width:100%;text-align:right;"/></td></tr>
<tr height="27">
<td>&nbsp;</td>
<td  height="27" align="center"><strong>Người lập biểu</strong></td>
<td>&nbsp;</td>
<td  height="27" align="center"><strong>Trưởng bộ phận</strong></td>
<td>&nbsp;</td>
