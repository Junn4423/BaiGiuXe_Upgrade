...
$motc_lv0020->ArrPush[999]=$vLangArr[100];
$motc_lv0020->ArrPush[1000]=$vLangArr[101];
...
<!--<table border="0" cellpadding="0" cellspacing="0" style="width: 100%;" >
	<tbody>
		<tr height="24">
			<td colspan="3" height="24" width="383"><?php echo $morp_lv0002->GetCompany();?></td>
			<td width="270">&nbsp;</td>
			<td width="166">&nbsp;</td>
			<td width="174">&nbsp;</td>
			<td width="64">&nbsp;</td>
		...
		<tr height="31">
			<td colspan="3" height="31"><?php echo $morp_lv0002->GetAddress();?></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr height="28">
			<td colspan="3" height="28">Tel: <?php echo $morp_lv0002->GetPhone();?></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
...
<td colspan="16" rowspan="4" align="center" valign="middle"><strong><span style="font-size: large;font-size:24px"><input type="text" value="BẢNG LƯƠNG CH&Iacute;NH TH&Aacute;NG"" style="border:0px #fff solid;width:100%;text-align:center;font:bold 20px arial,tahoma;"/>
...
<div id="showparent1" style="text-align:left" >
						...
						
						{
							...
							echo str_replace("@999","",$vstrReturn);
						}
						?>
