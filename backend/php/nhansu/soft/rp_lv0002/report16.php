...
if ($sExport == "excel") {
   ...
   header('Content-Disposition: attachment; filename=salaryall_hotel.xls');
}
if ($sExport == "word") {
    header('Content-Type: application/vnd.ms-word; charset=utf-8');
    header('Content-Disposition: attachment; filename=salaryall_hotel.doc');
}
if($sExport=="pdf"){
...
?>
	<table border="0" cellpadding="0" cellspacing="0" width="800">
		...
		<tr height="27">
			<td  colspan="4" rowspan="4"><img src="http://sof.vn/bueno/logo.png" height="100"/></td>
			<td colspan="12" height="27" ><strong><?php echo $morp_lv0002->GetCompany();?></strong></td>
			
		</tr>
		<tr height="27">
			<td colspan="12" height="27">Human Resources Dept</td>
			
		</tr>
		<tr height="27">
			<td colspan="12" height="27"><?php echo $morp_lv0002->GetAddress();?></td>
			
		</tr>
		<tr height="27">
			<td colspan="12" height="27">Tel: 064 3541900 - Fax:064 3541989
</td>
		...
		<tr height="40">
			...
			<td colspan="16" align="center"><h1><strong>BẢNG LƯƠNG THÁNG <?php echo getmonth($motc_lv0013->lv004).'/'.getyear($motc_lv0013->lv004);?> 			</strong></h1>														
<strong></td>
...
<?php
$vstrReturn= $motc_lv0020->LV_LuongSumHotel($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,$motc_lv0013,$motc_lv0020->optbh,$motc_lv0020->ismau);
echo $vstrReturn;
?>
