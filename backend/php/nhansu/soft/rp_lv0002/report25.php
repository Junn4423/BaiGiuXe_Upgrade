...
?>
	...
	<tbody>
		...
		<tr><td>Tháng <?php echo getmonth($motc_lv0013->lv004).'/'.getyear($motc_lv0013->lv004);?></td></tr>
	</tbody>
</table>
<?php
if($motc_lv0020->lv201=='VP' || $motc_lv0020->lv201=='XUONG' || trim($motc_lv0020->lv201)=='')
{
	$vstrReturn= $motc_lv0020->LV_TrichPITLevel1NNN($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,$motc_lv0013,$motc_lv0020->optbh,$motc_lv0020->ismau);
}
else	
	$vstrReturn= $motc_lv0020->LV_TrichPITNNN($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,$motc_lv0013,$motc_lv0020->optbh,$motc_lv0020->ismau);
echo $vstrReturn;
?>
