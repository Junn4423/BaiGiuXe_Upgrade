...
if ($sExport == "excel") {
   ...
   header('Content-Disposition: attachment; filename=trich_dong_kinh_phi_cong_doan.xls');
}
if ($sExport == "word") {
    header('Content-Type: application/vnd.ms-word; charset=utf-8');
    header('Content-Disposition: attachment; filename=trich_dong_kinh_phi_cong_doan.doc');
}
if($sExport=="pdf"){
//header('Content-type: application/pdf');
//header('Content-Disposition: attachment; filename="trich_dong_kinh_phi_cong_doan.pdf"');
}
include("../paras.php");
include("../config.php");
...
$motc_lv0013->LV_LoadID($motc_lv0020->lv060,$motc_lv0013->lv007,$motc_lv0013->lv006);
...
$motc_lv0020->isGRS=$_GET['ShowGRS'];
$motc_lv0020->isAmLuong=(int)$_GET['isAmLuong'];
$motc_lv0020->isSortOld=(int)$_GET['isSortOld'];
...
<td colspan="5" rowspan="2" align="left" valign="middle" width="500"><strong><span style="font: 26px Arial,Tahoma;text-align:center"><div ondblclick="this.innerHTML='CHI NHÁNH CÔNG TY CỔ PHẦN CÔNG NGHỆ ĐẦU TƯ MINH PHƯƠNG'">CÔNG TY CỔ PHẦN CÔNG NGHỆ ĐẦU TƯ MINH PHƯƠNG</div></span></strong></td>
<td colspan="16" rowspan="4" align="center" valign="middle">
...
<tr>
<td colspan="5" align="center" valign="middle" style="padding:5px;"><strong><span style="font:bold 26px Arial,Tahoma;">DANH SÁCH CB - CNV NỘP THUẾ THU NHẬP CÁ NHÂN THÁNG <?php echo getmonth($motc_lv0013->lv004);?>/<?php echo getyear($motc_lv0013->lv004);?></span></strong></td>
</tr>
<tr>
...
<tr>
<td colspan="5" align="center" valign="middle" style="padding:5px;"><strong><span style="font:bold 26px Arial,Tahoma;"><input type="text" value="DANH SÁCH CB - CNV NỘP THUẾ THU NHẬP CÁ NHÂN THÁNG <?php echo getmonth($motc_lv0013->lv004);?>/<?php echo getyear($motc_lv0013->lv004);?>" style="border:0px #fff solid;width:100%;height:40px;text-align:center;font:22px arial,tahoma;"/></span></strong></td>
</tr>
<tr>
<td colspan="5" align="center" valign="middle"><span style="font-size: small;"><input type="text" value="<?php echo $vLangArr[22];?>:<?php echo $motc_lv0013->FormatView($motc_lv0013->lv004,2);?> <?php echo 'đến ngày';?> <?php echo $motc_lv0013->FormatView($motc_lv0013->lv005,2);?>" style="font: 14px Arial,Tahoma;border:0px #fff solid;width:100%;text-align:center;"/></td>
</tr>
<?php
}
?>
...
<br/>
<?php
//$motc_lv0013->lv007,$motc_lv0013->lv006;
$vstrReturn= $motc_lv0020->LV_TrichPITFullSTKPhuThuoc($vOpt,$motc_lv0013->lv007,$motc_lv0013->lv006);
echo $vstrReturn;
?>
<table style="width: 100%;font: 26px Arial,Tahoma;" border="0" cellspacing="0" cellpadding="0">
<tbody>
<tr><td colspan="9" align="right"><BR/><span style="font: 14px Arial,Tahoma;"><input type="text" value="BÌNH DƯƠNG ngày <?php echo getday($motc_lv0013->DateCurrent);?> tháng <?php echo getmonth($motc_lv0013->DateCurrent);?> năm <?php echo getyear($motc_lv0013->DateCurrent);?>" style="font: 14px Arial,Tahoma;border:0px #fff solid;width:100%;text-align:right;"/></td></tr>
<tr height="27">
<td>&nbsp;</td>
<td  height="27" align="center" style="font: 14px Arial,Tahoma;"><strong>NGƯỜI LẬP BIỂU</strong></td>
<td>&nbsp;</td>
<td  height="27" align="center" style="font: 14px Arial,Tahoma;"><strong>CHỦ QUẢN</strong></td>
<td>&nbsp;</td>
<td  height="27" align="center" style="font: 14px Arial,Tahoma;"><strong>GIÁM ĐỐC TQL</strong></td>
<td>&nbsp;</td>
<td  height="27" align="center" style="font: 14px Arial,Tahoma;"><strong>GIÁM ĐỐC TÀI CHÍNH</strong></td>
<td>&nbsp;</td>
<td align="center" style="font: 14px Arial,Tahoma;"><strong>TỔNG GIÁM ĐỐC</strong></td>
<td>&nbsp;</td>
</tr>
<tr height="27">
<td height="27">&nbsp;</td>
