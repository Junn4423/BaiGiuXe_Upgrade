...
<?php
	...
	{
	$vStrHD='<tr height="37" style="font-weight:bold;">
			<td height="37" >@01</td>
			<td>&nbsp;</td>
			<td>@09</td>
			<td>&nbsp;</td>
		...
		$vsql="select A.lv002 MaNV,concat(B.lv004,' ',B.lv003,' ',B.lv002) NameNV,B.lv005 Position,A.lv035 ActualPayable,A.lv069 TotalPayable,(select BB.lv069 from tc_lv0021 BB where BB.lv002=A.lv002 and BB.lv098='$vPreCalID') ReTotalPayable,A.lv012 NetMonth,(select BB.lv012 from tc_lv0021 BB where BB.lv002=A.lv002 and BB.lv098='$vPreCalID') PreNetMonth from tc_lv0021 A left join hr_lv0020 B on A.lv002=B.lv001  where A.lv098='$vCalID' and A.lv096='".$vrow['lv001']."'";
