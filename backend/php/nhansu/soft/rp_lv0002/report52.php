...
<tr>
<td colspan="5" align="center" valign="middle"><strong><span style="font-size: large;font-size:24px"><input type="text" value="VI PHẠM NỘI QUY - SUNG CÔNG QUỸ <?php echo getmonth($motc_lv0013->lv004);?>/<?php echo getyear($motc_lv0013->lv004);?>" style="border:0px #fff solid;width:100%;text-align:center;font:16px arial,tahoma;"/></span></strong></td>
</tr>
<tr>
...
<?php
$vstrReturn= $motc_lv0020->LV_LuongVanPhong1DongPhi_TreHU($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,$motc_lv0013,$motc_lv0020->optbh,$motc_lv0020->ismau);
echo $vstrReturn;
?>
