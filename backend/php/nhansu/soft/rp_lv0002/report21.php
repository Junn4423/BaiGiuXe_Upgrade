...
?>
	...
	<tbody>
		<!--<tr height="26">
			<td colspan="3" height="26" width="246">Tel : <?php echo $morp_lv0002->GetPhone();?> Fax : <?php echo $morp_lv0002->GetFax();?></td>
		</tr>
		<tr height="28">
			<td colspan="3" height="28">Add: <?php echo $morp_lv0002->GetAddress();?></td>
		</tr>
		<tr height="26">
			<td colspan="3" height="26">Website: <?php echo $morp_lv0002->GetWeb();?></td>
		</tr>-->
		<tr height="32">
			<td colspan="7" height="32" style="text-align: center;"><strong><?php echo $morp_lv0002->GetCompany();?></strong></td>
		</tr>
		<tr height="32">
