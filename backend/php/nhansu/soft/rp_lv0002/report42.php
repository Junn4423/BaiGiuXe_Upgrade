...
<tr>
<td colspan="5" align="center" valign="middle"><strong><span style="font-size: large;font-size:24px">DANH SÁCH CHI LƯƠNG ĐỢT 1 THÁNG <?php echo getmonth($motc_lv0013->lv004);?>/<?php echo getyear($motc_lv0013->lv004);?></span></strong></td>
</tr>
<tr>
...
<?php
$vstrReturn= $motc_lv0020->LV_LuongNganHangUngLuongTK1($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,$motc_lv0013,$motc_lv0020->optbh,$motc_lv0020->ismau);
echo $vstrReturn;
?>
