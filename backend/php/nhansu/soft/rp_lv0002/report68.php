...
<tr>
<td colspan="5" align="center" valign="middle"><strong><span style="font-size: large;font-size:24px"><input type="text" value="BẢNG LƯƠNG THÁNG 13 NĂM <?php echo getyear($motc_lv0013->lv004)-1;?>" style="border:0px #fff solid;width:100%;text-align:center;font:16px arial,tahoma;"/></span></strong></td>
</tr>
<tr>
...
<?php
$vstrReturn= $motc_lv0020->LV_LuongThuongThang13_TinhToanBanDau($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$motc_lv0020->optbh,$motc_lv0020->ismau);
echo $vstrReturn;
?>
