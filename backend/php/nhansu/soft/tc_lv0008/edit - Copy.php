...
if($vFlag==1)
{
		$lvtc_lv0008->lv002=$_POST['txtlv002'];
  ...
  <div class="story">
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
				  ...
				  <td  height="20px"><input  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" type="text" value="<?php echo (int)$lvtc_lv0008->lv003;?>">					 </td>
							  ...
							  <td  height="20px"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo (int)$lvtc_lv0008->lv005;?>" tabindex="10" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
							  
							   <tr>
							  <td  height="20px"><?php echo $vLangArr[20];?></td>
							  <td  height="20px"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo $lvtc_lv0008->lv006;?>" tabindex="11" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>		
							   <tr>
