...
/////////////init object//////////////
$motc_lv0008=new tc_lv0008($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Tc0010');
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$motc_lv0008->lv002=base64_decode( $_GET['ID']);
...
?>
				...
				<?php echo $motc_lv0008->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
