...
//////////////init object////////////////
$lvtc_lv0008=new tc_lv0008($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Tc0009');
  ...
  <div class="story">
    <h2 id="pageName"><?php echo $vLangArr[1];?></h2>
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
				  ...
				  <td  height="20px"><input  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" type="text" value="<?php echo $vlv003;?>">					 </td>
							  </tr>	
							  <tr>
							  ...
							  <table width="80%"><tr><td width="50%"><select name="txtlv007" id="txtlv007"  tabindex="12" maxlength="50" style="width:100%" onKeyPress="return CheckKeys(event,7,this)">
							   	<option value=""></option>
								<?php echo $lvtc_lv0008->LV_LinkField('lv007',$vlv007);?>
                              </select></td><td>
							  ...
							  <td  height="20px">
							  <table width="80%"><tr><td width="50%"><select name="txtlv008" id="txtlv008"  tabindex="13" maxlength="50" style="width:100%" onKeyPress="return CheckKeys(event,7,this)">
							   <option value=""></option>
								<?php echo $lvtc_lv0008->LV_LinkField('lv008',$vlv008);?>
                              </select></td><td>
							  <ul id="pop-nav2" lang="pop-nav2" onMouseOver="ChangeName(this,2)" onkeyup="ChangeName(this,2)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlv008_search" id="txtlv008_search" style="width:100%" onKeyUp="LoadPopup(this,'txtlv008','tc_lv0032','lv002')" onFocus="LoadPopup(this,'txtlv008','tc_lv0032','lv002')" tabindex="200" >
