...
{
$mohr_lv0042->lv001=$_GET['txtlv001'];
$mohr_lv0042->lv002= $_GET['ID'] ?? '';
$mohr_lv0042->lv003=$_GET['txtlv003'];
$mohr_lv0042->lv004=$_GET['txtlv004'];
$mohr_lv0042->lv005=$_GET['txtlv005'];
$mohr_lv0042->lv006=$_GET['txtlv006'];
$mohr_lv0042->lv007=$_GET['txtlv007'];
$mohr_lv0042->lv899=$_GET['txtlv899'];
$mohr_lv0042->lv801=$_GET['txtlv801'];
$mohr_lv0042->lv829=$_GET['txtlv829'];
$mohr_lv0042->DateFrom=$_GET['txtDateFrom'];
$vMonth=substr($_GET['txtDateFrom'],3,2);
$vYear=substr($_GET['txtDateFrom'],6,4);
$mohr_lv0042->DateTo=$_GET['txtDateTo'];
$mohr_lv0042->FullName=$_GET['txtFullName'];	
$vCondition=$mohr_lv0042->GetCondition();
$mojo_lv0016->LV_Load();
?>
<html>
<head>
...
<?php
$lvsql="select  A.*,C.lv002 TenNV,D.lv002 NoiDungPhat from hr_lv0042 A left join hr_lv0020 C on A.lv002=C.lv001 left join hr_lv0035 D on A.lv004=D.lv001 where 1=1 $vCondition order by A.lv004,A.lv006";
...
<tr>
	...
	<td style="font-size: 12px;font-family:arial,times new roman; border: 1px solid #000000;" align="center"><span style="font-family: &quot;Times New Roman&quot;; color: #000000;"><?php echo $mohr_lv0042->FormatView($vrow['lv006'],2);?></span></td>
	<td style="font-size: 12px;font-family:arial,times new roman; border: 1px solid #000000;" align="right"><span style="font-family: &quot;Times New Roman&quot;; color: #000000;"><?php echo $mohr_lv0042->FormatView($vrow['lv007'],20);?></span></td>
...
<td style="font-size: 12px;font-family:arial,times new roman; border: 1px solid #000000;" align="left"><span style="font-family: &quot;Times New Roman&quot;; color: #000000;"><br /></span></td>
<td style="font-size: 12px;font-family:arial,times new roman; border: 1px solid #000000;" align="left"><span style="font-family: &quot;Times New Roman&quot;; color: #000000;"><br /></span></td>
<td style="font-size: 12px;font-family:arial,times new roman; border: 1px solid #000000;" align="right"><span style="font-family: &quot;Times New Roman&quot;; color: #000000;"><?php echo $mohr_lv0042->FormatView($vSumAll,20);?></span></td>
<td style="font-size: 12px;font-family:arial,times new roman; border: 1px solid #000000;" align="left"><span style="font-family: &quot;Times New Roman&quot;; color: #000000;"><br /></span></td>
</tr>
<tr>
