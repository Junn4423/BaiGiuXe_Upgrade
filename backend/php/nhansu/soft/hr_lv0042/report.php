...
$mohr_lv0042->ArrFunc[11]=$vLangArr[27];
$mohr_lv0042->ArrFunc[12]=$vLangArr[28];
$mohr_lv0042->ArrFunc[13]=$vLangArr[29];
$mohr_lv0042->ArrFunc[14]=$vLangArr[30];
$mohr_lv0042->ArrFunc[15]=$vLangArr[31];
////Other
$mohr_lv0042->ArrOther[1]=$vLangArr[25];
$mohr_lv0042->ArrOther[2]=$vLangArr[26];
//////Delete message///
$lvMessage=array();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$mohr_lv0042->lv002=base64_decode( $_GET['ID']);
...
?>
				...
				<?php echo $mohr_lv0042->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
