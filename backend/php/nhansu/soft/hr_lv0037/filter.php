					...
					<form action="#" name="frmfilter" method="post">
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
							  ...
							  <option value=""></option>
							  <option value="0" <?php echo ((int)$vlv003==0)?'selected="selected"':'';?>><?php echo $vLangArr[21];?></option>
							  <option value="1" <?php echo ((int)$vlv003==1)?'selected="selected"':'';?>><?php echo $vLangArr[22];?></option>
							  <option value="2" <?php echo ((int)$vlv003==2)?'selected="selected"':'';?>><?php echo $vLangArr[23];?></option>
							  <option value="3" <?php echo ((int)$vlv003==3)?'selected="selected"':'';?>><?php echo $vLangArr[24];?></option>
							  <option value="4" <?php echo ((int)$vlv003==4)?'selected="selected"':'';?>><?php echo $vLangArr[25];?></option>
							  <option value="5" <?php echo ((int)$lvhr_lv0037->lv003==5)?'selected="selected"':'';?>><?php echo "Qu? ngu?i ngh�o";?></option>
							    </select>
							  </td>
							</tr>
							<tr>
