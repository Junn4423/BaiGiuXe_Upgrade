...
//////////////init object////////////////
$lvki_lv0004=new ki_lv0004($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ki0004');
...
if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","KI0006.txt",$plang);

$curPage = (int)($_POST['curPg'] ?? 1);	
$vFlag   = (int)($_POST['txtFlag'] ?? 0);
$lvki_lv0004->lv001=InsertWithCheckExt('ki_lv0004', 'lv001', '',1);
$lvki_lv0004->lv002= $_GET['ID'] ?? '';
$lvki_lv0004->lv003=$_POST['txtlv003'];
$lvki_lv0004->lv004=$_POST['txtlv004'];
$lvki_lv0004->lv005=$_POST['txtlv005'];
$lvki_lv0004->lv006=$_POST['txtlv006'];

if($vFlag==1)
{
		
		$vresult=$lvki_lv0004->LV_Insert();
		if($vresult==true) {
...
{
	$data = array();
function add_person($lv002,$lv003, $lv004, $lv005,$lv006)
  {
  global $data;
  ...
  'lv006' => $lv006,
	 ...
	 if ( $_FILES['file']['tmp_name'] )
	  ...
	  foreach ($rows as $row)
	  {
		  ...
		  {
			//if(is_numeric($lv001))		
			add_person( $lv002,$lv003, $lv004, $lv005,$lv006);
		  }
	  }
	  $first_row = false;
	  }
	...
	$lvki_lv0002=new ki_lv0002($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Hr0020');
	foreach( $data as $row )
	{
		if(trim($row['lv003'])!="" && $row['lv003']!=NULL)
		{
			$lvki_lv0002->LV_LoadID($row['lv003']);
			if($lvki_lv0002->lv001!=NULL && $lvki_lv0002->lv001!='')
			{
				$lvki_lv0004->lv002= $_GET['ID'] ?? '';
				$lvki_lv0004->lv003=$row['lv003'];
				$lvki_lv0004->lv004=$row['lv004'];
				$lvki_lv0004->lv005=$row['lv005'];
				$lvki_lv0004->lv006=$row['lv006'];			
				$vCode=$lvki_lv0004->LV_CheckExistStaff( $_GET['ID'],$row['lv003']);
				if($vCode=="" || $vCode==NULL)
					$vresult=$lvki_lv0004->LV_Insert();
				else
				{
					$lvki_lv0004->lv001=$vCode;
					$vresult=$lvki_lv0004->LV_Update();
					}
    ...
    <h2 id="pageName"><?php echo $vLangArr[0];?></h2>
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<form action="#" name="frmadd" method="post"  enctype="multipart/form-data">
                       ...
                       ive                  alt="Save" title="<?php echo $vLangArr[1];?>" 
                      ...
                      <div id="enterline" style="display:block">
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
								...
								<td width="*%"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvki_lv0004->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvki_lv0004->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
							 	<td  height="20px"><?php echo $vLangArr[17];?></td>
								<td  height="20px">
									<table width="80%">
										<tr><td width="50%"><select  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:100%" onKeyPress="return CheckKey(event,7)"/><?php echo $lvki_lv0004->LV_LinkField('lv003',$lvki_lv0004->lv003);?>
												</select>
											</td>
											<td>
												<ul id="pop-nav" lang="pop-nav1" onMouseOver="ChangeName(this,1)" onkeyup="ChangeName(this,1)"> <li class="menupopT">
													<input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch1" id="txtlvsearch1" style="width:100%" onKeyUp="LoadPopup(this,'txtlv003','ki_lv0002','concat(lv002,@! @!,lv001)')" onFocus="if(this.value=='') { this.value=document.getElementById('txtlv002').value;}; LoadPopup(this,'txtlv003','ki_lv0002','concat(lv002,@! @!,lv001)')" tabindex="200" >
							...
							<tr>
							  ...
							  <td  height="20px"><input name="txtlv004" type="text" id="txtlv004" value="<?php echo ($lvki_lv0004->lv004=='')?1:$lvki_lv0004->lv004;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
							<tr>
							  <td  height="20px"><?php echo $vLangArr[19];?></td>
							  <td  height="20px"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo $lvki_lv0004->lv005;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[20];?></td>
							  <td  height="20px"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo $lvki_lv0004->lv006;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							</tr>
							<tr>
