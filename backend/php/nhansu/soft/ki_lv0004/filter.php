...
//////////////init object////////////////
$lvki_lv0004=new ki_lv0004($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Tc0014');
					...
					<form action="#" name="frmfilter" method="post">
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
							  ...
							  <td  height="20px"> <table width="80%">
					<tr><td width="50%"><select  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:100%" onKeyPress="return CheckKey(event,7)"/>
					<option value=""></option>
					<?php echo $lvki_lv0004->LV_LinkField('lv003',$vlv003);?>
							</select></td>
				  <td>
							  <ul id="pop-nav" lang="pop-nav1" onMouseOver="ChangeName(this,1)" onkeyup="ChangeName(this,1)"> <li class="menupopT">
							     <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch1" id="txtlvsearch1" style="width:100%" onKeyUp="LoadPopup(this,'txtlv003','ki_lv0001','concat(lv002,@! @!,lv001)')" onFocus="LoadPopup(this,'txtlv003','ki_lv0001','concat(lv002,@! @!,lv001)')" tabindex="200" >
