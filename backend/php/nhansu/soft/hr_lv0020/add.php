...
function isphone(s){
	...
	function uploadCCCD(){
		...
		.then(data => {
			...
			document.querySelector('[name="txtlv012"]').value = "CỤC TRƯỞNG CỤC CẢNH SÁT";
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
							  <td><?php echo $vLangArr[21];?></td>
								...
								<input onchange="uploadAvataNhanVien()" type="file" name="userfile" id="userfile"/>
							...
							<tr>
								...
								<div style="display: flex; align-items: center; gap: 10px;">
									<input name="txtlv010" type="text" id="txtlv010"
										   value="<?php echo $lvhr_lv0020->lv010;?>"
										   tabindex="14" maxlength="15" style="width: 60%; padding: 5px;"
										   onKeyPress="return CheckKey(event,7)" />

									<!-- Tùy biến giao diện file input -->
									<label for="anhcmnd" style="
									...
									<input type="file" id="anhcmnd" onchange="uploadCCCD()" style="display: none;" />
								</div>
							</td>
							...
							<tr>
							  ...
							  <td  height="20"><select name="txtlv017" id="txtlv017"  tabindex="27"  style="width:80%" onKeyPress="return CheckKey(event,7)">
							  <?php echo $lvhr_lv0020->LV_LinkField('lv017',$lvhr_lv0020->lv017);?>
							  </select></td>
							...
							<tr>
							  ...
							  <td  height="20"><table style="width:80%"><tr><td style="width:50%">
							  <select name="txtlv042" type="text" id="txtlv042"  value="<?php echo $lvhr_lv0020->lv042;?>" tabindex="36" maxlength="6" style="width:100%" onkeypress="return CheckKeys(event,7,this)" />
							  <option value=""></option>
							...
							<tr>
								...
								<td height="20">
								<table style="width:80%"><tr><td style="width:50%">
								<select name="txtlv062" type="text" id="txtlv062"  value="<?php echo $lvhr_lv0020->lv042;?>" tabindex="36" maxlength="6" style="width:100%" onkeypress="return CheckKeys(event,7,this)" />
									<option value=""></option>
							...
							<tr>
								...
								<td height="20">
									<select name="txtlv064" id="txtlv064"   tabindex="6"  style="width:80%" onkeypress="return CheckKey(event,7)">
										...
										<?php echo $lvhr_lv0020->LV_LinkField('lv064',$lvhr_lv0020->lv064);?>
