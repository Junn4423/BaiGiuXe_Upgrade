...
////Init object//////////////
		$mots_lv0014 = new ts_lv0014($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ts0014');	
/////////Varian////////////////		
...
<body onLoad="moveImgPrint()" onResize="moveImgPrint()">
	<table border="0" cellpadding="0" cellspacing="0" width="740px" align="center">
	    ...
	    <td align="center" colspan="6"><table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td align="center" valign="middle"><img  src="<?php echo $mots_lv0014->GetLogo();?>" /></td>
              </tr>
              <tr>
		...
		<tr height="40px">
			<td width="399" valign="middle" class="address">
				<div id="addr" align="left" style="width:480px;">
					<?php echo $mots_lv0014->GetCompany();?>
				<br><?php echo $vLangArr[18].":".$mots_lv0014->GetAddress();?>	
					<br><?php echo $vLangArr[15].":".$mots_lv0014->GetPhone()."&nbsp;&nbsp;&nbsp;".$vLangArr[16].":".$mots_lv0014->GetFax();?>
		  </div></td>
			...
			<td height="20px" colspan="6" align="center" class="normaltext">
				<?php 
						switch($vOptRun)
							{
								case 2:
							$strDataShow = $mots_lv0014->PrintInOutPutInStock($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),$vexist);								
									break;
								case 3:
							$strDataShow = $mots_lv0014->PrintInOutPutInStockDetail($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),0,"","","","","","","",$vexist);
									break;
							}
