...
require_once("../../clsall/cr_lv0341.php");
...
$mowh_lv0021=new wh_lv0021($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Cr0341');
...
$mocr_lv0341=new cr_lv0341($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Cr0341');
...
if($mowh_lv0021->GetView()==1)
{
    ...
    $mocr_lv0341->DefaultFieldList="lv299,lv026,lv013,lv011,lv914,lv012,lv152,lv061,lv008,lv009,lv139,lv049,lv154,lv155,lv004,lv204,lv005,lv006,lv054,lv162,lv163,lv062,lv063";//
    //////////////////////////////////////////////////////////////////////////////////////////////////////
    $mocr_lv0341->ArrPush[0]=$vLangArr[17];
    $mocr_lv0341->ArrPush[1]=$vLangArr[18];
    $mocr_lv0341->ArrPush[2]=$vLangArr[19];
    $mocr_lv0341->ArrPush[3]=$vLangArr[20];
    $mocr_lv0341->ArrPush[4]=$vLangArr[21];
    $mocr_lv0341->ArrPush[5]=$vLangArr[22];
    $mocr_lv0341->ArrPush[6]=$vLangArr[23];
    $mocr_lv0341->ArrPush[7]=$vLangArr[24];
    $mocr_lv0341->ArrPush[8]=$vLangArr[25];
    $mocr_lv0341->ArrPush[9]=$vLangArr[26];
    $mocr_lv0341->ArrPush[10]=$vLangArr[27];
    $mocr_lv0341->ArrPush[11]=$vLangArr[28];
    $mocr_lv0341->ArrPush[12]=$vLangArr[29];
    $mocr_lv0341->ArrPush[13]=$vLangArr[30];
    $mocr_lv0341->ArrPush[14]=$vLangArr[31];
    $mocr_lv0341->ArrPush[15]=$vLangArr[32];
    $mocr_lv0341->ArrPush[16]=$vLangArr[33];
    $mocr_lv0341->ArrPush[17]=$vLangArr[34];
    $mocr_lv0341->ArrPush[18]=$vLangArr[35];
    $mocr_lv0341->ArrPush[19]=$vLangArr[36];
    $mocr_lv0341->ArrPush[20]=$vLangArr[37];
    $mocr_lv0341->ArrPush[21]=$vLangArr[38];
    $mocr_lv0341->ArrPush[22]=$vLangArr[39];
    $mocr_lv0341->ArrPush[23]=$vLangArr[40];
    $mocr_lv0341->ArrPush[24]=$vLangArr[41];
    $mocr_lv0341->ArrPush[25]=$vLangArr[42];
    $mocr_lv0341->ArrPush[26]=$vLangArr[43];
    $mocr_lv0341->ArrPush[27]=$vLangArr[44];
    $mocr_lv0341->ArrPush[28]=$vLangArr[45];
    $mocr_lv0341->ArrPush[29]=$vLangArr[46];
    $mocr_lv0341->ArrPush[30]=$vLangArr[47];
    $mocr_lv0341->ArrPush[31]=$vLangArr[48];
    $mocr_lv0341->ArrPush[32]=$vLangArr[49];
    $mocr_lv0341->ArrPush[33]=$vLangArr[50];
    $mocr_lv0341->ArrPush[34]=$vLangArr[51];
    $mocr_lv0341->ArrPush[35]=$vLangArr[52];
    $mocr_lv0341->ArrPush[36]=$vLangArr[53];
    $mocr_lv0341->ArrPush[37]=$vLangArr[54];
    $mocr_lv0341->ArrPush[38]=$vLangArr[55];
    $mocr_lv0341->ArrPush[39]=$vLangArr[56];
    $mocr_lv0341->ArrPush[40]=$vLangArr[57];
    $mocr_lv0341->ArrPush[41]=$vLangArr[58];
    $mocr_lv0341->ArrPush[42]=$vLangArr[59];
    $mocr_lv0341->ArrPush[43]=$vLangArr[60];
    $mocr_lv0341->ArrPush[44]=$vLangArr[61];
    $mocr_lv0341->ArrPush[45]=$vLangArr[62];
    $mocr_lv0341->ArrPush[46]=$vLangArr[63];
    $mocr_lv0341->ArrPush[47]=$vLangArr[64];
    $mocr_lv0341->ArrPush[48]=$vLangArr[65];
    $mocr_lv0341->ArrPush[49]=$vLangArr[66];
    $mocr_lv0341->ArrPush[50]=$vLangArr[67];
    $mocr_lv0341->ArrPush[51]=$vLangArr[68];
    $mocr_lv0341->ArrPush[52]=$vLangArr[69];
    $mocr_lv0341->ArrPush[53]=$vLangArr[70];
    $mocr_lv0341->ArrPush[54]=$vLangArr[71];
    $mocr_lv0341->ArrPush[55]=$vLangArr[72];
    $mocr_lv0341->ArrPush[56]=$vLangArr[73];
    $mocr_lv0341->ArrPush[57]=$vLangArr[74];
    $mocr_lv0341->ArrPush[58]=$vLangArr[75];
    $mocr_lv0341->ArrPush[59]=$vLangArr[76];
    $mocr_lv0341->ArrPush[60]=$vLangArr[77];
    $mocr_lv0341->ArrPush[61]=$vLangArr[78];
    $mocr_lv0341->ArrPush[62]=$vLangArr[79];
    $mocr_lv0341->ArrPush[63]=$vLangArr[80];
    $mocr_lv0341->ArrPush[64]=$vLangArr[81];

    $mocr_lv0341->ArrPush[65]=$vLangArr[82];
    $mocr_lv0341->ArrPush[66]=$vLangArr[83];
    $mocr_lv0341->ArrPush[69]=$vLangArr[91];
    $mocr_lv0341->ArrPush[71]=GetLangExcept('ExtraDiscount',$plang);
    $mocr_lv0341->ArrPush[200]='Chức năng';
    $mocr_lv0341->ArrPush[100]='Mã cha';

    $mocr_lv0341->ArrPush[81]=$vLangArr[92];
    $mocr_lv0341->ArrPush[82]=$vLangArr[93];
    $mocr_lv0341->ArrPush[83]=$vLangArr[94];
    $mocr_lv0341->ArrPush[84]=$vLangArr[95];
    $mocr_lv0341->ArrPush[85]=$vLangArr[96];
    $mocr_lv0341->ArrPush[86]=$vLangArr[97];
    $mocr_lv0341->ArrPush[87]=$vLangArr[98];
    $mocr_lv0341->ArrPush[88]=$vLangArr[99];
    $mocr_lv0341->ArrPush[89]=$vLangArr[100];
    $mocr_lv0341->ArrPush[90]=$vLangArr[101];
    $mocr_lv0341->ArrPush[91]=$vLangArr[102];
    $mocr_lv0341->ArrPush[92]=$vLangArr[103];
    $mocr_lv0341->ArrPush[93]=$vLangArr[104];
    $mocr_lv0341->ArrPush[94]=$vLangArr[105];
    $mocr_lv0341->ArrPush[95]=$vLangArr[106];
    $mocr_lv0341->ArrPush[96]=$vLangArr[107];

    $mocr_lv0341->ArrPush[102]=$vLangArr[108];
    $mocr_lv0341->ArrPush[103]=$vLangArr[109];
    $mocr_lv0341->ArrPush[104]=$vLangArr[110];
    $mocr_lv0341->ArrPush[105]=$vLangArr[111];

    $mocr_lv0341->ArrPush[111]=$vLangArr[112];
    $mocr_lv0341->ArrPush[112]=$vLangArr[113];
    $mocr_lv0341->ArrPush[113]=$vLangArr[114];
    $mocr_lv0341->ArrPush[114]=$vLangArr[115];
    $mocr_lv0341->ArrPush[115]=$vLangArr[116];
    $mocr_lv0341->ArrPush[116]=$vLangArr[117];
    $mocr_lv0341->ArrPush[117]=$vLangArr[118];
    $mocr_lv0341->ArrPush[118]=$vLangArr[119];
    $mocr_lv0341->ArrPush[119]=$vLangArr[120];
    $mocr_lv0341->ArrPush[120]=$vLangArr[121];
    $mocr_lv0341->ArrPush[121]=$vLangArr[122];
    $mocr_lv0341->ArrPush[122]=$vLangArr[123];
    $mocr_lv0341->ArrPush[123]=$vLangArr[124];
    $mocr_lv0341->ArrPush[124]=$vLangArr[125];
    $mocr_lv0341->ArrPush[125]=$vLangArr[126];
    $mocr_lv0341->ArrPush[126]=$vLangArr[127];
    $mocr_lv0341->ArrPush[127]=$vLangArr[128];
    $mocr_lv0341->ArrPush[128]=$vLangArr[129];
    $mocr_lv0341->ArrPush[129]=$vLangArr[130];
    $mocr_lv0341->ArrPush[130]=$vLangArr[131];
    $mocr_lv0341->ArrPush[131]=$vLangArr[132];
    $mocr_lv0341->ArrPush[132]=$vLangArr[133];
    $mocr_lv0341->ArrPush[133]=$vLangArr[134];
    $mocr_lv0341->ArrPush[134]=$vLangArr[135];
    $mocr_lv0341->ArrPush[135]=$vLangArr[136];
    $mocr_lv0341->ArrPush[136]=$vLangArr[137];
    $mocr_lv0341->ArrPush[137]=$vLangArr[138];
    $mocr_lv0341->ArrPush[138]=$vLangArr[139];
    $mocr_lv0341->ArrPush[139]=$vLangArr[140];
    $mocr_lv0341->ArrPush[140]='Code';
    $mocr_lv0341->ArrPush[141]='Warranty Time';
    $mocr_lv0341->ArrPush[142]='Fault Product Type';
    $mocr_lv0341->ArrPush[143]='Q.ty Fault Product';
    $mocr_lv0341->ArrPush[144]='Thời gian trả SP lỗi';
    $mocr_lv0341->ArrPush[145]='Mã hàng NCC';
    $mocr_lv0341->ArrPush[170]='STT';
    if($plang=='EN')
    {
        $mocr_lv0341->ArrPush[300]='Supplier';
        $mocr_lv0341->ArrPush[163]='Price('.$mowh_lv0021->lv012.')';
        $mocr_lv0341->ArrPush[164]='Amount('.$mowh_lv0021->lv012.')';
        $mocr_lv0341->ArrPush[205]='Our ref. Q\'ty';
        $mocr_lv0341->ArrPush[7]='Price('.$mowh_lv0021->lv016.')';
        $mocr_lv0341->ArrPush[55]='Amount('.$mowh_lv0021->lv016.')';
    }
    else
    {
        $mocr_lv0341->ArrPush[300]='Mã NCC';
        $mocr_lv0341->ArrPush[163]='Đơn giá('.$mowh_lv0021->lv012.')';
        $mocr_lv0341->ArrPush[164]='Thành tiền('.$mowh_lv0021->lv012.')';
        $mocr_lv0341->ArrPush[205]='S\'lượng<br/>Our ref.';
        $mocr_lv0341->ArrPush[7]='Đơn giá('.$mowh_lv0021->lv016.')';
        $mocr_lv0341->ArrPush[55]='Thành tiền('.$mowh_lv0021->lv016.')';
    }
    $mocr_lv0341->ArrPush[146]='Charge Express Fault Product';
    $mocr_lv0341->ArrPush[147]='Name Express Fault Product';
    $mocr_lv0341->ArrPush[148]='Booking Express Bill No.';
    $mocr_lv0341->ArrPush[149]='SHIPPER';
    $mocr_lv0341->ArrPush[150]='Date (Loading)';
    $mocr_lv0341->ArrPush[151]='Date Estimated (Loading)';
    $mocr_lv0341->ArrPush[152]='AGENT SHIPPING';
    $mocr_lv0341->ArrPush[153]='Type (Our ref.)';
    $mocr_lv0341->ArrPush[154]='Sample Q\'ty ';
    $mocr_lv0341->ArrPush[155]='Model Sup';
    $mocr_lv0341->ArrPush[156]='Brand Sup';
    $mocr_lv0341->ArrPush[157]='Extra Q\'ty';
    $mocr_lv0341->ArrPush[158]='Date issue';
    $mocr_lv0341->ArrPush[159]='Catalogue';
    $mocr_lv0341->ArrPush[171]='Drawing/Construction';
    $mocr_lv0341->ArrPush[172]='TEST IP (54/65/67/68)';
    $mocr_lv0341->ArrPush[173]='IES File & Test Integrating Sphere';
    $mocr_lv0341->ArrPush[174]='Manual & maintaince';
    $mocr_lv0341->ArrPush[175]='CER. LM80 Chip';
    $mocr_lv0341->ArrPush[176]='CER.  (Pdf) IEC/EN/EMC/Driver';
    $mocr_lv0341->ArrPush[177]='Picture  Goods/ Packing ';
    $mocr_lv0341->ArrPush[178]='Picture  chip/driver/ Acessories';
    $mocr_lv0341->ArrPush[179]='Sample Date (Loading)';
    $mocr_lv0341->ArrPush[180]='Sample Express (Loading)';
    $mocr_lv0341->ArrPush[181]='Sample Delivery Date';
    $mocr_lv0341->ArrPush[182]='Sample Second Delivery Date';
    $mocr_lv0341->ArrPush[183]='Sample Loading By';
    $mocr_lv0341->ArrPush[184]='Sample Loading  Place';
    $mocr_lv0341->ArrPush[185]='Sample Loading type DDP';
    $mocr_lv0341->ArrPush[186]='Booking Bill Draf No.';
    $mocr_lv0341->ArrPush[187]='Country';
    $mocr_lv0341->ArrPush[188]='IV No';
    $mocr_lv0341->ArrPush[189]='CO No';
    $mocr_lv0341->ArrPush[190]='CO E/D No';
    $mocr_lv0341->ArrPush[191]='CQ No.';
    $mocr_lv0341->ArrPush[192]='BL No.';
    $mocr_lv0341->ArrPush[193]='PL No.';
    $mocr_lv0341->ArrPush[194]='SUR/Orgin B/L No.';
    $mocr_lv0341->ArrPush[195]='CER. Warranty No.';
    $mocr_lv0341->ArrPush[915]='Proj.';
    $mocr_lv0341->ArrPush[300]='SELLER';
    
    $mocr_lv0341->ArrFunc[0]='//Function';

    $mocr_lv0341->ArrFunc[1]=$vLangArr[2];
    $mocr_lv0341->ArrFunc[2]=$vLangArr[4];
    $mocr_lv0341->ArrFunc[3]=$vLangArr[6];
    $mocr_lv0341->ArrFunc[4]=$vLangArr[7];
    $mocr_lv0341->ArrFunc[5]=GetLangExcept('Rpt',$plang);
    $mocr_lv0341->ArrFunc[6]=GetLangExcept('Apr',$plang);
    $mocr_lv0341->ArrFunc[7]=GetLangExcept('UnApr',$plang);
    $mocr_lv0341->ArrFunc[8]=$vLangArr[10];
    $mocr_lv0341->ArrFunc[9]=$vLangArr[12];
    $mocr_lv0341->ArrFunc[10]=$vLangArr[0];
    $mocr_lv0341->ArrFunc[11]=$vLangArr[86];
    $mocr_lv0341->ArrFunc[12]=$vLangArr[87];
    $mocr_lv0341->ArrFunc[13]=$vLangArr[88];
    $mocr_lv0341->ArrFunc[14]=$vLangArr[89];
    $mocr_lv0341->ArrFunc[15]=$vLangArr[90];
    ////Other
    $mocr_lv0341->ArrOther[1]=$vLangArr[84];
    $mocr_lv0341->ArrOther[2]=$vLangArr[85];
    ...
    {
        //////////////////////////////////////////////////////////////////////////////////////////////////////
        $mocr_lv0341->LoadSaveOperationLocal($_SESSION['ERPSOFV2RUserID'],'cr_lv0341_1',$strCode);
        //////////////////////////////////////////////////////////////////////////////////////////////////////
        $vFieldList=$mocr_lv0341->ListView;
        $curPage = $mocr_lv0341->CurPage;
        $maxRows =$mocr_lv0341->MaxRows;
        $vOrderList=$mocr_lv0341->ListOrder;
        $vSortNum=$mocr_lv0341->SortNum;
    }
    elseif($_POST["txtFlag"]==2)
    {
        ...
        $mocr_lv0341->SaveOperation($_SESSION['ERPSOFV2RUserID'],'cr_lv0341_1',$vFieldList,(int)$_POST['lvmaxrow'],(int)$_POST['curPg'],$vOrderList,(int)$_POST['lvsort']);
    }
?>
<html>
<head>
...
<div id="idhdsl" style="display:none;clear:both;width:100%;overflow:hidden">
    ...
    <form name="frmchoose" method="post" id="frmchoose" enctype="multipart/form-data">
                ...
                <tr>
                    ...
                    <div><div style="float:right"><?php echo $mocr_lv0341->ListFieldSave('document.frmchoose',$vFieldList, $maxRows,$vOrderList,$vSortNum);?>
                                    <?php
...
?>
	...
	$mocr_lv0341->mowh_lv0021=$mowh_lv0021;
    ...
    <tr>
        ...
        <td nowrap style="font-family: Arial; font-size: 12px; border-top: 2px solid #000000; border-bottom: 2px solid #000000; border-right: 2px solid #000000;" align="center" valign="top" bgcolor="#FFC000"><strong><span style="color: #000000; font-size: 12px;">Date Issuse</span></strong></td>        
        <td nowrap style="font-family: Arial; font-size: 12px;" align="left" valign="center"><span style="color: #000000;"></span></td>-->
        <td width="*"></td>
    </tr>
    <tr>
    ...
    <?php
    $vi=0;
    $vArrDinhKem1=Array();//$lvcr_lv0171->LV_GetDinhKemGMH($mowh_lv0021->lv087,'0');
...
//////// Chi tiền đợt 3
    ...
    <tr><td colspan="20">
        <?php 
        $mocr_lv0341->LoadSaveOperation($_SESSION['ERPSOFV2RUserID'],'cr_lv0341_1');
        //////////////////////////////////////////////////////////////////////////////////////////////////////
        $mocr_lv0341->lv002= $_GET['ID'] ?? '';
        $vFieldList=$mocr_lv0341->ListView;
        $curPage = $mocr_lv0341->CurPage;
        $maxRows =$mocr_lv0341->MaxRows;
        $vOrderList=$mocr_lv0341->ListOrder;
        $mocr_lv0341->DefaultFieldList="lv299,lv052,lv157,lv011,lv914,lv012,lv152,lv061,lv008,lv009,lv139,lv049,lv154,lv155,lv004,lv204,lv005,lv006,lv054,lv162,lv163,lv062,lv063";//
       // $vFieldList=$mocr_lv0341->DefaultFieldList;
        $mocr_lv0341->lang='EN';
        $mocr_lv0341->isSTT=14;
        $mocr_lv0341->strTD='';
        echo $mocr_lv0341->LV_BuilListReportOtherMPGroup($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
    </td></tr>
    <tr>
