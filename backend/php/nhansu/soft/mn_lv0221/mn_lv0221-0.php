...
$momn_lv0221->ArrPush[13]=$vLangArr[30];
$momn_lv0221->ArrPush[14]='Đã hoàn thành';
$momn_lv0221->ArrPush[15]=$vLangArr[32];
$momn_lv0221->ArrPush[16]=$vLangArr[33];
$momn_lv0221->ArrPush[17]=$vLangArr[34];
$momn_lv0221->ArrPush[910]='Tên dự án';
...
$momn_lv0221->ArrFunc[6]=GetLangExcept('Apr',$plang);
$momn_lv0221->ArrFunc[7]=GetLangExcept('UnApr',$plang);
$momn_lv0221->ArrFunc[8]=$vLangArr[10];
$momn_lv0221->ArrFunc[9]=$vLangArr[12];
$momn_lv0221->ArrFunc[10]=$vLangArr[0];
$momn_lv0221->ArrFunc[11]=$vLangArr[44];
$momn_lv0221->ArrFunc[12]=$vLangArr[45];
$momn_lv0221->ArrFunc[13]=$vLangArr[46];
$momn_lv0221->ArrFunc[14]=$vLangArr[47];
$momn_lv0221->ArrFunc[15]=$vLangArr[48];

////Other
$momn_lv0221->ArrOther[1]=$vLangArr[42];
$momn_lv0221->ArrOther[2]=$vLangArr[43];
//////Delete message///
$lvMessage=array();
...
if($flagID>0)
{
	...
	$momn_lv0221->lv015=$_POST['txtlv015'];
	$momn_lv0221->lv016=$_POST['txtlv016'];
	$momn_lv0221->lv017=$_POST['txtlv017'];
	$momn_lv0221->lv018=$_POST['txtlv018'];
	$momn_lv0221->lv019=$_POST['txtlv019'];
	$momn_lv0221->lv020=$_POST['txtlv020'];
	$momn_lv0221->lv021=$_POST['txtlv021'];
	$momn_lv0221->lv022=$_POST['txtlv022'];
	$momn_lv0221->lv023=$_POST['txtlv023'];
	$momn_lv0221->lv024=$_POST['txtlv024'];
	$momn_lv0221->lv025=$_POST['txtlv025'];
...
if($vkeep==1)
{
	$momn_lv0221->tv001=$vkeep;
	$momn_lv0221->tv002=$_POST['qxtlv002'];
	$momn_lv0221->tv003=$_POST['qxtlv003'];
	$momn_lv0221->tv008=$_POST['qxtlv008'];
	$momn_lv0221->tv015=$_POST['qxtlv015'];
	$momn_lv0221->tv022=$_POST['qxtlv022'];
	$momn_lv0221->tv016=$_POST['qxtlv016_1']." ".$_POST['qxtlv016_2'];
	$momn_lv0221->tv017=$_POST['qxtlv017_1']." ".$_POST['qxtlv017_2'];
	$momn_lv0221->tv018=$_POST['qxtlv018_1']." ".$_POST['qxtlv018_2'];
	$momn_lv0221->tv019=$_POST['qxtlv019_1']." ".$_POST['qxtlv019_2'];
}
else
{
	$momn_lv0221->tv008=getInfor($_SESSION['ERPSOFV2RUserID'],2);
}
if(!isset($_POST['txtDateFrom']))
{
	$vYear=getyear($momn_lv0221->DateCurrent);
	$vMonth=getmonth($momn_lv0221->DateCurrent);
	$vDay=getday($momn_lv0221->DateCurrent);
	if($vDay==1)
	{
		if($vMonth==1)
...
/*
if($momn_lv0221->GetApr()<>1 || $momn_lv0221->GetUnApr()<>1)
{
	$momn_lv0221->lv008=$momn_lv0221->LV_UserID;
	if($momn_lv0221->GetApr()==1)
	{
		
		$momn_lv0221->ListStaff=$momn_lv0221->Get_User($_SESSION['ERPSOFV2RUserID'],'lv002');

		$momn_lv0221->lv029ex=$momn_lv0221->ListStaff;
	}
}
*/

$momn_lv0221->trangthai='0';
$totalRowsC=$momn_lv0221->GetCount();
$momn_lv0221->ListPBH='';
$momn_lv0221->trangthai='1';
$totalRowsC1=$momn_lv0221->GetCount();
$momn_lv0221->ListPBH='';
$momn_lv0221->trangthai='';
$totalRowsC2=$momn_lv0221->GetCount();
$maxPages = 10;
if($curPage=="") 
$curPage = 1;
...
function RunFunction(vID,func)
{
	...
	{
		case 'child':
			var str="<br><iframe height=1900 marginheight=0 marginwidth=0 frameborder=0 src=mn_lv0221?func="+func+"&ID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?>\" class=lvframe></iframe>";
			break;
		default:
			var str="<br><iframe height=1900 marginheight=0 marginwidth=0 frameborder=0 src=mn_lv0221?func="+func+"&ID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?>\" class=lvframe></iframe>";
			break;
...
function Report(vValue)
{
	...
	o.target="_blank";
	o.action="<?php echo $vDir;?>mn_lv0221?func=rpt&ID="+vValue+"&lang=<?php echo $plang;?>";
	o.submit();
}
...
<?php
if($momn_lv0221->GetApr()==0 && $momn_lv0221->GetUnApr()==0)
{
	$momn_lv0221->DefaultFieldList='lv001,lv015,lv829,lv003,lv022,lv025,lv016,lv017,lv098,lv008,lv013,lv018,lv019,lv021';
}
