...
$mohr_lv0221=new hr_lv0221($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Hr0221');
...
<tr>
<td style="font-size:14px;font-family:arial, times new roman;" colspan="7" height="22" align="left" valign="bottom"><span style="color: #000000;">T&ecirc;n người li&ecirc;n hệ: <?php echo $mohr_lv0221->lv004;?> <?php echo (trim($mohr_lv0221->lv037)!='')?'SĐT: '.$mohr_lv0221->lv037:'';?> <?php echo (trim($mohr_lv0221->lv040)!='')?'Email: '.$mohr_lv0221->lv040:'';?></span><span style="color: #000000;"></span></td>
</tr>
<tr>
