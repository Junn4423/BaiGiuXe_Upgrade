...
#echo base64_encode('mn_lv0221/mn_lv0221-1.php');
//////Delete message///
$lvMessage=array();
...
//PO VT
$momn_lv0221->TypePO='1';
$momn_lv0221->trangthai2='';
$totalRowsC=$momn_lv0221->GetCount();
//PO VT Phụ
$momn_lv0221->TypePO='4';
$momn_lv0221->trangthai2='';
$totalRowsC4=$momn_lv0221->GetCount();
// PO TN
$momn_lv0221->TypePO='2';
//$momn_lv0221->trangthai2='0,1';
$totalRowsC1=$momn_lv0221->GetCount();

// PO NN
$momn_lv0221->TypePO='3';
$momn_lv0221->trangthai2='';
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					...
					<table border="0" width="100%">
								...
								<tr>
									<td align="left" id="TabViewHr">
										<ul class="IdTabViewHr">
											<?php
											$vMaThamChieu=$momn_lv0221->Get_User($_SESSION['ERPSOFV2RUserID'],'lv904');
						...
						<?php
							...
							?>
						<div id="cl_1_1">
							<input type="hidden" name="cl_1_2" id="cl_1_2" value="home.php?lang=VN&opt=27&item=&link=bW5fbHYwMjIxL21uX2x2MDIyMS0xLnBocA==&TypePO=2"/>
							<iframe name="cl_1_3" id="cl_1_3" height=1000 marginheight=0 marginwidth=0 frameborder=0 title="" src="home.php?lang=VN&opt=27&item=&link=bW5fbHYwMjIxL21uX2x2MDIyMS0xLnBocA==&TypePO=2" class=lvframe></iframe>
						</div>	
						<div id="cl_2_1">
							<input type="hidden" name="cl_2_2" id="cl_2_2" value="home.php?lang=VN&opt=27&item=&link=bW5fbHYwMjIxL21uX2x2MDIyMS0xLnBocA==&TypePO=3"/>
