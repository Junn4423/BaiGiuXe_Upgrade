...
require_once("../../clsall/tc_lv0018.php");
//////////////init object////////////////
$lvtc_lv0018=new tc_lv0018($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Tc0018');
/////////Get ID///////////////
$lvtc_lv0018->lv001=$_GET['ChildID'];
...
if($vFlag==1)
{
		$lvtc_lv0018->lv002=$_POST['txtlv002'];
		$lvtc_lv0018->lv003=$_POST['txtlv003'];
		$vresult=$lvtc_lv0018->LV_Update();
		if($vresult==true) {
...
$lvtc_lv0018->LV_LoadID($lvtc_lv0018->lv001);
...
function isnumber(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvtc_lv0018->lv002;?>";
		o.txtlv003.value="<?php echo $lvtc_lv0018->lv003;?>";			
		o.txtlv002.focus();
	}
	function Cancel()
	{
						...
						?>
							...
							<tr>
								...
								<td width="*%"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvtc_lv0018->lv001;?>" tabindex="5" maxlength="32" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvtc_lv0018->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
<tr>
							  <td  height="20px"><?php echo $vLangArr[17];?></td>
				  <td  height="20px"><textarea  name="txtlv003" rows="4"  id="txtlv003" style="width:80%"  tabindex="7" onKeyPress="return CheckKey(event,7)" ><?php echo $lvtc_lv0018->lv003;?></textarea></td>
						  </tr>	
							<tr>
