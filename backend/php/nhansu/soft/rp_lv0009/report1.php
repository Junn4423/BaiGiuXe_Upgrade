			...
			<td height="20px" colspan="6" align="center" class="normaltext">
				<?php 
						switch($vOptRun)
							{
								case 2:
							$strDataShow = $morp_lv0009->PrintInOutPutInStockDetail($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),$vlv006,$vlv007,$vlv008,$vlv009);
									break;
								case 3:
							$strDataShow = $morp_lv0009->PrintInOutPutInStockDetail($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),$vlv006,$vlv007,$vlv008,$vlv009);									
									break;
