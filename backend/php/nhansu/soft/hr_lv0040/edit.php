...
*/
session_start();
//require_once("../../clsall/hr_lv0040.php");
...
require_once("../../clsall/hr_lv0040.php");
//////////////init object////////////////
$lvhr_lv0040=new hr_lv0040($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Hr0040');
/////////Get ID///////////////
$lvhr_lv0040->lv001= $_GET['ID'] ?? '';
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","HR0159.txt",$plang);
...
if($vFlag==1)
{
		$lvhr_lv0040->lv002=$_POST['txtlv002'];		
		$vresult=$lvhr_lv0040->LV_Update();
		if($vresult==true) {
...
$lvhr_lv0040->LV_LoadID($lvhr_lv0040->lv001);
...
<script language="javascript">
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvhr_lv0040->lv002;?>";
		o.txtlv002.focus();
	}
	function Cancel()
	{
					...
					<?php		
						...
						?>
							...
							<tr>
							  ...
							  <td width="335"  height="20px"><input  name="txtlv001" type="text" id="txtlv001" readonly="true" value="<?php echo $lvhr_lv0040->lv001;?>" /></td>
							</tr>
						<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input  name="txtlv002" type="text" id="txtlv002" value="<?php echo $lvhr_lv0040->lv002;?>" tabindex="6" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
							<tr>
