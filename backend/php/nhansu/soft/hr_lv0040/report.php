...
/////////////init object//////////////
$mohr_lv0040=new hr_lv0040($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Hr0069');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","HR0158.txt",$plang);
...
$mohr_lv0040->ArrPush[4]=$vLangArr[22];
$mohr_lv0040->ArrPush[5]=$vLangArr[23];
$mohr_lv0040->ArrPush[6]=$vLangArr[24];
...
?>
				...
				<?php echo $mohr_lv0040->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
