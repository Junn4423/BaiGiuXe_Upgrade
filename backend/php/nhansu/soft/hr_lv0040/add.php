...
$lvhr_lv0040->lv001=$_POST['txtlv001'] ?? '';
$lvhr_lv0040->lv002=$_POST['txtlv002'] ?? '';
if($vFlag==1)
{
		
		$vresult=$lvhr_lv0040->LV_Insert();
		if($vresult==true) {
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
								...
								<td width="*%"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvhr_lv0040->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
							</tr>
							<tr>
