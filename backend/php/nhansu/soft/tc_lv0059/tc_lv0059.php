...
require_once($vDir."../clsall/tc_lv0059.php");
require_once($vDir."../clsall/jo_lv0016.php");
$motc_lv0059=new tc_lv0059($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Tc0029');
...
$motc_lv0059->ArrFunc[9]=$vLangArr[12];
...
$motc_lv0059->LoadAccess($molv_toolodbc,$datadate,'CHECKINOUT','SSN','CHECKTIME','CHECKTIME','CHECKTYPE');
*/
$mojo_lv0016->LV_Load();
$vServer=$mojo_lv0016->lv026;
$vUser=$mojo_lv0016->lv027;
$vPass=$mojo_lv0016->lv028;
$vDatabase=$mojo_lv0016->lv029;

$motc_lv0059->LV_LoadSQLServer($vServer,$vUser,$vPass,$vDatabase,(int)getYear($vdatadate),(int)getMonth($vdatadate),(int)getDay($vdatadate),$vopt);
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>
			...
			<table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
				  <td height="20px" colspan="3" align="right"><?php echo $motc_lv0059->LV_ViewHelp($vFieldList,'document.frmgeneral',$vOrderList);?></td>
			  </tr>
				<tr>
