					...
					<form action="#"   name="frmadd" id="frmadd"  method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
							  ...
							  <td  height="20"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)"/><?php echo $lvts_lv0031->LV_LinkField('lv003',$lvts_lv0031->lv003);?>
							  </select>	<br>
							  <table><tr><td>
...
<tr>
							...
							<tr>
							  ...
							  <ul id="pop-nav4" lang="pop-nav4" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch9" id="txtlvsearch9" tabindex="200" style="width:200px"onKeyPress="return CheckKey(event,7)" value="<?php echo $lvts_lv0031->lv009;?>" onKeyUp="LoadSelf(this,'txtlv009','hr_lv0018','lv002')" onFocus="LoadSelf(this,'txtlv009','hr_lv0018','lv002')">
