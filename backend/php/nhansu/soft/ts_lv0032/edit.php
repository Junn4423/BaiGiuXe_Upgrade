...
require_once("../../clsall/ts_lv0032.php");
//////////////init object////////////////
$lvts_lv0032=new ts_lv0032($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ts0029');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvts_lv0032->lv001=$_GET['ChildDetailID'];
if($plang=="") $plang="VN";
...
if($vFlag==1)
{
$lvts_lv0032->lv002=$_POST['txtlv002'];
$lvts_lv0032->lv003=$_POST['txtlv003'];
$lvts_lv0032->lv004=$_POST['txtlv004'];
$lvts_lv0032->lv005=$_POST['txtlv005'];
$lvts_lv0032->lv006=$_POST['txtlv006'];
$lvts_lv0032->lv007=$_POST['txtlv007'];
$lvts_lv0032->lv008=$_POST['txtlv008'];
$lvts_lv0032->lv009=$_POST['txtlv009'];
$lvts_lv0032->lv010=$_POST['txtlv010'];
$lvts_lv0032->lv011=$_POST['txtlv011'];
$lvts_lv0032->lv012=$_POST['txtlv012'];
$lvts_lv0032->lv013=$_POST['txtlv013'].' '.$_POST['txtlv013_'];
$lvts_lv0032->lv014=$_POST['txtlv014'];
$lvts_lv0032->lv015=$_POST['txtlv015'];
$lvts_lv0032->lv016=GetServerDate()." ".GetServerTime();
		
		$vresult=$lvts_lv0032->LV_UpdateEdit($_POST['txtlv004old'],$_POST['txtlv006old']);
		if($vresult==true) {
...
$lvts_lv0032->LV_LoadID($lvts_lv0032->lv001);
echo $lvts_lv0032->lv011;
					...
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvts_lv0032->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>		</td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[16];?></td>
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvts_lv0032->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[17];?></td>
							  <td  height="20"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)"/><?php echo $lvts_lv0032->LV_LinkField('lv003',$lvts_lv0032->lv003);?>
							  </select>	<br>
							  <table><tr><td>
...
<tr>
				              ...
				              <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvts_lv0032->lv004;?>"/></td>
</tr>							  
							<tr>
							  ...
							  <?php echo $lvts_lv0032->LV_LinkField('lv005',$lvts_lv0032->lv005);?>
							  ...
							  <td  height="20"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo (float)$lvts_lv0032->lv006;?>" tabindex="10" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
<tr>
							  ...
							  <?php echo $lvts_lv0032->LV_LinkField('lv007',$lvts_lv0032->lv007);?>
							  </select>	<br><table><tr><td>
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv008" id="txtlv008"   tabindex="12"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvts_lv0032->lv008;?>"/>							  </td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[23];?></td>
							  <td  height="20">
							    <input type="text" name="txtlv009" id="txtlv009" tabindex="13" style="width:80%"onKeyPress="return CheckKey(event,7)" value="<?php echo $lvts_lv0032->lv009;?>" >
							   </td>
						    </tr>
                          <tr>
							  <td  height="20"><?php echo $vLangArr[24];?></td>
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo $lvts_lv0032->lv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>							 			  							  <tr>
							  <td  height="20"><?php echo $vLangArr[25];?></td>
				              <td  height="20"><input  name="txtlv011" type="text" id="txtlv011" value="<?php echo $lvts_lv0032->lv011;?>" tabindex="15" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	 	
						   <tr>
							  <td  height="20"><?php echo $vLangArr[26];?></td>
				  <td  height="20"><input  name="txtlv012" type="text" id="txtlv012" value="<?php echo $lvts_lv0032->lv012;?>" tabindex="16" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
						  <tr>
							  <td  height="20"><?php echo $vLangArr[30];?></td>
				  <td  height="20"><input onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmedit.txtlv013);return false;"   name="txtlv013" type="text" id="txtlv013" value="<?php echo $lvts_lv0032->FormatView($lvts_lv0032->lv013,2);?>" tabindex="20" maxlength="255" style="width:40%"/><input   name="txtlv013_" type="text" id="txtlv013_" value="<?php echo substr($lvts_lv0032->lv013,11,8);?>" tabindex="20" maxlength="255" style="width:40%" onKeyPress="return CheckKey(event,7)"/><span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
