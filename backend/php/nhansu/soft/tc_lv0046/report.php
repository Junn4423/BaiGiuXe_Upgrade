...
$motc_lv0046->ArrPush[9]=$vLangArr[27];
$motc_lv0046->ArrPush[10]=$vLangArr[28];
$motc_lv0046->ArrPush[11]=$vLangArr[29];
$motc_lv0046->ArrPush[12]=$vLangArr[30];
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$motc_lv0046->lv002=base64_decode( $_GET['ID']);
...
?>
				...
				<?php echo $motc_lv0046->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
