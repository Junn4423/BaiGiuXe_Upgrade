...
/////////Get ID///////////////
$lvtc_lv0046->lv001=$_GET['ChildID'];
...
if($vFlag==1)
{
		$lvtc_lv0046->lv002=$_POST['txtlv002'];
...
$lvtc_lv0046->LV_LoadID($lvtc_lv0046->lv001);
...
function isnumber(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvtc_lv0046->lv002;?>";
		o.txtlv003.value="<?php echo $lvtc_lv0046->lv003;?>";
		o.txtlv004.value="<?php echo $lvtc_lv0046->lv004;?>";
		o.txtlv005.value="<?php echo $lvtc_lv0046->lv005;?>";
		o.txtlv006.value="<?php echo $lvtc_lv0046->lv006;?>";	
		o.txtlv007.value="<?php echo $lvtc_lv0046->lv007;?>";				
		o.txtlv002.focus();
	}
	function Cancel()
	{
