						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
							  ...
							  <td  height="20px"><table width="80%"><tr><td width="50%"><select name="txtlv003" id="txtlv003"  tabindex="7" maxlength="50" style="width:100%" onKeyPress="return CheckKeys(event,7,this)">
									<option value=""></option>
									<?php echo $lvtc_lv0046->LV_LinkField('lv003',$vlv003);?>
                              </select>
							  </td><td>
						   ...
						   <tr>
							  ...
							  <td  height="20px"><input name="txtlv004" type="text" id="txtlv004" value="<?php echo $vlv004;?>" tabindex="8" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
						  <tr>
							  <td  height="20px"><?php echo $vLangArr[19];?></td>
							  <td  height="20px"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo $vlv005;?>" tabindex="9" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
							...
							<tr>
							  ...
							  <td  height="20px">
							  <table width="80%"><tr><td width="50%"><input name="txtlv006" type="text" id="txtlv006"  value="<?php echo $vlv006;?>" tabindex="6" maxlength="225" style="width:100%" onKeyPress="return CheckKey(event,7)"/>
							  </td><td>
