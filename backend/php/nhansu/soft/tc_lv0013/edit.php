...
$lvtc_lv0013->lv011=$_POST['txtlv011'];
...
//if($_POST['txtlv050']==1) $lvtc_lv0013->isCal=true;
		$vresult=$lvtc_lv0013->LV_Update();
		if($vresult==true) {
...
$lvtc_lv0013->LV_LoadID($lvtc_lv0013->lv001);
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvtc_lv0013->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
						<tr>
				  ...
				  <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvtc_lv0013->FormatView($lvtc_lv0013->lv004,2);?>"/><span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
							...
							<select  name="txtlv008"  id="txtlv008"  tabindex="12" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)">
							  ...
							  <td  height="20px"><?php echo $vLangArr[23];?></td>
								<td  height="20px"><select  name="txtlv009"  id="txtlv009"  tabindex="12" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)">
										...
										<option value="1" <?php echo ($lvtc_lv0013->lv009=='1')?'selected="selected"':'';?>>Yes</option>
									</select></td>
							  </tr>
							  	<tr>
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv012"  id="txtlv012" style="width:80%" tabindex="15" value="<?php echo $lvtc_lv0013->lv012;?>"  onKeyPress="return CheckKey(event,7)"></td>
							</tr>	
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[27];?></td>
							  <td  height="20"><input name="txtlv013"  id="txtlv013" style="width:80%" tabindex="16" value="<?php echo $lvtc_lv0013->lv013;?>"  onKeyPress="return CheckKey(event,7)"></td>
							</tr>	
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[28];?></td>
							  <td  height="20"><input name="txtlv014"  id="txtlv014" style="width:80%" tabindex="17" value="<?php echo $lvtc_lv0013->lv014;?>"  onKeyPress="return CheckKey(event,7)"></td>
							</tr>	
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[29];?></td>
							  <td  height="20"><input name="txtlv015"  id="txtlv015" style="width:80%" tabindex="18" value="<?php echo $lvtc_lv0013->lv015;?>"  onKeyPress="return CheckKey(event,7)"></td>
							</tr>
							 <tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[33];?></td>
							  <td  height="20"><input name="txtlv016"  id="txtlv016" style="width:80%" tabindex="19" value="<?php echo $lvtc_lv0013->lv016;?>"  onKeyPress="return CheckKey(event,7)"></td>
						  </tr>	
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[34];?></td>
							  <td  height="20"><input name="txtlv017"  id="txtlv017" style="width:80%" tabindex="20" value="<?php echo $lvtc_lv0013->lv017;?>" onKeyPress="return CheckKey(event,7)"></td>
							</tr>	
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[35];?></td>
							  <td  height="20"><input name="txtlv018"  id="txtlv018" style="width:80%" tabindex="21" value="<?php echo $lvtc_lv0013->lv018;?>" onKeyPress="return CheckKey(event,7)"></td>
							</tr>	
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[36];?></td>
							  <td  height="20"><input name="txtlv019"  id="txtlv019" style="width:80%" tabindex="22" value="<?php echo $lvtc_lv0013->lv019;?>" onKeyPress="return CheckKey(event,7)"></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[37];?></td>
							  <td  height="20"><input name="txtlv020"  id="txtlv020" style="width:80%" tabindex="22" value="<?php echo $lvtc_lv0013->lv020;?>" onKeyPress="return CheckKey(event,7)"></td>
							</tr>
                            <tr>
							 ...
							 <tr>
							  ...
							  <td  height="20"><input name="txtlv022"  id="txtlv022" style="width:80%" tabindex="22" value="<?php echo $lvtc_lv0013->lv022;?>" onKeyPress="return CheckKey(event,7)"></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[40];?></td>
							  <td  height="20"><input name="txtlv023"  id="txtlv023" style="width:80%" tabindex="22" value="<?php echo $lvtc_lv0013->lv023;?>" onKeyPress="return CheckKey(event,7)"></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[45];?></td>
							  <td  height="20"><input name="txtlv024"  id="txtlv024" style="width:80%" tabindex="22" value="<?php echo $lvtc_lv0013->lv024;?>" onKeyPress="return CheckKey(event,7)"></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[46];?></td>
							  <td  height="20"><input name="txtlv025"  id="txtlv025" style="width:80%" tabindex="22" value="<?php echo $lvtc_lv0013->lv025;?>" onKeyPress="return CheckKey(event,7)"></td>
							</tr>
						<tr>
							  <td  height="20" valign="top"><?php echo 'Mốc tính phí công đoàn tối thiểu';?></td>
							  <td  height="20"><input name="txtlv026"  id="txtlv026" style="width:80%" tabindex="22" value="<?php echo ($lvtc_lv0013->lv026=="")?'23000000':$lvtc_lv0013->lv026;?>" onKeyPress="return CheckKey(event,7)">
							  
							  </td>
							</tr>						
							<tr>
							  <td  height="20" valign="top"><?php echo 'Tính gross salary theo công thức';?></td>
							  <td  height="20"><input name="txtlv099"  id="txtlv099" style="width:80%" tabindex="22" value="<?php echo $lvtc_lv0013->lv099;?>" onKeyPress="return CheckKey(event,7)"></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo 'Mã cột thay thế';?></td>
							  <td  height="20"><input name="txtlv100"  id="txtlv100" style="width:80%" tabindex="22" value="<?php echo $lvtc_lv0013->lv100;?>" onKeyPress="return CheckKey(event,7)"></td>
							</tr>
							<tr>
							  ...
							  <td  height="20">
								<select name="txtlv098"  id="txtlv098" style="width:80%" tabindex="22" onKeyPress="return CheckKey(event,7)">
									<option value="0" <?php echo ($lvtc_lv0013->lv098=='0')?'selected="selected"':'';?>>0. Cho phép tất cả trường hợp trừ ngày làm và ngày nghỉ việc không nằm tháng tính lương</option>
									<option value="1" <?php echo ($lvtc_lv0013->lv098=='1')?'selected="selected"':'';?>>1. Chỉ nhân viên có lương, có công , có thai sản, có nghỉ SL mới có dòng lương </option>
									<option value="2" <?php echo ($lvtc_lv0013->lv098=='2')?'selected="selected"':'';?>>2. Cho phép tất cả trường hợp được thêm dòng lương </option>
								</select>
							  </td>
							</tr>
							<tr>
