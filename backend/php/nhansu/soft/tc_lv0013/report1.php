...
$motc_lv0020->ArrPush[40]=$vLangArr[61];
$motc_lv0020->ArrPush[41]=$vLangArr[20];
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
	...
	<tr>
	  ...
	  <td></td>
						...
						<?php echo $motc_lv0020->LV_BuilListReportOther($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
