  ...
  <div class="story">
    <h2 id="pageName"><?php echo $vLangArr[1];?></h2>
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
						...
						<tr>
							...
							<tr>
							  ...
							  <table width="80%"><tr><td width="50%">
								<select  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/>
								<option value=""></option>
								<?php echo $lvtc_lv0013->LV_LinkField('lv003',$vlv003);?>
								</select>
							  </td><td>
				  ...
				  <td  height="20px"><select  name="txtlv008"  id="txtlv008"  tabindex="13" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/><option value=""></option><?php echo $lvtc_lv0013->LV_LinkField('lv008',$vlv008);?>
				  </select>		<br>
							  <table><tr><td></td><td>
							  <ul id="pop-nav" lang="pop-nav1" onMouseOver="ChangeName(this,1)" onkeyup="ChangeName(this,1)"> <li class="menupopT">
				  ...
				  <td  height="20px">
							  <table width="80%"><tr><td width="50%"><select  name="txtlv009"  id="txtlv009"  tabindex="13" maxlength="255" style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/><option value=""></option><?php echo $lvtc_lv0013->LV_LinkField('lv009',$vlv009);?>
				  </select>	</td><td>
							  <ul id="pop-nav2" lang="pop-nav2" onMouseOver="ChangeName(this,2)" onkeyup="ChangeName(this,2)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlv009_search" id="txtlv009_search" style="width:200px" onKeyUp="LoadPopup(this,'txtlv009','ac_lv0002','concat(lv001,@! @!,lv002)')" onFocus="LoadPopup(this,'txtlv009','ac_lv0002','concat(lv001,@! @!,lv002)')" tabindex="200" >
