...
//////////////init object////////////////
$lvts_lv0012=new ts_lv0012($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ts0009');
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($vlv001=="")?InsertWithCheckExt('ts_lv0012', 'lv001', '',10):$vlv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
							...
							<tr>
							  ...
							  <td  height="20">
							  <table width="80%" border=0><tr><td width="50%"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/><option value=""></option><?php echo $lvts_lv0012->LV_LinkField('lv003',$vlv003);?>
							  </select></td><td>
							  <ul id="pop-nav" lang="pop-nav1" onMouseOver="ChangeName(this,1)" onkeyup="ChangeName(this,1)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlv003_search" id="txtlv003_search" style="width:100%" onKeyUp="LoadPopup(this,'txtlv003','ts_lv0012','lv002')" onFocus="LoadPopup(this,'txtlv003','ts_lv0012','lv002')" tabindex="200" >
...
<tr>
							...
							<tr>
							  ...
							  <?php echo $lvts_lv0012->LV_LinkField('lv005',$vlv005);?>
							  </select></td><td>
...
<tr>
								...
								<option value=""></option>
							  <?php echo $lvts_lv0012->LV_LinkField('lv007',$vlv007);?>
							  </select></td><td>
							...
							<tr>
							  ...
							  <?php echo $lvts_lv0012->LV_LinkField('lv009',$vlv009);?>
							  </select></td><td>
				  ...
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo $vlv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
							  ...
							  <?php echo $lvts_lv0012->LV_LinkField('lv011',$vlv011);?>
							  </select></td><td>
							  <ul id="pop-nav4" lang="pop-nav4" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
							...
							<tr>
							  ...
							  <?php echo $lvts_lv0012->LV_LinkField('lv012',$vlv012);?>
							  </select></td><td>
							...
							<tr>
							  ...
							  <?php echo $lvts_lv0012->LV_LinkField('lv013',$vlv013);?>
							  </select></td><td>
