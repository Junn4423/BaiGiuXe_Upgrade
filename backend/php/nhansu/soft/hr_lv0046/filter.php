  ...
  <div class="story">
    <h2 id="pageName"><?php echo $vLangArr[1];?></h2>
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
				  ...
				  <td  height="20px"><select  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/><option value=""></option><?php echo $lvhr_lv0046->LV_LinkField('lv003',$vlv003);?>
							...
							<tr>
							  ...
							  <td  height="20px"><input  name="txtlv004"  id="txtlv004"  tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" type="text" value="<?php echo $lvhr_lv0046->lv004;?>"/>							  </td>
							</tr>
							<tr>
							  ...
							  <option value=""></option>
							   <option value="0" <?php echo ($vlv005=='0')?'selected="selected"':'';?>>I.Bản thân ốm ngắn ngày</option>
							  <option value="1" <?php echo ($vlv005=='1')?'selected="selected"':'';?>>II.Bản thân ốm dài ngày</option>
							  <option value="2" <?php echo ($vlv005=='2')?'selected="selected"':'';?>>III.Con ốm</option>
							  </select></td>
							</tr>
								<tr>
