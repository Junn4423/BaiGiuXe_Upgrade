...
$mots_lv0013->ArrPush[4]='0:Cả hai, 1:Nhập, 2:Xuất';
...
//	$tsql="select count(*) from department where CompanyID ";
	...
	$strar="'".$strar."'";
	$vresult=$mots_lv0013->LV_Delete($strar);
	$vStrMessage=GetNoDelete($strar,"ts_lv0013",$lvMessage);
}
elseif($flagID==2)
{
$mots_lv0013->lv001=$_POST['txtlv001'];
$mots_lv0013->lv002=$_POST['txtlv002'];
}
//first is load
if(($_POST['txtFlag']) != 2)
{
...
$mots_lv0013->SaveOperation($_SESSION['ERPSOFV2RUserID'],'ts_lv0013',$vFieldList,(int)$_POST['lvmaxrow'],(int)$_POST['curPg'],$vOrderList,(int)$_POST['lvsort']);
...
{
	var str="<br><iframe id='lvframefrm' height=200 marginheight=0 marginwidth=0 frameborder=0 src= ts_lv0013?func="+func+"&ID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?> class=lvframe></iframe>";
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<div><div id="lvleft"><form onsubmit="return false;" action="?<?php echo $psaveget;?>" method="post" name="frmchoose" id="frmchoose">
					  <input type="hidden" name="curPg" value="<?php echo  $curPage;?>"/>
						<?php echo $mots_lv0013->LV_BuilList($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
						<input name="txtStringID" type="hidden" id="txtStringID" />
						<input name="txtFieldList" type="hidden" id="txtFieldList"  value="<?php echo $vFieldList;?>"/>
						<input name="txtOrderList" type="hidden" id="txtOrderList"  value="<?php echo $vOrderList;?>"/>
						<input  name="txtFlag" type="hidden" id="txtFlag" value="2"/>
						<input type="hidden" name="txtlv001" id="txtlv001"  value="<?php echo $mots_lv0013->lv001;?>"/>
						<input type="hidden" name="txtlv002" id="txtlv002" value="<?php echo $mots_lv0013->lv002;?>"/>					
...
div.innerHTML='<?php echo $mots_lv0013->ArrPush[0];?>';	
</script>