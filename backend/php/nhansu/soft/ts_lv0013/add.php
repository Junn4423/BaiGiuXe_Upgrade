					...
					<form action="#"   name="frmadd" id="frmadd"  method="post">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvts_lv0013->lv001=="")?InsertWithCheckExt('ts_lv0013', 'lv001', 'CC',4):$lvts_lv0013->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
							</tr>
							<tr>
