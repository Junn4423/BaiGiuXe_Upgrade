...
require_once("../../clsall/ts_lv0013.php");
//////////////init object////////////////
$lvts_lv0013=new ts_lv0013($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ts0013');
/////////Get ID///////////////
$lvts_lv0013->lv001= $_GET['ID'] ?? '';
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","TS0021.txt",$plang);
...
if($vFlag==1)
{
		$lvts_lv0013->lv002=$_POST['txtlv002'];		
		$lvts_lv0013->lv003=$_POST['txtlv003'];
		$vresult=$lvts_lv0013->LV_Update();
		if($vresult==true) {
...
$lvts_lv0013->LV_LoadID($lvts_lv0013->lv001);
...
function isphone(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvts_lv0013->lv002;?>";
		o.txtlv003.value="<?php echo $lvts_lv0013->lv003;?>";
		o.txtlv004.value="<?php echo $lvts_lv0013->lv004;?>";
		o.txtlv005.value="<?php echo $lvts_lv0013->lv005;?>";	
		o.txtlv002.focus();
	}
	function Cancel()
	{
					...
					<?php		
						...
						?>
							...
							<tr>
							  ...
							  <td width="335"  height="20px"><input  name="txtlv001" type="text" id="txtlv001" readonly="true" value="<?php echo $lvts_lv0013->lv001;?>" /></td>
							</tr>
						<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input  name="txtlv002" type="text" id="txtlv002" value="<?php echo $lvts_lv0013->lv002;?>" tabindex="6" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
							<tr>
