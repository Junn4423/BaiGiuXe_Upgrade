...
require_once("../../clsall/ki_lv0003.php");
//////////////init object////////////////
$lvki_lv0003=new ki_lv0003($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ki0003');
$lvki_lv0003->obj_detail=$lvsl_lv0044;
$lvki_lv0003->obj_config=$lvtc_lv0005;
$lvki_lv0003->obj_contract=$lvsl_lv0013;
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","KI0004.txt",$plang);
$vNow=GetServerDate();	
$lvki_lv0003->lang=strtoupper($plang);
$curPage = (int)($_POST['curPg'] ?? 1);	
$vFlag   = (int)($_POST['txtFlag'] ?? 0);
$lvki_lv0003->lv001=$_POST['txtlv001'];
$lvki_lv0003->lv002=$_POST['txtlv002'];
$lvki_lv0003->lv003=$_POST['txtlv003'];
if($vFlag==1)
{
		$lvki_lv0003->lv004=getInfor($_SESSION['ERPSOFV2RUserID'],2);
		$lvki_lv0003->lv005=$vNow;
		$vresult=$lvki_lv0003->LV_Insert();
		if($vresult==true) {
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvki_lv0003->lv001=="")?InsertWithCheck('ki_lv0003', 'lv001', 'KPI',1):$lvki_lv0003->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
						    </tr>
						    <tr>
								<td width="166"  height="20"><?php echo $vLangArr[16];?></td>
								<td width="178"  height="20">
									<input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvki_lv0003->lv002;?>" tabindex="5" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
						    </tr>
							  <tr>
								<td width="166"  height="20"><?php echo $vLangArr[17];?></td>
								<td width="178"  height="20">
									<textarea name="txtlv003" type="text" id="txtlv003"  tabindex="17" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"><?php echo $lvki_lv0003->lv003;?></textarea> 
									</td>
					      </tr>
