...
$lvki_lv0003->LV_LoadID($lvki_lv0003->lv001);
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvki_lv0003->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
						    </tr>
							 <tr>
							 ...
							 <tr>
								...
								<td width="178"  height="20">
									<textarea name="txtlv003" type="text" id="txtlv003"  tabindex="17" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"><?php echo $lvki_lv0003->lv003;?>
									</textarea> 
									</td>
					     	</tr>
						<tr>
