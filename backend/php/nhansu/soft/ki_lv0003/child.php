...
require_once("../paras.php");
require_once("../../clsall/ki_menulv0003.php");

$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","KI0007.txt",$plang);
//init object
$moki_menulv0003=new ki_menulv0003();
//Set variant
$moki_menulv0003->itemlst=$pitemlst;
$moki_menulv0003->childlst=$pchildlst;
$moki_menulv0003->level3lst=$plevel3lst;
$moki_menulv0003->child3lst=$pchild3lst;
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($moki_menulv0003->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>	
					</select>
	...
	<?php
	$moki_menulv0003->Dir="../";
include($moki_menulv0003->GetLinkEmp());
?>
	</div></td>
              </tr>
            </table
...
document.frmhr_employee.cbxoption.value="<?php echo $moki_menulv0003->level3lst;?>";
