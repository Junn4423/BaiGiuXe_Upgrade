						...
						<table width="100%" border="0" align="center" id="table1">
						    ...
						    <tr>
								...
								<td width="178"  height="20">
									<input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $Vlv002;?>" tabindex="5" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
						    </tr>
							  <tr>
								<td width="166"  height="20"><?php echo $vLangArr[17];?></td>
								<td width="178"  height="20">
									<input name="txtlv003" type="text" id="txtlv003"  value="<?php echo $Vlv003;?>" tabindex="5" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
								</td>
					      </tr>
						  <tr>
