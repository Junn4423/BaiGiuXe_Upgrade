...
$motc_lv0048->is_tc09_add=0;
$motc_lv0048->is_tc09_apr=0;
$motc_lv0048->is_tc09_unapr=0;
...
$motc_lv0048->ArrPush[30]=$vLangArr[30];
...
$motc_lv0048->lv004=$year."-".$month;
if($_GET['dayfrom']!="")
	$motc_lv0048->datefrom=$year."-".$month."-".$_GET['dayfrom'];
else
	$motc_lv0048->datefrom=$motc_lv0013->lv004;
if($_GET['dayto']!="")
	$motc_lv0048->dateto=$year."-".$month."-".$_GET['dayto'];
else
	$motc_lv0048->dateto=$motc_lv0013->lv005;
$motc_lv0048->isTime=(int)$_GET['isTime'];
$motc_lv0048->lv028="";
if($motc_lv0048->GetApr()==0)  echo $motc_lv0048->lv028=$motc_lv0048->Get_User($_SESSION['ERPSOFV2RUserID'],'lv002');
$motc_lv0048->lv029=$_GET['txtlv029'];
...
$motc_lv0048->lv001=$_GET['txtlv001'];
?>
...
<body  onkeyup="KeyPublicRun(event)">
			...
			<div>
					<div style="text-align:center">
						...
						<div style="font-size:16;font-weight:bold;"><?php echo $vLangArr[15].":".$motc_lv0048->FormatView($motc_lv0048->datefrom,2);?>&nbsp;&nbsp;&nbsp;<?php echo $vLangArr[16].":".$motc_lv0048->FormatView($motc_lv0048->dateto,2);?></div>
					</div>
					<div id="lvleft">
					    <?php 
						$motc_lv0048->SetAllDisiable();
						echo $motc_lv0048->LV_BuilListReportOtherPrintLateSoon($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,0,$_GET['chkviewinfo']);?>
					</div>
					...
					echo $motc_lv0002->LV_BuilListReportTC('lv001,lv002,lv003,lv004','document.frmchoose','chkAll','lvChk',$curRow, 1000,$paging,'',$motc_lv0048->ArrTC);?>
					</div>
					<div>
