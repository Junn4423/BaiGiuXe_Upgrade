						...
						<tr>
							...
							<tr>
							  ...
							  <td  height="20"><select name="txtlv002" id="txtlv002"   tabindex="6"  style="width:80%" onkeypress="return CheckKey(event,7)"><option value=""></option>
							   <?php echo $lvki_lv0011->LV_LinkField('lv002',$vlv002);?>
                              </select>
							    <br>
							  <table><tr><td>
...
<tr>
								...
								<?php echo $lvki_lv0011->LV_LinkField('lv003',$vlv003);?>
						  ...
						  <br></td></tr>
							<tr>
							  ...
							  <td  height="20"><select name="txtlv005" id="txtlv005"   tabindex="9"  style="width:80%" onkeypress="return CheckKey(event,7)"/><option value=""></option>
								<?php echo $lvki_lv0011->LV_LinkField('lv005',$lvki_lv0011->lv005);?>
							  </select>	<br><table><tr><td>
							  <ul id="pop-nav2" lang="pop-nav2" onkeyup="ChangeName(this,2)" onMouseOver="ChangeName(this,2)" onkeyup="ChangeName(this,2)"> <li class="menupopT">
		...
		<tr>
							  ...
							  <td  height="20"><input name="txtlv009" type="text" id="txtlv009" value="<?php echo $lvki_lv0011->lv009;?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
