<?php
session_start();
//require_once("../../clsall/ki_lv0011.php");
...
//////////////init object////////////////
$lvki_lv0011=new ki_lv0011($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ki0011');
...
$lvki_lv0011->lv001=InsertWithCheckExt('ki_lv0011', 'lv001', '',1);
$lvki_lv0011->lv002=$_GET['ChildID'];
$lvki_lv0011->lv003=$_POST['txtlv003'];
$lvki_lv0011->lv004=$_POST['txtlv004'];
$lvki_lv0011->lv005=$_POST['txtlv005'];
$lvki_lv0011->lv006=$_POST['txtlv006'];
$lvki_lv0011->lv007=$_POST['txtlv007'];
$lvki_lv0011->lv008=$_POST['txtlv008'];
$lvki_lv0011->lv009=$_POST['txtlv009'];
$lvki_lv0011->lv010=$_POST['txtlv010'];
$lvki_lv0011->lv011=$_POST['txtlv011'];
$lvki_lv0011->lv012=$_POST['txtlv012'];
$lvki_lv0011->lv015=$_POST['txtlv015'];
if($vFlag==1)
{
		
		$vresult=$lvki_lv0011->LV_Insert();
		if($vresult==true) {
	...
	foreach( $data as $row )
	{
		if(trim($row['lv003'])!="" && $row['lv003']!=NULL)
		{
			...
			if($lvhr_lv0020->lv001!=NULL && $lvhr_lv0020->lv001!='')
			{
				...
				$lvki_lv0011->lv002= $_GET['ID'] ?? '';
				$lvki_lv0011->lv003=$row['lv003'];
				
				if(trim($row['lv004'])=='' || $row['lv004']==NULL)
					$lvki_lv0011->lv004=$vPercen;
				else
					$lvki_lv0011->lv004=$row['lv004'];
				$lvki_lv0011->lv005=$row['lv005'];
				$lvki_lv0011->lv006=$row['lv006'];
				$lvki_lv0011->lv007=$row['lv007'];
				$lvki_lv0011->lv008=$row['lv008'];
				$lvki_lv0011->lv009=$row['lv009'];
				$lvki_lv0011->lv010=$row['lv010'];
				$lvki_lv0011->lv011=$row['lv011'];
				$lvki_lv0011->lv012=$row['lv012'];
				$lvki_lv0011->lv015=$row['lv015'];				
				$vCode=$lvki_lv0011->LV_CheckExistStaff( $_GET['ID'],$row['lv003']);
				if($vCode=="" || $vCode==NULL)
					$vresult=$lvki_lv0011->LV_Insert();
				else
				{
					$lvki_lv0011->lv001=$vCode;
					$vresult=$lvki_lv0011->LV_Update();
					}
                      ...
                      <div id="enterline" style="display:block">
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
								...
								<td width="*%"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvki_lv0011->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvki_lv0011->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[17];?></td>
				  <td  height="20px">
				  <table width="80%">
					<tr><td width="50%"><select  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:100%" onKeyPress="return CheckKey(event,7)"/><?php echo $lvki_lv0011->LV_LinkField('lv003',$lvki_lv0011->lv003);?>
							</select></td>
				  <td>
							...
							<tr>
							  ...
							  <td  height="20px"><input name="txtlv015" type="text" id="txtlv015" value="<?php echo (float)$lvki_lv0011->lv015;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>						  
							<tr>
							  <td  height="20px"><?php echo $vLangArr[18];?></td>
							  <td  height="20px"><input name="txtlv004" type="text" id="txtlv004" value="<?php echo (float)$lvki_lv0011->lv004;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
							<tr>
							  <td  height="20px"><?php echo $vLangArr[19];?></td>
							  <td  height="20px"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo $lvki_lv0011->lv005;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[20];?></td>
							  <td  height="20px"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo $lvki_lv0011->lv006;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[21];?></td>
							  <td  height="20px"><input name="txtlv007" type="text" id="txtlv007" value="<?php echo $lvki_lv0011->lv007;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[22];?></td>
							  <td  height="20px"><input name="txtlv008" type="text" id="txtlv008" value="<?php echo $lvki_lv0011->lv008;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[23];?></td>
							  <td  height="20px"><input name="txtlv009" type="text" id="txtlv009" value="<?php echo $lvki_lv0011->lv009;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[24];?></td>
							  <td  height="20px"><input name="txtlv010" type="text" id="txtlv010" value="<?php echo $lvki_lv0011->lv010;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[25];?></td>
							  <td  height="20px"><input name="txtlv011" type="text" id="txtlv011" value="<?php echo $lvki_lv0011->lv011;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[26];?></td>
							  <td  height="20px"><input name="txtlv012" type="text" id="txtlv012" value="<?php echo $lvki_lv0011->lv012;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							</tr>
							<tr>
