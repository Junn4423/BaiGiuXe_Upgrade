...
$lvts_lv1001->lv019=$_POST['txtlv019'];
		...
		if($vresult==true) {
			if($_FILES['userfile']['name']!="" && $_FILES['userfile']['name']!=null)
			{
				UploadImg(getInfor($_SESSION['ERPSOFV2RUserID'],2), $lvts_lv1001->lv018);///Call function Upload file
			}
					...
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<tr>
							...
							<tr>
								...
								<td  height="20"><input name="txtlv011" type="text" id="txtlv011" value="<?php echo $lvts_lv1001->FormatView($lvts_lv1001->lv011,2);?>" tabindex="10"  style="width:80%" onKeyPress="return CheckKey(event,7)"  onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmedit.txtlv011);return false;">
								<span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
															onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmedit.txtlv011);return false;" /> </span>	
								</td>
							</tr>
							<tr>
							...
							<td width="150"   height="20"><?php echo $vLangArr[30];?></td>
								...
								<td width="300"  height="20"><input type="file" Name="userfile" id="userfile" tabindex="12"/><input  name="txtlv018" type="hidden" id="txtlv018" value="<?php echo $lvts_lv1001->lv018;?>" tabindex="14" maxlength="15" style="width:80%" onKeyPress="return CheckKey(event,7)"/> </td>
							</tr>
							<tr>
							<td width="150"   height="20"><?php echo $vLangArr[32];?></td>
								...
								<td  height="20"><input name="txtlv020" type="text" id="txtlv020" value="<?php echo $lvts_lv1001->FormatView($lvts_lv1001->lv020,2);?>" tabindex="10"  style="width:80%" onKeyPress="return CheckKey(event,7)"  onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmedit.txtlv020);return false;">
								<span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
															onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmedit.txtlv020);return false;" /> </span>	
								</td>
							</tr>
							<tr>
