<?php
session_start();
//require_once("../../clsall/sp_lv0035_1.php");
...
//////////////init object////////////////
$lvsp_lv0035_1=new sp_lv0035_1($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sp0011');
...
$mosp_lv0035_1->lang=strtoupper($plang);
$curPage = (int)($_POST['curPg'] ?? 1);	
$vFlag   = (int)($_POST['txtFlag'] ?? 0);
$lvsp_lv0035_1->lv001=$_POST['txtlv001'];
$lvsp_lv0035_1->lv002= $_GET['ID'] ?? '';
$lvsp_lv0035_1->lv003=$_POST['txtlv003'];
$lvsp_lv0035_1->lv004=$_POST['txtlv004'];
$lvsp_lv0035_1->lv005=$_POST['txtlv005'];
$lvsp_lv0035_1->lv006=$_POST['txtlv006'];
$lvsp_lv0035_1->lv007=$_POST['txtlv007'];
$lvsp_lv0035_1->lv008=$_POST['txtlv008'];
$lvsp_lv0035_1->lv009=$_POST['txtlv009'];
$lvsp_lv0035_1->lv010=$_POST['txtlv010'];
$lvsp_lv0035_1->lv011=$_POST['txtlv011'];
if($lvsp_lv0035_1->lv011=="" || $lvsp_lv0035_1->lv011==NULL) $lvsp_lv0035_1->lv011=$lvsp_lv0035_1->DateCurrent;
$lvsp_lv0035_1->lv012=$_POST['txtlv012'];
$lvsp_lv0035_1->lv013=$_POST['txtlv013'];
$lvsp_lv0035_1->lv017=$_POST['txtlv017'];
$lvsp_lv0035_1->lv018=$_POST['txtlv018'];
$lvsp_lv0035_1->lv019=$_POST['txtlv019'];
if($vFlag==1)
{	
		if($_FILES['userfile']['name']=="" || $_FILES['userfile']['name']==NULL)
			$lvsp_lv0035->lv018=$_POST['txtlv018'];
		else
		{
			$lvsp_lv0035->lv018="qt_".time().exten($_FILES['userfile']['name']);
		}
		...
		{
		$vresult=$lvsp_lv0035_1->LV_Insert();
		if($vresult==true) {
			if($_FILES['userfile']['name']!="" || $_FILES['userfile']['name']!=NULL) UploadImg(getInfor($_SESSION['ERPSOFV2RUserID'],2), $mosp_lv0035_1->lv018);///Call function Upload file
...
function isphone(s){
	...
	var o=window.parent.document.getElementById('frmchoose');
		//o.action="?func=<?php echo $_GET['func'];?>&childfunc=<?php echo $_GET['childfunc'];?>&childdetailfunc=<?php echo $_GET['childdetailfunc'];?>"+"&ID=<?php echo  $_GET['ID']?>&ChildID=<?php echo $_GET['ChildID'];?>&ID=<?php echo  $_GET['ID'] ?? '';?>&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,2,0);?>";
		o.submit();
	}
	function Save()
	{
					...
					<form action="#"  name="frmadd" id="frmadd"  method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
								...
								<td  height="20"><input  name="txtlv003" type="text" id="txtlv003" value="<?php echo (float)$lvsp_lv0035_1->lv003;?>" tabindex="8" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
								</TR>
							<tr><td  height="20"><?php echo $vLangArr[19];?></td>
								<td  height="20"><table style="width:80%"><tr><td style="width:50%"><input  name="txtlv006" type="text" id="txtlv006" value="<?php echo $lvsp_lv0035_1->lv003;?>" tabindex="9" maxlength="225" style="width:100%" onKeyPress="return CheckKeys(event,7,this)" onblur="changecustomer_change(this.value)"/></td><td>
								...
								<td  height="20"><input type="textbox" name="txtlv007" id="txtlv007" tabindex="10" style="width:80%" onKeyPress="return CheckKey(event,7)"  value="<?php echo $lvsp_lv0035_1->lv007;?>"/>
							  						  </td>
							</tr>
							<tr>
								<td  height="20"><?php echo $vLangArr[25];?></td>
								<td  height="20">
								<table style="width:80%"><tr><td style="width:50%"><input type="textbox" name="txtlv012" id="txtlv012" tabindex="10" style="width:100%" onKeyPress="return CheckKeys(event,7,this)"  value="<?php echo $lvsp_lv0035_1->lv012;?>"/></td><td>
								...
								<td  height="20" ><textarea  name="txtlv013" type="text" id="txtlv013" tabindex="10" maxlength="255" style="width:80%"><?php echo $lvsp_lv0035_1->lv013?></textarea></td>												
							</tr>
							<tr>
							<td width="150"   height="20"><?php echo $vLangArr[30];?></td>
								<td width="300"  height="20"><select name="txtlv017" id="txtlv017" tabindex="11" style="width:80%" onKeyPress="return CheckKey(event,7)">
									<?php echo $lvsp_lv0035_1->LV_LinkField('lv017',$lvsp_lv0035_1->lv017);?>								
							    </select></td>
								<td width="150"   height="20"><?php echo $vLangArr[31];?></td>
								<td width="300"  height="20"><input type="file" Name="userfile" id="userfile" tabindex="9"/><input  name="txtlv018" type="hidden" id="txtlv018" value="<?php echo ($lvsp_lv0035_1->lv018!="")?$lvsp_lv0035_1->lv018:"qt_".time().".jpg";?>" tabindex="12" maxlength="15" style="width:80%" onKeyPress="return CheckKey(event,7)"/> </td>
							</tr>
							<tr>
							<td width="150"   height="20"><?php echo $vLangArr[32];?></td>
								<td width="300"  height="20"><select name="txtlv019" id="txtlv019" tabindex="13" style="width:80%" onKeyPress="return CheckKey(event,7)">
									<?php echo $lvsp_lv0035->LV_LinkField('lv019',$lvsp_lv0035->lv019);?>								
							    </select></td>
