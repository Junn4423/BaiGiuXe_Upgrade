...
require_once("../../clsall/hr_lv0047.php");
//////////////init object////////////////
$lvhr_lv0047=new hr_lv0047($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Hr0057');
/////////Get ID///////////////
$lvhr_lv0047->lv001=$_GET['ChildID'];
...
if($vFlag==1)
{
		$lvhr_lv0047->lv002=$_POST['txtlv002'];
		$lvhr_lv0047->lv003=$_POST['txtlv003'];
		$lvhr_lv0047->lv004=$_POST['txtlv004'];
		$lvhr_lv0047->lv005=$_POST['txtlv005'];
		if($_FILES['userfile']['name']!="" && $_FILES['userfile']['name']!=NULL)
		{
		$lvhr_lv0047->lv006=$_FILES['userfile']['name'];
		}
		else
			{
			$lvhr_lv0047->lv006=$_POST['txtlv006'];	
			}		
		$vresult=$lvhr_lv0047->LV_Update();
		if($vresult==true) {
			if($_FILES['userfile']['name']!="" && $_FILES['userfile']['name']!=NULL)
			{
			UploadImg($lvhr_lv0047->lv002."_".$lvhr_lv0047->lv001, $lvhr_lv0047->lv006);
			}
...
function isnumber(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvhr_lv0047->lv002;?>";
		o.txtlv003.value="<?php echo $lvhr_lv0047->lv003;?>";
		o.txtlv004.value="<?php echo $lvhr_lv0047->lv004;?>";
		o.txtlv005.value="<?php echo $lvhr_lv0047->lv005;?>";
		o.txtlv006.value="<?php echo $lvhr_lv0047->lv006;?>";			
		o.txtlv002.focus();
	}
	function Cancel()
	{
						...
						?>
							...
							<tr>
								...
								<td width="*%"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvhr_lv0047->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvhr_lv0047->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
<tr>
				  ...
				  <td  height="20px"><select  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
							  ...
							  <?php echo $lvhr_lv0047->LV_LinkField('lv003',$lvhr_lv0047->lv003);?>
							  </select>	</td>
						  </tr>								
							<tr>
							  <td  height="20px"><?php echo $vLangArr[18];?></td>
							  <td  height="20px"><input  name="txtlv004" type="text" id="txtlv004" value="<?php echo $lvhr_lv0047->lv004;?>" tabindex="8" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
						  
							<tr>
							  <td  height="20px"><?php echo $vLangArr[19];?></td>
							  <td  height="20px"><input name="txtlv005" type="hidden" id="txtlv005" value="<?php echo $lvhr_lv0047->lv005;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"><input name="txtlv0051" type="text" id="txtlv0051" value="<?php echo $lvhr_lv0047->FormatView($lvhr_lv0047->lv005,2);?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
							  ...
							  <input name="txtlv006" type="hidden" id="txtlv006" value="<?php echo $lvhr_lv0047->lv006;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>				 
							<tr>
