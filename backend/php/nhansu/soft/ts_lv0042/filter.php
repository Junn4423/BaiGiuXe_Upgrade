					...
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<tr>
							...
							<tr>
							  ...
							  <td  height="20"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)"/><option value=""></option><?php echo $lvts_lv0042->LV_LinkField('lv003',$vlv003);?>
							  </select>	<br>
							  <table><tr><td>
...
<tr>
							...
							<tr>
							  ...
							  <?php echo $lvts_lv0042->LV_LinkField('lv005',$vlv005);?>
...
<tr>
								...
								<option value=""></option>
							  <?php echo $lvts_lv0042->LV_LinkField('lv007',$vlv007);?>
							  </select>	<br><table><tr><td>
							...
							<tr>
							  ...
							  <?php echo $lvts_lv0042->LV_LinkField('lv009',$vlv009);?>
							  </select>	<br><table><tr><td>
				  ...
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo $vlv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
							  ...
							  <?php echo $lvts_lv0042->LV_LinkField('lv011',$vlv011);?>
							  </select><br>
							  <table><tr><td>
							  <ul id="pop-nav4" lang="pop-nav4" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
                    ...
                    <!--
							<tr>
							  ...
							  <?php echo $lvts_lv0042->LV_LinkField('lv012',$vlv012);?>
							  </select><br><table><tr><td>
							...
							<tr>
							  ...
							  <?php echo $lvts_lv0042->LV_LinkField('lv013',$vlv013);?>
							  </select><br><table><tr><td>
