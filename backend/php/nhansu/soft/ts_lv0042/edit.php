...
//require_once("../../clsall/ts_lv0042.php");
...
require_once("../../clsall/ts_lv0042.php");
//////////////init object////////////////
$lvts_lv0042=new ts_lv0042($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ts0009');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvts_lv0042->lv001=$_GET['ChildDetailID'];
if($plang=="") $plang="VN";
...
if($vFlag==1)
{
$lvts_lv0042->lv002=$_POST['txtlv002'];
$lvts_lv0042->lv003=$_POST['txtlv003'];
$lvts_lv0042->lv004=$_POST['txtlv004'];
$lvts_lv0042->lv005=$_POST['txtlv005'];
$lvts_lv0042->lv006=$_POST['txtlv006'];
$lvts_lv0042->lv007=$_POST['txtlv007'];
$lvts_lv0042->lv008=$_POST['txtlv008'];
$lvts_lv0042->lv009=$_POST['txtlv009'];
$lvts_lv0042->lv010=$_POST['txtlv010'];
$lvts_lv0042->lv011=$_POST['txtlv011'];
$lvts_lv0042->lv012=$_POST['txtlv012'];
$lvts_lv0042->lv013=$_POST['txtlv013'];
$lvts_lv0042->lv014=$_POST['txtlv014'];
$lvts_lv0042->lv015=$_POST['txtlv015'];
$lvts_lv0042->lv016=GetServerDate()." ".GetServerTime();
$lvts_lv0042->lv017=$_POST['txtlv017'];
$lvts_lv0042->lv018=$_POST['txtlv018'];
		
		$vresult=$lvts_lv0042->LV_UpdateEdit($_POST['txtlv004old'],$_POST['txtlv006old']);
		if($vresult==true) {
...
$lvts_lv0042->LV_LoadID($lvts_lv0042->lv001);
					...
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvts_lv0042->lv001=="")?InsertWithCheckExt('ts_lv0042', 'lv001', '',10):$lvts_lv0042->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[16];?></td>
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvts_lv0042->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[17];?></td>
							  <td  height="20"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)"/><?php echo $lvts_lv0042->LV_LinkField('lv003',$lvts_lv0042->lv003);?>
							  </select>	<br>
							  <table><tr><td>
...
<tr>
				              ...
				              <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvts_lv0042->lv004;?>"/></td>
</tr>							  
							<tr>
							  ...
							  <?php echo $lvts_lv0042->LV_LinkField('lv005',$lvts_lv0042->lv005);?>
							  ...
							  <td  height="20"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo (float)$lvts_lv0042->lv006;?>" tabindex="10" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
<tr>
							  ...
							  <?php echo $lvts_lv0042->LV_LinkField('lv007',$lvts_lv0042->lv007);?>
							  </select>	<br><table><tr><td>
				  ...
				  <td  height="20"><input  name="txtlv008" type="text" id="txtlv008" value="<?php echo (float)$lvts_lv0042->lv008;?>" tabindex="12" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
                          <tr>
							  <td  height="20"><?php echo $vLangArr[23];?></td>
				  <td  height="20"><input  name="txtlv009" type="text" id="txtlv009" value="<?php echo (float)$lvts_lv0042->lv009;?>" tabindex="13" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>							 			  							 
                          <tr>
							  ...
							  <?php echo $lvts_lv0042->LV_LinkField('lv010',$lvts_lv0042->lv010);?>
							  </select><br>
							  <table><tr><td>
				  ...
				  <td  height="20"><input  name="txtlv011" type="text" id="txtlv011" value="<?php echo $lvts_lv0042->lv011;?>" tabindex="15" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
                          <tr>
							  ...
							  <?php echo $lvts_lv0042->LV_LinkField('lv012',$lvts_lv0042->lv012);?>
							  </select><br>
							  <table><tr><td>
							  <ul id="pop-nav4" lang="pop-nav4" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch4" id="txtlvsearch4" style="width:200px" onKeyUp="LoadPopup(this,'txtlv011','sl_lv0029','lv002')" onFocus="LoadPopup(this,'txtlv011','ac_lv0003','lv002')" tabindex="200" >
				  ...
				  <td  height="20"><input  name="txtlv013" type="text" id="txtlv013" value="<?php echo $lvts_lv0042->lv013;?>" tabindex="17" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>		
                           <tr>
							  <td  height="20"><?php echo $vLangArr[28];?></td>
				  <td  height="20"><input  name="txtlv014" type="text" id="txtlv014" value="<?php echo $lvts_lv0042->lv014;?>" tabindex="18" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
                           <tr>
							  <td  height="20"><?php echo $vLangArr[29];?></td>
				  <td  height="20"><input  name="txtlv015" type="text" id="txtlv015" value="<?php echo $lvts_lv0042->lv015;?>" tabindex="19" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
                          <tr>
							  <td  height="20"><?php echo $vLangArr[32];?></td>
				  <td  height="20"><input  name="txtlv018" type="text" id="txtlv018" value="<?php echo $lvts_lv0042->lv018;?>" tabindex="20" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>		
						<tr>
