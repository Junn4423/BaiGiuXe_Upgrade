...
{
	var str="<br><iframe height=450 marginheight=0 marginwidth=0 frameborder=0 src=\"hr_lv0003?func="+func+"&ID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?>\" class=lvframe></iframe>";
