...
$vStrMessage="";
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////
$mohr_lv0020->LoadSaveOperation($_SESSION['ERPSOFV2RUserID'],'rp_lv0019');
//////////////////////////////////////////////////////////////////////////////////////////////////////
...
?>
						...
						<?php echo $mohr_lv0020->LV_BuilListReportAdvanceMember($vFieldList,'document.frmchoose','chkAll','lvChk',0,100000,$paging,$vOrderList,$vSortNum);?>
