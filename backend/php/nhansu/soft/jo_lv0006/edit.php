...
/////////Get ID///////////////
$lvjo_lv0006->lv001=$_GET['ChildID'];
...
if($vFlag==1)
{
		...
		$lvjo_lv0006->lv005=$_POST['txtlv005'];
		...
		$lvjo_lv0006->lv006=$_FILES['userfile']['name'];
			...
			{
			$lvjo_lv0006->lv006=$_POST['txtlv006'];	
			}		
		$vresult=$lvjo_lv0006->LV_Update();
		if($vresult==true) {
			if($_FILES['userfile']['name']!="" && $_FILES['userfile']['name']!=NULL)
			{
...
function isnumber(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvjo_lv0006->lv002;?>";
		o.txtlv003.value="<?php echo $lvjo_lv0006->lv003;?>";
		o.txtlv004.value="<?php echo $lvjo_lv0006->lv004;?>";
		o.txtlv005.value="<?php echo $lvjo_lv0006->lv005;?>";
		o.txtlv006.value="<?php echo $lvjo_lv0006->lv006;?>";			
		o.txtlv002.focus();
	}
	function Cancel()
	{
