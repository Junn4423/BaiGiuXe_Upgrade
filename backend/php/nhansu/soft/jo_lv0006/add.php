...
$lvjo_lv0006->lv001=InsertWithCheckExt('jo_lv0006', 'lv001', '',0);
if( $_GET['ID']=="")
$lvjo_lv0006->lv002=$_POST['txtlv002'];
else
$lvjo_lv0006->lv002= $_GET['ID'] ?? '';
$lvjo_lv0006->lv003=$_POST['txtlv003'];
$lvjo_lv0006->lv004=$_POST['txtlv004'];
$lvjo_lv0006->lv005=GetServerDate()." ".GetServerTime();
$lvjo_lv0006->lv006=$_FILES['userfile']['name'];
if($vFlag==1)
{
		
		$vresult=$lvjo_lv0006->LV_Insert();
		if($vresult==true) {
			UploadImg($lvjo_lv0006->lv002."_".$lvjo_lv0006->lv001, $lvjo_lv0006->lv006);
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvjo_lv0006->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvjo_lv0006->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/><br>
							  <table><tr><td>
							  <ul id="pop-nav" lang="pop-nav1" onkeyup="ChangeName(this,1)" onMouseOver="ChangeName(this,1)" onkeyup="ChangeName(this,1)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch1" id="txtlvsearch1" style="width:200px" onKeyUp="LoadPopupParentCSCondi(this,'txtlv002','sl_lv0001','lv002','1')" onFocus="LoadPopupParentCSCondi(this,'txtlv002','sl_lv0001','lv002','1')" tabindex="200" >
...
<tr>
				  ...
				  <td  height="20px"><select  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
							  ...
							  <?php echo $lvjo_lv0006->LV_LinkField('lv003',$lvjo_lv0006->lv003);?>
							  </select>	</td>
						  </tr>								
							<tr>
							  <td  height="20px"><?php echo $vLangArr[18];?></td>
							  <td  height="20px"><input  name="txtlv004" type="text" id="txtlv004" value="<?php echo $lvjo_lv0006->lv004;?>" tabindex="8" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
						  
							<tr>
							  <td  height="20px"><?php echo $vLangArr[19];?></td>
							  <td  height="20px"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo $lvjo_lv0006->FormatView($lvjo_lv0006->lv005,2);?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
							  ...
							  <input name="txtlv006" type="hidden" id="txtlv006" value="<?php echo $lvjo_lv0006->lv006;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>																			
							<tr>
