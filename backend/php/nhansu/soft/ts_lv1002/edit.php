...
/////////Get ID///////////////
$lvts_lv1002->lv001=$_GET['ChildID'];
...
if($vFlag==1)
{
		$lvts_lv1002->lv002=$_POST['txtlv002'];
...
$lvts_lv1002->LV_LoadID($lvts_lv1002->lv001);
...
function isnumber(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvts_lv1002->lv002;?>";
		o.txtlv003.value="<?php echo $lvts_lv1002->lv003;?>";
		o.txtlv004.value="<?php echo $lvts_lv1002->lv004;?>";
		o.txtlv005.value="<?php echo $lvts_lv1002->lv005;?>";
		o.txtlv006.value="<?php echo $lvts_lv1002->lv006;?>";	
		o.txtlv007.value="<?php echo $lvts_lv1002->lv007;?>";
		o.txtlv008.value="<?php echo $lvts_lv1002->lv008;?>";			
		o.txtlv002.focus();
	}
	function Cancel()
	{
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					...
					<?php		
						...
						?>
							...
							<tr>
								<td width="166"  height="20px"><?php echo $vLangArr[14];?></td>
								<td width="*%"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvts_lv1002->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
							</tr>
							<tr>
