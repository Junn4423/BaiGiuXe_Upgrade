						...
						<tr>
							...
							<tr>
							  ...
							  <table width="80%">
								<tr><td width="50%">
										...
										<option value=""></option>
										<?php echo $lvtc_lv0026->LV_LinkField('lv003',$vlv003);?>
										</select></td>
									<td>
							...
							<tr>
							  ...
							  <td  height="20"><table width="80%">
								...
								<option value=""></option>
							  <?php echo $lvtc_lv0026->LV_LinkField('lv005',$vlv005);?>
							  </select></td><td>
							...
							<tr>
							  ...
							  <?php echo $lvtc_lv0026->LV_LinkField('lv007',$vlv007);?>
							  <option value=""></option>
							  </select></td><td>
							...
							<tr>
								...
								<option value=""></option>
							  <?php echo $lvtc_lv0026->LV_LinkField('lv009',$vlv009);?>
							  </select></td><td>
