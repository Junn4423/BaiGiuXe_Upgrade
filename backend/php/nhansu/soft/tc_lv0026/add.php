...
//////////////init object////////////////
$lvtc_lv0026=new tc_lv0026($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Tc0026');
$lvtc_lv0013=new tc_lv0013($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Tc0013');
$lvsl_lv0007=new sl_lv0007($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Tc0026');
$lvhr_lv0020=new hr_lv0020($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Tc0026');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvtc_lv0013->LV_LoadActiveID();
if($lvtc_lv0013->lv001=="" || $lvtc_lv0013->lv001==NULL)
{
	echo "Lock Para Salary Now!";
	exit;
}
if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","SL0030_1.txt",$plang);
$motc_lv0026->lang=strtoupper($plang);
$curPage = (int)($_POST['curPg'] ?? 1);	
$vFlag   = (int)($_POST['txtFlag'] ?? 0);
$lvtc_lv0026->lv001=$_POST['txtlv001'];
$lvtc_lv0026->lv002=$lvtc_lv0013->lv001;
$lvtc_lv0026->lv003=$_POST['txtlv003'];
$lvtc_lv0026->lv004=$_POST['txtlv004'];
$lvtc_lv0026->lv005=$_POST['txtlv005'];
$lvtc_lv0026->lv006=$_POST['txtlv006'];
$lvtc_lv0026->lv007=$_POST['txtlv007'];
$lvtc_lv0026->lv008=$_POST['txtlv008'];
$lvtc_lv0026->lv009=$_POST['txtlv009'];
$lvtc_lv0026->lv010=$_POST['txtlv010'];
$lvtc_lv0026->lv011=$_POST['txtlv011'];
$lvtc_lv0026->lv012=$_POST['txtlv012'];
$lvtc_lv0026->lv013=$_POST['txtlv013'];
$lvtc_lv0026->lv014=$_POST['txtlv014'];
$lvtc_lv0026->lv015=$_POST['txtlv015'];
if($vFlag==1)
{
		$vresult=$lvtc_lv0026->LV_Insert();
		if($vresult==true) {
	...
	$lvtc_lv0013->LV_LoadActiveID();
	 ...
	 if ( $_FILES['file']['tmp_name'] )
	  ...
	  foreach ($rows as $row)
	  {
			  ...
			  {
				$lvsl_lv0007->LV_LoadID(trim($cell->nodeValue));
	  ...
	  for($s=$vRowItem+2;$s<=$row1;$s++)
		  {
			...
			{
				if((float)$vArrItem[$s][$v]!=0)
				{
					$lvsl_lv0007->LV_LoadID($vArrItem[$vRowItem][$v]);
					if($lvsl_lv0007->lv001!=NULL && $lvsl_lv0007->lv001!="") 
					{
						$lvtc_lv0026->lv002=$lvtc_lv0013->lv001;
						$lvtc_lv0026->lv003=$vArrItem[$vRowItem][$v];
						$lvtc_lv0026->lv004=$vArrItem[$s][$v];
						$lvtc_lv0026->lv005=$lvsl_lv0007->lv004;
						$lvtc_lv0026->lv006=$vArrItem[$vRowItem+1][$v];
						$lvtc_lv0026->lv007=$lvsl_lv0007->lv008;
						$lvtc_lv0026->lv008=0;
						$lvtc_lv0026->lv009=$lvhr_lv0020->lv001;
						$lvtc_lv0026->lv010=($vArrItem[$vRowItem+2][$v]<=0)?1:$vArrItem[$vRowItem+2][$v];
						$lvtc_lv0026->lv011=0;
						$lvtc_lv0026->LV_InsertAuto();
					}
				}
					...
					<form action="#" name="frmadd" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table">
                         ...
                         <table width="100%" border="0" align="center" class="table1">
							...
							<tr>
							  <td  height="20px" colspan="2"><a href="spi- import.zip" title="<?php echo $vLangArr[33];?>"><?php echo 'Tải mẫu';?></a></td>
							</tr>
							<tr>
...
<!---Enter New Line-->                      
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvtc_lv0026->lv001=="")?InsertWithCheckExt('sl_lv0014', 'lv001', '',1):$lvtc_lv0026->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[16];?></td>
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvtc_lv0026->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
							  ...
							  <table width="80%">
								<tr><td width="50%">
										<select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/><?php echo $lvtc_lv0026->LV_LinkField('lv003',$lvtc_lv0026->lv003);?>
										</select></td>
									<td>
							...
							<tr>
				              ...
				              <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvtc_lv0026->lv004;?>"/></td>
							</tr>							  
							<tr>
							  ...
							  <?php echo $lvtc_lv0026->LV_LinkField('lv005',$lvtc_lv0026->lv005);?>
							  </select></td><td>
							  ...
							  <td  height="20"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo (float)$lvtc_lv0026->lv006;?>" tabindex="10" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
							<tr>
							  ...
							  <?php echo $lvtc_lv0026->LV_LinkField('lv007',$lvtc_lv0026->lv007);?>
							  </select></td><td>
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv008" id="txtlv008"   tabindex="12"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvtc_lv0026->lv008;?>"/>							  </td>
						    </tr>
							<tr>
							  ...
							  <?php echo $lvtc_lv0026->LV_LinkField('lv009',$lvtc_lv0026->lv009);?>
							  </select></td><td>
							  <ul id="pop-nav4" lang="pop-nav4" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlv009_search" id="txtlv009_search" style="width:100%" onKeyUp="LoadPopup(this,'txtlv009','hr_lv0020','concat(lv004,@! @!,lv003,@! @!,lv002,@!-@!,lv001)')" onFocus="LoadPopup(this,'txtlv009','hr_lv0020','concat(lv004,@! @!,lv003,@! @!,lv002,@!-@!,lv001)')" tabindex="200" >
				  ...
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo $lvtc_lv0026->lv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>							 			  							  <tr>
							  <td  height="20"><?php echo $vLangArr[25];?></td>
				  <td  height="20"><input  name="txtlv011" type="text" id="txtlv011" value="<?php echo $lvtc_lv0026->lv011;?>" tabindex="15" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	 	
							<tr>
