...
$lvtc_lv0026->lv001=$_GET['ChildDetailID'];
if($plang=="") $plang="VN";
...
if($vFlag==1)
{
$lvtc_lv0026->lv002=$_POST['txtlv002'];
...
$lvtc_lv0026->LV_LoadID($lvtc_lv0026->lv001);
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvtc_lv0026->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>		</td>
						    </tr>
							<tr>
