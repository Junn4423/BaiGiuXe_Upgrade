...
if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","SL0029_1.txt",$plang);
...
$motc_lv0026->ArrPush[16]=$vLangArr[33];
$motc_lv0026->ArrPush[17]=$vLangArr[46];
$motc_lv0026->ArrPush[18]=$vLangArr[47];
$motc_lv0026->ArrPush[19]=$vLangArr[48];
$motc_lv0026->ArrPush[20]=$vLangArr[49];
$motc_lv0026->ArrPush[21]=$vLangArr[41];
...
$motc_lv0026->ArrFunc[6]='';
$motc_lv0026->ArrFunc[7]='';
$motc_lv0026->ArrFunc[8]=$vLangArr[10];
$motc_lv0026->ArrFunc[9]=$vLangArr[12];
$motc_lv0026->ArrFunc[10]=$vLangArr[0];
$motc_lv0026->ArrFunc[11]=$vLangArr[33];
$motc_lv0026->ArrFunc[12]=$vLangArr[34];
$motc_lv0026->ArrFunc[13]=$vLangArr[35];
$motc_lv0026->ArrFunc[14]=$vLangArr[36];
$motc_lv0026->ArrFunc[15]=$vLangArr[37];

////Other
$motc_lv0026->ArrOther[1]=$vLangArr[31];
$motc_lv0026->ArrOther[2]=$vLangArr[32];
//////Delete message///
$lvMessage=array();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$motc_lv0026->lv002=base64_decode( $_GET['ID']);
...
?>
						...
						<?php echo $motc_lv0026->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
