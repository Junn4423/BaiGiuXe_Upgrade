...
$curPage = (int)($_GET['curPg'] ?? 1);       // Mặc định là trang 1
$vFlag   = (int)($_GET['txtFlag'] ?? 0);     // Mặc định flag = 0
$vlv001=$_GET['lv001'];
$vlv002=$_GET['lv002'];
$vlv003=$_GET['lv003'];
$vlv004=$_GET['lv004'];
...
<tr>
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv007" type="text" id="txtlv007" value="<?php echo $vlv007;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							</tr>																			
							<tr>
