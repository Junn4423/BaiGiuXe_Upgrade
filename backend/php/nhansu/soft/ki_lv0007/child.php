...
include("../paras.php");
include("../../clsall/ki_menu0007.php");
...
//init object
$moki_menu0007=new ki_menu0007();
//Set variant
$moki_menu0007->itemlst=$pitemlst;
$moki_menu0007->childlst=$pchildlst;
$moki_menu0007->level3lst=$plevel3lst;
$moki_menu0007->child3lst=$pchild3lst;
$vEmpName = "";
...
<div id="content_child">
						...
						<TR vAlign="center" align="middle">				
							<td><form name="frmhr_employee" action="#" method="post">
								<select name="cbxoption" tabindex="1" onChange="callchange(this)" style="width:100px">
									<option value="1" <?php echo ($moki_menu0007->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
								</select><br/>
									Chọn thao tác
	...
	<?php
	$moki_menu0007->Dir="../";
include($moki_menu0007->GetLinkEmp());
?>
	</div></div></td></tr></table>
			<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
...
document.frmhr_employee.cbxoption.value="<?php echo $moki_menu0007->level3lst;?>";
