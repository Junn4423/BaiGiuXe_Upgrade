...
$motc_lv0042->is_tc09_add=0;
$motc_lv0042->is_tc09_apr=0;
$motc_lv0042->is_tc09_unapr=0;
...
$motc_lv0042->ArrPush[30]=$vLangArr[30];
...
$motc_lv0042->lv028="";
if($motc_lv0042->GetApr()==0)  echo $motc_lv0042->lv028=$motc_lv0042->Get_User($_SESSION['ERPSOFV2RUserID'],'lv002');
$motc_lv0042->lv029=$_GET['txtlv029'];
...
$motc_lv0042->lv001=$_GET['txtlv001'];
...
<body  onkeyup="KeyPublicRun(event)">
			...
			<div>
					<div style="text-align:center">
						...
						<div style="font-size:16;font-weight:bold;"><?php echo $vLangArr[15].":".$motc_lv0042->FormatView($motc_lv0042->datefrom,2);?>&nbsp;&nbsp;&nbsp;<?php echo $vLangArr[16].":".$motc_lv0042->FormatView($motc_lv0042->dateto,2);?></div>
					</div>
					<div id="lvleft">
					    <?php 
						$motc_lv0042->SetAllDisiable();
						echo $motc_lv0042->LV_BuilListReportOtherPrintLateSoon($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,1,$_GET['chkviewinfo']);?>
					</div>
					<div>
...
<td><br /></td>
<td colspan="3">
<div style="text-align: center;"><strong>NGU?I K� DUY?T<br /></strong></div>
</td>
<td><br /></td>
<td><br /></td>
<td colspan="3">
<div style="text-align: center;"><strong>NGU?I L?P<br /></strong></div>
</td>
<td><br /></td>
</tr>
<tr>
...
<td><br /></td>
<td colspan="3">
<div style="text-align: center;"><em>Ghi r&otilde; h? v&agrave; t&ecirc;n</em></div>
</td>
<td><br /></td>
<td><br /></td>
<td colspan="3">
