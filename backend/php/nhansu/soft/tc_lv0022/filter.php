    ...
    <h2 id="pageName"><?php echo $vLangArr[1];?></h2>
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
				  ...
				  <td  height="20px"><select name="txtlv003" id="txtlv003"  tabindex="7" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
							   <?php echo $lvtc_lv0022->LV_LinkField('lv003',$vlv003);?>
                              </select>
							    <br>
							  <table><tr><td></td><td>
							  ...
							  <td  height="20px"><select name="txtlv004" id="txtlv004"  tabindex="8" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
							   <?php echo $lvtc_lv0022->LV_LinkField('lv004',$vlv004);?>
                              </select>
							    <br>
							  <table><tr><td></td><td>
							  ...
							  <td  height="20px"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo (int)$vlv005;?>" tabindex="10" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
							  ...
							  <td  height="20px"><select name="txtlv006" id="txtlv006"  tabindex="11" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
							   <?php echo $lvtc_lv0022->LV_LinkField('lv006',$vlv006);?>
                              </select>
							    <br>
							  <table><tr><td></td><td>
							  ...
							  <tr>
							  <td  height="20px"><?php echo $vLangArr[21];?></td>
							  <td  height="20px"><input name="txtlv009" type="text" id="txtlv009" value="<?php echo $vlv009;?>" tabindex="14" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>																						
							<tr>
