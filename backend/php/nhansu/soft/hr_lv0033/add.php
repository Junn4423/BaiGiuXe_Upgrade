...
$lvhr_lv0033->lv001=InsertWithCheckExt('hr_lv0033', 'lv001', '',1);
$lvhr_lv0033->lv002= $_GET['ID'] ?? '';
					...
					<form action="#" name="frmadd" method="post">
						...
						<table width="100%" border="0" align="center" class="table1">
						  ...
						  <div id="lv_popup" lang="lv_popup1"> </div>						  
							  ...
							  <td  height="20px"><input onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmadd.txtlv004);return false;" name="txtlv004" type="text" id="txtlv004" value="<?php echo $lvhr_lv0033->FormatView($lvhr_lv0033->lv004,2);?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
							  ...
							  <td  height="20px"><input onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmadd.txtlv005);return false;" name="txtlv005" type="text" id="txtlv005" value="<?php echo $lvhr_lv0033->FormatView($lvhr_lv0033->lv005,2);?>" tabindex="10" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
						      <span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
