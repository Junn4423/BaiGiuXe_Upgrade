...
//////////////init object////////////////
$lvhr_lv0033=new hr_lv0033($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Hr0054');
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
							  <td  height="20px"><?php echo $vLangArr[17];?></td>
								...
								<option value=""></option>  
								<?php echo $lvhr_lv0033->LV_LinkField('lv003',$vlv003);?>
				  </select></td><td>
						  ...
						  <div id="lv_popup" lang="lv_popup1"> </div>						  
							...
							<tr>
							  ...
							  <td  height="20px"><input onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmedit.txtlv004);return false;" name="txtlv004" type="text" id="txtlv004" value="<?php echo $vlv004;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
						      <span class="td">(yyyy-mm-dd)</span></td>
							  </tr>
							  <tr>
							  <td  height="20px"><?php echo $vLangArr[19];?></td>
							  <td  height="20px"><input onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmedit.txtlv005);return false;" name="txtlv005" type="text" id="txtlv005" value="<?php echo $vlv005;?>" tabindex="10" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
						      <span class="td">(yyyy-mm-dd)</span></td>
							  </tr>
								<tr>
							  ...
							  <td  height="20px"><?php echo $vLangArr[24];?></td>
				  			  <td  height="20px"><table width="80%"><tr><td width="50%"><select  name="txtlv007"  id="txtlv007"  tabindex="12" maxlength="255" style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/><option value=""></option><?php echo $lvhr_lv0033->LV_LinkField('lv007',$vlv007);?>
				  </select></td><td>
