...
/////////////init object//////////////
$motc_lv0043=new tc_lv0041($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Tc0041');
...
$motc_lv0043->lv028="";
if($motc_lv0043->GetApr()==0)  echo $motc_lv0043->lv028=$motc_lv0043->Get_User($_SESSION['ERPSOFV2RUserID'],'lv002');
?>
...
<body  onkeyup="KeyPublicRun(event)">
			...
			<div>
					...
					<div id="lvleft">
						...
						echo $motc_lv0043->LV_BuilListReportOtherPrintLateSoon($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,0,$_POST['chkviewinfo']);?>
					</div>
					<div>
					<?php 
					if($plang=="") $plang="VN";
					...
					echo $motc_lv0002->LV_BuilListReportTC('lv001,lv002,lv003','document.frmchoose','chkAll','lvChk',$curRow, 1000,$paging,'',$motc_lv0043->ArrTC);?>
					</div>
		</div>
</body>
