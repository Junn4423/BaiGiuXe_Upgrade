...
$motc_lv0043->is_tc09_add=0;
$motc_lv0043->is_tc09_apr=0;
$motc_lv0043->is_tc09_unapr=0;
...
$motc_lv0043->ArrPush[30]=$vLangArr[30];
...
$motc_lv0043->lv029=$_GET['txtlv029'];
if($motc_lv0043->GetApr()==0)  $motc_lv0043->lv028=$motc_lv0043->Get_User($_SESSION['ERPSOFV2RUserID'],'lv002');
...
$motc_lv0043->lv001=$_GET['txtlv001'];
?>
...
<body  onkeyup="KeyPublicRun(event)">
			...
			<div>
					<div style="text-align:center">
						...
						<div style="font-size:16;font-weight:bold;"><?php echo $vLangArr[15].":".$motc_lv0043->FormatView($motc_lv0043->datefrom,2);?>&nbsp;&nbsp;&nbsp;<?php echo $vLangArr[16].":".$motc_lv0043->FormatView($motc_lv0043->dateto,2);?></div>
					</div>
					<div id="lvleft">
					    <?php 
						$motc_lv0043->SetAllDisiable();
						echo $motc_lv0043->LV_BuilListReportOtherPrintLateSoon($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,0,$_GET['chkviewinfo']);?>
					</div>
