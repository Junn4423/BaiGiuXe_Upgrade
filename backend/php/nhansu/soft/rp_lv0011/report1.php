...
if($_SERVER['HTTPS']=='on')
{
	$vLinkWeb="https://".$_SERVER['SERVER_NAME'].$_SERVER['PHP_SELF'].'?&childfunc=&func=rpt';
}
else
{
	$vLinkWeb="http://".$_SERVER['SERVER_NAME'].$_SERVER['PHP_SELF'].'?&childfunc=&func=rpt';
}
if($sExport=="pdf"){
...
<tr height="27">
<td>&nbsp;</td>
<td  height="27" align="center"><strong>Người lập</strong></td>
<td>&nbsp;</td>
<td  height="27" align="center"><strong>Trưởng bộ phận</strong></td>
<td>&nbsp;</td>
<td  height="27" align="center"><strong>Kế toán trưởng</strong></td>
<td>&nbsp;</td>
<td align="center"><strong>Duyệt bởi</strong></td>
<td>&nbsp;</td>
</tr>
<tr height="27">
<td height="27">&nbsp;</td>
