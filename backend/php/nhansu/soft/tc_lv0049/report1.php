...
$motc_lv0049->lv004=$year."-".$month;
$motc_lv0049->datefrom=$year."-".$month."-01";
$motc_lv0049->dateto=$year."-".$month."-".Fillnum(GetDayInMonth($year,$month),2);
$motc_lv0049->lv028="";
...
<body  onkeyup="KeyPublicRun(event)">
			...
			<div>
					...
					<div id="lvleft">
						...
						echo $motc_lv0049->LV_BuilListReportOtherPrintLateSoon($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,0,$_POST['chkviewinfo']);?>
					</div>
					<div>
					<?php 
					if($plang=="") $plang="VN";
					...
					$motc_lv0002->ArrPush[4]='Tổng';
					echo $motc_lv0002->LV_BuilListReportTC('lv001,lv002,lv003','document.frmchoose','chkAll','lvChk',$curRow, 1000,$paging,'',$motc_lv0049->ArrTC);?>
					</div>
		</div>
</body>
			...
			if (xmlhttp.readyState==4)
			{
				...
				if(parseInt(domainid)==3) 
				{
					if(parseInt(domainid2)==1)
					{
						...
						document.getElementById('btmonth_'+domainid1).value="M? kh�a";
				...
				if(parseInt(domainid)==4)
				{
					if(parseInt(domainid2)==1)
					{
						...
						document.getElementById('btmonth_'+domainid1).value="Kh�a";
						document.getElementById('btmonth_'+domainid1).onclick = function(){
