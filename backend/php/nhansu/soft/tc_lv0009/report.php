...
/////////////init object//////////////
$motc_lv0009=new tc_lv0009($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Tc0010');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","TC0024.txt",$plang);
...
$motc_lv0009->ArrFunc[121]='AL cuối kỳ';
$motc_lv0009->ArrFunc[122]='AL đầu kỳ';
$motc_lv0009->ArrFunc[123]='CL cuối kỳ';
$motc_lv0009->ArrFunc[124]='CL đầu ký';
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$motc_lv0009->lv002=base64_decode( $_GET['ID']);
...
?>
				...
				<?php echo $motc_lv0009->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
