...
<body onLoad="moveImgPrint()" onResize="moveImgPrint()">
	<table border="0" cellpadding="0" cellspacing="0" width="940px" align="center">
	    ...
	    <td align="center" colspan="6"><table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td align="center" valign="middle"  ondblclick="this.innerHTML=''"><img  src="<?php echo $mots_lv0060->GetLogo();?>" /></td>
              </tr>
              <tr>
		...
		<tr height="40px">
			<td width="399" valign="middle" class="address">
				<div id="addr" align="left" style="width:480px;">
					<?php echo $mots_lv0060->GetCompany();?>
				<br><?php echo $vLangArr[18].":".$mots_lv0060->GetAddress();?>	
					<br><?php echo $vLangArr[15].":".$mots_lv0060->GetPhone()."&nbsp;&nbsp;&nbsp;".$vLangArr[16].":".$mots_lv0060->GetFax();?>
		  </div></td>
...
?>			
		...
		<tr>
			...
			<td height="20px" colspan="6" align="center" class="normaltext">
				<?php 
					echo $strDataShow = $mots_lv0060->PrintInOutPutInStockDetail($plang, $vLangArr,$vlv001,recoverdate($vlv002,$plang),recoverdate($vlv003,$plang),2,$vlv005,$vlv013,$vlv006,$vlv009,$vlv016,$vlv008);
				?></td>
		</tr>
