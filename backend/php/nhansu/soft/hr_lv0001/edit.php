...
<tr>
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv010" type="text" id="txtlv010" value="<?php echo $lvhr_lv0001->lv010;?>" tabindex="14" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							  <td>&nbsp;</td>
							</tr>	
							<tr>
