...
include("../paras.php");
include("../../clsall/tc_menuemployee.php");

$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","TC0018.txt",$plang);
//init object
$motc_menuemployee=new tc_menuemployee();
//Set variant
$motc_menuemployee->itemlst=$pitemlst;
$motc_menuemployee->childlst=$pchildlst;
$motc_menuemployee->level3lst=$plevel3lst;
$motc_menuemployee->child3lst=$pchild3lst;
...
<div id="content_child">
              ...
              <tr>
                <td><TABLE id="toolbar" cellSpacing="0" cellPadding="0" border="0" width="100%">
					<TBODY>
	 			 	...
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)" style="width:180px">
						<option value="1" <?php echo ($motc_menuemployee->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
						<option value="2" <?php echo ((int)$motc_menuemployee->level3lst==2)?'selected="selected"':'';?>>2.<?php echo $vLangArr[9];?></option>
						<option value="3" <?php echo ((int)$motc_menuemployee->level3lst==3)?'selected="selected"':'';?>>3.<?php echo $vLangArr[10];?></option>
						<option value="4" <?php echo ((int)$motc_menuemployee->level3lst==4)?'selected="selected"':'';?>>4.<?php echo $vLangArr[11];?></option>
						<option value="5" <?php echo ((int)$motc_menuemployee->level3lst==5)?'selected="selected"':'';?>>5.<?php echo $vLangArr[12];?></option>
						<option value="6" <?php echo ((int)$motc_menuemployee->level3lst==6)?'selected="selected"':'';?>>6.<?php echo $vLangArr[13];?></option>
						<option value="7" <?php echo ((int)$motc_menuemployee->level3lst==7)?'selected="selected"':'';?>>7.<?php echo $vLangArr[14];?></option>
						<option value="8" <?php echo ((int)$motc_menuemployee->level3lst==8)?'selected="selected"':'';?>>8.<?php echo 'Nhập ca đêm';?></option>
					</select><br/>Chọn thông số
		
	    <input type="hidden" name="txtEmployeeID" id="txtEmployeeID" value="<?php echo $_SESSION['ERPSOFV2RUserID'];?>" />
		<input type="hidden" name="txtFlagDocument" id="txtFlagDocument" /> </form></td>
							<TD class="toolbar_<?php echo ($motc_menuemployee->level3lst==1)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(1);">
							...
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>
							<TD class="toolbar_<?php echo ($motc_menuemployee->level3lst==2)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(2);">
								<img src="../images/controlright/year.png" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo $vLangArr[9];?></a></TD>
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>
							<TD  class="toolbar_<?php echo ($motc_menuemployee->level3lst==3)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(3);">
								<img src="../images/controlright/monthly.png" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo $vLangArr[10];?></a></TD>
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>
							<TD class="toolbar_<?php echo ($motc_menuemployee->level3lst==4)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(4);">
								<img src="../images/controlright/job.gif" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo $vLangArr[11];?></a></TD>
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>
							<TD  class="toolbar_<?php echo ($motc_menuemployee->level3lst==5)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(5);">
								<img src="../images/controlright/payment.gif" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo $vLangArr[12];?></a></TD>
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>
							<TD  class="toolbar_<?php echo ($motc_menuemployee->level3lst==6)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(6);">
								<img src="../images/controlright/entertime.png" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo $vLangArr[13];?></a></TD>
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>	
							<TD  class="toolbar_<?php echo ($motc_menuemployee->level3lst==7)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(7);">
								<img src="../images/controlright/work_experience.gif" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo $vLangArr[14];?></a></TD>
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>		
							<TD  class="toolbar_<?php echo ($motc_menuemployee->level3lst==8)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(8);">
								<img src="../images/controlright/entertime.png" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo 'Nhập ca đêm';?></a></TD>
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>								
	...
	<?php
	$motc_menuemployee->Dir="../";
include($motc_menuemployee->GetLinkEmp());
?>
	</div></div></td></tr></table>
			<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
...
document.frmhr_employee.cbxoption.value="<?php echo $motc_menuemployee->level3lst;?>";
