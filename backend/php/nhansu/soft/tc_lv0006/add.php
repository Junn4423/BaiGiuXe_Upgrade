...
$lvtc_lv0006->lv001=$_POST['txtlv001'];
...
if($vFlag==1)
{
		...
		$vresult=$lvtc_lv0006->LV_Insert();
		if($vresult==true) {
			UploadImg($lvtc_lv0006->lv001, $lvtc_lv0006->lv007);///Call function Upload file
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvtc_lv0006->lv001=="")?InsertWithCheckExt('tc_lv0006', 'lv001', '',10):$lvtc_lv0006->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
...
<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv007" type="hidden" id="txtlv007"  value="<?php echo $lvtc_lv0006->lv007;?>" tabindex="11" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" />	<input type="file" name="userfile" id="userfile" size="23" readonly="true"/>		</td>
					      </tr>
							<tr>
...
<tr>
							...
							<tr>
							  ...
							  <td  height="20"><select name="txtlv026"  id="txtlv026"  value="<?php echo $lvtc_lv0006->lv026;?>" tabindex="30"  style="width:80%" onkeypress="return CheckKey(event,7)"/>
							  <?php echo $lvtc_lv0006->LV_LinkField('lv026',$lvtc_lv0006->lv026);?>
							      </select><br><table><tr><td></td><td>
