...
$lvcr_lv0004->lv002=$_POST['txtlv004'];
if( $_GET['ID']!='')
	$lvcr_lv0086->lv002= $_GET['ID'];
else
	$lvcr_lv0086->lv002=$lvcr_lv0004->LV_AutoBuilUser($lvcr_lv0004->LV_UserID);
if(!isset($_POST['txtlv003']))
	$lvcr_lv0086->lv003='TAMUNG';
else
	$lvcr_lv0086->lv003=$_POST['txtlv003'];
$lvcr_lv0086->lv004=str_replace(",","",$_POST['txtlv004']);
$lvcr_lv0086->lv005=$_POST['txtlv005'];
$lvcr_lv0086->lv006=$_POST['txtlv006'];
$lvcr_lv0086->lv007=$_POST['txtlv007'];
if(!isset($_POST['txtlv008']))
	$lvcr_lv0086->lv008=$lvsp_lv0008->lv017;
else
...
if($_POST['txtlv013']=='' || $_POST['txtlv013']==NULL) $lvcr_lv0086->lv013='CUS';
					...
					<form action="#"  name="frmadd" id="frmadd"  method="post">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
							  ...
							  <td  height="20px"> 
									<input name="txtlv005" type="text" id="txtlv005" value="<?php echo $lvcr_lv0086->FormatView($lvcr_lv0086->lv005,2);?>" tabindex="10" maxlength="50" style="width:100px" onKeyPress="return CheckKey(event,7)" onclick="if(self.gfPop)gfPop.fPopCalendar(document.frmadd.txtlv005);return false;">
									<select name="txtlv005_" type="text" id="txtlv005_" value="<?php echo $lvcr_lv0086->lv010_;?>" tabindex="10" maxlength="50" style="width:100px;text-align:center;" onKeyPress="return CheckKey(event,7)">
							...
							<td  height="20">		
							  <ul style="width:100%" id="pop-nav15" lang="pop-nav15" onmouseover="ChangeName(this,15)" onkeyup="ChangeName(this,15)"> <li class="menupopT">
									<input autocomplete="off" class="txtenterquick" type="text" style="width:80%;min-width:80px" name="txtlv015" id="txtlv015" onkeyup="LoadSelfNext<?php echo $vParentSearch;?>(this,'txtlv015','cr_lv0031','lv001','concat(lv001,@! @!,lv002)')" onkeypress="return CheckKey(event,7)" tabindex="2" value="" onblur="if(this.value.substr(this.value.length-1,this.value.length)==',') {this.value=this.value.substr(0,this.value.length-1);};">
