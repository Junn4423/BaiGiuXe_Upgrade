...
include("../paras.php");
include("../../clsall/tc_menulv0019.php");

$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","TC0035.txt",$plang);
//init object
$motc_menulv0019=new tc_menulv0019();
//Set variant
$motc_menulv0019->itemlst=$pitemlst;
$motc_menulv0019->childlst=$pchildlst;
$motc_menulv0019->level3lst=$plevel3lst;
$motc_menulv0019->child3lst=$pchild3lst;
...
<div id="content_child">
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($motc_menulv0019->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
						<option value="2" <?php echo ((int)$motc_menulv0019->level3lst==2)?'selected="selected"':'';?>>2.<?php echo $vLangArr[9];?></option>
						<option value="3" <?php echo ((int)$motc_menulv0019->level3lst==3)?'selected="selected"':'';?>>3.<?php echo $vLangArr[10];?></option>
						<option value="4" <?php echo ((int)$motc_menulv0019->level3lst==4)?'selected="selected"':'';?>>4.<?php echo $vLangArr[11];?></option>
						<option value="5" <?php echo ((int)$motc_menulv0019->level3lst==5)?'selected="selected"':'';?>>5.<?php echo $vLangArr[12];?></option>
						<option value="6" <?php echo ((int)$motc_menulv0019->level3lst==6)?'selected="selected"':'';?>>6.<?php echo $vLangArr[13];?></option>
					</select>
	...
	<?php
	$motc_menulv0019->Dir="../";
include($motc_menulv0019->GetLinkEmp());
?>
	</div></div></td></tr></table>
			<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
...
document.frmhr_employee.cbxoption.value="<?php echo $motc_menulv0019->level3lst;?>";
