  ...
  <div class="story">
    <h2 id="pageName"><?php echo $vLangArr[1];?></h2>
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
				  ...
				  <option value=""></option>
				  <?php echo $lvtc_lv0064->LV_LinkField('lv003',$vlv003);?>
				  </select></td><td>
				  ...
				  <td  height="20px"><table width="80%"><tr><td width="50%"><select  name="txtlv004"  id="txtlv004"  tabindex="10" maxlength="255" style="width:100%" onKeyPress="return CheckKey(event,7)"/>
				  <option value=""></option>
				  <?php echo $lvtc_lv0064->LV_LinkField('lv004',$lvtc_lv0064->lv004);?>
				  </select></td><td>
