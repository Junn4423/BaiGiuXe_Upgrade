...
require_once("../../clsall/jo_lv0003.php");
//////////////init object////////////////
$lvjo_lv0003=new  jo_lv0003($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'HR0027');
...
$lvjo_lv0003->lv001=$_POST['txtlv001'];
$lvjo_lv0003->lv002=$_POST['txtlv002'];
if($vFlag==1)
{
		
		$vresult=$lvjo_lv0003->LV_Insert();
		if($vresult==true) {
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvjo_lv0003->lv001=="")?InsertWithCheckExt('jo_lv0003', 'lv001', 'MD',4):$lvjo_lv0003->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
							</tr>
							<tr>
