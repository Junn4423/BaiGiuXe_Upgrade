...
if($lvts_lv0008->lv009=="") $lvts_lv0008->lv009=GetServerDate();
if($vFlag==1)
{
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvts_lv0008->lv001=="")?InsertWithCheckExt('ts_lv0008', 'lv001', 'PN',10):$lvts_lv0008->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
						    </tr>
							<tr>
