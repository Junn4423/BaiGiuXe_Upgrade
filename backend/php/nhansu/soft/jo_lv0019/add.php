...
$lvjo_lv0019->lv001=$_POST['txtlv001'];
...
if($lvjo_lv0019->lv006=="" || $lvjo_lv0019->lv006==NULL) $lvjo_lv0019->lv006=GetServerDate();
$lvjo_lv0019->lv007=$_POST['txtlv007'];
$lvjo_lv0019->lv008=$_POST['txtlv008'];
if($vFlag==1)
{
		
		$vresult=$lvjo_lv0019->LV_Insert();
		if($vresult==true) {
						...
						<table width="800" border="0" align="left" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvjo_lv0019->lv001=="")?InsertWithCheck('jo_lv0019', 'lv001', 'LOC-',1):$lvjo_lv0019->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
							</tr>
							<tr>
