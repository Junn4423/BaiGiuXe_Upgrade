...
$lvts_lv0004->lv001=$_POST['txtlv001'];
if( $_GET['ID']=="")
...
$lvts_lv0004->lv009=$_POST['txtlv006'];
$lvts_lv0004->lv010=$_POST['txtlv010'];
$lvts_lv0004->lv011=$_POST['txtlv011'];
if($lvts_lv0004->lv005=="") $lvts_lv0004->lv005=GetServerDate();
					...
					<form action="#" name="frmadd" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvts_lv0004->lv001=="")?InsertWithCheck('ts_lv0004', 'lv001', 'KK-'.getmonth($vNow)."/".getyear($vNow)."-",4):$lvts_lv0004->lv001;?>" tabindex="5" maxlength="32" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
						    </tr>
							<tr>
