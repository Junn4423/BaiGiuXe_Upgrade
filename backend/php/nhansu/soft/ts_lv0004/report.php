...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$mots_lv0004->lv002=base64_decode( $_GET['ID']);
...
?>
						...
						<?php echo $mots_lv0004->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
