						...
						<tr>
							...
							<tr>
							  ...
							  <td width="50%"><select name="txtlv002" id="txtlv002"   tabindex="6"  style="width:80%" onkeypress="return CheckKeys(event,7,this)">
							   <option value=""></option>
								<?php echo $lvts_lv0004->LV_LinkField('lv002',$vlv002);?>
                              </select></td><td>
...
<tr>
							  ...
							  <td width="50%"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:80%" onkeypress="return CheckKeys(event,7,this)"/>
								<option value=""></option>
								<?php echo $lvts_lv0004->LV_LinkField('lv003',$vlv003);?>
							  </select></td><td>
						  ...
						  <br></td></tr>
							<tr>
							  ...
							  <td  height="20"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo $lvts_lv0004->FormatView($vlv005,2);?>" tabindex="9" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
...
<tr>
								...
								<option value=""></option>
							  <?php echo $lvts_lv0004->LV_LinkField('lv007',$vlv007);?>
							...
							<tr>
							  ...
							  <option value=""></option>
							  <?php echo $lvts_lv0004->LV_LinkField('lv008',$vlv008);?>
							  </select><br><table><tr><td>
