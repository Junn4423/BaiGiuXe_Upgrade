...
$lvts_lv0004->lv001=$_GET['ChildID'];
if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","TS0006.txt",$plang);
...
$lvts_lv0004->lv003=$_POST['txtlv003'];
$lvts_lv0004->lv004=$_POST['txtlv004'];
$lvts_lv0004->lv005=$_POST['txtlv005'];
$lvts_lv0004->lv006=$_POST['txtlv006'];
if($_FILES['userfile']['name']=="")
$lvts_lv0004->lv007=$_POST['txtlv007'];
else
$lvts_lv0004->lv007=$_FILES['userfile']['name'];
$lvts_lv0004->lv008=$_POST['txtlv008'];
$lvts_lv0004->lv009=$_POST['txtlv009'];
$lvts_lv0004->lv010=$_POST['txtlv010'];
$lvts_lv0004->lv011=$_POST['txtlv011'];
$lvts_lv0004->lv012=$_POST['txtlv012'];
$lvts_lv0004->lv013=$_POST['txtlv013'];
$lvts_lv0004->lv014=$_POST['txtlv014'];
$lvts_lv0004->lv015=$_POST['txtlv015'];
$lvts_lv0004->lv016=$_POST['txtlv016'];
		
		$vresult=$lvts_lv0004->LV_Update();
		if($vresult==true) {
					...
					<form action="#" name="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvts_lv0004->lv001=="")?InsertWithCheckExt('huyvanv2_0.ts_lv0004', 'lv001', '',10):$lvts_lv0004->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
...
<tr>
							  ...
							  <td width="50%"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:80%" onkeypress="return CheckKeys(event,7,this)"/>
								<?php echo $lvts_lv0004->LV_LinkField('lv003',$lvts_lv0004->lv003);?>
							  </select></td><td>
							...
							<tr>
							  ...
							  <td  height="20"></select>
							  <input name="txtlv004" type="text" id="txtlv004"  value="<?php echo $lvts_lv0004->lv004;?>" tabindex="8" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
						  <br></td></tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[19];?></td>
							  <td  height="20"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo $lvts_lv0004->FormatView($lvts_lv0004->lv005,2);?>" tabindex="9" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
							...
							<tr>
							  ...
							  <td  height="20"><textarea name="txtlv006" rows="20" id="txtlv006" style="width:80%" tabindex="13" ><?php echo $lvts_lv0004->lv006;?></textarea></td>
						    </tr>		
						<tr>
