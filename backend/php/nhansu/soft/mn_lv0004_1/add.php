<?php
session_start();
//require_once("../../clsall/mn_lv0004_1.php");
...
//////////////init object////////////////
$lvmn_lv0004_1=new mn_lv0004_1($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Mn0004');
...
if(isset($_GET['ajax']))
{
	...
	echo '[CHECK]';
	echo '<select name="txtlv005" id="txtlv005"   tabindex="9"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/> '.$lvmn_lv0004_1->LV_LinkField('lv005',$lvsl_lv0007->lv004).'</select>';
	echo '[ENDCHECK]';
	exit;
}	
if($plang=="") $plang="VN";
...
$lvmn_lv0004_1->lv001=$_POST['txtlv001'];
$lvmn_lv0004_1->lv002= $_GET['ID'] ?? '';
$lvmn_lv0004_1->lv003=$_POST['txtlv003'];
$lvmn_lv0004_1->lv004=$_POST['txtlv004'];
$lvmn_lv0004_1->lv005=$_POST['txtlv005'];
$lvmn_lv0004_1->lv006=$_POST['txtlv006'];
$lvmn_lv0004_1->lv007=$_POST['txtlv007'];
$lvmn_lv0004_1->lv008=$_POST['txtlv008'];
$lvmn_lv0004_1->lv009=$_POST['txtlv009'];
$lvmn_lv0004_1->lv010=$_POST['txtlv010'];
$lvmn_lv0004_1->lv011=$_POST['txtlv011'];
$lvmn_lv0004_1->lv099=$_POST['txtlv099'];
if($lvmn_lv0004_1->lv011=="" || $lvmn_lv0004_1->lv011==NULL) $lvmn_lv0004_1->lv011="1";
if($vFlag==1)
{		
		$vresult=$lvmn_lv0004_1->LV_Insert();
		if($vresult==true) {
					...
					<form action="#"   name="frmadd" id="frmadd"  method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvmn_lv0004_1->lv001=="")?InsertWithCheckExt('mn_lv0004', 'lv001', '',1):$lvmn_lv0004_1->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[16];?></td>
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvmn_lv0004_1->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[17];?></td>
							  <td  height="20">
							 <table style="width:80%"><tr>
							 <td width="50%"><input name="txtlv003" type="text" id="txtlv003"  value="<?php echo $lvmn_lv0004_1->lv003;?>" tabindex="6" maxlength="225" style="width:100%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td><td>
...
<tr>
				              ...
				              <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvmn_lv0004_1->lv004;?>"/></td>
</tr>							  
							<tr>
							  ...
							  <?php echo $lvmn_lv0004_1->LV_LinkField('lv005',$lvmn_lv0004_1->lv005);?>
							  </select></div></td><td>
							...
							<tr>
								...
								<td  height="20"><input name="txtlv007" id="txtlv007"   tabindex="11"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvmn_lv0004_1->lv007;?>"/> </td>
					      </tr>						 
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[22];?></td>
							  <td  height="20"><input name="txtlv008" id="txtlv008"   tabindex="11"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvmn_lv0004_1->lv008;?>"/>		
							  </td>
						    </tr>
							<tr>
							  ...
							  <ul id="pop-nav4" lang="pop-nav4" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
							    <input type="text" name="txtlv009" id="txtlv009" tabindex="13" style="width:100%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvmn_lv0004_1->lv009;?>" onKeyUp="LoadSelf(this,'txtlv009','sl_lv0017','lv003')" onFocus="LoadSelf(this,'txtlv009','sl_lv0017','lv003')">
                         	...
                         	<tr>
							  ...
							  <?php echo $lvmn_lv0004_1->LV_LinkField('lv011',$lvmn_lv0004_1->lv011);?>
							  </select></td>
						    </tr>	
							<tr>
							  <td  height="20" valign="top"><?php echo 'Nhóm';?></td>
							  <td  height="20"><input name="txtlv099" id="txtlv099"   tabindex="11"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvmn_lv0004_1->lv099;?>"/>		
							  </td>
						    </tr>											
							<tr>
...
<?php
	...
	include("../mn_lv0004_1/permit.php");
}
?>
</body>
</html>