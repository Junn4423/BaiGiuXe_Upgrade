...
$lvjo_lv0005->lv001=$_POST['txtlv001'];
$lvjo_lv0005->lv002= $_GET['ID'] ?? '';
					...
					<form action="#" name="frmadd" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvjo_lv0005->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[17];?></td>
							  <td  height="20"><input name="txtlv003" type="text"  id="txtlv003"   tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvjo_lv0005->lv003;?>"/>			</td>
						    </tr>	
							<tr>
								<td width="166"  height="20" valign="top"><?php echo $vLangArr[20];?></td>
								<td width="178"  height="20"><textarea name="txtlv004" type="text"  id="txtlv004"   tabindex="7"  style="width:80%" ><?php echo $lvjo_lv0005->lv004;?></textarea></td>
					      </tr>																		
							<tr>
