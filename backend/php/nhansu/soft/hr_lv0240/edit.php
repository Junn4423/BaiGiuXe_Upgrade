...
$lvhr_lv0240->LV_LoadID($lvhr_lv0240->lv001);
...
<script language="javascript">
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvhr_lv0240->lv002;?>";
		o.txtlv002.focus();
	}
	function Cancel()
	{
					...
					<?php		
						...
						?>
							...
							<tr>
							  ...
							  <td width="335"  height="20px"><input class="norequired" name="txtlv001" type="text" id="txtlv001" readonly="true" value="<?php echo $lvhr_lv0240->lv001;?>" /></td>
							</tr>
						<tr>
