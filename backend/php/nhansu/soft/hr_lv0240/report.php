...
if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","HR0323.txt",$plang);
...
$mohr_lv0240->ArrFunc[11]=$vLangArr[25];
$mohr_lv0240->ArrFunc[12]=$vLangArr[26];
$mohr_lv0240->ArrFunc[13]=$vLangArr[27];
$mohr_lv0240->ArrFunc[14]=$vLangArr[28];
$mohr_lv0240->ArrFunc[15]=$vLangArr[29];
////Other
$mohr_lv0240->ArrOther[1]=$vLangArr[23];
$mohr_lv0240->ArrOther[2]=$vLangArr[24];
//////Delete message///
$lvMessage=array();
...
?>
				...
				<?php echo $mohr_lv0240->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
