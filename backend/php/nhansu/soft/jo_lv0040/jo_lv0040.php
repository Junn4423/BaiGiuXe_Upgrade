...
if(!isset($_POST['txtlv005'])) $mojo_lv0040->lv005=$vNow;
...
function RptWH(vValue)
{
	...
	o.txtlv221.value=getChecked(o.chklv221.value,'chklv221');
	o.action="jo_lv0040?func=rpt"
	o.submit();
}
function Refresh()
{
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
                    ...
                    <input type="hidden" name="lang" value="<?php echo $_GET['lang'];?>" />
					 <table width="100%" border="0" align="center" class="table1">
                             ...
                             <tr>
							  ...
							  <td width="178"  height="20">
								  <div style="max-height:400px;overflow:auto">
									<input name="txtlv002" type="hidden" id="txtlv002" value="<?php echo $mojo_lv0040->lv002;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"> <?php echo $mojo_lv0040->GetBuilCheckListDept($mojo_lv0040->lv002,'chklv002',10,'hr_lv0002','lv003',$mojo_lv0040->lv029);?>
								  </div>
							  </td>
						    </tr>	
						    <tr>
						  ...
						  <tr>
							  ...
							  <td  height="20">
							   <div style="max-height:200px;overflow:auto">
									<input name="txtlv003" type="hidden" id="txtlv003" value="<?php echo $mojo_lv0040->lv003;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"> <?php echo $mojo_lv0040->GetBuilCheckList('0,1,4,5,6','chklv003',10,'hr_lv0022');?>
								</div>
							</td>
					   </tr>	
							  ...
							  <td  height="20"><table><tr><td><input name="txtlv004" type="text" id="txtlv004" value="<?php echo $mojo_lv0040->lv004;?>" tabindex="9" maxlength="50" style="width:100%" onKeyPress="return CheckKeys(event,7,this)" /></td><td>
				      ...
				      <td  height="20"><input name="txtdatefrom" type="text" id="txtdatefrom" value="<?php echo $mojo_lv0040->FormatView($lvDateFrom,2);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
				      ...
				      <td  height="20"><input name="txtdateto" type="text" id="txtdateto" value="<?php echo $mojo_lv0040->FormatView($lvDateTo,2);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
			          <span class="td"><img src="../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
					    ...
					    <tr>
					   		<td><?php echo $vLangArr[28];?></td><td>
					   			 <div style="max-height:200px;overflow:auto">
									<input name="txtlv221" type="hidden" id="txtlv221" value="<?php echo $mojo_lv0040->lv221;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"> <?php echo $mojo_lv0040->GetBuilCheckList('4,5,6,7,8,9','chklv221',10,'jo_lv0100');?>
								</div>
					   		</select></td>
					   </tr>	
					   <tr>
