...
$lvts_lv0041->lv001=$_POST['txtlv001'];
if( $_GET['ID']=="")
...
if($lvts_lv0041->lv009=="") $lvts_lv0041->lv009=$vNow;
if($vFlag==1)
{
		
		$vresult=$lvts_lv0041->LV_Insert();
		if($vresult==true) {
			$vStrMessage=$vLangArr[9];
			$vFlag = 1;
		} else{
			$lvts_lv0041->lv009=$_POST['txtlv009'];
			$lvts_lv0041->lv001=InsertWithCheck('ts_lv0041', 'lv001', 'PK-'.getmonth($vNow)."/".getyear($vNow)."-",1);
			$vresult=$lvts_lv0041->LV_Insert();
			if($vresult==true) {
			$vStrMessage=$vLangArr[9];
			$vFlag = 1;
					...
					<form action="#"   name="frmadd" id="frmadd"  method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvts_lv0041->lv001=="")?InsertWithCheck('ts_lv0041', 'lv001', 'PK-'.getmonth($vNow)."/".getyear($vNow)."-",1):$lvts_lv0041->lv001;?>" tabindex="5" maxlength="32" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
						    </tr>
							<tr>
