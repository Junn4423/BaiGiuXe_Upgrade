						...
						<tr>
							...
							<tr>
							  ...
							  <td  height="20"><select name="txtlv002" id="txtlv002"   tabindex="6"  style="width:80%" onkeypress="return CheckKey(event,7)"><option value=""></option>
							   <?php echo $lvts_lv0041->LV_LinkField('lv002',$vlv002);?>
                              </select>
							    <br>
							  <table><tr><td>
...
<tr>
								...
								<?php echo $lvts_lv0041->LV_LinkField('lv003',$vlv003);?>
		...
		<tr>
							  ...
							  <td  height="20"><input name="txtlv009" type="text" id="txtlv009" value="<?php echo $lvts_lv0041->lv009;?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
