...
//require_once("../../clsall/ts_lv0041.php");
...
require_once("../../clsall/ts_lv0041.php");
//////////////init object////////////////
$lvts_lv0041=new ts_lv0041($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ts0008');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvts_lv0041->lv001=$_GET['ChildID'];
if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","TS0053.txt",$plang);
...
$lvts_lv0041->lv003=$_POST['txtlv003'];
$lvts_lv0041->lv004=$_POST['txtlv004'];
$lvts_lv0041->lv005=$_POST['txtlv005'];
$lvts_lv0041->lv006=$_POST['txtlv006'];
$lvts_lv0041->lv007=$_POST['txtlv007'];
$lvts_lv0041->lv008=$_POST['txtlv008'];
$lvts_lv0041->lv009=$_POST['txtlv009'];
$lvts_lv0041->lv010=$_POST['txtlv010'];
$lvts_lv0041->lv011=$_POST['txtlv011'];
$lvts_lv0041->lv012=$_POST['txtlv012'];
$lvts_lv0041->lv013=$_POST['txtlv013'];
$lvts_lv0041->lv014=$_POST['txtlv014'];
$lvts_lv0041->lv015=$_POST['txtlv015'];
$lvts_lv0041->lv016=$_POST['txtlv016'];
		
		$vresult=$lvts_lv0041->LV_Update();
		if($vresult==true) {
...
$lvts_lv0041->LV_LoadID($lvts_lv0041->lv001);
					...
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvts_lv0041->lv001=="")?InsertWithCheckExt('ts_lv0041', 'lv001', '',10):$lvts_lv0041->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
						    </tr>
							<tr>
							  ...
							  <td  height="20"><select name="txtlv002" id="txtlv002"   tabindex="6"  style="width:80%" onkeypress="return CheckKey(event,7)">
							   <?php echo $lvts_lv0041->LV_LinkField('lv002',$lvts_lv0041->lv002);?>
                              </select>
							    <br>
							  <table><tr><td>
...
<tr>
								...
								<?php echo $lvts_lv0041->LV_LinkField('lv003',$lvts_lv0041->lv003);?>
							...
							<tr>
							  ...
							  <td  height="20"></select>
							  <input name="txtlv004" type="text" id="txtlv004"  value="<?php echo $lvts_lv0041->lv004;?>" tabindex="8" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
						  <br></td></tr>
							<tr>
							  ...
							  <td  height="20"><select name="txtlv005" id="txtlv005"   tabindex="9"  style="width:80%" onkeypress="return CheckKey(event,7)"/>
								<?php echo $lvts_lv0041->LV_LinkField('lv005',$lvts_lv0041->lv005);?>
							  </select>	<br><table><tr><td>
							  <ul id="pop-nav3" lang="pop-nav3" onMouseOver="ChangeName(this,3)" onkeyup="ChangeName(this,3)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch1" id="txtlvsearch1" style="width:200px" onKeyUp="LoadPopup(this,'txtlv005','ts_lv0013','lv002')" onFocus="LoadPopup(this,'txtlv005','ts_lv0013','lv002)')" tabindex="200" >
						  ...
						  <tr>
							  ...
							  <td  height="20"></select>
							  <input name="txtlv006" type="text" id="txtlv006"  value="<?php echo $lvts_lv0041->lv006;?>" tabindex="10" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
						  <br></td></tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[28];?></td>
							  <td  height="20"></select>
							  <input name="txtlv010" type="text" id="txtlv010"  value="<?php echo $lvts_lv0041->lv010;?>" tabindex="10" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
						  <br></td></tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[23];?></td>
							  <td  height="20"><input name="txtlv009" type="text" id="txtlv009" value="<?php echo $lvts_lv0041->FormatView($lvts_lv0041->lv009,2);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
							  ...
							  <td  height="20"><textarea name="txtlv008" rows="20" id="txtlv008" style="width:80%" tabindex="13" ><?php echo $lvts_lv0041->lv008;?></textarea></td>
						    </tr>		
						<tr>
