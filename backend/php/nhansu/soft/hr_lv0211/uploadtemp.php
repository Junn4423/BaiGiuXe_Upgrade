...
if($vFlag==1)
{
	...
	if($vKetQua==null)
	{
		$vresult=$lvhr_lv0211->LV_InsertAutoTemp($vViTriUp,$vHinhUpdate);
	}
	else
	{
		$lvhr_lv0211->lv001=$vKetQua;
		$vresult=$lvhr_lv0211->LV_UpdateAutoTemp($vKetQua,$vViTriUp,$vHinhUpdate);
	}
...
<form name="frmpost" id="frmpost" target="_self" action="?childfunc=uploadtemp&FileID=<?php echo $_GET['FileID'];?>&ViTriUp=<?php echo $_GET['ViTriUp'];?>&lang=<?php echo $_GET['lang'];?>" method="post" enctype="multipart/form-data">
...
<?php
if($vFlag==1) 
	$lvImg="<a target=\"_blank\" href=\"../hr_lv0211/readfiletemp.php?FileID=".$vFileID."&type=".$vViTriUp."&size=0\"><div style=\"border-radius:5px;background:#aaa;padding:4px;color:#000;\">View</div></a>";
else
	$lvImg='';
?>		
	...
	{
		//if(qxtlv006.value=='') 
		qxtlv006.value='<?php echo $extension;?>';
	}
