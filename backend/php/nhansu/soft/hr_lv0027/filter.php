    ...
    <h2 id="pageName"><?php echo $vLangArr[1];?></h2>
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
							  ...
							  <td  height="20px"><span class="td">
						        ...
						        <input name="txtlv003" type="radio" tabindex="7" value="0" style="vertical-align:bottom" <?php echo ($vlv003==0)?"checked":"";?>/>
						  <?php echo $vLangArr[25];?>
						  <input name="txtlv003" type="radio" tabindex="7" value="1" style="vertical-align:bottom" <?php echo ($vlv003!=0)?"checked":"";?>/></td>
							</tr>
							<tr>
				  ...
				  <td  height="20px"><table width="80%"><tr><td width="50%"><select  name="txtlv005"  id="txtlv005"  tabindex="9" maxlength="255" style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/>
				  				<option value=""></option>
							  <?php echo $lvhr_lv0027->LV_LinkField('lv005',$vlv005);?>
							  </select></td><td>
