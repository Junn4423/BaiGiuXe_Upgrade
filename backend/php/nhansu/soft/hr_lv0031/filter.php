					...
					<form action="#" name="frmfilter" method="post">
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
							  ...
							  <td  height="20px"><table width="80%"><tr><td width="50%">
							  <select name="txtlv003" id="txtlv003"   tabindex="7" maxlength="225" style="width:100%" onKeyPress="return CheckKeys(event,7,this)" readonly="true"/><option value=""></option><?php echo $lvhr_lv0031->LV_LinkField('lv003',$lvhr_lv0031->lv003);?></select></td>
							  <td>
						  ...
						  <div id="lv_popup" lang="lv_popup1"> </div>						  
							...
							<tr>
							  ...
							  <td  height="20px"><select  name="txtlv004"  id="txtlv004" tabindex="8" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/><?php echo $lvhr_lv0031->LV_LinkField('lv004',$vlv004);?></select></td>
							</tr>							
							<tr>
							  <td  height="20px"><?php echo $vLangArr[19];?></td>
				  <td  height="20px"><input type="text" value="<?php echo $vlv005;?>" name="txtlv005"  id="txtlv005"  tabindex="9" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
							  ...
							  <td  height="20px"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo $vlv006;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
							  ...
							  <td  height="20px"><input name="txtlv007" type="text" id="txtlv007" value="<?php echo $vlv007;?>" tabindex="10" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
						      <span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
							  ...
							  <td  height="20px"><input name="txtlv008" type="text" id="txtlv008" value="<?php echo $vlv008;?>" tabindex="11" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>		
                              <tr>
