...
require_once("../../clsall/hr_lv0025.php");
//////////////init object////////////////
$lvhr_lv0025=new  hr_lv0025($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Hr0064');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","HR0149.txt",$plang);
	
$curPage = (int)($_POST['curPg'] ?? 1);
$vFlag   = (int)($_POST['txtFlag'] ?? 0);
$lvhr_lv0025->lv001=$_POST['txtlv001'];
$lvhr_lv0025->lv002=$_POST['txtlv002'];
if($vFlag==1)
{
		
		$vresult=$lvhr_lv0025->LV_Insert();
		if($vresult==true) {
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
								...
								<td width="*%"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvhr_lv0025->lv001=="")?InsertWithCheckExt('hr_lv0025', 'lv001', 'CDE',3):$lvhr_lv0025->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input  name="txtlv002" type="text" id="txtlv002" value="<?php echo $lvhr_lv0025->lv002;?>" tabindex="6" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
							<tr>
