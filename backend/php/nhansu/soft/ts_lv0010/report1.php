...
$vlv001=$varr[0];
/////////////init object//////////////
$mots_lv0010=new sl_lv0013($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0013');
$mots_lv0010=new sl_lv0001($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0001');
...
$mots_lv0010->ArrPush[100]=$vLangArr[20]." lưu chuyển đến";
...
<body onLoad="moveImgPrint()" onResize="moveImgPrint()">
	...
	if($mots_lv0010->lv005=='BANHANG' || $mots_lv0010->lv005=='TRAHANG')
	{
		$mots_lv0010->LV_LoadID($mots_lv0010->lv006);
		$mohr_lv0020->LV_LoadID($mots_lv0010->lv010);
		$mots_lv0010->LV_LoadID($mots_lv0010->lv002);
		$mosl_lv0009->LV_LoadID($mots_lv0010->lv007);
	}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  <tr>
	<td><div align="center" ><strong>Ngày</strong> <?php echo getday($mots_lv0010->lv009);?> <strong>tháng</strong> <?php echo getmonth($mots_lv0010->lv009);?> <strong>năm</strong> <?php echo getyear($mots_lv0010->lv009);?></div></td>
  </tr>
  <?php
  if(1!=1)//($mots_lv0010->lv005=='BANHANG' || $mots_lv0010->lv005=='CUS') && ($mots_lv0010->lv001!=NULL))
  {
  ?>
  <tr>
    <td align="center">
		<div style="float:left;text-align:left;width:50%;font-weight:none">
			<div style="padding-right:10px">
				<strong>Tên KH:</strong> <?php echo $mots_lv0010->lv002;?>
				<br><strong>Ð.CHỈ:</strong> <?php echo $mots_lv0010->lv006;?>
			</div>
		</div>
		<div style="float:left;text-align:left;width:50%;font-weight:none">
  ...
  <tr>
    <td align="right" ><table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
					...
					<tr>
						<td>&nbsp;</td>
						<td class="center_style" onDblClick="this.innerHTML=''" style="cursor:move"><b><span class="center_style" style="cursor:move"><b><?php echo $mots_lv0010->getvaluelink('lv002',$mots_lv0010->lv002);?></b></span></b></td>
						<td>&nbsp;</td>
						<td class="center_style" onDblClick="this.innerHTML=''" style="cursor:move"><span class="center_style" style="cursor:move"><b><?php echo $mots_lv0010->GetCompany();?></b></span></td>
						<td>&nbsp;</td>
					</tr>
