					...
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<tr>
							  ...
							  <table width="80%"><tr><td width="50%"><select name="txtlv002" id="txtlv002"   tabindex="6"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/><option value=""></option>
							   <?php echo $lvts_lv0010->LV_LinkField('lv002',$vlv002);?>
                              </select>
                              </td><td>
...
<tr>
								...
								<?php echo $lvts_lv0010->LV_LinkField('lv003',$vlv003);?>
							  </select>
							  </td>
							  <td>
						  ...
						  <br></td></tr>
							<tr>
							  ...
							  <td>
							  <ul id="pop-nav2" lang="pop-nav2" onMouseOver="ChangeName(this,2)" onkeyup="ChangeName(this,2)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlv005_search" id="txtlv005_search" style="width:100%" onKeyUp="LoadPopup(this,'txtlv003','ts_lv0013','lv002')" onFocus="LoadPopup(this,'txtlv003','ts_lv0013','lv002)')" tabindex="200" >
							    <div id="lv_popup2" lang="lv_popup2"> </div>						  
						</li>
		...
		<tr>
							  ...
							  <td  height="20"><input name="txtlv009" type="text" id="txtlv009" value="<?php echo $lvts_lv0010->lv009;?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
				  ...
				  <td  height="20"><input  name="txtlv008" type="text" id="txtlv008" value="<?php echo $vlv008;?>" tabindex="15"  style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						...
						<tr>
							  ...
							  <table width="80%"><tr><td width="50%"><select name="txtlv099" id="txtlv099"   tabindex="6"  style="width:100%" onkeypress="return CheckKey(event,7)">
							   <?php echo $lvts_lv0010->LV_LinkField('lv002',$vlv099);?>
                              </select>
                              </td>
                              <td>
