					...
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<tr>
							  ...
							  <table width="80%"><tr><td width="50%"><select name="txtlv002" id="txtlv002"   tabindex="6"  style="width:100%" onkeypress="return CheckKeys(event,7,this)"><option value=""></option>
							   <?php echo $lvts_lv0008->LV_LinkField('lv002',$vlv002);?>
                              </select>
                              </td><td>
...
<tr>
								...
								<?php echo $lvts_lv0008->LV_LinkField('lv003',$vlv003);?>
							  </select>
							  </td>
							  <td>
		...
		<tr>
							  ...
							  <td  height="20"><input name="txtlv009" type="text" id="txtlv009" value="<?php echo $lvts_lv0008->lv009;?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
