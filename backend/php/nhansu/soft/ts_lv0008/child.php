...
require_once("../paras.php");
require_once("../../clsall/ts_menusl0002.php");

$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","TS0014.txt",$plang);
//init object
$ts_menusl0002=new ts_menusl0002();
//Set variant
$ts_menusl0002->itemlst=$pitemlst;
$ts_menusl0002->childlst=$pchildlst;
$ts_menusl0002->level3lst=$plevel3lst;
$ts_menusl0002->child3lst=$pchild3lst;
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($ts_menusl0002->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
						<!--<option value="2" <?php echo ((int)$ts_menusl0002->level3lst==2)?'selected="selected"':'';?>>2.<?php echo $vLangArr[9];?></option>
						<option value="3" <?php echo ((int)$ts_menusl0002->level3lst==3)?'selected="selected"':'';?>>3.<?php echo $vLangArr[10];?></option>-->
	...
	<?php
	$ts_menusl0002->Dir="../";
include($ts_menusl0002->GetLinkEmp());
?>
	</div></td>
              </tr>
            </table
...
document.frmhr_employee.cbxoption.value="<?php echo $ts_menusl0002->level3lst;?>";
