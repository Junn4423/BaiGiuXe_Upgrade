...
require_once("../paras.php");
require_once("../../clsall/jo_menulv0001.php");

$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","JO0009.txt",$plang);
//init object
$mojo_menulv0001=new jo_menulv0001();
//Set variant
$mojo_menulv0001->itemlst=$pitemlst;
$mojo_menulv0001->childlst=$pchildlst;
$mojo_menulv0001->level3lst=$plevel3lst;
$mojo_menulv0001->child3lst=$pchild3lst;
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($mojo_menulv0001->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
						<option value="2" <?php echo ((int)$mojo_menulv0001->level3lst==2)?'selected="selected"':'';?>>2.<?php echo $vLangArr[9];?></option>
					</select>
	...
	<?php
	$mojo_menulv0001->Dir="../";
include($mojo_menulv0001->GetLinkEmp());
?>
	</div></td>
              </tr>
            </table
...
document.frmhr_employee.cbxoption.value="<?php echo $mojo_menulv0001->level3lst;?>";
