...
require_once("../../clsall/jo_lv0009.php");
//////////////init object////////////////
$lvjo_lv0009=new jo_lv0009($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Jo0004');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvjo_lv0009->lv001= $_GET['ID'] ?? '';
if($plang=="") $plang="VN";
...
if($vFlag==1)
{
$lvjo_lv0009->lv002=$_POST['txtlv002'];
$lvjo_lv0009->lv003=$_POST['txtlv003'];
$lvjo_lv0009->lv004=$_POST['txtlv004'];
$lvjo_lv0009->lv005=$_POST['txtlv005'];
$lvjo_lv0009->lv006=$_POST['txtlv006'];
if($_FILES['userfile']['name']=="")
$lvjo_lv0009->lv007=$_POST['txtlv007'];
else
$lvjo_lv0009->lv007=$_FILES['userfile']['name'];
$lvjo_lv0009->lv008=$_POST['txtlv008'];
$lvjo_lv0009->lv009=$_POST['txtlv009'];
$lvjo_lv0009->lv010=$_POST['txtlv010'];
$lvjo_lv0009->lv011=$_POST['txtlv011'];
$lvjo_lv0009->lv012=$_POST['txtlv012'];
$lvjo_lv0009->lv013=$_POST['txtlv013'];
$lvjo_lv0009->lv014=$_POST['txtlv014'];
$lvjo_lv0009->lv015=$_POST['txtlv015'];
$lvjo_lv0009->lv016=$_POST['txtlv016'];
$lvjo_lv0009->lv017=$_POST['txtlv017'];
$lvjo_lv0009->lv018=$_POST['txtlv018'];
$lvjo_lv0009->lv019=$_POST['txtlv019'];
$lvjo_lv0009->lv020=$_POST['txtlv020'];
$lvjo_lv0009->lv021=$_POST['txtlv021'];
$lvjo_lv0009->lv022=$_POST['txtlv022'];
$lvjo_lv0009->lv023=$_POST['txtlv023'];		
		$vresult=$lvjo_lv0009->LV_Update();
		if($vresult==true) {
...
$lvjo_lv0009->LV_LoadID($lvjo_lv0009->lv001);
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#f1f1f1">
			...
			<tr>
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvjo_lv0009->lv001=="")?InsertWithCheck('jo_lv0009', 'lv001', 'TASK',1):$lvjo_lv0009->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[16];?></td>
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvjo_lv0009->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
						    </tr>
							<tr>
							  ...
							  <?php echo $lvjo_lv0009->LV_LinkField('lv003',$lvjo_lv0009->lv003);?>
							...
							<tr>
							  ...
							  <?php echo $lvjo_lv0009->LV_LinkField('lv004',$lvjo_lv0009->lv004);?>
							  </select>	<br><table><tr><td>
							...
							<tr>
							  ...
							  <?php echo $lvjo_lv0009->LV_LinkField('lv006',$lvjo_lv0009->lv006);?>
							  </select>	<br><table><tr><td>
							...
							<tr>
							  ...
							  <td  height="20"><textarea rows="5" name="txtlv008" id="txtlv008"   tabindex="12"  style="width:80%"><?php echo $lvjo_lv0009->lv008;?></textarea></td>
						    </tr>
						    <tr>
								<td width="166"  height="20"><?php echo $vLangArr[27];?></td>
								<td width="178"  height="20">
									<input name="txtlv013" type="text" id="txtlv013"  value="<?php echo $lvjo_lv0009->lv013;?>" readonly="true" tabindex="17" maxlength="500" style="width:80%" onKeyPress="return CheckKey(event,7)"/>	
									<br><table><tr><td>
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv014" type="text" id="txtlv014" readonly="true"  value="<?php echo $lvjo_lv0009->lv014;?>" tabindex="18" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
							  <br><table><tr><td>
							...
							<tr>
							  ...
							  <td  height="20"><input  name="txtlv015" type="text" id="txtlv015" value="<?php echo $lvjo_lv0009->lv015;?>" tabindex="19" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
							  <br><table><tr><td>
				  ...
				  <td  height="20"><input  name="txtlv016" type="text" id="txtlv016" value="<?php echo formatdate($lvjo_lv0009->lv016,$plang);?>" tabindex="20" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/><span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
                          ...
                          <tr>
							  ...
							  <td  height="20"><input name="txtlv017" type="text" id="txtlv017" value="<?php echo formatdate($lvjo_lv0009->lv017,$plang);?>" tabindex="21" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"><span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
						...
						<tr>
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv019" id="txtlv019" style="width:80%" tabindex="23" onKeyPress="return CheckKey(event,7)" value="<?php echo formatdate($lvjo_lv0009->lv019,$plang);?>"/><span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
							...
							<tr>
							  ...
							  <td  height="20"><input  name="txtlv020" type="text" id="txtlv020" value="<?php echo $lvjo_lv0009->lv020;?>" tabindex="24" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
						    </tr>
							<tr>
							  ...
							  <?php echo $lvjo_lv0009->LV_LinkField('lv022',$lvjo_lv0009->lv022);?>
							  </select><br><table><tr><td>
