...
require_once("../paras.php");
require_once("../../clsall/tc_menulv0061.php");
...
//init object
$motc_menulv0061=new tc_menulv0061();
//Set variant
$motc_menulv0061->itemlst=$pitemlst;
$motc_menulv0061->childlst=$pchildlst;
$motc_menulv0061->level3lst=$plevel3lst;
$motc_menulv0061->child3lst=$pchild3lst;
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($motc_menulv0061->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>	
					</select>
	...
	<?php
	$motc_menulv0061->Dir="../";
include($motc_menulv0061->GetLinkEmp());
?>
	</div></td>
              </tr>
            </table
...
document.frmhr_employee.cbxoption.value="<?php echo $motc_menulv0061->level3lst;?>";
