  ...
  <div class="story">
    <h2 id="pageName"><?php echo $vLangArr[1];?></h2>
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
				  ...
				  <td  height="20px"><input  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $vlv003;?>">
								</td>
							  </tr>	
							...
							<tr>
							  ...
							  <td  height="20px"><input name="txtlv004" type="text" id="txtlv004" value="<?php echo $vlv004;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
						      <span class="td">(yyyy-mm-dd)</span></td>
							  </tr>
							  <tr>
							  <td  height="20px"><?php echo $vLangArr[19];?></td>
							  <td  height="20px"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo $vlv005;?>" tabindex="10" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>
								<tr>
							  ...
							  <td  height="20px"><select name="txtlv007" id="txtlv007" tabindex="12" style="width:80%" onKeyPress="return CheckKey(event,7)"><option value=""></option><?php echo $lvtc_lv0027->LV_LinkField('lv007',$vlv007);?></select></td>
							  </tr>	
							  <tr>
							  ...
							  <td  height="20px"><input name="txtlv009" type="text" id="txtlv009" value="<?php echo $vlv009;?>" tabindex="13" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"></td>
							  </tr>		
                              <tr>
							  <td  height="20px"><?php echo $vLangArr[29];?></td>
							  <td  height="20px"><select name="txtlv029"  id="txtlv029" value="<?php echo $vlv029;?>" tabindex="33"  style="width:80%" onKeyPress="return CheckKey(event,7)"><option value=""></option><?php echo $lvtc_lv0027->LV_LinkField('lv029',$vlv029);?></select></td>
							  </tr>																			
							<tr>
