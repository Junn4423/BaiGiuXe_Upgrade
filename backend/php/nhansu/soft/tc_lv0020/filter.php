					...
					<form action="#" name="frmfilter" method="post">
						...
						<tr>
							...
							<tr>
							  ...
							  <td  hseight="20"><input name="txtlv003" id="txtlv003"   tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $vlv003;?>" type="text"/>	</td>
						    </tr>
<tr>
							  <td  height="20"><?php echo $vLangArr[18];?></td>
				  <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $vlv004;?>"/><span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo $vlv005;?>" tabindex="9" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)"><span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
							  ...
							  <td  height="20"><input name="txtlv006" rows="15" id="txtlv006" style="width:80%" tabindex="13" value="<?php echo $vlv007;?>"></td>
							</tr>	
							  	<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[21];?></td>
							  <td  height="20"><input name="txtlv007"  id="txtlv007" style="width:80%" tabindex="13" value="<?php echo $vlv008;?>"></td>
							</tr>	
							<tr>
							  <td  height="20px"><?php echo $vLangArr[22];?></td>
				  <td  height="20px"><select  name="txtlv008"  id="txtlv008"  tabindex="13" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/><option value=""></option><?php echo $lvtc_lv0020->LV_LinkField('lv008',$vlv008);?>
				  </select>		<br>
							  <table><tr><td></td><td>
				  ...
				  <td  height="20px"><select  name="txtlv009"  id="txtlv009"  tabindex="13" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/><option value=""></option><?php echo $lvtc_lv0020->LV_LinkField('lv009',$vlv009);?>
				  </select>						<br>
							  <table><tr><td></td><td>
							  ...
							  <td  height="20"><input name="txtlv010"  id="txtlv010" style="width:80%" tabindex="14" value="<?php echo $vlv010;?>"></td>
							</tr>	
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[25];?></td>
							  <td  height="20"><input name="txtlv011"  id="txtlv011" style="width:80%" tabindex="15" value="<?php echo $vlv011;?>"></td>
							</tr>			  
						  <tr>
