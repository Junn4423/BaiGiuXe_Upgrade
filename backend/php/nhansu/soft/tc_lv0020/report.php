...
$motc_lv0020->lv002=base64_decode($_GET['NVID']);
$motc_lv0020->lv020=base64_decode($_GET['CalID']);
...
?>
						...
						<?php echo $motc_lv0020->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
