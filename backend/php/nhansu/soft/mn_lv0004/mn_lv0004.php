...
$momn_lv0004->ArrPush[12]=$vLangArr[38];
$momn_lv0004->ArrPush[13]=$vLangArr[37];
$momn_lv0004->ArrPush[100]='Nhóm';
...
$momn_lv0004->ArrFunc[6]='Khoá';
$momn_lv0004->ArrFunc[7]='Mở khoá';
...
elseif($flagID==3)
{
	...
	$strar=str_replace("@","','",$strar);
	$strar="'".$strar."'";
	$vresult=$momn_lv0004->LV_Aproval($strar);
}
elseif($flagID==4)
{
	$strar=substr($strchk,0,strlen($strchk)-1);
	$strar=str_replace("@","','",$strar);
	$strar="'".$strar."'";
	$vresult=$momn_lv0004->LV_UnAproval($strar);
}
