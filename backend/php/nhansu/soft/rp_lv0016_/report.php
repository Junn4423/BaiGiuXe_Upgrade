...
echo $mohr_lv0020->lv029=$_POST['txtlv029'];
...
?>
						...
						<?php echo $mohr_lv0020->LV_BuilListReportAdvance($vFieldList,'document.frmchoose','chkAll','lvChk',0,100000,$paging,$vOrderList,$vSortNum);?>
