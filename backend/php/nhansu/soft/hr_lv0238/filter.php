  ...
  <div class="story">
    <h2 id="pageName"><?php echo $vLangArr[1];?></h2>
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<form action="#" name="frmfilter" method="post">
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
							  ...
							  <option value=""></option>
							  <?php echo $lvhr_lv0238->LV_LinkField('lv003',$vlv003);?></select></td>
							</tr>
							<tr>
								...
								<div style="width:250px;height:150px;position:relative;overflow: auto;top:0px;">
									<?php echo $lvhr_lv0238->GetBuilCheckListDept($vDepID,'chkDept',10,'hr_lv0002','lv003',$vlv029ex);?>
								</div>
								</td>
							</tr>						
							<tr>
				  ...
				  <option value=""></option>
				  <?php echo $lvhr_lv0238->LV_LinkField('lv008',$vlv008);?>
				  </select>							 </td>
							  </tr>	
							  <tr>
							   ...
							   <tr>
							 	 <td  height="20px"><?php echo $vLangArr[27];?></td>
				  				 <td  height="20px"><table style="width:80%"><tr><td style="width:50%"><select  name="txtlv010"  id="txtlv010"  tabindex="12" maxlength="255" style="width:100%" onKeyPress="return CheckKey(event,7)"/>
									<option value=""></option>
									<?php echo $lvhr_lv0238->LV_LinkField('lv010',$lvhr_lv0238->lv010);?>
				 				</select>	
													</td>
							  <td>
							 ...
							 <tr>
							  <td  height="20px"><?php echo $vLangArr[29];?></td>
				  				<td  height="20px"><select  name="txtlv012"  id="txtlv012"  tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" />
									<option value=""></option><?php echo $lvhr_lv0238->LV_LinkField('lv012',$lvhr_lv0238->lv012);?>
				  									</select>							 
				  				</td>
							  </tr>	
							   <tr>
							  <td  height="20px"><?php echo $vLangArr[30];?></td>
				  				<td  height="20px"><select  name="txtlv013"  id="txtlv013"  tabindex="15" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /><option value=""></option><?php echo $lvhr_lv0238->LV_LinkField('lv013',$lvhr_lv0238->lv013);?>
				  									</select>							 
				  				</td>
							  </tr>	
							  <tr>
