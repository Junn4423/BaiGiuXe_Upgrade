...
require_once("../../clsall/cr_lv0150.php");
$vlWHID=$_GET['lv002'];	
$vlv005=$_GET['lv005'];	
$vlv006=$_GET['lv006'];	
$vDate=GetServerDate();
...
{
	case 'ĐNVT':
		$mocr_lv0150=new cr_lv0150($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Cr0150');
		$vReturn=$mocr_lv0150->LV_InsertOutStockNoCondition($vlv006);
		break;
	case 'BANHANG':
