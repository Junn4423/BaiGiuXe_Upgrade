...
$mojo_lv0012->ArrPush[25]=$vLangArr[42];
...
$mojo_lv0012->ArrFunc[5]='';
$mojo_lv0012->ArrFunc[6]='';
$mojo_lv0012->ArrFunc[7]='';
$mojo_lv0012->ArrFunc[8]=$vLangArr[10];
$mojo_lv0012->ArrFunc[9]=$vLangArr[12];
$mojo_lv0012->ArrFunc[10]=$vLangArr[0];
$mojo_lv0012->ArrFunc[11]=$vLangArr[63];
$mojo_lv0012->ArrFunc[12]=$vLangArr[64];
$mojo_lv0012->ArrFunc[13]=$vLangArr[65];
$mojo_lv0012->ArrFunc[14]=$vLangArr[66];

////Other
$mojo_lv0012->ArrOther[1]=$vLangArr[61];
$mojo_lv0012->ArrOther[2]=$vLangArr[62];
//////Delete message///
$lvMessage=array();
...
?>
						...
						<?php echo $mojo_lv0012->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
