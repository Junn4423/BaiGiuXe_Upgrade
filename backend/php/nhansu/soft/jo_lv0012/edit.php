...
$lvjo_lv0012->lv007=$_FILES['userfile']['name'];
...
$lvjo_lv0012->lv012=$_POST['txtlv012'];
...
$lvjo_lv0012->lv023=$_POST['txtlv023'];		
		$vresult=$lvjo_lv0012->LV_Update();
		if($vresult==true) {
...
$lvjo_lv0012->LV_LoadID($lvjo_lv0012->lv001);
