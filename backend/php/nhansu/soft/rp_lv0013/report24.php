...
?>
	...
	<tbody>
		...
		<tr height="28">
			<td colspan="7"  style="text-align: center;"><?php echo getyear($motc_lv0013->lv004);?> 年員工保費追蹤表</td>
		</tr>
	</tbody>
</table>
<?php
$vstrReturn= $motc_lv0020->LV_THANHTOANBHCONG2PERCEN($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,$motc_lv0013,$motc_lv0020->optbh,$motc_lv0020->ismau);
echo $vstrReturn;
$vNow=GetServerDate();
?>
