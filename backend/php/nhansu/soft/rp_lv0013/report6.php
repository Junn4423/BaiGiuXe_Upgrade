...
if($morp_lv0013->GetAdd()==1)
{
	if(isset($_GET['ajaxprint']))
	{
		echo '[CHECK]';
			echo $morp_lv0013->LV_DemSoLanIn($_SESSION['ERPSOFV2RUserID'],$_GET['CalID'],$vDept);
		echo '[ENDCHECK]';
		exit;
	}
}
...
<td colspan="16" rowspan="4" align="center" valign="middle"><strong><span style="font-size: large;font-size:24px">BẢNG LƯƠNG TH&Aacute;NG <?php echo getmonth($motc_lv0013->lv004);?>/<?php echo getyear($motc_lv0013->lv004);?></span></strong>
...
<tr>
<td colspan="5" align="center" valign="middle"><strong><span ><input type="text" value="<?php echo $motc_lv0020->lv201;?>" style="border:0px #fff solid;width:100%;text-align:center;font:16px arial,tahoma;"/></span></strong></td>
</tr>
<tr>
...
<?php
$vstrReturn= $motc_lv0020->LV_LuongVanPhongChinh($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,$motc_lv0013,$motc_lv0020->optbh,$motc_lv0020->ismau);
echo $vstrReturn;
?>
