...
?>
	...
	<tbody>
		...
		<tr height="42">
			<td colspan="7" height="42" style="text-align: center;font:18px Arial,Tahoma;"><strong>BẢNG CHI TIẾT SỐ THUẾ THU NHẬP CỦA CÁ NHÂN NGƯỜI LAO ĐỘNG - 個人所得稅申明細表</strong></td>
		</tr>
		<tr><td  colspan="7">Tháng <?php echo getmonth($motc_lv0013->lv004).'/'.getyear($motc_lv0013->lv004);?></td></tr>
		<tr><td colspan="3">[01] Mã số thuế cơ quan chi trả thu nhập :<td><td colspan="3" align="left"><?php echo $motc_lv0013->GetTaxCode();?></td></tr>
		<tr><td colspan="3">[02] Tên cơ quan chi trả thu nhập :<td><td colspan="3" align="left"><?php echo $motc_lv0020->GetCompany();?></td></tr>
		<tr><td colspan="3">[03] Địa chỉ :<td><td colspan="3" align="left"><?php echo $motc_lv0020->GetAddress();?></td></tr>
		<tr><td colspan="3">[04] Điện thoại :<td><td colspan="3" align="left"><?php echo $motc_lv0020->GetPhone();?></td></tr>
	</tbody>
</table>
<?php
/*if($motc_lv0020->lv201=='VP' || $motc_lv0020->lv201=='XUONG' || trim($motc_lv0020->lv201)=='')
{
	$vstrReturn= $motc_lv0020->LV_TrichPITLevel1($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,$motc_lv0013,$motc_lv0020->optbh,$motc_lv0020->ismau);
}
else*/	
	$vstrReturn= $motc_lv0020->LV_TrichPIT($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,$motc_lv0013,$motc_lv0020->optbh,$motc_lv0020->ismau);
echo $vstrReturn;
?>
<table border="0" cellpadding="0" cellspacing="0" width="800">
	<tbody>
		<tr height="22">
			<td height="22" style="text-align: center;" width="191"><strong><br/><br/>Phê duyệt<br/>核准</strong></td>
			<td colspan="3" style="text-align: center;" width="200"></td>
			<td colspan="2" style="text-align: center;" width="123"></td>
			<td style="text-align: center;"><strong></strong></td>
			<td style="text-align: center;"><strong><br/>Nhơn Trạch: Ngày <?php echo getday($vNow);?>   tháng <?php echo getmonth($vNow);?>  năm <?php echo getyear($vNow);?>
			<br/> Lập biểu<br/>製表
			</strong></td>
		</tr>
		<tr height="31">
		...
		<tr height="31">
			<td height="31" style="text-align: center;" ondblclick="this.innerHTML=''"><strong>CHOU TING JUNG</strong></td>
			<td colspan="3" style="text-align: center;"><strong> </strong></td>
			<td colspan="2" style="text-align: center;"><strong> </strong></td>
			<td style="text-align: center;"><strong><strong></td>
			<td style="text-align: center;" ondblclick="this.innerHTML=''"><strong>HỒ THỊ KIM THU</strong></td>
		</tr>
<?php
} else {
	include("../permit.php");
