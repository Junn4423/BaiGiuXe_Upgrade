...
?>
	...
	<tbody>
		<!--<tr height="26">
			<td colspan="3" height="26" width="246">Tel : <?php echo $morp_lv0013->GetPhone();?> Fax : <?php echo $morp_lv0013->GetFax();?></td>
		</tr>
		<tr height="28">
			<td colspan="3" height="28">Add: <?php echo $morp_lv0013->GetAddress();?></td>
		</tr>
		<tr height="26">
			<td colspan="3" height="26">Website: <?php echo $morp_lv0013->GetWeb();?></td>
		</tr>-->
		<tr height="32">
			<td colspan="7" height="32" style="text-align: center;"><strong><?php echo 'SOF TECHNOLOGY CO., LTD';?></strong></td>
		</tr>
		<tr height="28">
			<td colspan="7" style="text-align: center;"><?php echo '和正豐科技責任有限公司';?></td>
		</tr>
		<tr height="32">
			<td colspan="7" height="32" style="text-align: center;"><strong>BẢNG KÝ NHẬN LƯƠNG CNV XƯỞNG B THÁNG <?php echo getmonth($motc_lv0013->lv004).'/'.getyear($motc_lv0013->lv004);?></strong></td>
		</tr>
		<tr height="28">
			<td colspan="7"  style="text-align: center;"><?php echo getyear($motc_lv0013->lv004);?>年<?php echo getmonth($motc_lv0013->lv004);?>月份B厰人員發薪簽收單 </td>
		</tr>
	</tbody>
</table>
<?php
$vstrReturn= $motc_lv0020->LV_LuongTienMat($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,$motc_lv0013,$motc_lv0020->optbh,$motc_lv0020->ismau);
echo $vstrReturn;
$vNow=GetServerDate();
?>
