...
?>
	...
	<tbody>
		...
		<tr height="42">
			<td colspan="7" height="42" style="text-align: center;"><strong>DANH SÁCH  LƯƠNG THÁNG <?php echo getmonth($motc_lv0013->lv004).'/'.getyear($motc_lv0013->lv004);?> (CHUYỂN KHOẢN)</strong></td>
		</tr>
	</tbody>
</table>
<?php
$vstrReturn= $motc_lv0020->LV_LuongNganHang($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,$motc_lv0013,$motc_lv0020->optbh,$motc_lv0020->ismau);
echo $vstrReturn;
?>
