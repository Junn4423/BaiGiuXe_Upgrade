...
?>
	...
	<tbody>
		...
		<tr height="28">
			<td colspan="7"  style="text-align: center;">醫社保費 (公司負擔部分 22%) <?php //echo getyear($motc_lv0013->lv004);?></td>
		</tr>
	</tbody>
</table>
<?php
$vstrReturn= $motc_lv0020->LV_CONGDOAN22PERCEN($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,$motc_lv0013,$motc_lv0020->optbh,$motc_lv0020->ismau);
echo $vstrReturn;
$vNow=GetServerDate();
?>
