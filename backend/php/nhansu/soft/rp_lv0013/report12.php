...
?>
	...
	<tbody>
		...
		<tr height="42">
			<td colspan="7" height="42" style="text-align: center;font:18px Arial,Tahoma;"><strong>TRÍCH ĐÓNG KINH PHÍ CÔNG ĐOÀN NĂM <?php echo getyear($motc_lv0013->lv004);?></strong></td>
		</tr>
	</tbody>
</table>
<?php
//$motc_lv0013->lv007,$motc_lv0013->lv006;
$vstrReturn= $motc_lv0020->LV_TrichCongDoanFull($vOpt,$motc_lv0013->lv007,$motc_lv0013->lv006);
echo $vstrReturn;
?>
