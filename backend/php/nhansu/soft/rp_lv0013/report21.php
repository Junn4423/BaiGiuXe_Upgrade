...
?>
	...
	<tbody>
		...
		<tr height="32">
			<td colspan="7" height="32" style="text-align: center;"><strong><?php echo $morp_lv0013->GetCompany();?></strong></td>
		</tr>
		<tr height="32">
			<td colspan="7" height="32" style="text-align: center;"><strong>BẢNG CHI TIẾT TRÍCH NỘP 2% KINH PHÍ CÔNG ĐOÀN NĂM <?php echo getyear($motc_lv0013->lv004);?></strong></td>
		</tr>
		<tr height="28">
			<td colspan="7"  style="text-align: center;">公司提撥工團經費2% (<?php echo getyear($motc_lv0013->lv004);?>年）</td>
		</tr>
	</tbody>
</table>
<?php
$vstrReturn= $motc_lv0020->LV_KINHPHICD2PERCEN($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,$motc_lv0013,$motc_lv0020->optbh,$motc_lv0020->ismau);
echo $vstrReturn;
$vNow=GetServerDate();
?>
