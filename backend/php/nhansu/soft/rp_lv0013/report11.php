...
.print_hdtb
{
	...
	<tbody>
		...
		<tr height="42">
			<td colspan="7" height="42" style="text-align: center;font:18px Arial,Tahoma;"><strong>DANH SÁCH THAM GIA BẢO HIỂM THÁNG <?php echo getmonth($motc_lv0013->lv004).'/'.getyear($motc_lv0013->lv004);?></strong></td>
		</tr>
	</tbody>
</table>
<?php
if($motc_lv0020->lv201=='TDL' || $motc_lv0020->lv201=='TECH' || trim($motc_lv0020->lv201)=='')
	$vstrReturn= $motc_lv0020->LV_DanhSachThamGiaBHLevel1($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,$motc_lv0013,$motc_lv0020->optbh,$motc_lv0020->ismau);
else	
	$vstrReturn= $motc_lv0020->LV_DanhSachThamGiaBH($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum,$motc_lv0013,$motc_lv0020->optbh,$motc_lv0020->ismau);
echo $vstrReturn;
?>
