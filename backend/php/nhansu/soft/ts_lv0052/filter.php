					...
					<form action="#" name="frmfilter" id="frmfilter" method="post">
						...
						<tr>
							...
							<tr>
							  ...
							  <td  height="20"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)"><option value=""></option><?php echo $lvts_lv0052->LV_LinkField('lv003',$vlv003);?></select><br><table><tr><td>
...
<tr>
				  ...
				  <td  height="20"><select name="txtlv010" id="txtlv010"   tabindex="14"  style="width:80%" onKeyPress="return CheckKey(event,7)"><option value=""></option><?php echo $lvts_lv0052->LV_LinkField('lv010',$vlv010);?></select><br><table><tr><td>
							...
							<tr>
							  ...
							  <td  height="20"><select name="txtlv011" id="txtlv011"   tabindex="15"  style="width:80%" onKeyPress="return CheckKey(event,7)"><option value=""></option><?php echo $lvts_lv0052->LV_LinkField('lv011',$vlv011);?></select><br><table><tr><td>
