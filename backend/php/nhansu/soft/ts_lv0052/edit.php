...
$lvts_lv0052->lv001=$_GET['ChildDetailID'];
if($plang=="") $plang="VN";
...
{
$lvts_lv0052->lv002='1';
$lvts_lv0052->lv003=$_POST['txtlv003'];
$lvts_lv0052->lv004=$_POST['txtlv004'];
$lvts_lv0052->lv005=$_POST['txtlv005'];
$lvts_lv0052->lv006=$_POST['txtlv006'];
...
$lvts_lv0052->lv013=$_POST['txtlv013'];
$lvts_lv0052->lv014=$_POST['txtlv014'];
$lvts_lv0052->lv015=$_POST['txtlv015'];
$lvts_lv0052->lv016=$_POST['txtlv016'];
$lvts_lv0052->lv018=$_POST['txtlv018'];
$lvts_lv0052->lv019=$_POST['txtlv019'];		
		$vresult=$lvts_lv0052->LV_Update();
		if($vresult==true) {
...
$lvts_lv0052->LV_LoadID($lvts_lv0052->lv001);
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td width="178"  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvts_lv0052->lv001=="")?InsertWithCheckExt('ac_lv0004', 'lv001', '',1):$lvts_lv0052->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
						    </tr>
							<tr>
