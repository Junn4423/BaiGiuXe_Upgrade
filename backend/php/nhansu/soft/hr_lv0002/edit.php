...
if($vFlag==1)
{
		$lvhr_lv0002->lv001_=$_POST['txtlv001_'];
					...
					<?php		
						...
						?>
							...
							<tr>
							  ...
							  <td width="335"  height="20px"><input  type="hidden" name="txtlv001" type="text" id="txtlv001" maxlength="32" value="<?php echo $lvhr_lv0002->lv001;?>" />
							  <input name="txtlv001_" type="text" id="txtlv001_"  value="<?php echo $lvhr_lv0002->lv001;?>" tabindex="5" maxlength="32" style="width:80%" onKeyPress="return CheckKey(event,7)"/>	</td>
							</tr>
							<tr>
