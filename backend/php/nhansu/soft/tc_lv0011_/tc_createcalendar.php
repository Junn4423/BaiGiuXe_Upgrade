...
include("../../clsall/hr_lv0038.php");
if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","TC0026.txt",$plang);
////////////////////////init object///////////////////////////
$lvtc_lv0011=new tc_lv0011($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Hr0098');
$lvtc_lv0010=new tc_lv0010($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Hr0098');
$lvhr_lv0038=new hr_lv0038($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Hr0098');
...
<?php
$vFlag=$_POST['txtFlag'] ?? '';
$vLaborID=$_GET['ChildID'];
$lvhr_lv0038->LV_LoadIDNoActive($vLaborID);
$lvtc_lv0010->LV_LoadContractLaborID($vLaborID);
...
<script language="javascript">
	function CreateCalandar()
	{
		...
		if(o.txtlv010.value=='') 
		{
			if(confirm("Ban có muốn dừng tạo hợp đồng khi mã trống Y/N?"))
			{
				return;
			}
		}
...
<?php
if($lvhr_lv0038->lv001!=NULL && $lvhr_lv0038->lv001!='')
{

	if((int)$vFlag==1)
	{
	if($lvtc_lv0010->lv001==NULL || $lvtc_lv0010->lv001=="")
	{
		
		$lvtc_lv0010->lv002=$lvhr_lv0038->lv002;
		$lvtc_lv0010->lv003="PRJ000001";
		$lvtc_lv0010->lv004=$lvhr_lv0038->FormatView($lvhr_lv0038->lv004,2);
		$lvtc_lv0010->lv005=$lvhr_lv0038->FormatView($lvhr_lv0038->lv005,2);
		$lvtc_lv0010->lv006=1;
	...
	if($vTimesheetID=='' || $vTimesheetID==NULL)
	{
		echo 'Khổng thể tạo lịch';
		exit();
	}
	else
	{
