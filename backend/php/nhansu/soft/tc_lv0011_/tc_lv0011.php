...
include("$vDir../clsall/tc_lv0010.php");
...
{
	echo 'Xin vui lòng trả hợp đồng về trạng thái tạo hợp đồng đang làm và tạo lịch';
	exit();
}
$motc_lv0011->lv002=$vTimesheetID;
