...
//$molv_lv0004->LoadSaveOperation($_SESSION['ERPSOFV2RUserID'],'tc_lv0001');
//////////////////////////////////////////////////////////////////////////////////////////////////////
...
{
	var str="<br><iframe height=1500 marginheight=0 marginwidth=0 frameborder=0 src=<?php echo $vDir;?>tc_lv0001?func=<?php echo $_GET['func'];?>&func="+func+"&ID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?> class=lvframe></iframe>";
