...
//require_once("../../clsall/ts_lv0039.php");
...
require_once("../../clsall/ts_lv0039.php");
//////////////init object////////////////
$lvts_lv0039=new ts_lv0039($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ts0028');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvts_lv0039->lv001=$_GET['ChildDetailID'];
if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","TS0018.txt",$plang);
$mots_lv0039->lang=strtoupper($plang);
$curPage = (int)($_POST['curPg'] ?? 1);	
$vFlag   = (int)($_POST['txtFlag'] ?? 0);
if($vFlag==1)
{
$lvts_lv0039->lv002=$_POST['txtlv002'];
$lvts_lv0039->lv003=$_POST['txtlv003'];
$lvts_lv0039->lv004=$_POST['txtlv004'];
$lvts_lv0039->lv005=$_POST['txtlv005'];
$lvts_lv0039->lv006=$_POST['txtlv006'];
$lvts_lv0039->lv007=$_POST['txtlv007'];
$lvts_lv0039->lv008=$_POST['txtlv008'];
$lvts_lv0039->lv009=$_POST['txtlv009'];
$lvts_lv0039->lv010=$_POST['txtlv010'];
$lvts_lv0039->lv011=$_POST['txtlv011'];
$lvts_lv0039->lv012=$_POST['txtlv012'];
$lvts_lv0039->lv013=$_POST['txtlv013'];
$lvts_lv0039->lv014=$_POST['txtlv014'];
$lvts_lv0039->lv015=$_POST['txtlv015'];
$lvts_lv0039->lv016=GetServerDate()." ".GetServerTime();
$lvts_lv0039->lv017=$_POST['txtlv017'];
$lvts_lv0039->lv018=$_POST['txtlv018'];
$lvts_lv0039->lv019=$_POST['txtlv019'];
$lvts_lv0039->lv020=$_POST['txtlv020'];
		
		$vresult=$lvts_lv0039->LV_UpdateEdit($_POST['txtlv004old'],$_POST['txtlv006old']);
		if($vresult==true) {
...
$lvts_lv0039->LV_LoadID($lvts_lv0039->lv001);
					...
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvts_lv0039->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[16];?></td>
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvts_lv0039->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[17];?></td>
							  <td  height="20"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:80%" onKeyPress="return CheckKey(event,7)"/><?php echo $lvts_lv0039->LV_LinkField('lv003',$lvts_lv0039->lv003);?>
							  </select>	<br>
							  <table><tr><td>
...
<tr>
	              ...
	              <td  height="20"><input type="hidden" name="txtlv004old" id="txtlv004old" value="<?php echo $lvts_lv0039->lv004;?>" />
			                  <input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvts_lv0039->lv004;?>"/></td>
</tr>							  
							<tr>
							  ...
							  <?php echo $lvts_lv0039->LV_LinkField('lv005',$lvts_lv0039->lv005);?>
							  ...
							  <td  height="20"><input type="hidden" name="txtlv006old" id="txtlv006old" value="<?php echo $lvts_lv0039->lv006;?>" /><input name="txtlv006" type="text" id="txtlv006" value="<?php echo (float)$lvts_lv0039->lv006;?>" tabindex="10" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
<tr>
							  ...
							  <?php echo $lvts_lv0039->LV_LinkField('lv007',$lvts_lv0039->lv007);?>
							  </select>	<br><table><tr><td>
							...
							<tr>
							  ...
							  <td  height="20">	<input type="text" name="txtlv008" id="txtlv008"  style="width:80%"  tabindex="12"  value="<?php echo (float)$lvts_lv0039->lv008;?>" onKeyPress="return CheckKey(event,7)">					  </td>
						    </tr>
							<tr>
							  ...
							  <?php echo $lvts_lv0039->LV_LinkField('lv009',$lvts_lv0039->lv009);?>
							  </select>	<br><table><tr><td>
							  <ul id="pop-nav4" lang="pop-nav4" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch9" id="txtlvsearch9" tabindex="200" style="width:200px" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvts_lv0039->lv009;?>" onKeyUp="LoadSelf(this,'txtlv009','hr_lv0018','lv002')" onFocus="LoadSelf(this,'txtlv009','hr_lv0018','lv002')">
				  ...
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo (float)$lvts_lv0039->lv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>							 			  							 <tr>
							  ...
							  <?php echo $lvts_lv0039->LV_LinkField('lv011',$lvts_lv0039->lv011);?>
							  </select><br>
							  <table><tr><td>
							  <ul id="pop-nav4" lang="pop-nav4" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
					...
					<!--
							<tr>
							  ...
							  <?php echo $lvts_lv0039->LV_LinkField('lv012',$lvts_lv0039->lv012);?>
							  </select><br><table><tr><td>
							...
							<tr>
							  ...
							  <?php echo $lvts_lv0039->LV_LinkField('lv013',$lvts_lv0039->lv013);?>
							  </select><br><table><tr><td>
				  ...
				  <td  height="20"><input  name="txtlv014" type="text" id="txtlv014" value="<?php echo $lvts_lv0039->lv014;?>" tabindex="18" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
						   <tr>
							  <td  height="20"><?php echo $vLangArr[29];?></td>
				  <td  height="20"><input  name="txtlv015" type="text" id="txtlv015" value="<?php echo $lvts_lv0039->lv015;?>" tabindex="19" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
                           <tr>
				  ...
				  <td  height="20"><select name="txtlv017" id="txtlv017"   tabindex="20"  style="width:80%" onKeyPress="return CheckKey(event,1)"/>
							  <?php echo $lvts_lv0039->LV_LinkField('lv017',$lvts_lv0039->lv017);?>
							  </select>
						  </tr>	
                           <tr>
							  <td  height="20"><?php echo $vLangArr[39];?></td>
				  <td  height="20"><input  name="txtlv018" type="text" id="txtlv018" value="<?php echo $lvts_lv0039->lv018;?>" tabindex="21" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
                           <tr>
							  <td  height="20"><?php echo $vLangArr[40];?></td>
				  <td  height="20"><input  name="txtlv019" type="text" id="txtlv019" value="<?php echo $lvts_lv0039->lv019;?>" tabindex="22" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
                           <tr>
							  <td  height="20"><?php echo $vLangArr[41];?></td>
				  <td  height="20"><input  name="txtlv020" type="text" id="txtlv020" value="<?php echo $lvts_lv0039->lv020;?>" tabindex="23" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
						<tr>
