...
foreach( $data as $row )
{
	...
	{
	$lvts_lv0039->lv001=InsertWithCheckExt('ts_lv0039', 'lv001', '',1);
	$lvts_lv0039->lv002=getInfor($_SESSION['ERPSOFV2RUserID'],2);
	$lvts_lv0039->lv003=$lvsl_lv0007->lv001;
	$lvts_lv0039->lv004=$row['lv004'];
	$lvts_lv0039->lv005=$row['lv005'];
	$lvts_lv0039->lv006=$row['lv006'];
	$lvts_lv0039->lv007=$row['lv007'];
	$lvts_lv0039->lv008=$row['lv008'];
	$lvts_lv0039->lv009=$row['lv009'];
	$lvts_lv0039->lv014=$row['lv014'];
	$lvts_lv0039->lv015=$row['lv015'];
	$lvts_lv0039->lv016=$lvNow;
	$lvts_lv0039->lv017=$row['lv017'];
	$lvts_lv0039->lv018=$row['lv018'];
	$lvts_lv0039->lv019=$row['lv019'];
	$lvts_lv0039->lv020=$row['lv020'];
	
	$vresult=$lvts_lv0039->LV_Insert();
	}
}
		if($vresult==true) {
