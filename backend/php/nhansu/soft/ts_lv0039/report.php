...
$mots_lv0039->ArrPush[17]=$vLangArr[56];
$mots_lv0039->ArrPush[18]=$vLangArr[57];
$mots_lv0039->ArrPush[19]=$vLangArr[58];
$mots_lv0039->ArrPush[20]=$vLangArr[59];
...
$mots_lv0039->ArrFunc[11]=$vLangArr[36];
$mots_lv0039->ArrFunc[12]=$vLangArr[37];
$mots_lv0039->ArrFunc[13]=$vLangArr[38];
$mots_lv0039->ArrFunc[14]=$vLangArr[39];
$mots_lv0039->ArrFunc[15]=$vLangArr[40];
////Other
$mots_lv0039->ArrOther[1]=$vLangArr[31];
$mots_lv0039->ArrOther[2]=$vLangArr[32];
//////Delete message///
$lvMessage=array();
...
?>
						...
						<?php echo $mots_lv0039->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
