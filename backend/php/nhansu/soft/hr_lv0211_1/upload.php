...
if($vFlag==1)
{
	...
	//$lvhr_lv0086->LV_Load();
		...
		$vKetQua=$lvhr_lv0211->LV_LoadStepCheck($vContractID);
		$lvhr_lv0211->lv007=$vContractID;
		$lvhr_lv0211->lv006=$_FILES['userfile']['name'];
		$lvhr_lv0211->lv003='tailieu';
		$lvhr_lv0211->lv002=$lvhr_lv0211->LV_UserID;
		if($vKetQua==null)
		{
			$vresult=$lvhr_lv0211->LV_InsertAuto($vViTriUp,$vHinhUpdate);
		}
		else
		{
			$lvhr_lv0211->lv001=$vKetQua;
			$vresult=$lvhr_lv0211->LV_UpdateAuto($vKetQua,$vViTriUp,$vHinhUpdate);
		}
	
}
/*$vloadattach=$lvhr_lv0211->LV_LoadStep($lvhr_lv0211->lv007,$lvhr_lv0211->lv008,$lvhr_lv0211->lv009,$_GET['CodeID']);
...
<form name="frmpost" id="frmpost" target="_self" action="?childfunc=upload&ContractID=<?php echo $_GET['ContractID'];?>&ViTriUp=<?php echo $_GET['ViTriUp'];?>&lang=<?php echo $_GET['lang'];?>" method="post" enctype="multipart/form-data">
...
<?php
if($vFlag==1) 
	$lvImg="<a target=\"_blank\" href=\"hr_lv0211/readfile.php?ContractID=".$vContractID."&type=".$vViTriUp."&size=0\"><img name=\"imgView\" border=\"0\" style=\"border-color:#CCCCCC\" title=\"\" alt=\"Image\" width=\"96px\" height=\"128px\" src=\"hr_lv0211/readfile.php?ContractID=".$vContractID."&type=".$vViTriUp."&size=1\" /></a>";
else
	$lvImg='';
?>		
	var o = window.parent.document.getElementById('attachfile_<?php echo $vViTriUp;?>_'+'<?php echo $vContractID;?>');
