...
//echo base64_encode('mn_lv0020/mn_lv0020-1.php');
//////Delete message///
$lvMessage=array();
...
//PO VT
$momn_lv0020->TypePO='1';
$momn_lv0020->trangthai2='';
$totalRowsC=$momn_lv0020->GetCount();
//PO VT Phụ
$momn_lv0020->TypePO='4';
$momn_lv0020->trangthai2='';
$totalRowsC4=$momn_lv0020->GetCount();
// PO TN
$momn_lv0020->TypePO='2';
//$momn_lv0020->trangthai2='0,1';
$totalRowsC1=$momn_lv0020->GetCount();

// PO NN
$momn_lv0020->TypePO='3';
$momn_lv0020->trangthai2='';
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					...
					<table border="0" width="100%">
								...
								<tr>
									<td align="left" id="TabViewHr">
										<ul class="IdTabViewHr">
											<?php
											if($momn_lv0020->LV_UserID!='MP002' || $_SESSION['ERPSOFV2RRight']=='admin')
											{
											?>
											<li><div id="hrtab_0" class="curshow" onclick="RunDisableAll(0)">PMH HC<?php echo (($totalRowsC>0)?'('.$totalRowsC.')':'');?></div></li>
											<?php
											}
											if($momn_lv0020->LV_UserID!='MP001'|| $_SESSION['ERPSOFV2RRight']=='admin')
											{
											?>
											...
											if(($momn_lv0020->LV_UserID!='MP002' && $momn_lv0020->LV_UserID!='MP001') || $_SESSION['ERPSOFV2RRight']=='admin')
											{
											?>
						...
						<?php
							...
							?>
						<div id="cl_0_1">
							<input type="hidden" name="cl_0_2" id="cl_0_2" value="home.php?lang=VN&opt=27&item=&link=bW5fbHYwMDIwL21uX2x2MDAyMC0xLnBocA==&TypePO=1"/>
							<iframe name="cl_0_3" id="cl_0_3" height=1000 marginheight=0 marginwidth=0 frameborder=0 title="" src="home.php?lang=VN&opt=27&item=&link=bW5fbHYwMDIwL21uX2x2MDAyMC0xLnBocA==&TypePO=1" class=lvframe></iframe>
					 	</div>
						 <?php
							}
							if($momn_lv0020->LV_UserID!='MP001' || $_SESSION['ERPSOFV2RRight']=='admin')
							...
							?>
						<div id="cl_1_1">
							<input type="hidden" name="cl_1_2" id="cl_1_2" value="home.php?lang=VN&opt=27&item=&link=bW5fbHYwMDIwL21uX2x2MDAyMC0xLnBocA==&TypePO=2"/>
							<iframe name="cl_1_3" id="cl_1_3" height=1000 marginheight=0 marginwidth=0 frameborder=0 title="" src="" class=lvframe></iframe>
						</div>	
						<div id="cl_2_1">
							<input type="hidden" name="cl_2_2" id="cl_2_2" value="home.php?lang=VN&opt=27&item=&link=bW5fbHYwMDIwL21uX2x2MDAyMC0xLnBocA==&TypePO=3"/>
						...
						?>
						<div id="cl_3_1">
							<input type="hidden" name="cl_3_2" id="cl_3_2" value="home.php?lang=VN&opt=27&item=&link=bW5fbHYwMDIwL21uX2x2MDAyMC0xLnBocA==&TypePO="/>
						...
						?>
						<div id="cl_4_1">
							<input type="hidden" name="cl_4_2" id="cl_4_2" value="home.php?lang=VN&opt=27&item=&link=bW5fbHYwMDIwL21uX2x2MDAyMC0xLnBocA==&TypePO=4"/>
