...
$momn_lv0020->ArrFunc[5]='';
$momn_lv0020->ArrFunc[6]='';
$momn_lv0020->ArrFunc[7]='';
$momn_lv0020->ArrFunc[8]=$vLangArr[10];
$momn_lv0020->ArrFunc[9]=$vLangArr[12];
$momn_lv0020->ArrFunc[10]=$vLangArr[0];
$momn_lv0020->ArrFunc[11]=$vLangArr[34];
$momn_lv0020->ArrFunc[12]=$vLangArr[35];
$momn_lv0020->ArrFunc[13]=$vLangArr[36];
$momn_lv0020->ArrFunc[14]=$vLangArr[37];
$momn_lv0020->ArrFunc[15]=$vLangArr[38];

////Other
$momn_lv0020->ArrOther[1]=$vLangArr[32];
$momn_lv0020->ArrOther[2]=$vLangArr[33];
//////Delete message///
$lvMessage=array();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$momn_lv0020->lv002=base64_decode( $_GET['ID']);
...
?>
						...
						<?php echo $momn_lv0020->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
