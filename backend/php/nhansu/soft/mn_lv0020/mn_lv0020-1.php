...
require_once("$vDir../clsall/mn_lv0020.php");
...
$mojo_lv0016->LV_Load();
$momn_lv0020->lvcr_lv0202=$lvcr_lv0202;
$lvcr_lv0203->mocr_lv0324=$mocr_lv0324;
$momn_lv0020->lvcr_lv0203=$lvcr_lv0203;
$momn_lv0020->mocr_lv0092=$mocr_lv0092;
$momn_lv0020->mowh_lv0003=$mowh_lv0003;
$momn_lv0020->mojo_lv0016=$mojo_lv0016;
$momn_lv0020->lvcr_lv0108=$lvcr_lv0108;
$momn_lv0020->lvcr_lv0109=$lvcr_lv0109;
$momn_lv0020->TypePO=$_GET['TypePO'];
$momn_lv0020->LV_OptionType();
$momn_lv0020->Dir=$vDir;
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("$vDir../","WH0024.txt",$plang);
if($momn_lv0020->GetView()>0)
{	
	if(isset($_GET['ajaxchitiethistory']))
	{
		require_once("$vDir../clsall/cr_lv0105.php");
		$mocr_lv0105=new cr_lv0105($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Mn0020');
		if($plang=="") $plang="VN";
...
$momn_lv0020->ArrPush[13]=$vLangArr[40];
$momn_lv0020->ArrPush[14]=$vLangArr[31];
$momn_lv0020->ArrPush[15]=$vLangArr[32];
$momn_lv0020->ArrPush[16]='Tỷ giá tiền tệ thứ 2';
$momn_lv0020->ArrPush[28]='Trạng thái duyệt';
$momn_lv0020->ArrPush[13]='Tiền tệ thứ 2';
$momn_lv0020->ArrPush[14]='Tỷ giá VNĐ';
$momn_lv0020->ArrPush[15]='';
$momn_lv0020->ArrPush[16]='Tỷ giá tiền tệ thứ 2';
$momn_lv0020->ArrPush[17]='Tiền tệ chính';
$momn_lv0020->ArrPush[88]='Mã nhóm đơn hàng';
$momn_lv0020->ArrPush[89]='Phiếu ĐNVT';
$momn_lv0020->ArrPush[90]='PBH Số';
$momn_lv0020->ArrPush[190]='Tên dự án';
$momn_lv0020->ArrPush[91]='Phiếu đầu ra';
$momn_lv0020->ArrPush[213]='Tổng tiền';
$momn_lv0020->ArrPush[214]='Thanh toán';
$momn_lv0020->ArrPush[99]='Tiền nợ treo';
$momn_lv0020->ArrPush[100]='Tiền nợ còn lại';
$momn_lv0020->ArrPush[115]='Mã công việc';
$momn_lv0020->ArrPush[212]='Tổng tiền mua VNĐ';
$momn_lv0020->ArrPush[213]='Tổng tiền mua chính';
$momn_lv0020->ArrPush[214]='Thanh toán chính';
$momn_lv0020->ArrPush[215]='Tổng tiền mua thứ 2';
$momn_lv0020->ArrPush[216]='Thanh toán thứ 2';
$momn_lv0020->ArrPush[217]='Qui đổi thanh toán thứ 2 → chính';
$momn_lv0020->ArrPush[218]='Qui đổi thanh toán';
$momn_lv0020->ArrPush[219]='Tổng tiền nợ còn lại';
$momn_lv0020->ArrPush[221]='Thanh toán VND';
$momn_lv0020->ArrPush[222]='Qui đổi thanh toán VND → chính';
$momn_lv0020->ArrPush[283]='Tổng tiền mua chính trước VAT';
$momn_lv0020->ArrPush[293]='Tiền VAT';

$momn_lv0020->ArrPush[105]=$vLangArr[42];
$momn_lv0020->ArrPush[106]=$vLangArr[43];
$momn_lv0020->ArrPush[107]=$vLangArr[44];
$momn_lv0020->ArrPush[108]=$vLangArr[45];
$momn_lv0020->ArrPush[109]=$vLangArr[46];
$momn_lv0020->ArrPush[110]=$vLangArr[47];
$momn_lv0020->ArrPush[111]=$vLangArr[48];
$momn_lv0020->ArrPush[112]=$vLangArr[49];
$momn_lv0020->ArrPush[113]=$vLangArr[50];
$momn_lv0020->ArrPush[114]=$vLangArr[51];

$momn_lv0020->ArrPush[200]='Chức năng';
...
$momn_lv0020->ArrFunc[6]=GetLangExcept('duyet',$plang);
$momn_lv0020->ArrFunc[7]=GetLangExcept('tralai',$plang);
$momn_lv0020->ArrFunc[8]=$vLangArr[10];
$momn_lv0020->ArrFunc[9]=$vLangArr[12];
$momn_lv0020->ArrFunc[10]=$vLangArr[0];
$momn_lv0020->ArrFunc[11]=$vLangArr[35];
$momn_lv0020->ArrFunc[12]=$vLangArr[36];
$momn_lv0020->ArrFunc[13]=$vLangArr[37];
$momn_lv0020->ArrFunc[14]=$vLangArr[38];
$momn_lv0020->ArrFunc[15]=$vLangArr[39];

////Other
$momn_lv0020->ArrOther[1]=$vLangArr[33];
$momn_lv0020->ArrOther[2]=$vLangArr[34];
//////Delete message///
$lvMessage=array();
...
elseif($flagID==3)
{
	...
	$momn_lv0020->mosl_lv0007=$mosl_lv0007;
	$strar=substr($strchk,0,strlen($strchk)-1);
	$strar=str_replace("@","','",$strar);
	$strar="'".$strar."'";
...
{
	$strar="'".$strchk."'";
	$vresult=$momn_lv0020->LV_AprovalNo($strar);
}
elseif($flagID==4)
{
	$strar=substr($strchk,0,strlen($strchk)-1);
...
elseif($flagID==24)
{
	$momn_lv0020->Remark=$_POST['txtRemark'];
	$strar="'".$strchk."'";
	$vresult=$momn_lv0020->LV_UnAproval($strar);
}
elseif($flagID==34)
...
$momn_lv0020->trangthai=$_GET['trangthai'];
...
function Report(vValue)
{
	...
	o.action="<?php echo $vDir;?>mn_lv0020?func=<?php echo $_GET['func'];?>&childfunc=rpt1&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
...
function Report2(vValue)
{
	var o=document.frmprocess;
	o.target="_blank";
	o.action="<?php echo $vDir;?>mn_lv0020?func=<?php echo $_GET['func'];?>&childfunc=rpt1&ID="+vValue+"&lang=<?php echo $plang;?>";
	o.submit();
}
...
function Report3(vValue)
{
	var o=document.frmprocess;
	o.target="_blank";
	o.action="<?php echo $vDir;?>mn_lv0020?func=<?php echo $_GET['func'];?>&childfunc=rpt3&ID="+vValue+"&lang=<?php echo $plang;?>";
	o.submit();
...
function Report9(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0020?func=<?php echo $_GET['func'];?>&childfunc=rpt9&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
...
function Report19(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0020?func=<?php echo $_GET['func'];?>&childfunc=rpt19&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report19KTT(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0020?func=<?php echo $_GET['func'];?>&childfunc=rpt19ktt&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report19KTVT(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0020?func=<?php echo $_GET['func'];?>&childfunc=rpt19ktvt&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report19KTCT(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0020?func=<?php echo $_GET['func'];?>&childfunc=rpt19ktct&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report69(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0020?func=<?php echo $_GET['func'];?>&childfunc=rpt69&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report10(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0020?func=<?php echo $_GET['func'];?>&childfunc=rpt10&TypeID=4&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
...
function Report20(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0020?func=<?php echo $_GET['func'];?>&childfunc=rpt20&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report20KTT(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0020?func=<?php echo $_GET['func'];?>&childfunc=rpt20ktt&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report20KTVT(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0020?func=<?php echo $_GET['func'];?>&childfunc=rpt20ktvt&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report20KTCT(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0020?func=<?php echo $_GET['func'];?>&childfunc=rpt20ktct&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report5(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0020?func=<?php echo $_GET['func'];?>&childfunc=rpt5&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
	//var fun2="Report5('"+vValue+"')";
	setTimeout(fun2,100);
}
...
<body  onkeyup="KeyPublicRun(event)">
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<div><div id="lvleft">
							...
							<table style="background:#f2f2f2;font:10px arial" >	
								...
								<tr>
									<td><select class="norequired" name="LANGIAOHANG"  id="LANGIAOHANG"  style="min-width:90px;width:100%;">
											...
											<?php echo $momn_lv0020->LV_LinkField('lv000',$mosl_lv0013->LANGIAOHANG);?>
										</select>
									</td>
								<td  height="20px"><input  autocomplete="off" style="width:120px;text-align:center;" name="txtlv001" type="text" id="txtlv001" value="<?php echo $momn_lv0020->lv001;?>" tabindex="9" maxlength="50" style="width:100%" onKeyPress="return CheckKey(event,7)"></td>
								<td>
									<table width="95%">
											<tr>
											<td>
								...
								<td  height="20px"><input  autocomplete="off" style="width:120px;text-align:center;" name="txtTenDuAn" type="text" id="txtTenDuAn" value="<?php echo $momn_lv0020->TenDuAn;?>" tabindex="9" maxlength="50" style="width:100%" onKeyPress="return CheckKey(event,7)"></td> 
								<td>
									<table width="95%">
											<tr>
											<td>
								...
								<td  height="20px"><input  autocomplete="off" style="width:120px;text-align:center;" name="txtlv004" type="text" id="txtlv004" value="<?php echo $momn_lv0020->lv004;?>" tabindex="9" maxlength="50" style="width:100%" onKeyPress="return CheckKey(event,7)" onClick="if(self.gfPop)gfPop.fPopCalendar(this);return false;" autocomplete="off" ></td> 
								<td><table width="100%"><tr><td>
									<select name="txtlv010" id="txtlv010"   tabindex="14"  style="width:100px" onKeyPress="return CheckKeys(event,7,this)">
										<option value=''>...</option>
										<?php echo $momn_lv0020->LV_LinkField('lv010',$momn_lv0020->lv010);?>
									</select>
								</td>
								<td>
						...
						<input type="hidden" name="txtlv002" id="txtlv002" value="<?php echo $momn_lv0020->lv002;?>"/>
						<input type="hidden" name="txtlv003" id="txtlv003" value="<?php echo $momn_lv0020->lv003;?>"/>
						<input type="hidden" name="txtlv004" id="txtlv004" value="<?php echo $momn_lv0020->lv004;?>"/>
						<input type="hidden" name="txtlv005" id="txtlv005" value="<?php echo $momn_lv0020->lv005;?>"/>
						<input type="hidden" name="txtlv006" id="txtlv006" value="<?php echo $momn_lv0020->lv006;?>"/>
						<input type="hidden" name="txtlv007" id="txtlv007" value="<?php echo $momn_lv0020->lv007;?>"/>
						<input type="hidden" name="txtlv008" id="txtlv008" value="<?php echo $momn_lv0020->lv008;?>"/>
						<input type="hidden" name="txtlv009" id="txtlv009" value="<?php echo $momn_lv0020->lv009;?>"/>
						<input type="hidden" name="txtlv011" id="txtlv011" value="<?php echo $momn_lv0020->lv011;?>"/>
					
						<?php echo $momn_lv0020->LV_BuilList($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
...
div.innerHTML='<?php echo $momn_lv0020->ArrPush[0];?>';	
</script>
</html>