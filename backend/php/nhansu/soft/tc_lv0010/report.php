...
$motc_lv0010->ArrPush[11]=$vLangArr[28];
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$motc_lv0010->lv002=base64_decode( $_GET['ID']);
...
?>
				...
				<?php echo $motc_lv0010->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
