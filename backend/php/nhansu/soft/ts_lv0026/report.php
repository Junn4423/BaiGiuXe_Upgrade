...
if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","TS0033.txt",$plang);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$mots_lv0026->lv002=base64_decode( $_GET['ID']);
...
?>
				...
				<?php echo $mots_lv0026->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
