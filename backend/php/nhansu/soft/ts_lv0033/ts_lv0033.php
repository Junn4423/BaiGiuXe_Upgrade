...
require_once("$vDir../clsall/ts_lv0033.php");

/////////////init object//////////////
$mots_lv0033=new ts_lv0033($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ts0033');
$mots_lv0033->Dir=$vDir;
$mots_lv0033->lv015=1;
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("$vDir../","TS0046.txt",$plang);
...
$mots_lv0033->ArrFunc[5]=GetLangExcept('Rpt',$plang);
$mots_lv0033->ArrFunc[6]=GetLangExcept('Apr',$plang);
$mots_lv0033->ArrFunc[7]=GetLangExcept('UnApr',$plang);
...
//	$tsql="select count(*) from department where CompanyID ";
	...
	$strar="'".$strar."'";
	$vresult=$mots_lv0033->LV_Delete($strar);
	$vStrMessage=GetNoDelete($strar,"ts_lv0033",$lvMessage);
}
elseif($flagID==2)
{
$mots_lv0033->lv001=$_POST['txtlv001'];
if( $_GET['ID']=="")
$mots_lv0033->lv002=$_POST['txtlv002'];
else
$mots_lv0033->lv002= $_GET['ID'] ?? '';
$mots_lv0033->lv003=$_POST['txtlv003'];
$mots_lv0033->lv004=$_POST['txtlv004'];
$mots_lv0033->lv005=$_POST['txtlv005'];
$mots_lv0033->lv006=$_POST['txtlv006'];
$mots_lv0033->lv007=$_POST['txtlv007'];
$mots_lv0033->lv008=$_POST['txtlv008'];
$mots_lv0033->lv009=$_POST['txtlv009'];
$mots_lv0033->lv010=$_POST['txtlv010'];
}
elseif($flagID==3)
{
	$strar=substr($strchk,0,strlen($strchk)-1);
	$strar=str_replace("@","','",$strar);
	$strar="'".$strar."'";
	$vresult=$mots_lv0033->LV_Aproval($strar);
}
elseif($flagID==4)
{
	$strar=substr($strchk,0,strlen($strchk)-1);
	$strar=str_replace("@","','",$strar);
	$strar="'".$strar."'";
	$vresult=$mots_lv0033->LV_UnAproval($strar);
}
//first is load
if(($_POST['txtFlag']) != 2)
{
...
$mots_lv0033->SaveOperation($_SESSION['ERPSOFV2RUserID'],'ts_lv0033',$vFieldList,(int)$_POST['lvmaxrow'],(int)$_POST['curPg'],$vOrderList,(int)$_POST['lvsort']);
...
{
	var str="<br><iframe id='lvframefrm' height=2000 marginheight=0 marginwidth=0 frameborder=0 src=<?php echo $vDir;?>ts_lv0033?func=<?php echo $_GET['func'];?>&childfunc="+func+"&ID=<?php echo  $_GET['ID'] ?? '';?>&ChildID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?> class=lvframe></iframe>";
...
var o=document.frmprocess;
	o.target="_blank";
	o.action="<?php echo $vDir;?>ts_lv0033?func=<?php echo $_GET['func'];?>&childfunc=rpt&ID="+vValue+"&lang=<?php echo $plang;?>";
	o.submit();
	o.action="<?php echo $vDir;?>ts_lv0033?func=<?php echo $_GET['func'];?>&childfunc=rpten&ID="+vValue+"&lang=<?php echo $plang;?>";
	o.submit();
}
//-->
</script>
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<div><div id="lvleft"><form onSubmit="return false;" action="?func=<?php echo $_GET['func'];?>&ID=<?php echo  $_GET['ID']?>&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,1,0);?>" method="post" name="frmchoose" id="frmchoose">
					  <input type="hidden" name="curPg" value="<?php echo  $curPage;?>"/>
						<?php echo $mots_lv0033->LV_BuilList($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
						<input name="txtStringID" type="hidden" id="txtStringID" />
						<input name="txtFieldList" type="hidden" id="txtFieldList"  value="<?php echo $vFieldList;?>"/>
						<input name="txtOrderList" type="hidden" id="txtOrderList"  value="<?php echo $vOrderList;?>"/>
						
						<input name="txtFlag" type="hidden" id="txtFlag" value="2"/>
						<input type="hidden" name="txtlv001" id="txtlv001"  value="<?php echo $mots_lv0033->lv001;?>"/>
						<input type="hidden" name="txtlv002" id="txtlv002" value="<?php echo $mots_lv0033->lv002;?>"/>
						<input type="hidden" name="txtlv003" id="txtlv003" value="<?php echo $mots_lv0033->lv003;?>"/>
						<input type="hidden" name="txtlv004" id="txtlv004" value="<?php echo $mots_lv0033->lv004;?>"/>
						<input type="hidden" name="txtlv005" id="txtlv005" value="<?php echo $mots_lv0033->lv005;?>"/>
						<input type="hidden" name="txtlv006" id="txtlv006" value="<?php echo $mots_lv0033->lv006;?>"/>
						<input type="hidden" name="txtlv007" id="txtlv007" value="<?php echo $mots_lv0033->lv007;?>"/>
						<input type="hidden" name="txtlv008" id="txtlv008" value="<?php echo $mots_lv0033->lv008;?>"/>
						<input type="hidden" name="txtlv009" id="txtlv009" value="<?php echo $mots_lv0033->lv009;?>"/>
						<input type="hidden" name="txtlv010" id="txtlv010" value="<?php echo $mots_lv0033->lv010;?>"/>
						<input type="hidden" name="txtlv011" id="txtlv011" value="<?php echo $mots_lv0033->lv011;?>"/>
						<input type="hidden" name="txtlv012" id="txtlv012" value="<?php echo $mots_lv0033->lv012;?>"/>
						<input type="hidden" name="txtlv013" id="txtlv013" value="<?php echo $mots_lv0033->lv013;?>"/>
				 </form>
...
div.innerHTML='<?php echo $mots_lv0033->ArrPush[0];?>';	
</script>
</html>