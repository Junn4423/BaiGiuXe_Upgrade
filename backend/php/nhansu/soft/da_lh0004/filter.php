...
//////////////init object////////////////
$lvcr_lv0039=new  cr_lv0039($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0006');
...
function isphone(s){
	...
	function Save()
	{
		...
		o.txtlv003.value=(document.frmfilter.txtlv003.checked)?'1':'';		
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
								...
								<td width="*"  height="20px">
									<input class="norequired" name="txtlv001" type="text" id="txtlv001"  value="<?php echo $vlv001;?>" tabindex="5" maxlength="32" style="width:80%" onKeyPress="return CheckKey(event,7)" />			</td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input class="norequired" name="txtlv002" type="text" id="txtlv002" value="<?php echo $vlv002;?>" tabindex="6" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[17];?></td>
							  <td  height="20px"  align="left">
							  		<input type="checkbox" name="txtlv003" id="txtlv003" tabindex="7"  onKeyPress="return CheckKey(event,7)" value="1" <?php echo ($lvcr_lv0039->lv003==1)?'checked="true"':'';?>/>	  
							  </td>
							</tr>
						<tr>
						  <td  height="20px"><?php echo $vLangArr[18];?></td>
						  <td  height="20px"><input class="norequired" name="txtlv004" type="text" id="txtlv004" value="<?php echo $vlv004;?>" tabindex="8" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
						</tr>
						<tr>
							<td  height="20px"><?php echo $vLangArr[19];?></td>
							<td  height="20px"><input class="norequired" name="txtlv005" type="text" id="txtlv005" value="<?php echo $vlv005;?>" tabindex="6" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
						</tr>
							<tr>
