...
/////////////init object//////////////
$motc_lv0028=new tc_lv0028($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Tc0026');
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$motc_lv0028->lv002=base64_decode( $_GET['ID']);
...
?>
				...
				<?php echo $motc_lv0028->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
