  ...
  <div class="story">
    <h2 id="pageName"><?php echo $vLangArr[1];?></h2>
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
				  ...
				  <td  height="20px"><select name="txtlv003" id="txtlv003"  tabindex="7" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"><option value=""></option>
							   <?php echo $lvtc_lv0028->LV_LinkField('lv003',$vlv003);?>
                              </select>
							    <br>
							  <table><tr><td></td><td>
						  ...
						  <tr>
							  ...
							  <td  height="20px"><input name="txtlv004" type="text" id="txtlv004" value="<?php echo $vlv004;?>" tabindex="8" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
					        <span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
							  ...
							  <td  height="20px"><select name="txtlv005" id="txtlv005"  tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"><option value=""></option>
							   <?php echo $lvtc_lv0028->LV_LinkField('lv005',$vlv005);?>
                              </select>	
							    <br>
							  <table><tr><td></td><td>
							  ...
							  <td  height="20px"><select name="txtlv007" id="txtlv007"  tabindex="12" maxlength="50" style="width:80%" onkeypress="return CheckKey(event,7)"><option value=""></option>
                                <?php echo $lvtc_lv0028->LV_LinkField('lv007',$vlv007);?>
                              </select>
							    <br>
							  <table><tr><td></td><td>
							  ...
							  <td  height="20px"><input name="txtlv008" type="text" id="txtlv008" value="<?php echo $vlv008;?>" tabindex="13" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
							    <tr>
							  <td  height="20px"><?php echo $vLangArr[23];?></td>
							  <td  height="20px"><input name="txtlv009" type="text" id="txtlv009" value="<?php echo $vlv009;?>" tabindex="13" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
							   <tr>
							  <td  height="20px"><?php echo $vLangArr[24];?></td>
							  <td  height="20px"><select name="txtlv010" id="txtlv010"  tabindex="14" maxlength="50" style="width:80%" onkeypress="return CheckKey(event,7)"><option value=""></option>
                                <?php echo $lvtc_lv0028->LV_LinkField('lv010',$vlv010);?>
                              </select>
							    <br>
							  <table><tr><td></td><td>
							  ...
							  <td  height="20px"><input name="txtlv011" type="text" id="txtlv011" value="<?php echo $vlv011;?>" tabindex="15" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>																				
							<tr>
