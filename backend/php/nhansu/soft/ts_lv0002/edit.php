...
require_once("../../clsall/ts_lv0002.php");
//////////////init object////////////////
$lvts_lv0002=new ts_lv0002($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ts0002');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvts_lv0002->lv001= $_GET['ID'] ?? '';
if($plang=="") $plang="VN";
...
if($vFlag==1)
{
$lvts_lv0002->lv002=$_POST['txtlv002'];
$lvts_lv0002->lv003=$_POST['txtlv003'];
$lvts_lv0002->lv004=$_POST['txtlv004'];
$lvts_lv0002->lv005=$_POST['txtlv005'];
$lvts_lv0002->lv006=$_POST['txtlv006'];
if($_FILES['userfile']['name']=="")
$lvts_lv0002->lv007=$_POST['txtlv007'];
else
$lvts_lv0002->lv007=$_FILES['userfile']['name'];
$lvts_lv0002->lv008=$_POST['txtlv008'];
$lvts_lv0002->lv009=$_POST['txtlv009'];
$lvts_lv0002->lv010=$_POST['txtlv010'];
$lvts_lv0002->lv011=$_POST['txtlv011'];
$lvts_lv0002->lv012=$_POST['txtlv012'];
$lvts_lv0002->lv013=$_POST['txtlv013'];
$lvts_lv0002->lv014=$_POST['txtlv014'];
$lvts_lv0002->lv015=$_POST['txtlv015'];
$lvts_lv0002->lv016=$_POST['txtlv016'];
		
		$vresult=$lvts_lv0002->LV_Update();
		if($vresult==true) {
...
$lvts_lv0002->LV_LoadID($lvts_lv0002->lv001);
					...
					<form action="#" name="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvts_lv0002->lv001=="")?InsertWithCheckExt('huyvanv2_0.ts_lv0002', 'lv001', '',10):$lvts_lv0002->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[16];?></td>
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvts_lv0002->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[17];?></td>
							  <td  height="20"><input  name="txtlv003" type="text" id="txtlv003" value="<?php echo $lvts_lv0002->lv003;?>" tabindex="7" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
						    </tr>
<tr>
							  <td  height="20"><?php echo $vLangArr[18];?></td>
				  <td  height="20"><input  name="txtlv004" type="text" id="txtlv004" value="<?php echo $lvts_lv0002->lv004;?>" tabindex="8" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
						  </tr>							  
							<tr>
							  <td  height="20"><?php echo $vLangArr[19];?></td>
							  <td  height="20"><input name="txtlv005" type="text" id="txtlv005" value="<?php echo $lvts_lv0002->lv005;?>" tabindex="9" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
						    </tr>
								<tr>
							  <td  height="20"><?php echo $vLangArr[20];?></td>
							  <td  height="20"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo $lvts_lv0002->lv006;?>" tabindex="10" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
<tr>
							  ...
							  <?php echo $lvts_lv0002->LV_LinkField('lv007',$lvts_lv0002->lv007);?>
							  </select></td><td>
							...
							<tr>
							  ...
							  <?php echo $lvts_lv0002->LV_LinkField('lv008',$lvts_lv0002->lv008);?>
							  </select></td><td>
							...
							<tr>
							  ...
							  <td  height="20"><input type="text" name="txtlv009" id="txtlv009" tabindex="13" style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo $lvts_lv0002->lv009;?>"></td>
						    </tr>
                          <tr>
							  <td  height="20"><?php echo $vLangArr[24];?></td>
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo $lvts_lv0002->lv010;?>" tabindex="14" maxlength="15" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
						  </tr>							  
							<tr>
							  <td  height="20"><?php echo $vLangArr[25];?></td>
							  <td  height="20"><input name="txtlv011" type="text" id="txtlv011" value="<?php echo $lvts_lv0002->lv011;?>" tabindex="15" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
						    </tr>
								<tr>
							  <td  height="20"><?php echo $vLangArr[26];?></td>
							  <td  height="20"><input name="txtlv012" type="text" id="txtlv012" value="<?php echo $lvts_lv0002->lv012;?>" tabindex="16" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>		
<tr>
								<td width="166"  height="20"><?php echo $vLangArr[27];?></td>
								<td  height="20">
									<input name="txtlv013" type="text" id="txtlv013"  value="<?php echo $lvts_lv0002->lv013;?>" tabindex="17" maxlength="500" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
					      </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[28];?></td>
							  <td  height="20"><input name="txtlv014" type="text" id="txtlv014"  value="<?php echo $lvts_lv0002->lv014;?>" tabindex="18" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[29];?></td>
							  <td  height="20"><input  name="txtlv015" type="text" id="txtlv015" value="<?php echo $lvts_lv0002->lv015;?>" tabindex="19" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
						    </tr>
<tr>
							  <td  height="20"><?php echo $vLangArr[30];?></td>
				  <td  height="20"><input  name="txtlv016" type="text" id="txtlv016" value="<?php echo $lvts_lv0002->lv016;?>" tabindex="20" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
				  		</tr>	
						<tr>
