...
$lvts_lv0002->lv001=$_POST['txtlv001'];
					...
					<form action="#" name="frmadd" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvts_lv0002->lv001=="")?InsertWithCheckExt('huyvanv2_0.ts_lv0002', 'lv001', 'WCUS',7):$lvts_lv0002->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)"/>			</td>
						    </tr>
							<tr>
