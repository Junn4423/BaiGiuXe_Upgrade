...
$lvts_lv0023->lv001=InsertWithCheckExt('ts_lv0023', 'lv001', '',0);
$lvts_lv0023->lv002=$_GET['ChildID'];
$lvts_lv0023->lv003=$_POST['txtlv003'];
$lvts_lv0023->lv004=$_POST['txtlv004'];
$lvts_lv0023->lv005=GetServerDate()." ".GetServerTime();
$lvts_lv0023->lv006=$_FILES['userfile']['name'];
if($vFlag==1)
{
		
		$vresult=$lvts_lv0023->LV_Insert();
		if($vresult==true) {
