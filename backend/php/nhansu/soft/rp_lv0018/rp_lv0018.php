...
/////////////init object//////////////
$morp_lv0016=new  rp_lv0016($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Rp0018');
/////////////init object//////////////
...
{
	//////////////////////////////////////////////////////////////////////////////////////////////////////
$morp_lv0016->LoadSaveOperation($_SESSION['ERPSOFV2RUserID'],'rp_lv0018');
//////////////////////////////////////////////////////////////////////////////////////////////////////
...
$morp_lv0016->SaveOperation($_SESSION['ERPSOFV2RUserID'],'rp_lv0018',$vFieldList,(int)$_POST['lvmaxrow'],(int)$_POST['curPg'],$vOrderList,(int)$_POST['lvsort']);
}
$vStrMessage="";
if($flagID==1)
{
...
function RptWH(vValue)
{
	...
	o.target="_blank";
	o.action="rp_lv0018/?func="+o.childfunc.value+"&lang=<?php echo $plang;?>";
	o.submit();
	o.target="_self";
	o.action="";
}
