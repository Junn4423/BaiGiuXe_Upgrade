...
$mohr_lv0041->ArrFunc[11]=$vLangArr[29];
$mohr_lv0041->ArrFunc[12]=$vLangArr[30];
$mohr_lv0041->ArrFunc[13]=$vLangArr[31];
$mohr_lv0041->ArrFunc[14]=$vLangArr[32];
$mohr_lv0041->ArrFunc[15]=$vLangArr[33];
////Other
$mohr_lv0041->ArrOther[1]=$vLangArr[27];
$mohr_lv0041->ArrOther[2]=$vLangArr[28];
//////Delete message///
$lvMessage=array();
...
?>
				...
				<?php echo $mohr_lv0041->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
