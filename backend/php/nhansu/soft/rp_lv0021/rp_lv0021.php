...
if(!isset($_POST['txtlv005'])) $morp_lv0021->lv005=$vNow;
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
                    ...
                    <input type="hidden" name="lang" value="<?php echo $_GET['lang'];?>" />
					 <table width="100%" border="0" align="center" class="table1">
                             ...
                             <tr>
							  ...
							  <td width="178"  height="20">
								  <div style="max-height:400px;overflow:auto">
									<input name="txtlv002" type="hidden" id="txtlv002" value="<?php echo $morp_lv0021->lv002;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"> <?php echo $morp_lv0021->GetBuilCheckListDept($morp_lv0021->lv002,'chklv002',10,'hr_lv0002','lv003',$morp_lv0021->lv029);?>
								  </div>
							  </td>
						    </tr>	
						  <tr>
							  ...
							  <td  height="20">
							   <div style="max-height:200px;overflow:auto">
									<input name="txtlv003" type="hidden" id="txtlv003" value="<?php echo $morp_lv0021->lv003;?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"> <?php echo $morp_lv0021->GetBuilCheckList('0,1,4,5,6','chklv003',10,'hr_lv0022');?>
								</div>
							</td>
					   </tr>	
							  ...
							  <td  height="20"><table><tr><td><input name="txtlv004" type="text" id="txtlv004" value="<?php echo $morp_lv0021->lv004;?>" tabindex="9" maxlength="50" style="width:100%" onKeyPress="return CheckKeys(event,7,this)" /></td><td>
				      ...
				      <td  height="20"><input name="txtdatefrom" type="text" id="txtdatefrom" value="<?php echo $morp_lv0021->FormatView($lvDateFrom,2);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
				      ...
				      <td  height="20"><input name="txtdateto" type="text" id="txtdateto" value="<?php echo $morp_lv0021->FormatView($lvDateTo,2);?>" tabindex="11" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)">
			          <span class="td"><img src="../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
					   ...
					   <tr>
					   		<td><?php echo $vLangArr[14];?></td><td><select name="txtlv022">
					   			...
					   			<option value="2" ><?php echo 'Theo người thêm,ngày';?></option>
					   			<option value="3" ><?php echo 'Theo người thêm,nhan viên,ngày';?></option>
					   		</select></td>
					   </tr>	
						 <tr>
								  <td  height="20" width="166"><?php echo 'Chỉ lấy ngoại lệ';?></td>
