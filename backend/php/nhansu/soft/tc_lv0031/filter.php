					...
					<form action="#" name="frmfilter" method="post">
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
							  ...
							  <option value=""></option>
							  <?php echo $lvtc_lv0031->LV_LinkField('lv003',$vlv003);?></select></td>
							</tr>						  
							<tr>
							  ...
							  <tr>
							  <td  height="20px"><?php echo $vLangArr[17];?></td>
				  <td  height="20px"><select  name="txtlv005"  id="txtlv005"  tabindex="10" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/><option value=""></option><?php echo $lvtc_lv0031->LV_LinkField('lv005',$vlv005);?>
