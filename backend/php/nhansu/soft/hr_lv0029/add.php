...
$lvhr_lv0029->lv001=InsertWithCheckExt('hr_lv0029', 'lv001', '',1);
$lvhr_lv0029->lv002= $_GET['ID'] ?? '';
$lvhr_lv0029->lv003=$_POST['txtlv003'];
$lvhr_lv0029->lv004=$_POST['txtlv004'];
$lvhr_lv0029->lv005=(int)$_POST['txtlv005'];
				  ...
				  <td  height="20px"><input type="text" value=" <?php echo $lvhr_lv0029->lv003;?>"  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
						  ...
						  <input name="txtlv005" type="radio" tabindex="9" value="1" style="vertical-align:bottom" <?php echo ($lvhr_lv0029->lv005!=0)?"checked":"";?>/></td>
							...
							<tr>
							  ...
							  <td  height="20px"><input onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmadd.txtlv006);return false;" name="txtlv006" type="text" id="txtlv006" value="<?php echo $lvhr_lv0029->FormatView($lvhr_lv0029->lv006,2);?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
							  ...
							  <td  height="20px"><input onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmadd.txtlv007);return false;" name="txtlv007" type="text" id="txtlv007" value="<?php echo $lvhr_lv0029->FormatView($lvhr_lv0029->lv007,2);?>" tabindex="10" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
						      <span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
