...
$mohr_lv0029->ArrFunc[11]=$vLangArr[30];
$mohr_lv0029->ArrFunc[12]=$vLangArr[31];
$mohr_lv0029->ArrFunc[13]=$vLangArr[32];
$mohr_lv0029->ArrFunc[14]=$vLangArr[33];
$mohr_lv0029->ArrFunc[15]=$vLangArr[34];
////Other
$mohr_lv0029->ArrOther[1]=$vLangArr[28];
$mohr_lv0029->ArrOther[2]=$vLangArr[29];
//////Delete message///
$lvMessage=array();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$mohr_lv0029->lv002=base64_decode( $_GET['ID']);
...
?>
				...
				<?php echo $mohr_lv0029->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
