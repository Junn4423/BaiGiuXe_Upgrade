...
//////////////init object////////////////
$lvhr_lv0029=new hr_lv0029($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Hr0054');
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
				  ...
				  <td  height="20px"><input  name="txtlv004" type="text" id="txtlv004" value="<?php echo $vlv004;?>" tabindex="8" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>
							  ...
							  <td  height="20px"><span class="td">
						        <input name="txtlv005" type="radio" tabindex="7" value="" style="vertical-align:bottom" <?php echo ($lvhr_lv0029->lv005=="")?"checked":"";?>/>
						        <?php echo $vLangArr[23];?>
						        <input name="txtlv005" type="radio" tabindex="7" value="0" style="vertical-align:bottom" <?php echo ($lvhr_lv0029->lv005==0)?"checked":"";?>/>
						  <?php echo $vLangArr[24];?>
						  <input name="txtlv005" type="radio" tabindex="7" value="1" style="vertical-align:bottom" <?php echo ($lvhr_lv0029->lv005!=0)?"checked":"";?>/></td>
							</tr>						  
							<tr>
