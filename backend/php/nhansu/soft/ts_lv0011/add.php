...
$lvts_lv0011->obj_wb_lv0006=$mowb_lv0006;
if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","TS0018.txt",$plang);
$lvts_lv0011->lang=strtoupper($plang);
$curPage = (int)($_POST['curPg'] ?? 1);	
$vFlag   = (int)($_POST['txtFlag'] ?? 0);
$lvts_lv0011->lv001=$_POST['txtlv001'];
$lvts_lv0011->lv002=$_GET['ChildID'];
