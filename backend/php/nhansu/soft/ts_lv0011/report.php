...
$mots_lv0011->ArrFunc[11]=$vLangArr[36];
$mots_lv0011->ArrFunc[12]=$vLangArr[37];
$mots_lv0011->ArrFunc[13]=$vLangArr[38];
$mots_lv0011->ArrFunc[14]=$vLangArr[39];
$mots_lv0011->ArrFunc[15]=$vLangArr[40];
////Other
$mots_lv0011->ArrOther[1]=$vLangArr[31];
$mots_lv0011->ArrOther[2]=$vLangArr[32];
//////Delete message///
$lvMessage=array();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$mots_lv0011->lv002=base64_decode( $_GET['ID']);
...
?>
						...
						<?php echo $mots_lv0011->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
