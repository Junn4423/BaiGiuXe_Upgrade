...
require_once("../../clsall/ts_lv0011.php");
//////////////init object////////////////
$lvts_lv0011=new ts_lv0011($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Ts0011');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvts_lv0011->lv001=$_GET['ChildDetailID'];
if($plang=="") $plang="VN";
...
if($vFlag==1)
{
$lvts_lv0011->lv002=$_POST['txtlv002'];
$lvts_lv0011->lv003=$_POST['txtlv003'];
$lvts_lv0011->lv004=$_POST['txtlv004'];
$lvts_lv0011->lv005=$_POST['txtlv005'];
$lvts_lv0011->lv006=$_POST['txtlv006'];
$lvts_lv0011->lv007=$_POST['txtlv007'];
$lvts_lv0011->lv008=$_POST['txtlv008'];
$lvts_lv0011->lv009=$_POST['txtlv009'];
$lvts_lv0011->lv010=$_POST['txtlv010'];
$lvts_lv0011->lv011=$_POST['txtlv011'];
$lvts_lv0011->lv012=$_POST['txtlv012'];
$lvts_lv0011->lv013=$_POST['txtlv013'];
$lvts_lv0011->lv014=$_POST['txtlv014'];
$lvts_lv0011->lv015=$_POST['txtlv015'];
$lvts_lv0011->lv016=GetServerDate()." ".GetServerTime();
		
		$vresult=$lvts_lv0011->LV_UpdateEdit($_POST['txtlv004old'],$_POST['txtlv006old']);
		if($vresult==true) {
...
$lvts_lv0011->LV_LoadID($lvts_lv0011->lv001);
					...
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo ($lvts_lv0011->lv001=="")?InsertWithCheckExt('ts_lv0011', 'lv001', '',10):$lvts_lv0011->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[16];?></td>
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvts_lv0011->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[17];?></td>
							  <td  height="20"><table style="width:80%"><tr><td width="50%">
							  <input name="txtlv003" type="text" id="txtlv003"  value="<?php echo $lvts_lv0011->lv003;?>" tabindex="6" maxlength="225" style="width:100%" onKeyPress="return CheckKey(event,7)"/>
							  </td><td>
...
<tr>
				              ...
				              <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvts_lv0011->lv004;?>"/></td>
</tr>							  
							<tr>
							  ...
							  <?php echo $lvts_lv0011->LV_LinkField('lv005',$lvts_lv0011->lv005);?>
							  </select>
							  </td>
							  <td>
							  ...
							  <td  height="20">
							  <input name="txtlv006" type="text" id="txtlv006"  value="<?php echo $lvts_lv0011->FormatView($lvts_lv0011->lv006,2);?>" tabindex="10" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/>
						  <span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1"  tabindex="11"
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
															onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmedit.txtlv006);return false;" /></span></td></tr>
<tr>
							  ...
							  <?php echo $lvts_lv0011->LV_LinkField('lv007',$lvts_lv0011->lv007);?>
							  </select>
							  </td><td>
							...
							<tr>
							  ...
							  <td  height="20">	<input type="text" name="txtlv008" id="txtlv008"  style="width:80%"  tabindex="12"  value="<?php echo (float)$lvts_lv0011->lv008;?>" onKeyPress="return CheckKey(event,7)">					  </td>
						    </tr>
							<tr>
							  ...
							  <?php echo $lvts_lv0011->LV_LinkField('lv009',$lvts_lv0011->lv009);?>
							  </select>
							  </td><td>
							  <ul id="pop-nav4" lang="pop-nav4" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlv009_search" id="txtlv009_search" tabindex="200" style="width:100%"onKeyPress="return CheckKey(event,7)" value="<?php echo $lvts_lv0011->lv009;?>" onKeyUp="LoadSelf(this,'txtlv009','hr_lv0018','lv002')" onFocus="LoadSelf(this,'txtlv009','hr_lv0018','lv002')">
				  ...
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo (float)$lvts_lv0011->lv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>							 			  							 <tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[25];?></td>
							  <td  height="20"><input  name="txtlv011" type="text" id="txtlv011" value="<?php echo (float)$lvts_lv0011->lv011;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td></tr>
						<!--	<tr>
							  ...
							  <?php echo $lvts_lv0011->LV_LinkField('lv012',$lvts_lv0011->lv012);?>
							...
							<tr>
							  ...
							  <?php echo $lvts_lv0011->LV_LinkField('lv013',$lvts_lv0011->lv013);?>
							  </select><br><table style="width:80%"><tr><td width="50%">
				  ...
				  <td  height="20"><input  name="txtlv014" type="text" id="txtlv014" value="<?php echo $lvts_lv0011->lv014;?>" tabindex="18" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>		
						   <tr>
							  <td  height="20"><?php echo $vLangArr[29];?></td>
				  <td  height="20"><input  name="txtlv015" type="text" id="txtlv015" value="<?php echo $lvts_lv0011->lv015;?>" tabindex="19" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>		
						<tr>
