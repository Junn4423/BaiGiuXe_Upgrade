...
$lvjo_lv0010->lv001=$_POST['txtlv001'];
...
$lvjo_lv0010->lv012=getInfor($_SESSION['ERPSOFV2RUserID'],2);
...
if($lvjo_lv0010->lv016=="" || $lvjo_lv0010->lv016==NULL) $lvjo_lv0010->lv016=GetServerDate();
...
$lvjo_lv0010->lv023=GetServerDate().' '.GetServerTime();
if($vFlag==1)
{
		
		$vresult=$lvjo_lv0010->LV_Insert();
		if($vresult==true) {
