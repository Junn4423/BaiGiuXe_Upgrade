...
require_once("../paras.php");
require_once("../../clsall/hr_menusl0001.php");

$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","HR0172.txt",$plang);
//init object
$mohr_menusl0001=new hr_menusl0001();
//Set variant
$mohr_menusl0001->itemlst=$pitemlst;
$mohr_menusl0001->childlst=$pchildlst;
$mohr_menusl0001->level3lst=$plevel3lst;
$mohr_menusl0001->child3lst=$pchild3lst;
...
<div id="content_child">
					...
					<TBODY>
						<TR vAlign="center" align="middle">				
							<TD><a class="toolbar" href="javascript:rundisplayLayer(3);">
								<img src="../images/icon/add_bs.png" title="<?php echo $vLangArr[100];?>" 
              ...
              <tr>
                <td> <form name="frmhr_employee" action="#" method="post">
	 			 	<select name="cbxoption" tabindex="1" onChange="callchange(this)">
						<option value="1" <?php echo ($mohr_menusl0001->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
	...
	<?php
	$mohr_menusl0001->Dir="../";
include($mohr_menusl0001->GetLinkEmp());
?>
	</div></div></td></tr></table>
	</div>
			<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
...
document.frmhr_employee.cbxoption.value="<?php echo $mohr_menusl0001->level3lst;?>";
