...
$lvhr_lv0002=new hr_lv0002($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Hr0046');
$lvhr_lv0038->motc_lv0064=$motc_lv0064;
$lvhr_lv0020->LV_LoadID( $_GET['ID']);
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);

if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","HR0124.txt",$plang);
$lvhr_lv0038->lang= $plang;
$curPage = (int)($_POST['curPg'] ?? 1);	
$vFlag   = (int)($_POST['txtFlag'] ?? 0);
$lvhr_lv0038->lv001=InsertWithCheckExt('hr_lv0038', 'lv001', '',1);
$lvhr_lv0038->lv002= $_GET['ID'];
$lvhr_lv0038->lv003=$_POST['txtlv003'];
$lvhr_lv0038->lv004=$_POST['txtlv004'];
$lvhr_lv0038->lv005=$_POST['txtlv005'];
if($lvhr_lv0038->lv004=="" || $lvhr_lv0038->lv004==NULL) 
{
	$lvhr_lv0038->lv004=$lvhr_lv0020->lv030;
	if(getyear($lvhr_lv0020->lv030)>2000)
	{
		switch(getmonth($lvhr_lv0020->lv030))
		{
			case 11:
				$lvhr_lv0038->lv005=(getyear($lvhr_lv0020->lv030)+1)."-01-".getday($lvhr_lv0020->lv030);
				break;
			case 12:
				$lvhr_lv0038->lv005=(getyear($lvhr_lv0020->lv030)+1)."-02-".getday($lvhr_lv0020->lv030);
				break;
			default:
				$lvhr_lv0038->lv005=getyear($lvhr_lv0020->lv030)."-".Fillnum(getmonth($lvhr_lv0020->lv030)+2,2)."-".getday($lvhr_lv0020->lv030);
		}
	}
	
}	
$lvhr_lv0038->lv006=$_POST['txtlv006'] ?? '';
$lvhr_lv0038->lv007=$_POST['txtlv007'] ?? '';
$lvhr_lv0038->lv008=$_POST['txtlv008'] ?? '';
$lvhr_lv0038->lv009=$_POST['txtlv009'] ?? '';
if(!isset($_POST['txtlv010']))
{
	$lvhr_lv0038->lv010=$lvhr_lv0020->lv029;
}
else
	$lvhr_lv0038->lv010=$_POST['txtlv010'];
$lvhr_lv0038->lv011=$_POST['txtlv011'] ?? '';
$lvhr_lv0038->lv012=$_POST['txtlv012'] ?? '';
$lvhr_lv0038->lv013=$_POST['txtlv013'] ?? '';
$lvhr_lv0038->lv014=$_POST['txtlv014'] ?? '';
$lvhr_lv0038->lv015=$_POST['txtlv015'] ?? '';
$lvhr_lv0038->lv016=$_POST['txtlv016'] ?? '';
$lvhr_lv0038->lv017=$_POST['txtlv017'] ?? '';
$lvhr_lv0038->lv018=$_POST['txtlv018'] ?? '';
$lvhr_lv0038->lv019=$_POST['txtlv019'] ?? '';
$lvhr_lv0038->lv020=$_POST['txtlv020'] ?? '';
$lvhr_lv0038->lv021=$_POST['txtlv021'] ?? '';
$lvhr_lv0038->lv022=$_POST['txtlv022'] ?? '';
$lvhr_lv0038->lv023=$_POST['txtlv023'] ?? '';
$lvhr_lv0038->lv024=$_POST['txtlv024'] ?? '';
$lvhr_lv0038->lv025=$_POST['txtlv025'] ?? '';
$lvhr_lv0038->lv026=$_POST['txtlv026'] ?? '';
$lvhr_lv0038->lv027=$_POST['txtlv027'] ?? '';
$lvhr_lv0038->lv028=$_POST['txtlv028'] ?? '';
$lvhr_lv0038->lv029=$_POST['txtlv029'] ?? '';
$lvhr_lv0038->lv030=$_POST['txtlv030'] ?? '';
$lvhr_lv0038->lv031=$_POST['txtlv031'] ?? '';
$lvhr_lv0038->lv032=$_POST['txtlv032'] ?? '';
$lvhr_lv0038->lv033=$_POST['txtlv033'] ?? '';
$lvhr_lv0038->lv034=$_POST['txtlv034'] ?? '';
$lvhr_lv0038->lv035=$_POST['txtlv035'] ?? '';
$lvhr_lv0038->lv036=$_POST['txtlv036'] ?? '';
$lvhr_lv0038->lv037=$_POST['txtlv037'] ?? '';

$lvhr_lv0038->lv099=$_POST['txtlv099'] ?? '';
$lvhr_lv0038->lv098=$_POST['txtlv098'] ?? '';
$lvhr_lv0038->lv299=$_POST['txtlv299'] ?? '';
if(!isset($_POST['txtlv027']))
{
	$lvhr_lv0038->lv027=$lvhr_lv0020->lv005;
	$lvhr_lv0038->lv028=$lvhr_lv0020->lv060;
	$lvhr_lv0038->lv029=$lvhr_lv0020->lv061;
	$lvhr_lv0038->lv030=$lvhr_lv0020->lv067;

}
if($vFlag==1)
{
		
		$vresult=$lvhr_lv0038->LV_Insert();
		if($vresult==true) {
			$vStrMessage=$vLangArr[9];
			$vFlag = 1;
			if($lvhr_lv0038->lv003!=9)
			{
				...
				$lvtc_lv0008->LV_InsertEmpContract($lvhr_lv0038->lv002,$lvhr_lv0038->lv010,$lvhr_lv0038->lv007,$_POST['txtlv004'],$_POST['txtlv005']);
				...
				$lvhr_lv0002->LV_LoadID($lvhr_lv0038->lv010);
				...
				$lvtc_lv0010->LV_UpdateBalanceCalanda($lvtc_lv0010->lv002,$lvtc_lv0010->lv001,$lvtc_lv0010->lv004,$lvtc_lv0010->lv005,$lvhr_lv0038->lv001,$lvhr_lv0038->lv099);
			}
			$lvhr_lv0038->LV_ShowLichFullStaff($lvhr_lv0038->lv002);
		} else{
  ...
  'lv888' => $lv888
	...
	foreach( $data as $row )
	{
		...
		if(trim($row['lv001'])!="" && $row['lv001']!=NULL)
		{
			...
			{
				$lvhr_lv0038->LV_LoadActiveSpecial($row['lv001']);
				$lvhr_lv0038->lv002=$lvhr_lv0020->lv001;
				$lvhr_lv0038->lv003=$row['lv003'];
				if($lv004=="" && $lv005=="")
				{
					$lvhr_lv0038->lv004=$lvhr_lv0038->FormatView(ADDDATE($lvhr_lv0038->lv004,1),2);
					$lvhr_lv0038->lv005=$lvhr_lv0038->FormatView(ADDDATE($lvhr_lv0038->lv004,365),2);
				}
				elseif($lv004=="")
				{
					$lvhr_lv0038->lv004=$lvhr_lv0038->FormatView(ADDDATE($lvhr_lv0038->lv004,1),2);
					$lvhr_lv0038->lv005=$lv005;
				}
				else
				{
					$lvhr_lv0038->lv004=$lv004;
					$lvhr_lv0038->lv005=$lv005;
				}
				$vStartDate=$lvhr_lv0038->lv004;
				$vEndDate=$lvhr_lv0038->lv005;
				$lvhr_lv0038->lv008=$row['lv008'];
				$lvhr_lv0038->lv009=$row['lv009'];				
				if(trim($row['lv010'])!='') 
				{
					$lvhr_lv0038->lv010=$row['lv010'];
				}
				else
					$lvhr_lv0038->lv010=$lvhr_lv0020->lv029;
				$lvhr_lv0038->lv011=$row['lv011'];
				$lvhr_lv0038->lv012=$row['lv012'];
				$lvhr_lv0038->lv013=$row['lv013'];
				$lvhr_lv0038->lv014=$row['lv014'];
				$lvhr_lv0038->lv015=$row['lv015'];
				$lvhr_lv0038->lv016=$row['lv016'];
				$lvhr_lv0038->lv017=$row['lv017'];
				$lvhr_lv0038->lv018=$row['lv018'];
				$lvhr_lv0038->lv020=$row['lv020'];
				$lvhr_lv0038->lv021=$row['lv021'];
				$lvhr_lv0038->lv022=$row['lv022'];
				$lvhr_lv0038->lv023=$row['lv023'];
				$lvhr_lv0038->lv024=$row['lv024'];
				$lvhr_lv0038->lv025=$row['lv025'];
				$lvhr_lv0038->lv026=$row['lv026'];
				if(trim($row['lv027'])!="" && $row['lv027']!=NULL)
					$lvhr_lv0038->lv027=$row['lv027'];
				else
					$lvhr_lv0038->lv027=$lvhr_lv0020->lv005;
				if(trim($row['lv028'])!="" && $row['lv028']!=NULL)
					$lvhr_lv0038->lv028=$row['lv028'];
				else
					$lvhr_lv0038->lv028=$lvhr_lv0020->lv060;
				if(trim($row['lv029'])!="" && $row['lv029']!=NULL)
					$lvhr_lv0038->lv029=$row['lv029'];
				else
					$lvhr_lv0038->lv029=$lvhr_lv0020->lv061;
				if(trim($row['lv030'])!="" && $row['lv030']!=NULL)
					$lvhr_lv0038->lv030=$row['lv030'];
				else
					$lvhr_lv0038->lv030=$lvhr_lv0020->lv067;
				$lvhr_lv0038->lv031=$row['lv031'];
				$lvhr_lv0038->lv032=$row['lv032'];
				$lvhr_lv0038->lv033=$row['lv033'];
				$lvhr_lv0038->lv034=$row['lv034'];
				$lvhr_lv0038->lv035=$row['lv035'];
				$lvhr_lv0038->lv036=$row['lv036'];
				$lvhr_lv0038->lv037=$row['lv037'];
				$lvhr_lv0038->lv098=$row['lv098'];
				if(trim($lvhr_lv0038->lv098)=='' || $lvhr_lv0038->lv098==NULL) $lvhr_lv0038->lv098=$lvhr_lv0038->lv004;
				if($lvhr_lv0038->lv001!=NULL)
				{
					$vOldContractID=$lvhr_lv0038->lv001;
					if($row['lv009']==1) $lvhr_lv0038->LV_Aproval("'".$lvhr_lv0038->lv001."'");
				}
				...
				if($vresult && $lv888==1)
				{
					...
					$lvtc_lv0010=new tc_lv0010('admin','admin','Hr0046');
					//$lvtc_lv0010->lv001=InsertWithCheckExt('tc_lv0010', 'lv001', '',1);
					...
					if($lvResult)
					{
						...
						if($vDateLimited=="''")
						{
							$psql="insert into tc_lv0011 (lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv015,lv099) select '$vTimesheetID',lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,IF(DayOfWeek(lv004)=1,'','$vShift'),'$lvhr_lv0038->lv001' from tc_lv0011_ where lv004>='$lvtc_lv0010->lv004' and lv004<='$lvtc_lv0010->lv005'";
							db_query($psql);
						}
						else
						{
							$psql="insert into tc_lv0011 (lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv015,lv099) select '$vTimesheetID',lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,IF(DayOfWeek(lv004)=1,'','$vShift'),'$lvhr_lv0038->lv001' from tc_lv0011_ where lv004>='$lvtc_lv0010->lv004' and lv004<='$lvtc_lv0010->lv005' and (lv004 not in ($vDateLimited))";
							db_query($psql);
							$psql="insert into tc_lv0011 (lv002,lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,lv015,lv099) select '$vTimesheetID',lv003,lv004,lv005,lv006,lv007,lv008,lv009,lv010,lv011,IF(DayOfWeek(lv004)=1,'','$vShift'),'$lvhr_lv0038->lv001 from tc_lv0011_ where lv004>='$lvtc_lv0010->lv004' and lv004<='$lvtc_lv0010->lv005' and (A.lv004 in ($vDateLimited))";
							db_query($psql);
						}
					...
					$lvtc_lv0010->LV_UpdateBalanceCalanda($lvtc_lv0010->lv002,$lvtc_lv0010->lv001,$lvtc_lv0010->lv004,$lvtc_lv0010->lv005,$lvhr_lv0038->lv001,$vOldContractID);
				}
...
function isnumber(s){
	...
	function LoadSource(value)
	{
		...
		{
			var o=document.frmadd;
			ajax_do ('../hr_lv0038/hr_lv0038excesource.php?&lang=<?php echo $plang;?>&childfunc=load'+'&HDID='+value+'&Type='+o.txtlv003.value,1);
		}
                      ...
                      <div id="enterline" style="display:block">
						<table width="100%" border="0" align="center" class="table1">
							<tr>
								...
								<?php
									 $vStrMessage = '';echo "<font color='#FF0066' face='Verdana, Arial, Helvetica, sans-serif'>".$vStrMessage."</font>";
								?>			</td>	
							</tr>
							...
							<tr>
								...
								<td width="*%"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvhr_lv0038->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvhr_lv0038->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
							  </tr>
							  <tr>
							  <td  height="20px"><?php echo $vLangArr[17];?></td>
				  				<td  height="20px"><select  name="txtlv003"  id="txtlv003"  tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"/><?php echo $lvhr_lv0038->LV_LinkField('lv003',$lvhr_lv0038->lv003);?>
				 									</select>							 
				 				</td>
							  </tr>	
							  ...
							  <td  height="20px"><?php echo 'Chọn hợp đồng trước lấy dữ liệu';?></td>
				  				<td  height="20px">
									<select  name="txtlv099"  id="txtlv099"  tabindex="7" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" onblur="LoadSource(this.value)"/>
										<option value=""></option><?php echo $lvhr_lv0038->LV_LinkField('lv099',$lvhr_lv0038->lv099);?>
				  					</select>							 
				  				</td>
							  ...
							  <td  height="20px"><input onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmadd.txtlv004);return false;" name="txtlv004" type="text" id="txtlv004" value="<?php echo $lvhr_lv0038->FormatView($lvhr_lv0038->lv004,2);?>" tabindex="9" style="width:80%" onKeyPress="return CheckKey(event,7)">
							  ...
							  <td  height="20px"><input  onfocus="if(this.value==''){this.value=document.frmadd.txtlv004.value;}" onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmadd.txtlv098);return false;" name="txtlv098" type="text" id="txtlv098" value="<?php echo $lvhr_lv0038->FormatView($lvhr_lv0038->lv098,2);?>" tabindex="9" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
						      <span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
							  ...
							  <td  height="20px"><input onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmadd.txtlv005);return false;" name="txtlv005" type="text" id="txtlv005" value="<?php echo $lvhr_lv0038->FormatView($lvhr_lv0038->lv005,2);?>" tabindex="10" style="width:80%" onKeyPress="return CheckKey(event,7)">
						      <span class="td"><img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
							  ...
							  <td  height="20px"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo $lvhr_lv0038->lv006;?>" tabindex="11" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>																			
							<tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[21];?></td>
							  <td  height="20px"><input name="txtlv007" type="text" id="txtlv007" value="<?php echo $lvhr_lv0038->lv007;?>" tabindex="12" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
							  <tr>
							 	 <td  height="20px"><?php echo $vLangArr[27];?></td>
				  				 <td  height="20px"><table style="width:80%"><tr><td style="width:50%"><select  name="txtlv010"  id="txtlv010"  tabindex="12" maxlength="255" style="width:100%" onKeyPress="return CheckKey(event,7)" <option value=""></option><?php echo $lvhr_lv0038->LV_LinkField('lv010',$lvhr_lv0038->lv010);?>
				  									</select>	
													</td>
							  <td>
							  ...
							  <td  height="20px"><?php echo $vLangArr[22];?></td>
				  				<td  height="20px"><select  name="txtlv009"  id="txtlv009"  tabindex="12" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" onChange="LoadHD(this)"/><option value=""></option><?php echo $lvhr_lv0038->LV_LinkField('lv020',$lvhr_lv0038->lv009);?>
				  									</select>							 
				  				</td>
							  </tr>	
							  	<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[22];?></td>
							  <td  height="20"><textarea name="txtlv008" rows="20" id="txtlv008" style="width:80%" tabindex="13"><?php echo $lvhr_lv0038->lv008;?></textarea></td>
							</tr>						
							   <tr>
							  <td  height="20px"><?php echo $vLangArr[32];?></td>
				  				<td  height="20px"><select  name="txtlv015"  id="txtlv015"  tabindex="12" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" />
													<option value="0" <?php echo ($lvhr_lv0038->lv015=="0")?'selected="selected"':''?>>No</option>
													<option value="1" <?php echo ($lvhr_lv0038->lv015=="1")?'selected="selected"':''?>>Yes</option>
				  									</select>							 
				  				</td>
							  </tr>	
							  ...
							  <td  height="20px"><select  name="txtlv019"  id="txtlv019"  tabindex="12" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" />
													<option value="0" <?php echo ($lvhr_lv0038->lv019=="0")?'selected="selected"':''?>>Gross Salary</option>
													<option value="1" <?php echo ($lvhr_lv0038->lv019=="1")?'selected="selected"':''?>>Net Salary</option>
				  									</select>	</td>
							  </tr>	
							 ...
							 <tr>
							  <td  height="20px"><?php echo $vLangArr[28];?></td>
				  				<td  height="20px"><select  name="txtlv011"  id="txtlv011"  tabindex="13" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /><option value=""></option><?php echo $lvhr_lv0038->LV_LinkField('lv011',$lvhr_lv0038->lv011);?>
				  									</select>							 
				  				</td>
							  </tr>	
							  <tr>
							  <td  height="20px"><?php echo $vLangArr[29];?></td>
				  				<td  height="20px"><select  name="txtlv012"  id="txtlv012"  tabindex="13" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /><option value=""></option><?php echo $lvhr_lv0038->LV_LinkField('lv012',$lvhr_lv0038->lv012);?>
				  									</select>							 
				  				</td>
							  </tr>	
							   <tr>							  						    
							  ...
							  <td  height="20px"><?php echo $vLangArr[38];?></td>
				  				<td  height="20px"><input name="txtlv021" type="text" id="txtlv021" value="<?php echo $lvhr_lv0038->lv021;?>" tabindex="20" style="width:80%" onKeyPress="return CheckKey(event,7)">							 
				  				</td>
							  </tr>	
							  <tr>
							  <td  height="20px"><?php echo $vLangArr[39];?></td>
				  				<td  height="20px"><input name="txtlv022" type="text" id="txtlv022" value="<?php echo $lvhr_lv0038->lv022;?>" tabindex="20" style="width:80%" onKeyPress="return CheckKey(event,7)">							 
				  				</td>
							  </tr>	
							<tr>
							  <td  height="20px"><?php echo $vLangArr[43];?></td>
							  <td  height="20px"><input name="txtlv026" type="text" id="txtlv026" value="<?php echo $lvhr_lv0038->lv026;?>" tabindex="20" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
							  <tr>
							  <td  height="20px"><?php echo $vLangArr[30];?></td>
				  				<td  height="20px"><input name="txtlv013" type="text" id="txtlv013" value="<?php echo $lvhr_lv0038->lv013;?>" tabindex="20" style="width:80%" onKeyPress="return CheckKey(event,7)">						 
				  				</td>
							  </tr>	
							  <tr>
							  <td  height="20px"><?php echo $vLangArr[31];?></td>
				  				<td  height="20px"><input name="txtlv014" type="text" id="txtlv014" value="<?php echo $lvhr_lv0038->lv014;?>" tabindex="20" style="width:80%" onKeyPress="return CheckKey(event,7)">						 
				  				</td>
							  </tr>	
							  <tr>
							  <td  height="20px"><?php echo $vLangArr[41];?></td>
				  				<td  height="20px"><select  name="txtlv024"  id="txtlv024"  tabindex="13" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /><option value=""></option><?php echo $lvhr_lv0038->LV_LinkField('lv024',$lvhr_lv0038->lv024);?>
				  									</select>							 
				  				</td>
							  </tr>	
							  <tr>
							   <td  height="20px"><?php echo $vLangArr[44];?></td>
				  				<td  height="20px"><input name="txtlv027" type="text" id="txtlv027" value="<?php echo $lvhr_lv0038->lv027;?>" tabindex="21" style="width:80%" onKeyPress="return CheckKey(event,7)">							 
				  				</td>
							  </tr>
							  <tr>
							   <td  height="20px"><?php echo $vLangArr[45];?></td>
				  				<td  height="20px"><input name="txtlv028" type="text" id="txtlv028" value="<?php echo $lvhr_lv0038->lv028;?>" tabindex="21" style="width:80%" onKeyPress="return CheckKey(event,7)">							 
				  				</td>
							  </tr>
							  <tr>
							   <td  height="20px"><?php echo $vLangArr[46];?></td>
				  				<td  height="20px"><input name="txtlv029" type="text" id="txtlv029" value="<?php echo $lvhr_lv0038->lv029;?>" tabindex="21" style="width:80%" onKeyPress="return CheckKey(event,7)">							 
				  				</td>
							  </tr>
							  <tr>
							   <td  height="20px"><?php echo $vLangArr[47];?></td>
				  				<td  height="20px"><input name="txtlv030" type="text" id="txtlv030" value="<?php echo $lvhr_lv0038->lv030;?>" tabindex="21" style="width:80%" onKeyPress="return CheckKey(event,7)">							 
				  				</td>
							  </tr>
							  <tr>
							    ...
							    <td  height="20">
									<table style="width:80%"><tr><td style="width:50%">
										<select name="txtlv299"  id="txtlv299" value="<?php echo $lvhr_lv0020->lv299;?>" tabindex="11"  style="width:100%" onKeyPress="return CheckKey(event,7)">
									 	<?php echo $lvhr_lv0038->LV_LinkField('lv299',$lvhr_lv0038->lv299);?>
									 	</select>
								 	</td>
								  <td>
