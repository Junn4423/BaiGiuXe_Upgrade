...
foreach( $data as $row )
{
	...
	{
	$lvts_lv0030->lv001=InsertWithCheckExt('ts_lv0030', 'lv001', '',1);
	$lvts_lv0030->lv002=getInfor($_SESSION['ERPSOFV2RUserID'],2);
	$lvts_lv0030->lv003=$lvsl_lv0007->lv001;
	$lvts_lv0030->lv004=$row['lv004'];
	$lvts_lv0030->lv005=$row['lv005'];
	$lvts_lv0030->lv006=$row['lv006'];
	$lvts_lv0030->lv007=$row['lv007'];
	$lvts_lv0030->lv008=$row['lv008'];
	$lvts_lv0030->lv009=$row['lv009'];
	$lvts_lv0030->lv011=$row['lv011'];
	$lvts_lv0030->lv014=$row['lv014'];
	$lvts_lv0030->lv015=$row['lv015'];
	$lvts_lv0030->lv016=$lvNow;
	
	$vresult=$lvts_lv0030->LV_Insert();
	}
}
		if($vresult==true) {
