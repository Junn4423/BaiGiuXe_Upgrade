...
$moki_lv0005->ArrFunc[5]=GetLangExcept('Rpt',$plang);
$moki_lv0005->ArrFunc[6]=GetLangExcept('Apr',$plang);
$moki_lv0005->ArrFunc[7]=GetLangExcept('UnApr',$plang);
...
//	$tsql="select count(*) from department where CompanyID ";
	...
	$strar="'".$strar."'";
	$vresult=$moki_lv0005->LV_Delete($strar);
	$vStrMessage=GetNoDelete($strar,"ki_lv0005",$lvMessage);
}
elseif($flagID==2)
{
$moki_lv0005->lv001=$_POST['txtlv001'];
$moki_lv0005->lv002=$_POST['txtlv002'];
$moki_lv0005->lv003=$_POST['txtlv003'];
$moki_lv0005->lv004=$_POST['txtlv004'];
$moki_lv0005->lv005=$_POST['txtlv005'];
$moki_lv0005->lv006=$_POST['txtlv006'];
$moki_lv0005->lv007=$_POST['txtlv007'];
$moki_lv0005->lv008=$_POST['txtlv008'];
$moki_lv0005->lv009=$_POST['txtlv009'];
$moki_lv0005->lv010=$_POST['txtlv010'];
$moki_lv0005->lv011=$_POST['txtlv011'];
$moki_lv0005->lv012=$_POST['txtlv012'];
$moki_lv0005->lv013=$_POST['txtlv013'];
$moki_lv0005->lv014=$_POST['txtlv014'];
$moki_lv0005->lv015=$_POST['txtlv015'];
$moki_lv0005->lv016=$_POST['txtlv016'];
$moki_lv0005->lv017=$_POST['txtlv017'];
$moki_lv0005->lv018=$_POST['txtlv018'];
$moki_lv0005->lv019=$_POST['txtlv019'];
$moki_lv0005->lv020=$_POST['txtlv020'];
$moki_lv0005->lv021=$_POST['txtlv021'];
$moki_lv0005->lv022=$_POST['txtlv022'];
$moki_lv0005->lv023=$_POST['txtlv023'];
$moki_lv0005->lv024=$_POST['txtlv024'];
$moki_lv0005->lv025=$_POST['txtlv025'];
$moki_lv0005->lv026=$_POST['txtlv026'];
$moki_lv0005->lv027=$_POST['txtlv027'];
$moki_lv0005->lv028=$_POST['txtlv028'];
$moki_lv0005->lv029=$_POST['txtlv029'];
$moki_lv0005->lv030=$_POST['txtlv030'];
$moki_lv0005->lv031=$_POST['txtlv031'];
$moki_lv0005->lv032=$_POST['txtlv032'];
$moki_lv0005->lv033=$_POST['txtlv033'];
$moki_lv0005->lv034=$_POST['txtlv034'];
$moki_lv0005->lv035=$_POST['txtlv035'];
$moki_lv0005->lv036=$_POST['txtlv036'];
$moki_lv0005->lv037=$_POST['txtlv037'];
$moki_lv0005->lv038=$_POST['txtlv038'];
$moki_lv0005->lv039=$_POST['txtlv039'];
$moki_lv0005->lv040=$_POST['txtlv040'];
$moki_lv0005->lv041=$_POST['txtlv041'];
$moki_lv0005->lv042=$_POST['txtlv042'];
$moki_lv0005->lv043=$_POST['txtlv043'];
$moki_lv0005->FullName=$_POST['txtFullName'];
}
elseif($flagID==3)
{
	$strar=substr($strchk,0,strlen($strchk)-1);
	$strar=str_replace("@","','",$strar);
	$strar="'".$strar."'";
	$vresult=$moki_lv0005->LV_Aproval($strar);
}
elseif($flagID==4)
{
	$strar=substr($strchk,0,strlen($strchk)-1);
	$strar=str_replace("@","','",$strar);
	$strar="'".$strar."'";
	$vresult=$moki_lv0005->LV_UnAproval($strar);
}
elseif($flagID==5)
{
	$strar=substr($strchk,0,strlen($strchk)-1);
	$strar=explode("@",$strar);
	//Tinh
	if(trim($motc_lv0013->lv001)!='' && $motc_lv0013->lv001!=NULL) $moki_lv0005->LV_CalculateAuto($motc_lv0013);
}
//first is load
if(($_POST['txtFlag']) != 2)
{
...
$moki_lv0005->SaveOperation($_SESSION['ERPSOFV2RUserID'],'ki_lv0005',$vFieldList,(int)$_POST['lvmaxrow'],(int)$_POST['curPg'],$vOrderList,(int)$_POST['lvsort']);

}
$moki_lv0005->lv003=$motc_lv0013->lv001;
if(trim($moki_lv0005->lv003.'')=='') $moki_lv0005->lv003='NOCAL';
$moki_lv0005->lv029_=$moki_lv0005->Get_User($_SESSION['ERPSOFV2RUserID'],'lv002');
$moki_lv0005->lsempid=$_POST['LSEMPID'];
...
function Fil()
{
	RunFunction('&lv001=<?php echo $_POST['txtlv001'];?>&lv002=<?php echo $moki_lv0005->lv002;?>&lv003=<?php echo $_POST['txtlv003'];?>&lv004=<?php echo $_POST['txtlv004'];?>&lv005=<?php echo $_POST['txtlv005'];?>&lv006=<?php echo $_POST['txtlv006'];?>&lv007=<?php echo $_POST['txtlv007'];?>&lv010=<?php echo $_POST['txtlv010'];?>&lv029=<?php echo $_POST['txtlv029'];?>','filter');
}
function Del()
{
...
function RunFunction(vID,func)
{
	...
	{
		case 'child':
			var str="<br><iframe id='lvframefrm' height=1400 marginheight=0 marginwidth=0 frameborder=0 src=<?php echo $vDir;?>ki_lv0005?func=<?php echo $_GET['func'];?>&ID=<?php echo  $_GET['ID'] ?? '';?>&childfunc="+func+"&ChildID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?> class=lvframe></iframe>";
			break;
		default:
			var str="<iframe id='lvframefrm' height='"+oheight+"' marginheight=0 marginwidth=0 frameborder=0 src=<?php echo $vDir;?>ki_lv0005?func=<?php echo $_GET['func'];?>&ID=<?php echo  $_GET['ID'] ?? '';?>&childfunc="+func+"&ChildID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?> class=lvframe></iframe>";
			break;
	}
...
var o=document.frmprocess;
	o.target="_blank";
	o.action="<?php echo $vDir;?>ki_lv0005?func=<?php echo $_GET['func'];?>&ID=<?php echo  $_GET['ID'] ?? '';?>&childfunc=rpt&ChildID="+vValue+"&lang=<?php echo $plang;?>";
...
var o=document.frmprocess1;
	o.target="_blank";
	o.action="<?php echo $vDir;?>ki_lv0005?func=<?php echo $_GET['func'];?>&ID=<?php echo  $_GET['ID'] ?? '';?>&childfunc=rpt1&ChildID="+vValue+"&lang=<?php echo $plang;?>";
	o.submit();
}
function Apr()
{
					  ...
					  <input type="hidden" name="curPg" value="<?php echo  $curPage;?>"/>
						...
						<tr>
							   ...
							   <td>
								...
								<td>
								<input type="text"  tabindex="1" name="txtlv010" id="txtlv010" value="<?php echo $moki_lv0005->lv010;?>" onChange="ChangeInfor()"/></td>
								<td>
								Phòng ban
								</td>
								<td>
									<select name="txtlv029" id="txtlv029" tabindex="1" style="width:80%" onKeyPress="return CheckKey(event,7)" onChange="ChangeInfor()">
								  		<option value=""></option>
								  		<?php echo $moki_lv0005->LV_LinkField('lv029',$moki_lv0005->lv029);?>
								    </select>
								</td>
							  </tr>	
							 </table>
						<?php echo $moki_lv0005->LV_BuilList($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
						<input name="txtStringID" type="hidden" id="txtStringID" />
						<input name="txtFieldList" type="hidden" id="txtFieldList"  value="<?php echo $vFieldList;?>"/>
						<input name="txtOrderList" type="hidden" id="txtOrderList"  value="<?php echo $vOrderList;?>"/>
						
						<input name="txtFlag" type="hidden" id="txtFlag" value="2"/>
						<input type="hidden" name="txtlv001" id="txtlv001"  value="<?php echo $moki_lv0005->lv001;?>"/>
						<input type="hidden" name="txtlv003" id="txtlv003" value="<?php echo $moki_lv0005->lv003;?>"/>
						<input type="hidden" name="txtlv004" id="txtlv004" value="<?php echo $moki_lv0005->lv004;?>"/>
						<input type="hidden" name="txtlv005" id="txtlv005" value="<?php echo $moki_lv0005->lv005;?>"/>
						<input type="hidden" name="txtlv006" id="txtlv006" value="<?php echo $moki_lv0005->lv006;?>"/>
						<input type="hidden" name="txtlv007" id="txtlv007" value="<?php echo $moki_lv0005->lv007;?>"/>
...
div.innerHTML='<?php echo $moki_lv0005->ArrPush[0];?>';	
