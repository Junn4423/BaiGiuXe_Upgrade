...
$lvhr_lv0078->lv001=$_GET['ChildID'];
if($plang=="") $plang="VN";
...
$lvhr_lv0078->lv355=$_POST['txtlv355'];		
		$vresult=$lvhr_lv0078->LV_Update();
		if($vresult==true) {
			if($_FILES['userfile']['name']!="")
			UploadImg($vDefaultPath,$lvhr_lv0078->lv001, $lvhr_lv0078->lv038);///Call function Upload file
...
{
	if(trim($lvhr_lv0078->lv001)!="" || $lvhr_lv0078->lv001!=NULL) 
	{
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
							 ...
							 <?php echo $lvhr_lv0078->LV_LinkField('lv002',$lvhr_lv0078->lv089);?>
									...
									Ngày sinh : <input class="required" onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmedit.txtlv010);return false;" name="txtlv010" type="text" id="txtlv010" value="<?php echo $lvhr_lv0078->lv010;?>" tabindex="2" maxlength="50" style="width:140px" />
									...
									Ngày cấp : <input class="required" onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmedit.txtlv008);return false;" name="txtlv008" type="text" id="txtlv008" value="<?php echo $lvhr_lv0078->lv008;?>" tabindex="3" maxlength="50" style="width:140px;" >
						      <span class="td"> <img src="../../images/calendar/calendar.gif" name="imgDate1" id="imgDate1" 
															border="0" style="cursor:pointer" width="16" height="16" align="top" 
