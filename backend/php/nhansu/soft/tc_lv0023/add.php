...
$vNow=GetServerDate();	
$lvtc_lv0023->lang= strtolower($plang);
$curPage = (int)($_POST['curPg'] ?? 1);	
$vFlag   = (int)($_POST['txtFlag'] ?? 0);
$lvtc_lv0023->lv001=InsertWithCheckExt('tc_lv0023', 'lv001', '',1);
$lvtc_lv0023->lv002=$_POST['txtlv002'];
$lvtc_lv0023->lv003=$_POST['txtlv003'];
$lvtc_lv0023->lv004=$_POST['txtlv004'];
$lvtc_lv0023->lv005=$_POST['txtlv005'];
$lvtc_lv0023->lv006=$_POST['txtlv006'];
$lvtc_lv0023->lv007=$_POST['txtlv007'];
$lvtc_lv0023->lv008=0;
$lvtc_lv0023->lv009=getInfor($_SESSION['ERPSOFV2RUserID'],2);
$lvtc_lv0023->lv012=$_POST['txtlv012'];
$lvtc_lv0023->lv013=$_POST['txtlv013'];
if($lvtc_lv0023->lv013=="" || $lvtc_lv0023->lv013==NULL) $lvtc_lv0023->lv013=getyear($vNow)."/".getmonth($vNow)."/".GetDayInMonth(getyear($vNow),(int)getmonth($vNow));
if($vFlag==1)
{
		
		$vresult=$lvtc_lv0023->LV_Insert();
		if($vresult==true) {
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
								...
								<td width="*%"  height="20px">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvtc_lv0023->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>			</td>
							</tr>
							<tr>
							  <td  height="20px"><?php echo $vLangArr[16];?></td>
							  <td  height="20px"> <table width="80%"><tr><td width="50%"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvtc_lv0023->lv002;?>" tabindex="6" maxlength="225" style="width:100%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td><td>
							  <ul id="pop-nav4" lang="pop-nav4" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
							    <input type="text" autocomplete="off" class="search_img_btn" name="txtlv002_search" id="txtlv002_search" style="width:100%" onKeyUp="LoadPopup(this,'txtlv002','hr_lv0020','concat(lv004,@! @!,lv003,@! @!,lv002,@!-@!,lv001)')" onFocus="LoadPopup(this,'txtlv002','hr_lv0020','concat(lv004,@! @!,lv003,@! @!,lv002,@!-@!,lv001)')" tabindex="200" >
				  ...
				  <td  height="20px">
							   ...
							   <table width="80%"><tr><td width="50%">
							   	<select name="txtlv003" id="txtlv003"  tabindex="7" maxlength="50" style="width:100%" onKeyPress="return CheckKey(event,7)">
							   <?php echo $lvtc_lv0023->LV_LinkField('lv003',$lvtc_lv0023->lv003);?>
                              </select>
							   </td><td>
							  ...
							  <td  height="20px">
							  <table width="80%"><tr><td width="50%"><select name="txtlv004" id="txtlv004"  tabindex="8" maxlength="50" style="width:100%" onKeyPress="return CheckKeys(event,7,this)">
							  ...
							  <td  height="20px">
							   <table width="80%"><tr><td width="50%">
							   	<input name="txtlv005" type="text" id="txtlv005" value="<?php echo (int)$lvtc_lv0023->lv005;?>" tabindex="10" maxlength="50" style="width:69%" onKeyPress="return CheckKey(event,7)"><select name="txtlv006" id="txtlv006"  tabindex="11" maxlength="50" style="width:30%" onKeyPress="return CheckKeys(event,7,this)">
							  ...
							  <tr>
								...
								<td  height="20"><input name="txtlv013" type="text" id="txtlv013" value="<?php echo $lvtc_lv0023->FormatView($lvtc_lv0023->lv013,2);?>" tabindex="11" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
							 ...
							 <tr>
							  ...
							  <td  height="20px"><input name="txtlv007" type="text" id="txtlv007" value="<?php echo $lvtc_lv0023->lv007;?>" tabindex="12" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>		
							  <tr>
							  <td  height="20px"><?php echo $vLangArr[28];?></td>
							  <td  height="20px"><input name="txtlv012" type="text" id="txtlv012" value="<?php echo $lvtc_lv0023->lv012;?>" tabindex="12" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>																																
							<tr>
