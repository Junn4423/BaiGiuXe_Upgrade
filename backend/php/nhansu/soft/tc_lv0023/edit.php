...
/////////Get ID///////////////
$lvtc_lv0023->lv001=$_GET['ChildID'];
...
$lvtc_lv0023->LV_LoadID($lvtc_lv0023->lv001);
...
function isnumber(s){
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvtc_lv0023->lv002;?>";
		o.txtlv003.value="<?php echo $lvtc_lv0023->lv003;?>";
		o.txtlv004.value="<?php echo $lvtc_lv0023->lv004;?>";
		o.txtlv005.value="<?php echo $lvtc_lv0023->lv005;?>";
		o.txtlv006.value="<?php echo $lvtc_lv0023->lv006;?>";	
		o.txtlv007.value="<?php echo $lvtc_lv0023->lv007;?>";				
		o.txtlv002.focus();
	}
	function Cancel()
	{
					...
					<?php		
						...
						?>
							...
							<tr>
							  ...
							  <td  height="20px"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvtc_lv0023->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
