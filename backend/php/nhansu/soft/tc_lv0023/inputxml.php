...
foreach( $data as $row )
{
	...
	$lvtc_lv0023->lv003=$motc_lv0013->lv001;
	$lvtc_lv0023->lv002=$row['lv002'];
	$lvtc_lv0023->lv004=$row['lv004'];
	$lvtc_lv0023->lv005=$row['lv005'];
	$lvtc_lv0023->lv006=$row['lv006'];
	$lvtc_lv0023->lv007=$row['lv007'];
	$lvtc_lv0023->lv008='0';
...
<div id="content_child">
  <div class="story">
    <h2 id="pageName"><?php echo $vLangArr[0];?> XML</h2>
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<form action="#" name="frmadd" method="post" enctype="multipart/form-data" >
						...
						<table width="100%" border="0" align="center" class="table1">
							...
							<tr>
							  <td  height="20px" colspan="2"><input name="txtFlag" type="hidden" id="txtFlag"  /><a href="MAU_CHI_PHI_TAM_UNG.zip" title="<?php echo 'Tải mẫu';?>"><?php echo 'Tải mẫu';?></a></td>
							</tr>
							<tr>
