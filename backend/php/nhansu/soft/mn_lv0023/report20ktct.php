...
if($mowh_lv0021->GetView()==1)
{
    ...
    $mocr_lv0343->DefaultFieldList="lv299,lv011,lv914,lv012,lv152,lv061,lv008,lv009,lv139,lv049,lv154,lv155,lv004,lv204,lv005,lv158,lv170,lv171,lv172,lv173,lv174,lv175,lv195,lv196,lv190,lv197,lv194";//
    //////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $mocr_lv0343->ArrPush[9]='Model';
    $mocr_lv0343->ArrPush[10]=$vLangArr[27];
    $mocr_lv0343->ArrPush[11]=$vLangArr[28];
    $mocr_lv0343->ArrPush[12]='Mô tả sản phẩm';
    $mocr_lv0343->ArrPush[13]='Our ref.';
    ...
    $mocr_lv0343->ArrPush[62]='Hình ảnh';
    ...
    $mocr_lv0343->ArrPush[141]='Hạn bảo hành';
    $mocr_lv0343->ArrPush[142]='Loại lỗi s\'p';
    $mocr_lv0343->ArrPush[143]='S\'lượng s\'p lỗi';
    $mocr_lv0343->ArrPush[144]='Thời gian trả s\'p lỗi';
    ...
    $mocr_lv0343->ArrPush[146]='Phí vận chuyển s\'p lỗi';
    $mocr_lv0343->ArrPush[147]='Đơn vị vận chuyển s\'p lỗi';
    $mocr_lv0343->ArrPush[148]='Số Bill Booking Vận chuyển';
    $mocr_lv0343->ArrPush[149]='SHIPPER';
    $mocr_lv0343->ArrPush[150]='Hạn giao hàng';
    $mocr_lv0343->ArrPush[151]='Ngày giao hàng dự kiến';
    $mocr_lv0343->ArrPush[152]='Phí vận chuyển';
    $mocr_lv0343->ArrPush[153]='Type (Our ref.)';
    $mocr_lv0343->ArrPush[154]='S\'lượng<br/>Sample';
    $mocr_lv0343->ArrPush[155]='Model Sup';
    $mocr_lv0343->ArrPush[156]='Thương hiệu<br/>NCC';
    $mocr_lv0343->ArrPush[157]='S\'lượng<br/> Extra';
    $mocr_lv0343->ArrPush[158]='Ngày phát hành';
    $mocr_lv0343->ArrPush[159]='Catalogue';
    $mocr_lv0343->ArrPush[171]='Bản vẽ';
    $mocr_lv0343->ArrPush[172]='TEST IP (54/65/67/68)';
    $mocr_lv0343->ArrPush[173]='IES File & Test Integrating Sphere';
    $mocr_lv0343->ArrPush[174]='HDLĐ & Bảo trì bảo dưỡng';
    $mocr_lv0343->ArrPush[175]='CER. LM80 Chip';
    $mocr_lv0343->ArrPush[176]='Giấy HCHQ';
    $mocr_lv0343->ArrPush[177]='Hình ảnh hàng hóa/ Đóng gói';
    $mocr_lv0343->ArrPush[178]='Hình ảnh<br/>chip/driver/Phị kiện';
    $mocr_lv0343->ArrPush[179]='Ngày giao mẫu';
    $mocr_lv0343->ArrPush[180]='Đơn vị vận chuyển mẫu';
    $mocr_lv0343->ArrPush[181]='Ngày giao hàng';
    $mocr_lv0343->ArrPush[182]='Ngày giao hàng Đợt 2';
    $mocr_lv0343->ArrPush[183]='Sample Loading By';
    $mocr_lv0343->ArrPush[184]='Địa điểm lấy hàng';
    ...
    $mocr_lv0343->ArrPush[191]='Giấy chứng nhận chất lượng (CQ)';
    $mocr_lv0343->ArrPush[192]='BL No.';
    $mocr_lv0343->ArrPush[193]='PL No.';
    $mocr_lv0343->ArrPush[194]='SUR/Orgin B/L No.';
    $mocr_lv0343->ArrPush[195]='Phiếu bảo hành';

    $mocr_lv0343->ArrPush[196]='Phiếu giao hàng';
    $mocr_lv0343->ArrPush[197]='Phiếu xuất kho';
    $mocr_lv0343->ArrPush[198]='Phiếu xuất xưởng';
    ...
    {
        //////////////////////////////////////////////////////////////////////////////////////////////////////
        $mocr_lv0343->LoadSaveOperationLocal($_SESSION['ERPSOFV2RUserID'],'cr_lv0343_2',$strCode);
        //////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    elseif($_POST["txtFlag"]==2)
    {
        ...
        $mocr_lv0343->SaveOperation($_SESSION['ERPSOFV2RUserID'],'cr_lv0343_2',$vFieldList,(int)$_POST['lvmaxrow'],(int)$_POST['curPg'],$vOrderList,(int)$_POST['lvsort']);
    }
?>
<html>
<head>
...
//////// Chi tiền đợt 3
    ...
    <tr><td colspan="20">
        <?php 
        $mocr_lv0343->LoadSaveOperation($_SESSION['ERPSOFV2RUserID'],'cr_lv0343_2');
        //////////////////////////////////////////////////////////////////////////////////////////////////////
