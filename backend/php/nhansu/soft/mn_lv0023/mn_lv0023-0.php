...
$momn_lv0023->ArrPush[16]='Tỷ giá tiền tệ thứ 2';
$momn_lv0023->ArrPush[28]='Trạng thái duyệt';
$momn_lv0023->ArrPush[13]='Tiền tệ thứ 2';
$momn_lv0023->ArrPush[14]='Tỷ giá VNĐ';
$momn_lv0023->ArrPush[15]='';
$momn_lv0023->ArrPush[16]='Tỷ giá tiền tệ thứ 2';
$momn_lv0023->ArrPush[17]='Tiền tệ chính';
$momn_lv0023->ArrPush[88]='Mã nhóm đơn hàng';
$momn_lv0023->ArrPush[89]='Phiếu ĐNVT';
$momn_lv0023->ArrPush[90]='PBH Số';
$momn_lv0023->ArrPush[190]='Tên dự án';
$momn_lv0023->ArrPush[91]='Phiếu đầu ra';
$momn_lv0023->ArrPush[213]='Tổng tiền';
$momn_lv0023->ArrPush[214]='Thanh toán';
$momn_lv0023->ArrPush[99]='Tiền nợ treo';
$momn_lv0023->ArrPush[100]='Tiền nợ còn lại';
$momn_lv0023->ArrPush[115]='Mã công việc';
$momn_lv0023->ArrPush[212]='Tổng tiền mua VNĐ';
$momn_lv0023->ArrPush[213]='Tổng tiền mua chính';
$momn_lv0023->ArrPush[214]='Thanh toán chính';
$momn_lv0023->ArrPush[215]='Tổng tiền mua thứ 2';
$momn_lv0023->ArrPush[216]='Thanh toán thứ 2';
$momn_lv0023->ArrPush[217]='Qui đổi thanh toán thứ 2 → chính';
$momn_lv0023->ArrPush[218]='Qui đổi thanh toán';
$momn_lv0023->ArrPush[219]='Tổng tiền nợ còn lại';
$momn_lv0023->ArrPush[221]='Thanh toán VND';
$momn_lv0023->ArrPush[222]='Qui đổi thanh toán VND → chính';
...
$momn_lv0023->ArrPush[200]='Chức năng';
...
$momn_lv0023->ArrFunc[5]=GetLangExcept('Rpt',$plang);
$momn_lv0023->ArrFunc[6]=GetLangExcept('dexuatduyet',$plang);
$momn_lv0023->ArrFunc[7]=GetLangExcept('huy',$plang);
$momn_lv0023->ArrFunc[8]=$vLangArr[10];
$momn_lv0023->ArrFunc[9]=$vLangArr[12];
$momn_lv0023->ArrFunc[10]=$vLangArr[0];
$momn_lv0023->ArrFunc[11]=$vLangArr[35];
$momn_lv0023->ArrFunc[12]=$vLangArr[36];
$momn_lv0023->ArrFunc[13]=$vLangArr[37];
$momn_lv0023->ArrFunc[14]=$vLangArr[38];
$momn_lv0023->ArrFunc[15]=$vLangArr[39];

////Other
$momn_lv0023->ArrOther[1]=$vLangArr[33];
$momn_lv0023->ArrOther[2]=$vLangArr[34];
//////Delete message///
$lvMessage=array();
...
if($flagID==1)
{
	...
	$strar="'".$strar."'";
	$vresult=$momn_lv0023->LV_Delete($strar);
	$vStrMessage=GetNoDelete($strar,"mn_lv0023",$lvMessage);
}
elseif($flagID==2)
{
$momn_lv0023->lv001=$_POST['txtlv001'];
if( $_GET['ID']=="")
$lvmn_lv0023->lv002=$_POST['txtlv002'];
else
$lvmn_lv0023->lv002= $_GET['ID'] ?? '';
$momn_lv0023->lv003=$_POST['txtlv003'];
$momn_lv0023->lv004=$_POST['txtlv004'];
$momn_lv0023->lv005=$_POST['txtlv005'];
$momn_lv0023->lv006=$_POST['txtlv006'];
$momn_lv0023->lv007=$_POST['txtlv007'];
$momn_lv0023->lv008=$_POST['txtlv008'];
$momn_lv0023->lv009=$_POST['txtlv009'];
$momn_lv0023->lv010=$_POST['txtlv010'];
$momn_lv0023->lv011=$_POST['txtlv011'];
$momn_lv0023->lv012=$_POST['txtlv012'];
$momn_lv0023->lv013=$_POST['txtlv013'];
$momn_lv0023->lv014=$_POST['txtlv014'];
}
elseif($flagID==3)
{
	$strar=substr($strchk,0,strlen($strchk)-1);
	$strar=str_replace("@","','",$strar);
	$strar="'".$strar."'";
	$vresult=$momn_lv0023->LV_Aproval($strar);
}
elseif($flagID==4)
{
	$strar=substr($strchk,0,strlen($strchk)-1);
	$strar=str_replace("@","','",$strar);
	$strar="'".$strar."'";
	$vresult=$momn_lv0023->LV_UnAproval($strar);
}
//first is load
if(($_POST['txtFlag']) != 2)
{
...
$momn_lv0023->SaveOperation($_SESSION['ERPSOFV2RUserID'],'mn_lv0023',$vFieldList,(int)$_POST['lvmaxrow'],(int)$_POST['curPg'],$vOrderList,(int)$_POST['lvsort']);

}
if( $_GET['ID']=="")
$momn_lv0023->lv002=$_POST['txtlv002'];
else
$momn_lv0023->lv002= $_GET['ID'] ?? '';
if($maxRows ==0) $maxRows = 10;
$momn_lv0023->trangthai=$_GET['trangthai'];
...
{
	var str="<br><iframe id='lvframefrm' height=1200 marginheight=0 marginwidth=0 frameborder=0 src=<?php echo $vDir;?>mn_lv0023?func=<?php echo $_GET['func'];?>&childfunc="+func+"&ID=<?php echo  $_GET['ID'] ?? '';?>&ChildID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?> class=lvframe></iframe>";
...
var o=document.frmprocess;
	o.target="_blank";
	o.action="<?php echo $vDir;?>mn_lv0023?func=<?php echo $_GET['func'];?>&childfunc=rpt&ID="+vValue+"&lang=<?php echo $plang;?>";
	o.submit();
}
function ReportPMH(vValue)
{
	...
	o.action="<?php echo $vDir;?>mn_lv0023?func=<?php echo $_GET['func'];?>&childfunc=rpt&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function ReportDNTU(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0023?func=<?php echo $_GET['func'];?>&childfunc=rpt5&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;	
	o.submit();
}
function Save()
{
					...
					<table style="background:#f2f2f2;font:10px arial" >	
								...
								<tr>
									<td><select class="norequired" name="LANGIAOHANG"  id="LANGIAOHANG"  style="min-width:90px;width:100%;">
											...
											<?php echo $momn_lv0023->LV_LinkField('lv000',$mosl_lv0013->LANGIAOHANG);?>
										</select>
									</td>
								<td  height="20px"><input  autocomplete="off" style="width:120px;text-align:center;" name="txtlv001" type="text" id="txtlv001" value="<?php echo $momn_lv0023->lv001;?>" tabindex="9" maxlength="50" style="width:100%" onKeyPress="return CheckKey(event,7)"></td>
								<td>
									<table width="95%">
											<tr>
											<td>
								...
								<td  height="20px"><input  autocomplete="off" style="width:120px;text-align:center;" name="txtTenDuAn" type="text" id="txtTenDuAn" value="<?php echo $momn_lv0023->TenDuAn;?>" tabindex="9" maxlength="50" style="width:100%" onKeyPress="return CheckKey(event,7)"></td> 
								<td>
									<table width="95%">
											<tr>
											<td>
								...
								<td  height="20px"><input  autocomplete="off" style="width:120px;text-align:center;" name="txtlv004" type="text" id="txtlv004" value="<?php echo $momn_lv0023->lv004;?>" tabindex="9" maxlength="50" style="width:100%" onKeyPress="return CheckKey(event,7)" onClick="if(self.gfPop)gfPop.fPopCalendar(this);return false;" autocomplete="off" ></td> 
								<td><table width="100%"><tr><td>
									<select name="txtlv010" id="txtlv010"   tabindex="14"  style="width:100px" onKeyPress="return CheckKeys(event,7,this)">
										<option value=''>...</option>
										<?php echo $momn_lv0023->LV_LinkField('lv010',$momn_lv0023->lv010);?>
									</select>
								</td>
								<td>
					  ...
					  <input type="hidden" name="curPg" value="<?php echo  $curPage;?>"/>
						...
						<input type="hidden" name="txtlv002" id="txtlv002" value="<?php echo $momn_lv0023->lv002;?>"/>
						<input type="hidden" name="txtlv003" id="txtlv003" value="<?php echo $momn_lv0023->lv003;?>"/>
						<input type="hidden" name="txtlv004" id="txtlv004" value="<?php echo $momn_lv0023->lv004;?>"/>
						<input type="hidden" name="txtlv005" id="txtlv005" value="<?php echo $momn_lv0023->lv005;?>"/>
						<input type="hidden" name="txtlv006" id="txtlv006" value="<?php echo $momn_lv0023->lv006;?>"/>
						<input type="hidden" name="txtlv007" id="txtlv007" value="<?php echo $momn_lv0023->lv007;?>"/>
						<input type="hidden" name="txtlv008" id="txtlv008" value="<?php echo $momn_lv0023->lv008;?>"/>
						<input type="hidden" name="txtlv009" id="txtlv009" value="<?php echo $momn_lv0023->lv009;?>"/>
						<input type="hidden" name="txtlv010" id="txtlv010" value="<?php echo $momn_lv0023->lv010;?>"/>
						<input type="hidden" name="txtlv011" id="txtlv011" value="<?php echo $momn_lv0023->lv011;?>"/>
						<?php echo $momn_lv0023->LV_BuilList($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
					</form>
...
div.innerHTML='<?php echo $momn_lv0023->ArrPush[0];?>';	
</script>
</html>