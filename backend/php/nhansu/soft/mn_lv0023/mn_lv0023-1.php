...
require_once("$vDir../clsall/mn_lv0023-1.php");

/////////////init object//////////////
$momn_lv0023=new mn_lv0023($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Mn0023');
$momn_lv0023->TypePO=$_GET['TypePO'];
$momn_lv0023->LV_OptionType();
...
$momn_lv0023->ArrFunc[6]=GetLangExcept('duyet',$plang);
$momn_lv0023->ArrFunc[7]=GetLangExcept('tralai',$plang);
...
function Report(vValue)
{
	...
	o.action="<?php echo $vDir;?>mn_lv0023?func=<?php echo $_GET['func'];?>&childfunc=rpt1&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
...
function Report2(vValue)
{
	var o=document.frmprocess;
	o.target="_blank";
	o.action="<?php echo $vDir;?>mn_lv0023?func=<?php echo $_GET['func'];?>&childfunc=rpt1&ID="+vValue+"&lang=<?php echo $plang;?>";
	o.submit();
}
...
function Report3(vValue)
{
	var o=document.frmprocess;
	o.target="_blank";
	o.action="<?php echo $vDir;?>mn_lv0023?func=<?php echo $_GET['func'];?>&childfunc=rpt3&ID="+vValue+"&lang=<?php echo $plang;?>";
	o.submit();
...
function Report9(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0023?func=<?php echo $_GET['func'];?>&childfunc=rpt9&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
...
function Report19(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0023?func=<?php echo $_GET['func'];?>&childfunc=rpt19&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report19KTT(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0023?func=<?php echo $_GET['func'];?>&childfunc=rpt19ktt&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report19KTVT(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0023?func=<?php echo $_GET['func'];?>&childfunc=rpt19ktvt&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report19KTCT(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0023?func=<?php echo $_GET['func'];?>&childfunc=rpt19ktct&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report69(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0023?func=<?php echo $_GET['func'];?>&childfunc=rpt69&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report10(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0023?func=<?php echo $_GET['func'];?>&childfunc=rpt10&TypeID=4&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
...
function Report20(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0023?func=<?php echo $_GET['func'];?>&childfunc=rpt20&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report20KTT(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0023?func=<?php echo $_GET['func'];?>&childfunc=rpt20ktt&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report20KTVT(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0023?func=<?php echo $_GET['func'];?>&childfunc=rpt20ktvt&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
function Report20KTCT(vValue)
{
	...
	o.target="_blank";
	var LANGIAOHANG=document.getElementById('LANGIAOHANG').value;
	o.action="<?php echo $vDir;?>mn_lv0023?func=<?php echo $_GET['func'];?>&childfunc=rpt20ktct&ID="+vValue+"&lang=<?php echo $plang;?>&LANGIAOHANG="+LANGIAOHANG;
	o.submit();
}
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<div><div id="lvleft"><form onSubmit="return false;" action="?func=<?php echo $_GET['func'];?>&ID=<?php echo  $_GET['ID']?>&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,1,0);?>" method="post" name="frmchoose" id="frmchoose">
					  <input type="hidden" name="curPg" value="<?php echo  $curPage;?>"/>
						...
						<input type="hidden" name="txtlv001" id="txtlv001"  value="<?php echo $momn_lv0023->lv001;?>"/>
