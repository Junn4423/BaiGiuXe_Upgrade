...
$lvts_lv0022->lv001=$_GET['ChildDetailID'];
if($plang=="") $plang="VN";
...
if($vFlag==1)
{
$lvts_lv0022->lv002=$_POST['txtlv002'];
...
$lvts_lv0022->LV_LoadID($lvts_lv0022->lv001);
					...
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvts_lv0022->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>		</td>
						    </tr>
							<tr>
