...
$lvts_lv0048->LV_LoadID($lvts_lv0048->lv001);
...
<script language="javascript">
	...
	function Refresh()
	{
		...
		o.txtlv002.value="<?php echo $lvts_lv0048->lv002;?>";
		o.txtlv002.focus();
	}
	function Cancel()
	{
					...
					<?php		
						...
						?>
							...
							<tr>
							  ...
							  <td width="335"  height="20px"><input  name="txtlv001" type="text" id="txtlv001" readonly="true" value="<?php echo $lvts_lv0048->lv001;?>" /></td>
							</tr>
						<tr>
