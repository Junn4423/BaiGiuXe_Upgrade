...
include("../paras.php");
include("../../clsall/ki_menu0009.php");
...
//init object
$moki_menu0009=new ki_menu0009();
//Set variant
$moki_menu0009->itemlst=$pitemlst;
$moki_menu0009->childlst=$pchildlst;
$moki_menu0009->level3lst=$plevel3lst;
$moki_menu0009->child3lst=$pchild3lst;
$vEmpName = "";
...
<div id="content_child">
						...
						<TR vAlign="center" align="middle">				
							<td><form name="frmhr_employee" action="#" method="post">
								<select name="cbxoption" tabindex="1" onChange="callchange(this)" style="width:100px">
									<option value="1" <?php echo ($moki_menu0009->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
								</select><br/>
									Chọn thao tác
	...
	<?php
	$moki_menu0009->Dir="../";
include($moki_menu0009->GetLinkEmp());
?>
	</div></div></td></tr></table>
			<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
...
document.frmhr_employee.cbxoption.value="<?php echo $moki_menu0009->level3lst;?>";
