...
$lvhr_lv0098->lv001=InsertWithCheckExt('hr_lv0098', 'lv001', '',1);
$lvhr_lv0098->lv002= $_GET['ID'] ?? '';
$lvhr_lv0098->lv003=$_POST['txtlv003'];
$lvhr_lv0098->lv004=$_POST['txtlv004'];
if($lvhr_lv0098->lv004=="" || $lvhr_lv0098->lv004==NULL) $lvhr_lv0098->lv004=GetServerDate();
...
function isnumber(s){
	...
	function LoadSource(value)
	{
		...
		{
			var o=document.frmadd;
			ajax_do ('../hr_lv0098/hr_lv0098excesource.php?&lang=<?php echo $plang;?>&childfunc=load'+'&HDID='+value,1);
		}
    ...
    <h2 id="pageName"><?php echo $vLangArr[0];?></h2>
			  ...
			  <td  height="20px"><select  name="txtlv003"  id="txtlv003"  tabindex="6" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /><option value=""></option><?php echo $lvhr_lv0098->LV_LinkField('lv003',$lvhr_lv0098->lv003);?>
							...
							<tr>
							  ...
							  <td  height="20px"><input onClick="if(self.gfPop)gfPop.fPopCalendar(document.frmadd.txtlv004);return false;" name="txtlv004" type="text" id="txtlv004" value="<?php echo $lvhr_lv0098->FormatView($lvhr_lv0098->lv004,2);?>" tabindex="7" maxlength="50" style="width:80%" onKeyPress="return CheckKey(event,7)">
				  ...
				  <td  height="20px"><select  name="txtlvtype"  id="txtlvtype"  tabindex="13" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" onChange="LoadText(this,'txtlv008','hr_lv0043','lv003',document.frmadd.txtlv002.value,2,'<?php echo $plang;?>'+'&StartDate='+document.frmadd.txtlv004.value+'&EndDate='+document.frmadd.txtlv005.value+'&TimeWork='+document.frmadd.txtlv007.value)"/><option value=""></option><?php echo $lvhr_lv0098->LV_LinkField('lv100',$lvhr_lv0098->lv100);?>
				  </select>							 </td>
							  </tr>	
							  	<tr>
