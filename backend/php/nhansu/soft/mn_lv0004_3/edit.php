...
$lvmn_lv0004_3->lv001=$_GET['ChildID'];
if($plang=="") $plang="VN";
...
if($vFlag==1)
{
$lvmn_lv0004_3->lv002=$_POST['txtlv002'];
...
$lvmn_lv0004_3->lv012=$_POST['txtlv012'];
$lvmn_lv0004_3->lv099=$_POST['txtlv099'];		
		$vresult=$lvmn_lv0004_3->LV_Update();
		if($vresult==true) {
...
$lvmn_lv0004_3->LV_LoadID($lvmn_lv0004_3->lv001);
					...
					<form action="#" name="frmedit" id="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="760" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvmn_lv0004_3->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>		</td>
						    </tr>
							<tr>
