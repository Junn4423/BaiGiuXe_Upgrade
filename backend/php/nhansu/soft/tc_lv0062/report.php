...
if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","TC0102.txt",$plang);
...
////Other
$motc_lv0062->ArrOther[1]=$vLangArr[28];
$motc_lv0062->ArrOther[2]=$vLangArr[29];
//////Delete message///
$lvMessage=array();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$motc_lv0062->lv002=base64_decode( $_GET['ID']);
...
?>
						...
						<?php echo $motc_lv0062->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
