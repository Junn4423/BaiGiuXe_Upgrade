...
$momn_lv0220->ArrPush[13]=$vLangArr[30];
$momn_lv0220->ArrPush[14]='Đã hoàn thành';
$momn_lv0220->ArrPush[15]=$vLangArr[32];
$momn_lv0220->ArrPush[16]=$vLangArr[33];
$momn_lv0220->ArrPush[17]=$vLangArr[34];
$momn_lv0220->ArrPush[910]='Tên dự án';
...
$momn_lv0220->ArrFunc[6]=GetLangExcept('Apr',$plang);
$momn_lv0220->ArrFunc[7]=GetLangExcept('UnApr',$plang);
$momn_lv0220->ArrFunc[8]=$vLangArr[10];
$momn_lv0220->ArrFunc[9]=$vLangArr[12];
$momn_lv0220->ArrFunc[10]=$vLangArr[0];
$momn_lv0220->ArrFunc[11]=$vLangArr[44];
$momn_lv0220->ArrFunc[12]=$vLangArr[45];
$momn_lv0220->ArrFunc[13]=$vLangArr[46];
$momn_lv0220->ArrFunc[14]=$vLangArr[47];
$momn_lv0220->ArrFunc[15]=$vLangArr[48];

////Other
$momn_lv0220->ArrOther[1]=$vLangArr[42];
$momn_lv0220->ArrOther[2]=$vLangArr[43];
//////Delete message///
$lvMessage=array();
...
if($flagID>0)
{
	...
	$momn_lv0220->lv015=$_POST['txtlv015'];
	$momn_lv0220->lv016=$_POST['txtlv016'];
	$momn_lv0220->lv017=$_POST['txtlv017'];
	$momn_lv0220->lv018=$_POST['txtlv018'];
	$momn_lv0220->lv019=$_POST['txtlv019'];
	$momn_lv0220->lv020=$_POST['txtlv020'];
	$momn_lv0220->lv021=$_POST['txtlv021'];
	$momn_lv0220->lv022=$_POST['txtlv022'];
	$momn_lv0220->lv023=$_POST['txtlv023'];
	$momn_lv0220->lv024=$_POST['txtlv024'];
	$momn_lv0220->lv025=$_POST['txtlv025'];
...
if($vkeep==1)
{
	$momn_lv0220->tv001=$vkeep;
	$momn_lv0220->tv002=$_POST['qxtlv002'];
	$momn_lv0220->tv003=$_POST['qxtlv003'];
	$momn_lv0220->tv008=$_POST['qxtlv008'];
	$momn_lv0220->tv015=$_POST['qxtlv015'];
	$momn_lv0220->tv022=$_POST['qxtlv022'];
	$momn_lv0220->tv016=$_POST['qxtlv016_1']." ".$_POST['qxtlv016_2'];
	$momn_lv0220->tv017=$_POST['qxtlv017_1']." ".$_POST['qxtlv017_2'];
	$momn_lv0220->tv018=$_POST['qxtlv018_1']." ".$_POST['qxtlv018_2'];
	$momn_lv0220->tv019=$_POST['qxtlv019_1']." ".$_POST['qxtlv019_2'];
}
else
{
	$momn_lv0220->tv008=getInfor($_SESSION['ERPSOFV2RUserID'],2);
}
if(!isset($_POST['txtDateFrom']))
{
	$vYear=getyear($momn_lv0220->DateCurrent);
	$vMonth=getmonth($momn_lv0220->DateCurrent);
	$vDay=getday($momn_lv0220->DateCurrent);
	if($vDay==1)
	{
		if($vMonth==1)
...
/*
if($momn_lv0220->GetApr()<>1 || $momn_lv0220->GetUnApr()<>1)
{
	$momn_lv0220->lv008=$momn_lv0220->LV_UserID;
	if($momn_lv0220->GetApr()==1)
	{
		
		$momn_lv0220->ListStaff=$momn_lv0220->Get_User($_SESSION['ERPSOFV2RUserID'],'lv002');

		$momn_lv0220->lv029ex=$momn_lv0220->ListStaff;
	}
}
*/

$momn_lv0220->trangthai='0';
$totalRowsC=$momn_lv0220->GetCount();
$momn_lv0220->ListPBH='';
$momn_lv0220->trangthai='1';
$totalRowsC1=$momn_lv0220->GetCount();
$momn_lv0220->ListPBH='';
$momn_lv0220->trangthai='';
...
function RunFunction(vID,func)
{
	...
	{
		case 'child':
			var str="<br><iframe height=1900 marginheight=0 marginwidth=0 frameborder=0 src=mn_lv0220?func="+func+"&ID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?>\" class=lvframe></iframe>";
			break;
		default:
			var str="<br><iframe height=1900 marginheight=0 marginwidth=0 frameborder=0 src=mn_lv0220?func="+func+"&ID="+vID+"&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?>\" class=lvframe></iframe>";
			break;
...
function Report(vValue)
{
	...
	o.target="_blank";
	o.action="<?php echo $vDir;?>mn_lv0220?func=rpt&ID="+vValue+"&lang=<?php echo $plang;?>";
	o.submit();
}
