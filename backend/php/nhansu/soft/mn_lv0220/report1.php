...
require_once("../../clsall/hr_lv0220.php");
...
$mohr_lv0220=new hr_lv0220($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Hr0220');
...
$mohr_lv0220->LV_LoadID($mowh_lv0021->lv010);
...
<body  onkeyup="KeyPublicRun(event)" style="background-color:#fff!important">
	...
	$vFieldList="lv003,lv011,lv004,lv005,lv006,lv015";
	else
	$vFieldList="lv003,lv011,lv004,lv005,lv006,lv015";
	$mowh_lv0022->DefaultFieldList="lv003,lv011,lv004,lv005,lv006,lv015";
...
<tr>
<td style="font-size:14px;font-family:arial, times new roman;" colspan="7" height="22" align="left" valign="bottom"><span style="color: #000000;">T&ecirc;n người li&ecirc;n hệ: <?php echo $mohr_lv0220->lv004;?> <?php echo (trim($mohr_lv0220->lv037)!='')?'SĐT: '.$mohr_lv0220->lv037:'';?> <?php echo (trim($mohr_lv0220->lv040)!='')?'Email: '.$mohr_lv0220->lv040:'';?></span><span style="color: #000000;"></span></td>
</tr>
<tr>
