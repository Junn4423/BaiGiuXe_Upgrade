...
?>
    ...
    <td nowrap style="font-family: Arial; font-size: 12px; border-top: 2px solid #000000; border-bottom: 2px solid #000000; border-right: 2px solid #000000;" align="center" valign="middle" bgcolor="#F4B183"><strong><span style="color: #000000; font-size: 14px;">Vendor<br/>/Third Party</span></strong></td>
...
-->
    <td nowrap style="font-family: Arial; font-size: 12px; border-top: 2px solid #000000; border-bottom: 2px solid #000000; border-right: 2px solid #000000;" align="center" valign="middle" bgcolor="#F4B183"><strong><span style="color: #000000; font-size: 14px;">Order Q'ty</span></strong></td>
    <!--
...
<!--<td nowrap style="font-family: Arial; font-size: 12px; border-top: 2px solid #000000; border-bottom: 2px solid #000000; border-right: 2px solid #000000;" align="center" valign="middle" bgcolor="#F4B183"><strong><span style="color: #000000; font-size: 14px;">Qty</span></strong></td>
    ...
    ?>
    <td nowrap style="font-family: Arial; font-size: 12px; border-top: 2px solid #000000; border-bottom: 2px solid #000000; border-right: 2px solid #000000;" align="center" valign="middle" bgcolor="#F4B183"><strong><span style="color: #000000; font-size: 14px;">Unit<br/>(Pcs /Sets)</span></strong></td>
    <?php
    $vCot13=false;
    $vCot14=false;
    $vCot15=false;
...
//////// Chi tiền đợt 3
	...
	?>
    <tr>
        <td colspan="4" style="font-family: Arial; font-size: 12px;" height="33" align="left" valign="center"><strong><span style="color: #000000; font-size: 14px;">TT Advance Payment</span></strong>:<span style="color: #000000; font-size: 14px;"> <?php echo $mowh_lv0021->getvaluelink('lv007',$mowh_lv0021->lv007);?></span></td>
        <td colspan="6" style="font-family: Arial; font-size: 12px;" align="left" valign="center"><span style="color: #000000;"><span style="color: #000000;"><strong>Detail Company Loading</strong></span></td></span></td>
        <td colspan="<?php echo (5-$vTruCot);?>" style="font-family: Arial; font-size: 12px;" align="left" valign="center"><strong><span style="color: #000000; font-size: 14px;">TOTAL</span></strong></td>
    ...
    <tr>
        ...
        <td colspan="4" style="font-family: Arial; font-size: 12px;" height="33" align="left" valign="center"><strong><span style="text-decoration: underline;"><span style="color: #000000; font-size: 14px;">Bank Name:</span></span><span style="color: #000000; font-size: 14px;"> <?php echo $lvcr_lv0292->lv003;?></span></strong></td>
        <td colspan="6" style="font-family: Arial; font-size: 12px;" align="left" valign="center"><span style="color: #000000;"><span style="color: #000000;"><strong>Name company: <?php echo $mowh_lv0003->lv002;?></strong></span></td></span></td>
        <td colspan="<?php echo (5-$vTruCot);?>" style="font-family: Arial; font-size: 12px;" align="left" valign="center"><strong><span style="text-decoration: underline;"><span style="color: #000000; font-size: 12px;">Extra Discount.:</span></span></strong></td>
    ...
    <tr>
        <td colspan="4" style="font-family: Arial; font-size: 12px;" height="33" align="left" valign="center"><span style="color: #000000; font-size: 14px;">Bank Address:</span><span> <?php echo $lvcr_lv0292->lv004;?></span></strong></td>
        <td colspan="6" style="font-family: Arial; font-size: 12px;" align="left" valign="center"><span style="color: #000000;"><span style="color: #000000;">Address: <?php echo $mowh_lv0003->lv006;?></span></td></span></td>
        <td colspan="<?php echo (5-$vTruCot);?>" style="font-family: Arial; font-size: 12px;" align="left" valign="center"><strong><span style="text-decoration: underline;"><span style="color: #000000; font-size: 12px;">VAT.:</span></span></strong></td>
    ...
    <tr>
        <td colspan="4" style="font-family: Arial; font-size: 12px;" height="33" align="left" valign="center"><strong><span style="text-decoration: underline;"><span style="color: #000000; font-size: 14px;">Account No.:</span></span><span style="color: #000000; font-size: 14px;"> <?php echo $lvcr_lv0292->lv005;?></span></td>
        <td colspan="6" style="font-family: Arial; font-size: 12px;" align="left" valign="center"><span style="color: #000000;"><span style="color: #000000;">Contact: <?php echo $lvwh_lv0003->lv003;?></span></td></span></td>
        <td colspan="<?php echo (5-$vTruCot);?>" style="font-family: Arial; font-size: 12px;" align="left" valign="center"><strong><span style="color: #000000; font-size: 14px;">Net Amount:</span></strong></td>
    ...
    <tr>
        <td colspan="4" style="font-family: Arial; font-size: 12px;" height="33" align="left" valign="center"><strong><span style="text-decoration: underline;"><span style="color: #000000; font-size: 14px;">Beneficiary:</span></span><span style="color: #000000; font-size: 14px;"> <?php echo $lvcr_lv0292->lv006;?></span></td>
        ...
        <td colspan="<?php echo (5-$vTruCot);?>" style="font-family: Arial; font-size: 12px;" align="left" valign="center"><strong><span style="text-decoration: underline;"><span style="color: #000000; font-size: 12px;">First Deposit:</span></span></strong></td>
    ...
    <tr>
        <td colspan="6" style="font-family: Arial; font-size: 12px;" height="33" align="left" valign="center"><strong><span style="color: #000000; font-size: 14px;">Swift Code: <?php echo $lvcr_lv0292->lv007;?></span></td>
        <td colspan="4" style="font-family: Arial; font-size: 12px;" align="left" valign="center"><span style="color: #000000;"><br /></span></td>
        <td colspan="<?php echo (5-$vTruCot);?>" style="font-family: Arial; font-size: 12px;" align="left" valign="center"><strong><span style="text-decoration: underline;"><span style="color: #000000; font-size: 12px;">Second Deposit:</span></span></strong></td>
    ...
    <tr>
        <td colspan="6" style="font-family: Arial; font-size: 12px;" height="33" align="left" valign="center"><span style="color: #000000; font-size: 14px;">IBAN: <?php echo $lvcr_lv0292->lv008;?></span></td>
        <td colspan="4" style="font-family: Arial; font-size: 12px;" align="left" valign="center"><span style="color: #000000;"><br /></span></td>
        <td colspan="<?php echo (5-$vTruCot);?>" style="font-family: Arial; font-size: 12px;" align="left" valign="center"><strong><span style="text-decoration: underline;"><span style="color: #000000; font-size: 12px;">Third Deposit:</span></span></strong></td>
    ...
    <tr>
        <td colspan="6" style="font-family: Arial; font-size: 12px;" height="33" align="left" valign="center"><span style="color: #000000; font-size: 14px;"></span></td>
        <td colspan="4" style="font-family: Arial; font-size: 12px;" align="left" valign="center"><span style="color: #000000;"><br /></span></td>
        <td colspan="<?php echo (5-$vTruCot);?>" style="font-family: Arial; font-size: 12px;" align="left" valign="center"><strong><span style="color: #000000; font-size: 14px;">Total Net Amount:</span></strong></td>
    ...
    <tr>
        <td colspan="6" style="font-family: Arial; font-size: 12px;" height="33" align="left" valign="center"><span style="color: #000000; font-size: 14px;"></span></td>
        <td colspan="4" style="font-family: Arial; font-size: 12px;" align="left" valign="center"><span style="color: #000000;"><br /></span></td>
        <td colspan="<?php echo (5-$vTruCot);?>" style="font-family: Arial; font-size: 12px;" align="left" valign="center"><strong><span style="color: #000000; font-size: 14px;">Payment Percent(%): <span style="color:red"><?php echo $mocr_lv0176->FormatView($vTongPercent,20).(($vTongPercent>0)?'%':'');?></span></span></strong></td>
    ...
    <tr>
        ...
        <td style="font-family: Arial; font-size: 12px;border-top: 2px solid #000000;" align="left" valign="middle"><strong><span style="color: #000000; font-size: 14px;"><br /></span></strong></td>
        <td style="font-family: Arial; font-size: 12px;border-top: 2px solid #000000;" align="left" valign="middle"><strong><span style="color: #000000; font-size: 14px;"><br /></span></strong></td>
        <td colspan="10" style=" border-left: 1px solid #000000;font-family: Arial; font-size: 12px;font-family: Arial; font-size: 12px; border-top: 2px solid #000000;" height="33" align="left" valign="middle">
            <table width="100%">
