...
$mohr_lv0220=new hr_lv0220($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0015');
...
if($_GET['txtEdit']==0)
{
    ...
    else
    {
         ...
         // Mã PMH
          ...
          //Ngày mua hàng
          $strReturn=str_replace("@!004",$mohr_lv0220->FormatView($mowh_lv0021->lv004,2),$strReturn);
          //Ngày hết hạn
          $strReturn=str_replace("@!005",$mohr_lv0220->FormatView($mowh_lv0021->lv005,2),$strReturn);
          //Tỷ lệ thuế(%)
