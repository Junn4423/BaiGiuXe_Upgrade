...
if(isset($_GET['ajaxlot']))
{
	...
	echo '[CHECKLOT]';
	echo '<select name="txtlv914" id="txtlv914"   tabindex="22"  style="width:100%" onkeypress="return CheckKey(event,1)" ><option value="">...Chọn lô...</option>'.$mots_lv0011->LV_LinkField('lv014',$_GET['itemid']).'</select>	';
	echo '[ENDCHECKLOT]';
	exit;
}		
if($plang=="") $plang="VN";
...
$mots_lv0010->lv002=($mots_lv0008->lv002=="")?"PRODUC":$mots_lv0008->lv002;
$mots_lv0010->lv009=$_POST['txtlv809'];
$mots_lv0010->lv009=($mots_lv0010->lv009=="")?GetServerDate():$mots_lv0010->lv009;
if($flagCtrl == 1){
$mots_lv0010->lv002=$_POST['txtlv802'];
...
<script language="javascript" src="<?php echo $vDir;?>../javascripts/engines.js"></script>
	...
	{
	var str="<br><iframe id='lvframefrm' height=900 marginheight=0 marginwidth=0 frameborder=0 src=<?php echo $vDir;?>ts_lv0039/ts_lv0039.php?&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?> class=lvframe></iframe>";
	...
	var str="<br><iframe id='lvframefrm' height=900 marginheight=0 marginwidth=0 frameborder=0 src='<?php echo $vDir;?>ts_lv0039/ts_lv0039.php?&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0)?>"+strvalue+"' class=lvframe></iframe>";
	div = document.getElementById('lvloaddata');
	div.innerHTML=str;
	o.txtlv903.focus();
	}
	function LoadType(to)
	{
		...
		switch(vo)
		{
			...
			case 'TRAHANG':
				...
				break;
			case 'MUAHANG':
				LoadPopupParent(to,'txtlv806','ts_lv0021','concat(lv003,@! @!,lv002,@! @!,lv001)');
				break;
		}
	}
	function LoadSource()
	...
	var vo=o.txtlv805.value;
		...
		{
			case 'BANHANG':
				ajax_do ('ts_lv0038/ts_lv0038excesource.php?&lang=<?php echo $plang;?>&Type=BANHANG&childfunc=load'+'&lv002='+o.txtlv802.value	+'&lv005='+o.txtlv805.value+'&lv006='+o.txtlv806.value,1);
				window.setTimeout('RunFunction()',500);
				break;
			case 'TRAHANG':
				ajax_do ('ts_lv0038/ts_lv0038excesource.php?&lang=<?php echo $plang;?>&Type=TRAHANG&childfunc=load'+'&lv002='+o.txtlv802.value	+'&lv005='+o.txtlv805.value+'&lv006='+o.txtlv806.value,1);
				window.setTimeout('RunFunction()',500);
				break;
			case 'MUAHANG':
				ajax_do ('ts_lv0038/ts_lv0038excesource.php?&lang=<?php echo $plang;?>&Type=MUAHANG&childfunc=load'+'&lv002='+o.txtlv802.value	+'&lv005='+o.txtlv805.value+'&lv006='+o.txtlv806.value,1);
				window.setTimeout('RunFunction()',500);
				break;
		}
	...
	{
		var o=document.frmadd;
		ajax_do ('ts_lv0038/ts_lv0038exce.php?&lang=<?php echo $plang;?>&childfunc=load'+'&lv002='+o.txtlv903.value+'&lv003='+o.txtlv802.value,1);
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
										...
										<form   name="frmadd" id="frmadd"  id="frmadd" method="POST" action="?func=<?php echo $_GET['func'];?>&ID=<?php echo  $_GET['ID']?>&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,0,0);?>" autocomplete="off">
											...
											<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
												...
												<tr>
												  ...
												  <td class="td" width="32%"><input name="txtlv801" type="text" id="txtlv801"  value="<?php echo InsertWithCheck('ts_lv0010', 'lv001', 'PX-'.getmonth($vNow)."/".getyear($vNow)."-",4);?>" tabindex="3" maxlength="32" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
												...
												<tr>
												  ...
												  <td height="20px" class="td"><input name="txtlv804" type="text" id="txtlv804"  value="<?php echo $mots_lv0010->lv004;?>" tabindex="4" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)"/></td>		<td><?php echo $vLangArr[27];?></td>
												  <td><input name="txtlv809" type="text" id="txtlv809" value="<?php echo $mots_lv0010->FormatView($mots_lv0010->lv009,2);?>" tabindex="111" maxlength="100" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true" />
                                                    </td>
												</tr>
												<tr>
												    ...
												    <td height="20px" class="td">
                                                      <table style="width:80%"><tr>
                                                      	  <td><input name="txtlv806" type="text" id="txtlv806"  value="<?php echo $mots_lv0010->lv006;?>" tabindex="6" maxlength="225" style="width:100%" onKeyPress="return CheckKey(event,7)"/></td>                                                          
												...
												<tr height="1">
												    ...
												    <td colspan="3" class="td"><textarea name="txtlv808" rows="3" id="txtlv808" style="width:80%" tabindex="13" ><?php echo $mots_lv0010->lv007;?></textarea></td>
											    </tr>												
												<tr height="1">
		...
		<tr>
			...
			<td><table width="100%" border="0">
                                                    ...
                                                    <tr>
                                                      <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td><input name="txtlv904" id="txtlv904"   tabindex="21"  style="width:80%" onKeyPress="return CheckKey(event,1)" value="<?php echo (float)$mots_lv0011->lv004;?>"/></td>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td><input name="txtlv906" type="text" id="txtlv906" value="<?php echo (float)$mots_lv0011->lv006;?>" tabindex="22" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,1)" /></td>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td>
															  <table style="width:80%"><tr>
															  <td><div id="txtlotid"><input  name="txtlv914" type="text" id="txtlv914" value="<?php echo $mots_lv0011->lv014;?>" tabindex="23" maxlength="255" style="width:100%" onKeyPress="return CheckKey(event,1)" /></div></td>
															  <td>
															    <ul id="pop-nav7" lang="pop-nav7" onMouseOver="ChangeName(this,7)" onkeyup="ChangeName(this,7)"> <li class="menupopT">
															      <input type="text" autocomplete="off" class="search_img_btn" name="txtlvsearch7" id="txtlvsearch7" style="width:100%" onKeyUp="LoadPopupParentWHCondi(this,'txtlv914','ts_lv0020','concat(lv001,@! @!,lv002,@! @!,lv003,@! @!,lv004,@! @!,lv005,@! @!,lv006,@! @!,lv007,@! @!,lv008)',document.frmadd.txtlv802.value)" onFocus="LoadPopupParentWHCondi(this,'txtlv914','ts_lv0020','concat(lv001,@! @!,lv002,@! @!,lv003,@! @!,lv004,@! @!,lv005,@! @!,lv006,@! @!,lv007,@! @!,lv008)',document.frmadd.txtlv802.value)"  tabindex="200" >
															      <div id="lv_popup7" lang="lv_popup7"> </div>						  
														  		</li>
													  			</ul></td></tr></table>
													  		</td>
                                                          <td><?php echo $vLangArr[43];?></td>
                                                          <td><input  name="txtlv915" type="text" id="txtlv915" value="<?php echo $mots_lv0011->lv015;?>" tabindex="24" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,1)" /></td>
                                                        </tr>
                                                         <tr>
							  ...
							  <?php echo $mots_lv0011->LV_LinkField('lv017',$mots_lv0011->lv017);?>
							  </select></td>
                                                          <td><?php echo $vLangArr[57];?></td>
                                                            <td><input  name="txtlv918" type="text" id="txtlv918" value="<?php echo $mots_lv0011->lv018;?>" tabindex="24" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,1)" /></td>
                                                        </tr>
                                                        <tr>
                                                        	<td><?php echo $vLangArr[58];?></td>
                                                          <td><input  name="txtlv919" type="text" id="txtlv919" value="<?php echo $mots_lv0011->lv019;?>" tabindex="24" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,1)" /></td>
                                                          <td><?php echo $vLangArr[59];?></td>
                                                            <td><input  name="txtlv920" type="text" id="txtlv920" value="<?php echo $mots_lv0011->lv020;?>" tabindex="24" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,1)" /></td>
                                                        </tr>
                                                        <tr>
                                                          <td><?php echo $vLangArr[36];?></td>
                                                          <td><input type="text" name="txtlv908" id="txtlv908"  style="width:80%"  tabindex="25"  value="<?php echo (float)$mots_lv0011->lv008;?>" onKeyPress="return CheckKey(event,1)"></td>
							  ...
							  <?php echo $mots_lv0011->LV_LinkField('lv011',$mots_lv0011->lv011);?>
							  </select></td>
                                                          <td><?php echo $vLangArr[38];?></td>
                                                          <td><input  name="txtlv910" type="text" id="txtlv910" value="<?php echo (float)$mots_lv0011->lv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,1)" /></td>
                                                        </tr>
														<!--
                                                        <tr>
							  ...
							  <?php echo $mots_lv0011->LV_LinkField('lv012',$mots_lv0011->lv012);?>
							  ...
							  <?php echo $mots_lv0011->LV_LinkField('lv013',$mots_lv0011->lv013);?>
							  </select><br><table><tr><td>
