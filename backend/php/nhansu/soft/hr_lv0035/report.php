...
if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","HR0152.txt",$plang);
...
$mohr_lv0035->ArrPush[4]=$vLangArr[22];
$mohr_lv0035->ArrPush[5]=$vLangArr[23];
$mohr_lv0035->ArrPush[6]=$vLangArr[24];
...
?>
				...
				<?php echo $mohr_lv0035->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList,$vSortNum);?>
