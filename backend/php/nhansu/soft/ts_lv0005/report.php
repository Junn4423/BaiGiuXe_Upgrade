...
/////////////init object//////////////
$mots_lv0005=new ts_lv0005($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0013');
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
$mots_lv0005->lv002=base64_decode( $_GET['ID']);
...
?>
						...
						<?php echo $mots_lv0005->LV_BuilListReport($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
