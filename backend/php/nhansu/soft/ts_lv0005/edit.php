...
require_once("../../clsall/ts_lv0005.php");
//////////////init object////////////////
$lvts_lv0005=new ts_lv0005($_SESSION['ERPSOFV2RRight'],$_SESSION['ERPSOFV2RUserID'],'Sl0013');
$psaveget=getsaveget($plang,$popt,$pitem,$plink,$pgroup,$pitemlst,$pchildlst,$plevel3lst,$pchild3lst);
$lvts_lv0005->lv001=$_GET['ChildDetailID'];
if($plang=="") $plang="VN";
	$vLangArr=GetLangFile("../../","TS0009.txt",$plang);
$mots_lv0005->lang=strtoupper($plang);
$curPage = (int)($_POST['curPg'] ?? 1);	
$vFlag   = (int)($_POST['txtFlag'] ?? 0);
if($vFlag==1)
{
$lvts_lv0005->lv002=$_POST['txtlv002'];
$lvts_lv0005->lv003=$_POST['txtlv003'];
$lvts_lv0005->lv004=$_POST['txtlv004'];
$lvts_lv0005->lv005=$_POST['txtlv005'];
$lvts_lv0005->lv006=$_POST['txtlv006'];
$lvts_lv0005->lv007=$_POST['txtlv007'];
$lvts_lv0005->lv008=$_POST['txtlv008'];
$lvts_lv0005->lv009=$_POST['txtlv009'];
$lvts_lv0005->lv010=$_POST['txtlv010'];
$lvts_lv0005->lv011=$_POST['txtlv011'];
$lvts_lv0005->lv012=$_POST['txtlv012'];
		
		$vresult=$lvts_lv0005->LV_Update();
		if($vresult==true) {
...
$lvts_lv0005->LV_LoadID($lvts_lv0005->lv001);
					...
					<form action="#" name="frmedit" method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" align="center" id="table1">
							...
							<tr>
								...
								<td  height="20">
									<input name="txtlv001" type="text" id="txtlv001"  value="<?php echo $lvts_lv0005->lv001;?>" tabindex="5" maxlength="10" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/>		</td>
						    </tr>
							<tr>
							  <td  height="20"><?php echo $vLangArr[16];?></td>
							  <td  height="20"><input name="txtlv002" type="text" id="txtlv002"  value="<?php echo $lvts_lv0005->lv002;?>" tabindex="6" maxlength="225" style="width:80%" onKeyPress="return CheckKey(event,7)" readonly="true"/></td>
							</tr>
							<tr>
							  <td  height="20" valign="top"><?php echo $vLangArr[17];?></td>
							  <td  height="20">
							 <table style="width:80%"><tr>
							  <td width="50%"><select name="txtlv003" id="txtlv003"   tabindex="7"  style="width:100%" onKeyPress="return CheckKeys(event,7,this)"/><?php echo $lvts_lv0005->LV_LinkField('lv003',$lvts_lv0005->lv003);?>
							  </select></td><td>
...
<tr>
				              ...
				              <td  height="20"><input name="txtlv004" id="txtlv004"   tabindex="8"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvts_lv0005->lv004;?>"/></td>
</tr>							  
							<tr>
							  ...
							  <?php echo $lvts_lv0005->LV_LinkField('lv005',$lvts_lv0005->lv005);?>
							  </select></td><td>
							  ...
							  <td  height="20"><input name="txtlv006" type="text" id="txtlv006" value="<?php echo (float)$lvts_lv0005->lv006;?>" tabindex="10" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)"></td>
							  </tr>	
<tr>
							  ...
							  <?php echo $lvts_lv0005->LV_LinkField('lv007',$lvts_lv0005->lv007);?>
							  </select></td><td>
							...
							<tr>
							  ...
							  <td  height="20"><input name="txtlv008" id="txtlv008"   tabindex="12"  style="width:80%" onKeyPress="return CheckKey(event,7)" value="<?php echo (float)$lvts_lv0005->lv008;?>"/>							  </td>
						    </tr>
							<tr>
							  ...
							  <ul id="pop-nav4" lang="pop-nav4" onMouseOver="ChangeName(this,4)" onkeyup="ChangeName(this,4)"> <li class="menupopT">
							    <input type="text" name="txtlv009" id="txtlv009" tabindex="13" style="width:200px"onKeyPress="return CheckKey(event,7)" value="<?php echo $lvts_lv0005->lv009;?>" onKeyUp="LoadSelf(this,'txtlv009','sl_lv0017','lv003')" onFocus="LoadSelf(this,'txtlv009','sl_lv0017','lv003')">
				  ...
				  <td  height="20"><input  name="txtlv010" type="text" id="txtlv010" value="<?php echo $lvts_lv0005->lv010;?>" tabindex="14" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>							 			  							  <tr>
							  <td  height="20"><?php echo $vLangArr[25];?></td>
				  <td  height="20"><input  name="txtlv011" type="text" id="txtlv011" value="<?php echo $lvts_lv0005->lv011;?>" tabindex="15" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	 	
						   <tr>
							  <td  height="20"><?php echo $vLangArr[26];?></td>
				  <td  height="20"><input  name="txtlv012" type="text" id="txtlv012" value="<?php echo $lvts_lv0005->lv012;?>" tabindex="16" maxlength="255" style="width:80%" onKeyPress="return CheckKey(event,7)" /></td>
						  </tr>	
						<tr>
