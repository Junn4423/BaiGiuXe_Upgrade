...
//	$tsql="select count(*) from department where CompanyID ";
	...
	{
		$mots_lv0005->lv001=$_POST['txtlv001'.$i];
		$mots_lv0005->lv002=$_POST['txtlv002'.$i];
		$mots_lv0005->lv008=$_POST['txtlv008'.$i];
		$mots_lv0005->lv009=$_POST['txtlv009'.$i];
		$mots_lv0005->lv010=$_POST['txtlv010'.$i];
		$mots_lv0005->lv011=$_POST['txtlv011'.$i];
		$mots_lv0005->lv012=$_POST['txtlv012'.$i];
		$vresult=$mots_lv0005->LV_UpdateOther();
				...
				<!--////////////////////////////////////Code add here///////////////////////////////////////////-->
					<div><div id="lvleft"><form onSubmit="return false;" action="?func=<?php echo $_GET['func'];?>&childfunc=<?php echo $_GET['childfunc'];?>&ID=<?php echo  $_GET['ID']?>&ChildID=<?php echo $_GET['ChildID'];?>&<?php echo getsaveget($plang,$popt,$pitem,$plink,$pgroup,0,0,2,0);?>" method="post" name="frmchoose" id="frmchoose">
					  <input type="hidden" name="curPg" value="<?php echo  $curPage;?>"/>
						<?php echo $mots_lv0005->LV_BuilListInput($vFieldList,'document.frmchoose','chkAll','lvChk',$curRow, $maxRows,$paging,$vOrderList);?>
