...
require_once("../paras.php");
require_once("../../clsall/mn_menusl0006.php");
...
//init object
$mn_menusl0006=new mn_menusl0006();
//Set variant
$mn_menusl0006->itemlst=$pitemlst;
$mn_menusl0006->childlst=$pchildlst;
$mn_menusl0006->level3lst=$plevel3lst;
$mn_menusl0006->child3lst=$pchild3lst;
...
<div id="content_child">
              ...
              <tr>
                <td><TABLE id="toolbar" cellSpacing="0" cellPadding="0" border="0" width="100%">
					<TBODY>
						<TR vAlign="center" align="middle">				
	 			 		...
	 			 		<select name="cbxoption" tabindex="1" onChange="callchange(this)" style="width:80px">
							<option value="1" <?php echo ($mn_menusl0006->level3lst==1)?'selected="selected"':'';?> >1.<?php echo $vLangArr[8];?></option>
							<option value="2" <?php echo ((int)$mn_menusl0006->level3lst==2)?'selected="selected"':'';?>>2.<?php echo $vLangArr[9];?></option>
							<option value="3" <?php echo ((int)$mn_menusl0006->level3lst==3)?'selected="selected"':'';?>>3.<?php echo $vLangArr[10];?></option>
							<option value="4" <?php echo ((int)$mn_menusl0006->level3lst==4)?'selected="selected"':'';?>>4.<?php echo 'Bán Thành Phẩm';?></option>
						</select>
					...
					<input type="hidden" name="txtFlagDocument" id="txtFlagDocument" />
							...
							<TD  class="toolbar_<?php echo ($mn_menusl0006->level3lst==1)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(1);">
							...
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>
							<TD  class="toolbar_<?php echo ($mn_menusl0006->level3lst==2)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(2);">
								<img src="../images/controlright/save_document.gif" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo $vLangArr[9];?></a></TD>
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>
							<TD  class="toolbar_<?php echo ($mn_menusl0006->level3lst==3)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(3);">
								<img src="../images/controlright/instock_add.gif" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo $vLangArr[10];?></a></TD>
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>
							<TD  class="toolbar_<?php echo ($mn_menusl0006->level3lst==4)?'selected':'';?>"><a class="toolbar" href="javascript:rundisplayLayer(4);">
								<img src="../images/controlright/instock_add.gif" title="<?php echo $vLangArr[100];?>" 
									 alt="add" border="0" align="middle" width="32" height="32">
								<br><?php echo 'Bán Thành Phẩm';?></a></TD>
							<TD>&nbsp;</TD>
							<TD>&nbsp;</TD>
	...
	<?php
	$mn_menusl0006->Dir="../";
include($mn_menusl0006->GetLinkEmp());
?>
	</div></div></td>
              </tr>
            </table>
...
document.frmhr_employee.cbxoption.value="<?php echo $mn_menusl0006->level3lst;?>";
